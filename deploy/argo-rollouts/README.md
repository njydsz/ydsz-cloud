...
#
#   3) 原 Deployment 已迁出, 改用 Rollout 接管 (参见 overlays/prod/project-rollout.yaml 范例)
#
# 用法 (替换原有 canary-shift.sh):
#   kubectl argo rollouts set image pmis-project project=registry/ydsz/ydsz-pmis-project:v1.2.0-rc1 -n pmis-prod
#   kubectl argo rollouts promote pmis-project -n pmis-prod       # 推进到下一步
#   kubectl argo rollouts abort pmis-project -n pmis-prod          # 紧急中止 + 回滚
#   kubectl argo rollouts status pmis-project -n pmis-prod -w      # 实时观察
...
#   examples/              - 各服务 Rollout 范例 (project/finance/agent/...)
#   README.md              - 本文件
