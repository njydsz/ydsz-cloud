...
echo
echo "下一步:"
echo "  1. 检查状态:  deploy/scripts/ubuntu/infra-manager.sh status"
echo "  2. 导入 Nacos 共享配置:  deploy/scripts/import-nacos-config.sh"
echo "  3. 启动后端:  deploy/scripts/start-all.sh"
echo "============================================================"
