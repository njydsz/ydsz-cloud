...
#
#  用法：
#    ./deploy/ubuntu/scripts/start-all.sh            # 全量启动
#    ./deploy/ubuntu/scripts/start-all.sh --backend  # 只启动后端
#    ./deploy/ubuntu/scripts/start-all.sh --frontend # 只启动前端
#    ./deploy/ubuntu/scripts/start-all.sh --infra    # 只启动基础设施
# =============================================================================
set -e
