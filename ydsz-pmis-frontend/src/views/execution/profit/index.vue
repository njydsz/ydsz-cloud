        ...
        >
          ...
          <template #table="scope">
            <vxe-table :data="rList" :loading="rLoading" border stripe :height="scope.tableProps.height" :scroll-y="scope.tableProps.scrollY">
              ...
              <vxe-column field="amount" :title="$t('execution.profit.columns.amount')" width="130" align="right" :formatter="({ cellValue }) => cellValue != null ? `¥${Number(cellValue).toLocaleString()}` : '-'" />
        ...
        >
          ...
          <template #table="scope">
            <vxe-table :data="pList" :loading="pLoading" border stripe :height="scope.tableProps.height" :scroll-y="scope.tableProps.scrollY">
              ...
              <vxe-column field="period" :title="$t('execution.profit.columns.period')" width="100" />
              <vxe-column field="revenue" :title="$t('execution.profit.columns.revenue')" width="130" align="right" :formatter="({ cellValue }) => cellValue != null ? `¥${Number(cellValue).toLocaleString()}` : '-'" />
              <vxe-column field="laborCost" :title="$t('execution.profit.columns.laborCost')" width="120" align="right" :formatter="({ cellValue }) => cellValue != null ? `¥${Number(cellValue).toLocaleString()}` : '-'" />
              <vxe-column field="purchaseCost" :title="$t('execution.profit.columns.purchaseCost')" width="120" align="right" :formatter="({ cellValue }) => cellValue != null ? `¥${Number(cellValue).toLocaleString()}` : '-'" />
              <vxe-column field="expenseCost" :title="$t('execution.profit.columns.expenseCost')" width="120" align="right" :formatter="({ cellValue }) => cellValue != null ? `¥${Number(cellValue).toLocaleString()}` : '-'" />
              <vxe-column field="totalCost" :title="$t('execution.profit.columns.totalCost')" width="130" align="right" :formatter="({ cellValue }) => cellValue != null ? `¥${Number(cellValue).toLocaleString()}` : '-'" />
              <vxe-column field="grossProfit" :title="$t('execution.profit.columns.grossProfit')" width="130" align="right" :formatter="({ cellValue }) => cellValue != null ? `¥${Number(cellValue).toLocaleString()}` : '-'" />
              <vxe-column field="grossMargin" :title="$t('execution.profit.columns.grossMargin')" width="100" align="right" :formatter="({ cellValue }) => cellValue != null ? `${(Number(cellValue) * 100).toFixed(1)}%` : '-'" />
