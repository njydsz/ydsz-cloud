...
CREATE TABLE ydsz_gen_template (
    ...
    folder                   NUMBER(1)                NOT NULL DEFAULT 0,
...
COMMENT ON COLUMN ydsz_gen_template.folder IS '是否为虚拟文件夹标记（0=否 1=是）';
...
COMMENT ON COLUMN ydsz_gen_template.active IS '是否启用（0=否 1=是）';
...
CREATE TABLE ydzs_gen_column_meta (
    ...
    pk                       NUMBER(1)                NOT NULL DEFAULT 0,
    comment                  VARCHAR2(255 CHAR)        DEFAULT NULL,
    override_java_type       VARCHAR2(64 CHAR)        DEFAULT NULL,
    override_field_name      VARCHAR2(64 CHAR)        DEFAULT NULL,
    dto_skipped              NUMBER(1)                NOT NULL DEFAULT 0,
    vo_skipped               NUMBER(1)                NOT NULL DEFAULT 0,
    query_skipped            NUMBER(1)                NOT NULL DEFAULT 0,
...
COMMENT ON COLUMN ydzs_gen_column_meta.pk IS '是否为主键（0=否 1=是）';
...
COMMENT ON COLUMN ydzs_gen_column_meta.dto_skipped IS '是否在 DTO 中跳过（0=否 1=是）';
COMMENT ON COLUMN ydzs_gen_column_meta.vo_skipped IS '是否在 VO 中跳过（0=否 1=是）';
COMMENT ON COLUMN ydzs_gen_column_meta.query_skipped IS '是否在 Query 中跳过（0=否 1=是）';
