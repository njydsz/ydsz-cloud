...
--       搜索死信队列表由 PostgreSQL 版本（ydsz_search_dead_letter.sql）转译为 PostgreSQL。
...
CREATE INDEX IF NOT EXISTS idx_ydsz_outbox_pending ON ydsz_outbox (status, created_at ASC);
CREATE INDEX IF NOT EXISTS idx_ydsz_outbox_retry ON ydsz_outbox (status, next_retry_at);
CREATE INDEX IF NOT EXISTS idx_ydsz_outbox_processing ON ydsz_outbox (status, updated_at);
CREATE INDEX IF NOT EXISTS idx_ydsz_outbox_sent_at ON ydsz_outbox (status, sent_at);
CREATE INDEX IF NOT EXISTS idx_ydsz_outbox_tenant ON ydsz_outbox (tenant_id, status);
CREATE INDEX IF NOT EXISTS idx_ydsz_outbox_dedup ON ydsz_outbox (deduplication_id, status);
CREATE INDEX IF NOT EXISTS idx_ydsz_outbox_aggregate ON ydsz_outbox (aggregate_type, aggregate_id, created_at DESC);
...
CREATE INDEX IF NOT EXISTS idx_ydsz_search_dead_letter_dlq_status_created ON ydsz_search_dead_letter (status, created_at);
CREATE INDEX IF NOT EXISTS idx_ydsz_search_dead_letter_dlq_doc_type ON ydsz_search_dead_letter (doc_type, status);
...
DROP TRIGGER IF EXISTS trg_ydsz_outbox_updated_at ON ydsz_outbox;
