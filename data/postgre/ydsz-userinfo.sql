...
CREATE INDEX IF NOT EXISTS idx_ydsz_user_account_phone ON ydsz_user_account (phone);
CREATE INDEX IF NOT EXISTS idx_ydsz_user_account_dept_id ON ydsz_user_account (dept_id);
CREATE INDEX IF NOT EXISTS idx_ydsz_user_account_company_id ON ydsz_user_account (company_id);
CREATE INDEX IF NOT EXISTS idx_ydsz_user_account_tenant_deleted ON ydsz_user_account (tenant_id, deleted);
...
CREATE INDEX IF NOT EXISTS idx_ydsz_company_parent_id ON ydsz_company (parent_id);
CREATE INDEX IF NOT EXISTS idx_ydsz_company_tenant_deleted ON ydsz_company (tenant_id, deleted);
...
CREATE INDEX IF NOT EXISTS idx_ydsz_department_parent_id ON ydsz_department (parent_id);
CREATE INDEX IF NOT EXISTS idx_ydsz_department_leader_id ON ydsz_department (leader_id);
CREATE INDEX IF NOT EXISTS idx_ydsz_department_tenant_deleted ON ydsz_department (tenant_id, deleted);
...
CREATE INDEX IF NOT EXISTS idx_ydsz_role_tenant_deleted ON ydsz_role (tenant_id, deleted);
...
CREATE INDEX IF NOT EXISTS idx_ydsz_menu_parent_id ON ydsz_menu (parent_id);
CREATE INDEX IF NOT EXISTS idx_ydsz_menu_permission_code ON ydsz_menu (permission_code);
CREATE INDEX IF NOT EXISTS idx_ydsz_menu_tenant_deleted ON ydsz_menu (tenant_id, deleted);
...
CREATE INDEX IF NOT EXISTS idx_ydsz_post_tenant_deleted ON ydsz_post (tenant_id, deleted);
...
CREATE INDEX IF NOT EXISTS idx_ydsz_language_tenant_deleted ON ydsz_language (tenant_id, deleted);
...
CREATE INDEX IF NOT EXISTS idx_ydsz_user_role_user_id ON ydsz_user_role (user_id);
CREATE INDEX IF NOT EXISTS idx_ydsz_user_role_role_id ON ydsz_user_role (role_id);
CREATE INDEX IF NOT EXISTS idx_ydsz_user_role_tenant_deleted ON ydsz_user_role (tenant_id, deleted);
...
CREATE INDEX IF NOT EXISTS idx_ydsz_user_post_user_id ON ydsz_user_post (user_id);
CREATE INDEX IF NOT EXISTS idx_ydsz_user_post_post_id ON ydsz_user_post (post_id);
CREATE INDEX IF NOT EXISTS idx_ydsz_user_post_tenant_deleted ON ydsz_user_post (tenant_id, deleted);
...
CREATE INDEX IF NOT EXISTS idx_ydsz_user_dept_user_id ON ydsz_user_dept (user_id);
CREATE INDEX IF NOT EXISTS idx_ydsz_user_dept_dept_id ON ydsz_user_dept (dept_id);
CREATE INDEX IF NOT EXISTS idx_ydsz_user_dept_tenant_deleted ON ydsz_user_dept (tenant_id, deleted);
...
CREATE INDEX IF NOT EXISTS idx_ydsz_company_dept_company_id ON ydsz_company_dept (company_id);
CREATE INDEX IF NOT EXISTS idx_ydsz_company_dept_dept_id ON ydsz_company_dept (dept_id);
CREATE INDEX IF NOT EXISTS idx_ydsz_company_dept_tenant_deleted ON ydsz_company_dept (tenant_id, deleted);
...
CREATE INDEX IF NOT EXISTS idx_ydsz_role_permission_role_id ON ydsz_role_permission (role_id);
CREATE INDEX IF NOT EXISTS idx_ydsz_role_permission_permission_id ON ydsz_role_permission (permission_id);
CREATE INDEX IF NOT EXISTS idx_ydsz_role_permission_menu_id ON ydsz_role_permission (menu_id);
CREATE INDEX IF NOT EXISTS idx_ydsz_role_permission_tenant_deleted ON ydsz_role_permission (tenant_id, deleted);
...
CREATE INDEX IF NOT EXISTS idx_ydsz_user_login_history_user_id_created_at ON ydsz_user_login_history (user_id, created_at);
CREATE INDEX IF NOT EXISTS idx_ydsz_user_login_history_ip ON ydsz_user_login_history (login_ip);
CREATE INDEX IF NOT EXISTS idx_ydsz_user_login_history_created_at ON ydsz_user_login_history (created_at);
...
CREATE INDEX IF NOT EXISTS idx_ydsz_user_password_history_user_id_created_at ON ydsz_user_password_history (user_id, created_at);
CREATE INDEX IF NOT EXISTS idx_ydsz_user_password_history_user_id ON ydsz_user_password_history (user_id);
...
CREATE INDEX IF NOT EXISTS idx_ydsz_social_client_tenant_deleted ON ydsz_social_client (tenant_id, deleted);
...
CREATE INDEX IF NOT EXISTS idx_ydsz_saml_idp_config_tenant_deleted ON ydsz_saml_idp_config (tenant_id, deleted);
...
CREATE INDEX IF NOT EXISTS idx_ydsz_oauth2_application_tenant_deleted ON ydsz_oauth2_application (tenant_id, deleted);
...
CREATE INDEX IF NOT EXISTS idx_ydsz_social_account_user_id ON ydsz_social_account (user_id);
CREATE INDEX IF NOT EXISTS idx_ydsz_social_account_tenant_deleted ON ydsz_social_account (tenant_id, deleted);
...
CREATE INDEX IF NOT EXISTS idx_ydsz_security_alert_status_risk ON ydsz_security_alert (status, risk_level);
CREATE INDEX IF NOT EXISTS idx_ydsz_security_alert_type_time ON ydsz_security_alert (alert_type, created_at);
CREATE INDEX IF NOT EXISTS idx_ydsz_security_alert_user_id ON ydsz_security_alert (user_id);
CREATE INDEX IF NOT EXISTS idx_ydsz_security_alert_source_ip ON ydsz_security_alert (source_ip);
CREATE INDEX IF NOT EXISTS idx_ydsz_security_alert_tenant_deleted ON ydsz_security_alert (tenant_id, deleted);
...
CREATE INDEX IF NOT EXISTS idx_ydsz_user_credential_user_id ON ydsz_user_credential (user_id);
...
DROP TRIGGER IF EXISTS trg_ydsz_user_account_updated_at ON ydsz_user_account;
...
DROP TRIGGER IF EXISTS trg_ydsz_company_updated_at ON ydsz_company;
...
DROP TRIGGER IF EXISTS trg_ydsz_department_updated_at ON ydsz_department;
...
DROP TRIGGER IF EXISTS trg_ydsz_role_updated_at ON ydsz_role;
...
DROP TRIGGER IF EXISTS trg_ydsz_menu_updated_at ON ydsz_menu;
...
DROP TRIGGER IF EXISTS trg_ydsz_post_updated_at ON ydsz_post;
...
DROP TRIGGER IF EXISTS trg_ydsz_language_updated_at ON ydsz_language;
...
DROP TRIGGER IF EXISTS trg_ydsz_user_role_updated_at ON ydsz_user_role;
...
DROP TRIGGER IF EXISTS trg_ydsz_user_post_updated_at ON ydsz_user_post;
...
DROP TRIGGER IF EXISTS trg_ydsz_user_dept_updated_at ON ydsz_user_dept;
...
DROP TRIGGER IF EXISTS trg_ydsz_company_dept_updated_at ON ydsz_company_dept;
...
DROP TRIGGER IF EXISTS trg_ydsz_role_permission_updated_at ON ydsz_role_permission;
...
DROP TRIGGER IF EXISTS trg_ydsz_social_client_updated_at ON ydsz_social_client;
...
DROP TRIGGER IF EXISTS trg_ydsz_saml_idp_config_updated_at ON ydsz_saml_idp_config;
...
DROP TRIGGER IF EXISTS trg_ydsz_oauth2_application_updated_at ON ydsz_oauth2_application;
...
DROP TRIGGER IF EXISTS trg_ydsz_social_account_updated_at ON ydsz_social_account;
...
DROP TRIGGER IF EXISTS trg_ydsz_security_alert_updated_at ON ydsz_security_alert;
...
DROP TRIGGER IF EXISTS trg_ydsz_user_credential_updated_at ON ydsz_user_credential;
