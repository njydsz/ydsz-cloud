...
--   - 执行方式: psql -U <user> -d <db> -f ydsz-workflow.sql
-- ============================================================================
...
CREATE TABLE IF NOT EXISTS ydsz_flow_definition (
    ...
    form_custom              VARCHAR(8)               DEFAULT NULL,
    form_path                VARCHAR(1024)            DEFAULT NULL,
    activity_status          INTEGER                  NOT NULL DEFAULT 1,
    is_publish               INTEGER                  NOT NULL DEFAULT 0,
    listener_type            VARCHAR(32)              DEFAULT NULL,
    listener_path            VARCHAR(128)             DEFAULT NULL,
    ext                      JSONB                    DEFAULT NULL,
    description              VARCHAR(512)             DEFAULT NULL,
    provider_trace_id        VARCHAR(64)              DEFAULT NULL,
    canary_percent           INTEGER                  NOT NULL DEFAULT 0,
    canary_status            VARCHAR(32)              DEFAULT NULL,
    canary_strategy          VARCHAR(32)              DEFAULT NULL,
    canary_rollout_log       JSONB                    DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS ydsz_flow_node (
    ...
    skip_any_node            VARCHAR(512)             DEFAULT NULL,
    coordinate               JSONB                    DEFAULT NULL,
    skip_list                JSONB                    DEFAULT NULL,
    ext                      JSONB                    DEFAULT NULL,
    form_fields_config       JSONB                    DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS ydsz_flow_skip (
    ...
    source_node_code         VARCHAR(64)              DEFAULT NULL,
    next_node_type           INTEGER                  DEFAULT NULL,
    coordinate_next          JSONB                    DEFAULT NULL,
    skip_list                JSONB                    DEFAULT NULL,
    ext                      JSONB                    DEFAULT NULL,
    provider_trace_id        VARCHAR(64)              DEFAULT NULL,
    status                   VARCHAR(32)              DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS ydsz_flow_instance (
    ...
    variable                 JSONB                    DEFAULT NULL,
    flow_status              VARCHAR(32)              NOT NULL,
    activity_status          INTEGER                  NOT NULL DEFAULT 1,
    start_at                 TIMESTAMP                DEFAULT NULL,
    end_at                   TIMESTAMP                DEFAULT NULL,
    duration_ms              BIGINT                   DEFAULT NULL,
    parent_instance_id       VARCHAR(32)              DEFAULT NULL,
    parent_node_code         VARCHAR(64)              DEFAULT NULL,
    provider_trace_id        VARCHAR(64)              DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS ydsz_flow_run_task (
    ...
    title                    VARCHAR(128)             DEFAULT NULL,
    assignor_id              VARCHAR(32)              DEFAULT NULL,
    assignor_name            VARCHAR(64)              DEFAULT NULL,
    assignee_type            VARCHAR(32)              DEFAULT NULL,
    assignee_id              VARCHAR(64)              NOT NULL,
    assignee_name            VARCHAR(64)              DEFAULT NULL,
    permission_flag          VARCHAR(512)             DEFAULT NULL,
    perform_type             VARCHAR(32)              DEFAULT NULL,
    approve_count            INTEGER                  DEFAULT NULL,
    approve_finished         INTEGER                  DEFAULT NULL,
    vote_pass_rate           NUMERIC(20,6)            DEFAULT NULL,
    user_weight              INTEGER                  DEFAULT NULL,
    approve_weight           INTEGER                  DEFAULT NULL,
    total_weight             INTEGER                  DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS ydsz_flow_timer (
    ...
    boundary_task_id         VARCHAR(32)              DEFAULT NULL,
    fire_at                  TIMESTAMP                NOT NULL,
    cycle                    VARCHAR(64)              DEFAULT NULL,
    timer_status             VARCHAR(32)              NOT NULL DEFAULT 'PENDING',
...
CREATE TABLE IF NOT EXISTS ydsz_flow_event_subscription (
    ...
    boundary_task_id         VARCHAR(32)              DEFAULT NULL,
    subscription_status      VARCHAR(32)              NOT NULL DEFAULT 'WAITING',
...
CREATE INDEX IF NOT EXISTS idx_ydsz_flow_event_subscription_instance_id ON ydsz_flow_event_subscription (instance_id);
...
CREATE INDEX IF NOT EXISTS idx_ydsz_flow_his_task_instance_id ON ydsz_flow_his_task (instance_id);
...
CREATE TABLE IF NOT EXISTS ydsz_flow_his_instance (
    ...
    flow_name                VARCHAR(128)             DEFAULT NULL,
    definition_id            VARCHAR(32)              NOT NULL,
    flow_version             VARCHAR(32)              DEFAULT NULL,
    business_type            VARCHAR(64)              NOT NULL,
    business_id              VARCHAR(64)              NOT NULL,
    business_no              VARCHAR(64)              DEFAULT NULL,
    title                    VARCHAR(128)             DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS ydsz_flow_comment (
    ...
    reply_to_user_id         VARCHAR(32)              DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS ydsz_flow_cc (
    ...
    trigger_user_id          VARCHAR(32)              DEFAULT NULL,
    trigger_user_name        VARCHAR(64)              DEFAULT NULL,
    title                    VARCHAR(128)             DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS ydsz_flow_cc_rule (
    ...
    rule_target              VARCHAR(512)             DEFAULT NULL,
    enabled                  INTEGER                  NOT NULL DEFAULT 1,
    provider_trace_id        VARCHAR(64)              DEFAULT NULL,
    status                   VARCHAR(32)              DEFAULT NULL,
    deleted                  SMALLINT                 NOT NULL DEFAULT 0,
...
CREATE TABLE IF NOT EXISTS ydsz_flow_delegate_auth (
    ...
    delegate_user_name       VARCHAR(64)              DEFAULT NULL,
...
CREATE INDEX IF NOT EXISTS idx_ydsz_flow_audit_log_instance_id ON ydsz_flow_audit_log (instance_id);
...
CREATE OR REPLACE FUNCTION fn_ydsz_flow_category_set_updated_at()
RETURNS TRIGGER AS $$
BEGIN
...
DROP TRIGGER IF EXISTS trg_ydsz_flow_category_updated_at ON ydsz_flow_category;
CREATE TRIGGER trg_ydsz_flow_category_updated_at
BEFORE UPDATE ON ydsz_flow_category
FOR EACH ROW
EXECUTE FUNCTION fn_ydsz_flow_category_set_updated_at();

-- 自动更新 updated_at（原 MySQL ON UPDATE CURRENT_TIMESTAMP）
CREATE OR REPLACE FUNCTION fn_ydsz_flow_definition_set_updated_at()
RETURNS TRIGGER AS $$
BEGIN
    NEW.updated_at := CURRENT_TIMESTAMP;
    RETURN NEW;
...
DROP TRIGGER IF EXISTS trg_ydsz_flow_definition_updated_at ON ydsz_flow_definition;
CREATE TRIGGER trg_ydsz_flow_definition_updated_at
BEFORE UPDATE ON ydsz_flow_definition
FOR EACH ROW
EXECUTE FUNCTION fn_ydsz_flow_definition_set_updated_at();

-- 自动更新 updated_at（原 MySQL ON UPDATE CURRENT_TIMESTAMP）
CREATE OR REPLACE FUNCTION fn_ydsz_flow_template_set_updated_at()
RETURNS TRIGGER AS $$
BEGIN
    NEW.updated_at := CURRENT_TIMESTAMP;
    RETURN NEW;
...
DROP TRIGGER IF EXISTS trg_ydsz_flow_template_updated_at ON ydsz_flow_template;
CREATE TRIGGER trg_ydsz_flow_template_updated_at
BEFORE UPDATE ON ydsz_flow_template
FOR EACH ROW
EXECUTE FUNCTION fn_ydsz_flow_template_set_updated_at();

-- 自动更新 updated_at（原 MySQL ON UPDATE CURRENT_TIMESTAMP）
CREATE OR REPLACE FUNCTION fn_ydsz_flow_node_set_updated_at()
RETURNS TRIGGER AS $$
BEGIN
    NEW.updated_at := CURRENT_TIMESTAMP;
    RETURN NEW;
...
DROP TRIGGER IF EXISTS trg_ydsz_flow_node_updated_at ON ydsz_flow_node;
CREATE TRIGGER trg_ydsz_flow_node_updated_at
BEFORE UPDATE ON ydsz_flow_node
FOR EACH ROW
EXECUTE FUNCTION fn_ydsz_flow_node_set_updated_at();

-- 自动更新 updated_at（原 MySQL ON UPDATE CURRENT_TIMESTAMP）
CREATE OR REPLACE FUNCTION fn_ydsz_flow_skip_set_updated_at()
RETURNS TRIGGER AS $$
BEGIN
    NEW.updated_at := CURRENT_TIMESTAMP;
    RETURN NEW;
...
DROP TRIGGER IF EXISTS trg_ydsz_flow_skip_updated_at ON ydsz_flow_skip;
CREATE TRIGGER trg_ydsz_flow_skip_updated_at
BEFORE UPDATE ON ydsz_flow_skip
FOR EACH ROW
EXECUTE FUNCTION fn_ydsz_flow_skip_set_updated_at();

-- 自动更新 updated_at（原 MySQL ON UPDATE CURRENT_TIMESTAMP）
CREATE OR REPLACE FUNCTION fn_ydsz_flow_auto_trigger_set_updated_at()
RETURNS TRIGGER AS $$
BEGIN
    NEW.updated_at := CURRENT_TIMESTAMP;
    RETURN NEW;
...
DROP TRIGGER IF EXISTS trg_ydsz_flow_auto_trigger_updated_at ON ydsz_flow_auto_trigger;
CREATE TRIGGER trg_ydsz_flow_auto_trigger_updated_at
BEFORE UPDATE ON ydsz_flow_auto_trigger
FOR EACH ROW
EXECUTE FUNCTION fn_ydsz_flow_auto_trigger_set_updated_at();

-- 自动更新 updated_at（原 MySQL ON UPDATE CURRENT_TIMESTAMP）
CREATE OR REPLACE FUNCTION fn_ydsz_flow_instance_set_updated_at()
RETURNS TRIGGER AS $$
BEGIN
    NEW.updated_at := CURRENT_TIMESTAMP;
    RETURN NEW;
...
DROP TRIGGER IF EXISTS trg_ydsz_flow_instance_updated_at ON ydsz_flow_instance;
CREATE TRIGGER trg_ydsz_flow_instance_updated_at
BEFORE UPDATE ON ydsz_flow_instance
FOR EACH ROW
EXECUTE FUNCTION fn_ydsz_flow_instance_set_updated_at();

-- 自动更新 updated_at（原 MySQL ON UPDATE CURRENT_TIMESTAMP）
CREATE OR REPLACE FUNCTION fn_ydsz_flow_run_task_set_updated_at()
RETURNS TRIGGER AS $$
BEGIN
    NEW.updated_at := CURRENT_TIMESTAMP;
    RETURN NEW;
...
DROP TRIGGER IF EXISTS trg_ydsz_flow_run_task_updated_at ON ydsz_flow_run_task;
CREATE TRIGGER trg_ydsz_flow_run_task_updated_at
BEFORE UPDATE ON ydsz_flow_run_task
FOR EACH ROW
EXECUTE FUNCTION fn_ydsz_flow_run_task_set_updated_at();

-- 自动更新 updated_at（原 MySQL ON UPDATE CURRENT_TIMESTAMP）
CREATE OR REPLACE FUNCTION fn_ydsz_flow_user_set_updated_at()
RETURNS TRIGGER AS $$
BEGIN
    NEW.updated_at := CURRENT_TIMESTAMP;
    RETURN NEW;
...
DROP TRIGGER IF EXISTS trg_ydsz_flow_user_updated_at ON ydsz_flow_user;
CREATE TRIGGER trg_ydsz_flow_user_updated_at
BEFORE UPDATE ON ydsz_flow_user
FOR EACH ROW
EXECUTE FUNCTION fn_ydsz_flow_user_set_updated_at();

-- 自动更新 updated_at（原 MySQL ON UPDATE CURRENT_TIMESTAMP）
CREATE OR REPLACE FUNCTION fn_ydsz_flow_timer_set_updated_at()
RETURNS TRIGGER AS $$
BEGIN
    NEW.updated_at := CURRENT_TIMESTAMP;
    RETURN NEW;
...
DROP TRIGGER IF EXISTS trg_ydsz_flow_timer_updated_at ON ydsz_flow_timer;
CREATE TRIGGER trg_ydsz_flow_timer_updated_at
BEFORE UPDATE ON ydsz_flow_timer
FOR EACH ROW
EXECUTE FUNCTION fn_ydsz_flow_timer_set_updated_at();

-- 自动更新 updated_at（原 MySQL ON UPDATE CURRENT_TIMESTAMP）
CREATE OR REPLACE FUNCTION fn_ydsz_flow_event_subscription_set_updated_at()
RETURNS TRIGGER AS $$
BEGIN
    NEW.updated_at := CURRENT_TIMESTAMP;
    RETURN NEW;
...
DROP TRIGGER IF EXISTS trg_ydsz_flow_event_subscription_updated_at ON ydsz_flow_event_subscription;
CREATE TRIGGER trg_ydsz_flow_event_subscription_updated_at
BEFORE UPDATE ON ydsz_flow_event_subscription
FOR EACH ROW
EXECUTE FUNCTION fn_ydsz_flow_event_subscription_set_updated_at();

-- 自动更新 updated_at（原 MySQL ON UPDATE CURRENT_TIMESTAMP）
CREATE OR REPLACE FUNCTION fn_ydsz_flow_comment_set_updated_at()
RETURNS TRIGGER AS $$
BEGIN
    NEW.updated_at := CURRENT_TIMESTAMP;
    RETURN NEW;
...
DROP TRIGGER IF EXISTS trg_ydsz_flow_comment_updated_at ON ydsz_flow_comment;
CREATE TRIGGER trg_ydsz_flow_comment_updated_at
BEFORE UPDATE ON ydsz_flow_comment
FOR EACH ROW
EXECUTE FUNCTION fn_ydsz_flow_comment_set_updated_at();

-- 自动更新 updated_at（原 MySQL ON UPDATE CURRENT_TIMESTAMP）
CREATE OR REPLACE FUNCTION fn_ydsz_flow_quick_comment_set_updated_at()
RETURNS TRIGGER AS $$
BEGIN
    NEW.updated_at := CURRENT_TIMESTAMP;
    RETURN NEW;
...
DROP TRIGGER IF EXISTS trg_ydsz_flow_quick_comment_updated_at ON ydsz_flow_quick_comment;
CREATE TRIGGER trg_ydsz_flow_quick_comment_updated_at
BEFORE UPDATE ON ydsz_flow_quick_comment
FOR EACH ROW
EXECUTE FUNCTION fn_ydsz_flow_quick_comment_set_updated_at();

-- 自动更新 updated_at（原 MySQL ON UPDATE CURRENT_TIMESTAMP）
CREATE OR REPLACE FUNCTION fn_ydsz_flow_cc_set_updated_at()
RETURNS TRIGGER AS $$
BEGIN
    NEW.updated_at := CURRENT_TIMESTAMP;
    RETURN NEW;
...
DROP TRIGGER IF EXISTS trg_ydsz_flow_cc_updated_at ON ydsz_flow_cc;
CREATE TRIGGER trg_ydsz_flow_cc_updated_at
BEFORE UPDATE ON ydsz_flow_cc
FOR EACH ROW
EXECUTE FUNCTION fn_ydsz_flow_cc_set_updated_at();

-- 自动更新 updated_at（原 MySQL ON UPDATE CURRENT_TIMESTAMP）
CREATE OR REPLACE FUNCTION fn_ydsz_flow_cc_rule_set_updated_at()
RETURNS TRIGGER AS $$
BEGIN
    NEW.updated_at := CURRENT_TIMESTAMP;
    RETURN NEW;
...
DROP TRIGGER IF EXISTS trg_ydsz_flow_cc_rule_updated_at ON ydsz_flow_cc_rule;
CREATE TRIGGER trg_ydsz_flow_cc_rule_updated_at
BEFORE UPDATE ON ydsz_flow_cc_rule
FOR EACH ROW
EXECUTE FUNCTION fn_ydsz_flow_cc_rule_set_updated_at();

-- 自动更新 updated_at（原 MySQL ON UPDATE CURRENT_TIMESTAMP）
CREATE OR REPLACE FUNCTION fn_ydsz_flow_attachment_set_updated_at()
RETURNS TRIGGER AS $$
BEGIN
    NEW.updated_at := CURRENT_TIMESTAMP;
    RETURN NEW;
...
DROP TRIGGER IF EXISTS trg_ydsz_flow_attachment_updated_at ON ydsz_flow_attachment;
CREATE TRIGGER trg_ydsz_flow_attachment_updated_at
BEFORE UPDATE ON ydsz_flow_attachment
FOR EACH ROW
EXECUTE FUNCTION fn_ydsz_flow_attachment_set_updated_at();

-- 自动更新 updated_at（原 MySQL ON UPDATE CURRENT_TIMESTAMP）
CREATE OR REPLACE FUNCTION fn_ydsz_flow_delegate_auth_set_updated_at()
RETURNS TRIGGER AS $$
BEGIN
    NEW.updated_at := CURRENT_TIMESTAMP;
    RETURN NEW;
...
DROP TRIGGER IF EXISTS trg_ydsz_flow_delegate_auth_updated_at ON ydsz_flow_delegate_auth;
CREATE TRIGGER trg_ydsz_flow_delegate_auth_updated_at
BEFORE UPDATE ON ydsz_flow_delegate_auth
FOR EACH ROW
EXECUTE FUNCTION fn_ydsz_flow_delegate_auth_set_updated_at();

-- 自动更新 updated_at（原 MySQL ON UPDATE CURRENT_TIMESTAMP）
CREATE OR REPLACE FUNCTION fn_ydsz_flow_admin_role_set_updated_at()
RETURNS TRIGGER AS $$
BEGIN
    NEW.updated_at := CURRENT_TIMESTAMP;
    RETURN NEW;
...
DROP TRIGGER IF EXISTS trg_ydsz_flow_admin_role_updated_at ON ydsz_flow_admin_role;
CREATE TRIGGER trg_ydsz_flow_admin_role_updated_at
BEFORE UPDATE ON ydsz_flow_admin_role
FOR EACH ROW
EXECUTE FUNCTION fn_ydsz_flow_admin_role_set_updated_at();

-- 自动更新 updated_at（原 MySQL ON UPDATE CURRENT_TIMESTAMP，历史归档表补列后追加）
CREATE OR REPLACE FUNCTION fn_ydsz_flow_his_task_set_updated_at()
RETURNS TRIGGER AS $$
BEGIN
    NEW.updated_at := CURRENT_TIMESTAMP;
    RETURN NEW;
...
DROP TRIGGER IF EXISTS trg_ydsz_flow_his_task_updated_at ON ydsz_flow_his_task;
CREATE TRIGGER trg_ydsz_flow_his_task_updated_at
BEFORE UPDATE ON ydsz_flow_his_task
FOR EACH ROW
EXECUTE FUNCTION fn_ydsz_flow_his_task_set_updated_at();

-- 自动更新 updated_at（原 MySQL ON UPDATE CURRENT_TIMESTAMP，历史归档表补列后追加）
CREATE OR REPLACE FUNCTION fn_ydsz_flow_his_instance_set_updated_at()
RETURNS TRIGGER AS $$
BEGIN
    NEW.updated_at := CURRENT_TIMESTAMP;
    RETURN NEW;
...
DROP TRIGGER IF EXISTS trg_ydsz_flow_his_instance_updated_at ON ydsz_flow_his_instance;
CREATE TRIGGER trg_ydsz_flow_his_instance_updated_at
BEFORE UPDATE ON ydsz_flow_his_instance
FOR EACH ROW
EXECUTE FUNCTION fn_ydsz_flow_his_instance_set_updated_at();

-- 自动更新 updated_at（原 MySQL ON UPDATE CURRENT_TIMESTAMP，审计日志表补列后追加）
CREATE OR REPLACE FUNCTION fn_ydsz_flow_audit_log_set_updated_at()
RETURNS TRIGGER AS $$
BEGIN
    NEW.updated_at := CURRENT_TIMESTAMP;
    RETURN NEW;
...
DROP TRIGGER IF EXISTS trg_ydsz_flow_audit_log_updated_at ON ydsz_flow_audit_log;
CREATE TRIGGER trg_ydsz_flow_audit_log_updated_at
