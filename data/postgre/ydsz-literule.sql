...
--            （MyBatis-Plus 实体 -> PostgreSQL DDL，含公共审计/租户/乐观锁列）
-- 日期     : 2026-08-25
-- @author  : ydsz-team
-- ----------------------------------------------------------------------------
...
--   - 执行方式: psql -U <user> -d <db> -f ydsz-literule.sql
-- ============================================================================
...
CREATE TABLE IF NOT EXISTS ydsz_rule_def (
    ...
    canary_ratio             NUMERIC(5,4)             DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS ydsz_rule_decision_table (
    ...
    description              VARCHAR(512)             DEFAULT NULL,
    category                 VARCHAR(64)              DEFAULT NULL,
    condition_columns        JSONB                    DEFAULT NULL,
    action_columns           JSONB                    DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS ydsz_rule_scorecard (
    ...
    category                 VARCHAR(64)              DEFAULT NULL,
    description              VARCHAR(512)             DEFAULT NULL,
    base_score               NUMERIC(20,6)            NOT NULL DEFAULT 100,
    red_threshold            NUMERIC(20,6)            DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS ydsz_rule_pack (
    ...
    rule_codes               JSONB                    DEFAULT NULL,
    rule_snapshots           JSONB                    DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS ydsz_rule_ab_policy (
    ...
    check_window_minutes     INTEGER                  DEFAULT NULL,
...
CREATE INDEX IF NOT EXISTS idx_ydsz_rule_execution_trace_scenario ON ydsz_rule_execution_trace (scenario);
...
CREATE OR REPLACE FUNCTION fn_ydsz_rule_def_set_updated_at()
RETURNS TRIGGER AS $$
BEGIN
...
DROP TRIGGER IF EXISTS trg_ydsz_rule_def_updated_at ON ydsz_rule_def;
CREATE TRIGGER trg_ydsz_rule_def_updated_at
BEFORE UPDATE ON ydsz_rule_def
FOR EACH ROW
EXECUTE FUNCTION fn_ydsz_rule_def_set_updated_at();

-- 自动更新 updated_at（原 MySQL ON UPDATE CURRENT_TIMESTAMP）
CREATE OR REPLACE FUNCTION fn_ydsz_rule_variable_def_set_updated_at()
RETURNS TRIGGER AS $$
BEGIN
    NEW.updated_at := CURRENT_TIMESTAMP;
    RETURN NEW;
...
DROP TRIGGER IF EXISTS trg_ydsz_rule_variable_def_updated_at ON ydsz_rule_variable_def;
CREATE TRIGGER trg_ydsz_rule_variable_def_updated_at
BEFORE UPDATE ON ydsz_rule_variable_def
FOR EACH ROW
EXECUTE FUNCTION fn_ydsz_rule_variable_def_set_updated_at();

-- 自动更新 updated_at（原 MySQL ON UPDATE CURRENT_TIMESTAMP）
CREATE OR REPLACE FUNCTION fn_ydsz_rule_template_set_updated_at()
RETURNS TRIGGER AS $$
BEGIN
    NEW.updated_at := CURRENT_TIMESTAMP;
    RETURN NEW;
...
DROP TRIGGER IF EXISTS trg_ydsz_rule_template_updated_at ON ydsz_rule_template;
CREATE TRIGGER trg_ydsz_rule_template_updated_at
BEFORE UPDATE ON ydsz_rule_template
FOR EACH ROW
EXECUTE FUNCTION fn_ydsz_rule_template_set_updated_at();

-- 自动更新 updated_at（原 MySQL ON UPDATE CURRENT_TIMESTAMP）
CREATE OR REPLACE FUNCTION fn_ydsz_rule_script_set_updated_at()
RETURNS TRIGGER AS $$
BEGIN
    NEW.updated_at := CURRENT_TIMESTAMP;
    RETURN NEW;
...
DROP TRIGGER IF EXISTS trg_ydsz_rule_script_updated_at ON ydsz_rule_script;
CREATE TRIGGER trg_ydsz_rule_script_updated_at
BEFORE UPDATE ON ydsz_rule_script
FOR EACH ROW
EXECUTE FUNCTION fn_ydsz_rule_script_set_updated_at();

-- 自动更新 updated_at（原 MySQL ON UPDATE CURRENT_TIMESTAMP）
CREATE OR REPLACE FUNCTION fn_ydsz_rule_decision_table_set_updated_at()
RETURNS TRIGGER AS $$
BEGIN
    NEW.updated_at := CURRENT_TIMESTAMP;
    RETURN NEW;
...
DROP TRIGGER IF EXISTS trg_ydsz_rule_decision_table_updated_at ON ydsz_rule_decision_table;
CREATE TRIGGER trg_ydsz_rule_decision_table_updated_at
BEFORE UPDATE ON ydsz_rule_decision_table
FOR EACH ROW
EXECUTE FUNCTION fn_ydsz_rule_decision_table_set_updated_at();

-- 自动更新 updated_at（原 MySQL ON UPDATE CURRENT_TIMESTAMP）
CREATE OR REPLACE FUNCTION fn_ydsz_rule_decision_tree_set_updated_at()
RETURNS TRIGGER AS $$
BEGIN
    NEW.updated_at := CURRENT_TIMESTAMP;
    RETURN NEW;
...
DROP TRIGGER IF EXISTS trg_ydsz_rule_decision_tree_updated_at ON ydsz_rule_decision_tree;
CREATE TRIGGER trg_ydsz_rule_decision_tree_updated_at
BEFORE UPDATE ON ydsz_rule_decision_tree
FOR EACH ROW
EXECUTE FUNCTION fn_ydsz_rule_decision_tree_set_updated_at();

-- 自动更新 updated_at（原 MySQL ON UPDATE CURRENT_TIMESTAMP）
CREATE OR REPLACE FUNCTION fn_ydsz_rule_scorecard_set_updated_at()
RETURNS TRIGGER AS $$
BEGIN
    NEW.updated_at := CURRENT_TIMESTAMP;
    RETURN NEW;
...
DROP TRIGGER IF EXISTS trg_ydsz_rule_scorecard_updated_at ON ydsz_rule_scorecard;
CREATE TRIGGER trg_ydsz_rule_scorecard_updated_at
BEFORE UPDATE ON ydsz_rule_scorecard
FOR EACH ROW
EXECUTE FUNCTION fn_ydsz_rule_scorecard_set_updated_at();

-- 自动更新 updated_at（原 MySQL ON UPDATE CURRENT_TIMESTAMP）
CREATE OR REPLACE FUNCTION fn_ydsz_rule_chain_graph_set_updated_at()
RETURNS TRIGGER AS $$
BEGIN
    NEW.updated_at := CURRENT_TIMESTAMP;
    RETURN NEW;
...
DROP TRIGGER IF EXISTS trg_ydsz_rule_chain_graph_updated_at ON ydsz_rule_chain_graph;
CREATE TRIGGER trg_ydsz_rule_chain_graph_updated_at
BEFORE UPDATE ON ydsz_rule_chain_graph
FOR EACH ROW
EXECUTE FUNCTION fn_ydsz_rule_chain_graph_set_updated_at();

-- 自动更新 updated_at（原 MySQL ON UPDATE CURRENT_TIMESTAMP）
CREATE OR REPLACE FUNCTION fn_ydsz_rule_dependency_set_updated_at()
RETURNS TRIGGER AS $$
BEGIN
    NEW.updated_at := CURRENT_TIMESTAMP;
    RETURN NEW;
...
DROP TRIGGER IF EXISTS trg_ydsz_rule_dependency_updated_at ON ydsz_rule_dependency;
CREATE TRIGGER trg_ydsz_rule_dependency_updated_at
BEFORE UPDATE ON ydsz_rule_dependency
FOR EACH ROW
EXECUTE FUNCTION fn_ydsz_rule_dependency_set_updated_at();

-- 自动更新 updated_at（原 MySQL ON UPDATE CURRENT_TIMESTAMP）
CREATE OR REPLACE FUNCTION fn_ydsz_rule_pack_set_updated_at()
RETURNS TRIGGER AS $$
BEGIN
    NEW.updated_at := CURRENT_TIMESTAMP;
    RETURN NEW;
...
DROP TRIGGER IF EXISTS trg_ydsz_rule_pack_updated_at ON ydsz_rule_pack;
CREATE TRIGGER trg_ydsz_rule_pack_updated_at
BEFORE UPDATE ON ydsz_rule_pack
FOR EACH ROW
EXECUTE FUNCTION fn_ydsz_rule_pack_set_updated_at();

-- 自动更新 updated_at（原 MySQL ON UPDATE CURRENT_TIMESTAMP）
CREATE OR REPLACE FUNCTION fn_ydsz_rule_pack_install_set_updated_at()
RETURNS TRIGGER AS $$
BEGIN
    NEW.updated_at := CURRENT_TIMESTAMP;
    RETURN NEW;
...
DROP TRIGGER IF EXISTS trg_ydsz_rule_pack_install_updated_at ON ydsz_rule_pack_install;
CREATE TRIGGER trg_ydsz_rule_pack_install_updated_at
BEFORE UPDATE ON ydsz_rule_pack_install
FOR EACH ROW
EXECUTE FUNCTION fn_ydsz_rule_pack_install_set_updated_at();

-- 自动更新 updated_at（原 MySQL ON UPDATE CURRENT_TIMESTAMP）
CREATE OR REPLACE FUNCTION fn_ydsz_rule_ab_policy_set_updated_at()
RETURNS TRIGGER AS $$
BEGIN
    NEW.updated_at := CURRENT_TIMESTAMP;
    RETURN NEW;
...
DROP TRIGGER IF EXISTS trg_ydsz_rule_ab_policy_updated_at ON ydsz_rule_ab_policy;
CREATE TRIGGER trg_ydsz_rule_ab_policy_updated_at
BEFORE UPDATE ON ydsz_rule_ab_policy
FOR EACH ROW
EXECUTE FUNCTION fn_ydsz_rule_ab_policy_set_updated_at();

-- 自动更新 updated_at（原 MySQL ON UPDATE CURRENT_TIMESTAMP）
CREATE OR REPLACE FUNCTION fn_ydsz_rule_canary_bucket_set_updated_at()
RETURNS TRIGGER AS $$
BEGIN
    NEW.updated_at := CURRENT_TIMESTAMP;
    RETURN NEW;
...
DROP TRIGGER IF EXISTS trg_ydsz_rule_canary_bucket_updated_at ON ydsz_rule_canary_bucket;
CREATE TRIGGER trg_ydsz_rule_canary_bucket_updated_at
BEFORE UPDATE ON ydsz_rule_canary_bucket
FOR EACH ROW
EXECUTE FUNCTION fn_ydsz_rule_canary_bucket_set_updated_at();

-- 自动更新 updated_at（原 MySQL ON UPDATE CURRENT_TIMESTAMP）
CREATE OR REPLACE FUNCTION fn_ydsz_rule_ab_rollback_set_updated_at()
RETURNS TRIGGER AS $$
BEGIN
    NEW.updated_at := CURRENT_TIMESTAMP;
    RETURN NEW;
...
DROP TRIGGER IF EXISTS trg_ydsz_rule_ab_rollback_updated_at ON ydsz_rule_ab_rollback;
CREATE TRIGGER trg_ydsz_rule_ab_rollback_updated_at
BEFORE UPDATE ON ydsz_rule_ab_rollback
FOR EACH ROW
EXECUTE FUNCTION fn_ydsz_rule_ab_rollback_set_updated_at();
