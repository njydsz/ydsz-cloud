-- ============================================================================
-- ydsz-cloud: ydsz-message（消息中心模块）Oracle DDL 脚本
-- ----------------------------------------------------------------------------
...
CREATE TABLE ydsz_msg_template (
    ...
    version                  VARCHAR2(32 CHAR)        NOT NULL DEFAULT '1',
    category                 VARCHAR2(64 CHAR)        DEFAULT NULL,
    scene_code               VARCHAR2(64 CHAR)        DEFAULT NULL,
    subject                  VARCHAR2(255 CHAR)       DEFAULT NULL,
    content                  CLOB                     NOT NULL,
    provider                 VARCHAR2(64 CHAR)        DEFAULT NULL,
    provider_key             VARCHAR2(128 CHAR)       DEFAULT NULL,
    sign_name                VARCHAR2(128 CHAR)       DEFAULT NULL,
    status                   VARCHAR2(32 CHAR)        NOT NULL DEFAULT 'DISABLED',
    audit_status             VARCHAR2(32 CHAR)        NOT NULL DEFAULT 'DRAFT',
    audit_by                 VARCHAR2(64 CHAR)        DEFAULT NULL,
...
CREATE TABLE ydsz_msg_template_version (
    ...
    content                  CLOB                     NOT NULL,
    variable_defs            CLOB                     DEFAULT NULL CONSTRAINT ck_ydsz_msg_template_version_variable_defs CHECK (variable_defs IS JSON),
    audit_status             VARCHAR2(32 CHAR)        DEFAULT NULL,
...
CREATE TABLE ydsz_msg_notification (
    ...
    extra                    CLOB                     DEFAULT NULL CONSTRAINT ck_ydsz_msg_notification_extra CHECK (extra IS JSON),
    source_module            VARCHAR2(64 CHAR)        DEFAULT NULL,
    read_status              NUMBER(1)                NOT NULL DEFAULT 0,
    read_time                TIMESTAMP                DEFAULT NULL,
    recall_status            VARCHAR2(32 CHAR)        NOT NULL DEFAULT 'NONE',
...
CREATE INDEX idx_ydsz_msg_notification_receiver_read ON ydsz_msg_notification (receiver_id, read_status);
...
CREATE TABLE ydsz_msg_route_rule (
    ...
    condition_expr           VARCHAR2(512 CHAR)       DEFAULT NULL,
...
CREATE TABLE ydsz_msg_variable_source (
    ...
    source_expr              VARCHAR2(512 CHAR)       NOT NULL,
...
CREATE TABLE ydsz_msg_canary (
    ...
    template_code            VARCHAR2(64 CHAR)        NOT NULL,
    channel                  VARCHAR2(32 CHAR)        NOT NULL,
    bucket_total             NUMBER(10)               NOT NULL DEFAULT 100,
    bucket_selected          NUMBER(10)               NOT NULL DEFAULT 0,
    percentage               NUMBER(10)               NOT NULL DEFAULT 0,
...
CREATE TABLE ydsz_msg_tenant_config (
    ...
    channel_overrides        CLOB                     DEFAULT NULL CONSTRAINT ck_ydsz_msg_tenant_config_channel_overrides CHECK (channel_overrides IS JSON),
...
CREATE TABLE ydsz_msg_batch (
    ...
    success                  NUMBER(10)               NOT NULL DEFAULT 0,
    failed                   NUMBER(10)               NOT NULL DEFAULT 0,
    skipped                  NUMBER(10)               NOT NULL DEFAULT 0,
    status                   VARCHAR2(32 CHAR)        NOT NULL DEFAULT 'PENDING',
    audience_source          VARCHAR2(128 CHAR)       DEFAULT NULL,
...
CREATE TABLE ydsz_msg_aggregate (
    ...
    channel                  VARCHAR2(32 CHAR)        NOT NULL,
    batch_status             VARCHAR2(32 CHAR)        NOT NULL DEFAULT 'PENDING',
    message_count            NUMBER(10)               NOT NULL DEFAULT 0,
...
CREATE TABLE ydsz_msg_log (
    ...
    recall_status            VARCHAR2(32 CHAR)        NOT NULL DEFAULT 'NONE',
    recall_at                TIMESTAMP                DEFAULT NULL,
    receipt_status           VARCHAR2(32 CHAR)        NOT NULL DEFAULT 'NONE',
...
CREATE INDEX idx_ydsz_msg_trace_msg_event ON ydsz_msg_trace (msg_id, event_at);
CREATE INDEX idx_ydsz_msg_trace_trace_id ON ydsz_msg_trace (trace_id);
CREATE INDEX idx_ydsz_msg_trace_node_status ON ydsz_msg_trace (node, status);
...
CREATE OR REPLACE TRIGGER trg_ydsz_msg_template_updated_at
...
-- 自动更新 updated_at（原 MySQL ON UPDATE CURRENT_TIMESTAMP）
CREATE OR REPLACE TRIGGER trg_ydsz_msg_template_version_updated_at
...
-- 自动更新 updated_at（原 MySQL ON UPDATE CURRENT_TIMESTAMP）
CREATE OR REPLACE TRIGGER trg_ydsz_msg_notification_updated_at
...
-- 自动更新 updated_at（原 MySQL ON UPDATE CURRENT_TIMESTAMP）
CREATE OR REPLACE TRIGGER trg_ydsz_msg_user_channel_updated_at
...
-- 自动更新 updated_at（原 MySQL ON UPDATE CURRENT_TIMESTAMP）
CREATE OR REPLACE TRIGGER trg_ydsz_msg_subscription_updated_at
...
-- 自动更新 updated_at（原 MySQL ON UPDATE CURRENT_TIMESTAMP）
CREATE OR REPLACE TRIGGER trg_ydsz_msg_preference_updated_at
...
-- 自动更新 updated_at（原 MySQL ON UPDATE CURRENT_TIMESTAMP）
CREATE OR REPLACE TRIGGER trg_ydsz_msg_route_rule_updated_at
...
-- 自动更新 updated_at（原 MySQL ON UPDATE CURRENT_TIMESTAMP）
CREATE OR REPLACE TRIGGER trg_ydsz_msg_variable_source_updated_at
...
-- 自动更新 updated_at（原 MySQL ON UPDATE CURRENT_TIMESTAMP）
CREATE OR REPLACE TRIGGER trg_ydsz_msg_canary_updated_at
...
-- 自动更新 updated_at（原 MySQL ON UPDATE CURRENT_TIMESTAMP）
CREATE OR REPLACE TRIGGER trg_ydsz_msg_batch_updated_at
...
-- 自动更新 updated_at（原 MySQL ON UPDATE CURRENT_TIMESTAMP）
CREATE OR REPLACE TRIGGER trg_ydsz_msg_aggregate_updated_at
...
-- 自动更新 updated_at（原 MySQL ON UPDATE CURRENT_TIMESTAMP）
CREATE OR REPLACE TRIGGER trg_ydsz_msg_offline_updated_at
...
-- 自动更新 updated_at（原 MySQL ON UPDATE CURRENT_TIMESTAMP）
CREATE OR REPLACE TRIGGER trg_ydsz_msg_log_updated_at
...
-- 自动更新 updated_at（原 MySQL ON UPDATE CURRENT_TIMESTAMP）
CREATE OR REPLACE TRIGGER trg_ydsz_msg_receipt_updated_at
...
-- 自动更新 updated_at（原 MySQL ON UPDATE CURRENT_TIMESTAMP）
CREATE OR REPLACE TRIGGER trg_ydsz_msg_feedback_updated_at
