#!/usr/bin/env python3
"""Scan workflow module Java files for comment-to-code ratio."""
import os

base = 'd:/Code/ydsz/ydsz-pmis/ydsz-backend/ydsz-workflow/ydsz-workflow-server/src/main/java'
results = []
...
for root, _, fnames in os.walk(base):
    for fn in fnames:
        ...
        rel = fpath.split('workflow-server')[-1]
