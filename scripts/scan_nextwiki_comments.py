#!/usr/bin/env python3
"""Scan nextwiki module Java files for comment-to-code ratio."""
import os

base = 'd:/Code/ydsz/ydsz-pmis/ydsz-backend/ydsz-nextwiki/ydsz-nextwiki-server/src/main/java'
results = []
