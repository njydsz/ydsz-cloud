 ...
 * P2-2: 流程评论实体
 *
 * <p>对应数据库表 {@code ydsz_flow_comment}，对标钉钉/飞书审批评论区。 独立于 {@link FlowAuditLogDO}（审计日志是操作轨迹、不可变），
 * 评论是讨论（可回复、可删除），关注点正交。
 *
 * <p><b>与审计日志的区别：</b>
 *
 * <ul>
 *   <li><b>审计日志（{@link FlowAuditLogDO}）</b>：系统视角，记录「谁在什么时间做了什么」， 用于合规审计、问题回溯，<b>不可修改、不可删除</b>
 *   <li><b>评论（{@code FlowCommentDO}）</b>：用户视角，记录「审批人之间的沟通讨论」， <b>支持回复、编辑、删除</b>（仅评论本人或管理员可删）
 * </ul>
 *
 * <p><b>多级回复机制：</b>
 *
...
public class FlowCommentDO extends MpBaseEntity<String> {
