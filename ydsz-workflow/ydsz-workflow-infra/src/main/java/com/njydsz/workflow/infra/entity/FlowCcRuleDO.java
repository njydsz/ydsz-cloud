 ...
 * 流程抄送规则实体
 *
 * <p>对应数据库表 {@code ydsz_flow_cc_rule}，P0-3: 自动抄送规则配置， 区别于 {@link FlowCcDO}（具体抄送实例） —
...
public class FlowCcRuleDO extends MpBaseEntity<String> {
