 ...
 * 三方审批账号映射 Mapper
 *
 * <p>对应数据表 <code>ydsz_flow_third_party_account</code>（P0-2），存储 ydsz 用户与三方平台账号的映射。
 *
 ...
 *
 * <ul>
 *   <li>uk_platform_user — (platform+thirdUserId) 唯一索引
 *   <li>idx_user_id — ydsz 用户 ID 索引（反向查询）
 * </ul>
 *
...
public interface FlowThirdPartyAccountMapper extends BaseMapper<FlowThirdPartyAccount> {
   ...
   * @return 账号映射记录
   */
  FlowThirdPartyAccount selectByUserIdAndPlatform(
   ...
   * @return 账号映射记录
   */
  FlowThirdPartyAccount selectByOpenId(
