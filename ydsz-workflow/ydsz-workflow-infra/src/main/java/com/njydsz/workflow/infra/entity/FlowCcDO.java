 ...
 *
 * <ul>
 *   <li><b>待办（{@link FlowRunTaskDO}）</b>：需要办理动作（同意/拒绝），流程阻塞等待
 *   <li><b>抄送（{@code FlowCcDO}）</b>：仅通知，不阻塞流程，接收人可读可不读
 * </ul>
 *
...
public class FlowCcDO extends MpBaseEntity<String> {
