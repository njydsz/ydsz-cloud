 ...
 * <p><b>核心能力：</b>
 * <ul>
 *   <li><b>办理人解析</b>：根据节点 {@code permissionFlag} 解析实际办理人 ID，
 *       支持显式指定、发起人兜底、变量策略解析三种路径</li>
 *   <li><b>发起人识别</b>：从流程变量中提取发起人 ID（{@code initiatorId / _initiatorId}）</li>
 * </ul>
 *
...
public class AssigneeResolutionService {
     ...
     * <p>解析优先级：
     * <ol>
     *   <li>{@code explicit} 非空 — 直接使用显式指定的办理人</li>
     *   <li>{@code permissionFlag} 为空 — 回退为发起人（INITIATOR）</li>
     *   <li>通过 {@link FlowVariableStrategy#resolveAssignee} 解析表达式</li>
     * </ol>
     *
     ...
     */
    public void resolveAssignee(FlowRunTask task, FlowNode node,
