 ...
 *
 * <p>skip 表无 source_node_code 列，源节点编码冗余存储在 ext JSON 的 {@code sourceRef} 字段
 * （见 FlowDefinitionServiceImpl 部署逻辑）。本工具提供唯一规范的读取入口。
 *
 * @author ydsz-team
 * @since 1.0.0
 */
...
public final class FlowSkipUtils {
     ...
     *
     * <p>统一替代 {@code DefaultFlowAdvancer#extractSourceNodeCode}、
     * {@code FlowGraphValidator#extractSourceRef}、{@code FlowDefinitionCacheService#extractSourceRef}
     * 三处重复实现。
     *
     * @param skip 跳转边
