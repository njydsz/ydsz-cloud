...
public class FlowProperties {
   ...
   * P3-3.4: 三方审批配置。
   *
   * <p>包含钉钉/飞书/企微 Webhook 回调的签名校验密钥， 以及三方回调失败重试策略（由 {@link
   * com.njydsz.workflow.server.job.FlowThirdPartyRetryJobHandler} 消费）。
   */
  @Data
  public static class ThirdParty {
     ...
     * 三方回调失败重试策略配置。
     *
     * <p>由 {@link com.njydsz.workflow.server.job.FlowThirdPartyRetryJobHandler} 定时消费， 超过 {@link
     * #maxRetries} 次后进入死信不再扫描。
     *
     * @author ydsz-team
     * @since 1.0.0
     */
