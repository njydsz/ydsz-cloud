 ...
 *   <li>{@code previewType=OFFICE} → {@code previewUrl} 为外部预览服务 URL （kkFileView/Office Online），需配置
 *       {@code workflow.attachment.preview-server-url}
 *   <li>{@code previewType=UNSUPPORTED} → 不支持在线预览，前端引导下载
 * </ul>
 *
 * @author ydsz-team
 * @since 1.0.0
 */
@Data
public class FlowAttachmentPreviewDTO implements Serializable {
