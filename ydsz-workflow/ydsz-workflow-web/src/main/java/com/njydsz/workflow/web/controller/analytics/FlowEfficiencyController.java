 ...
 * 审批效率分析 Controller
 *
 * <p>业务背景：工作流审批效率分析是运营管理的核心能力，对标钉钉/飞书审批后台的 「效率分析」面板。为运维人员提供审批单量统计、节点瓶颈排名、审批人效率排名、
 * 审批趋势分析、流程健康度综合评分等能力。
 *
 * <p>核心能力：
 *
 * <ul>
 *   <li>审批效率统计 — 单量/平均耗时/代批率/超期率
 *   <li>节点瓶颈排名 — 平均耗时 Top N 节点
 *   <li>审批人效率排名 — 人均审批耗时排名
 *   <li>审批趋势 — 按日/周/月聚合
 *   <li>流程健康度评分 — 0-100 分综合评级
 * </ul>
 *
 * <p>从原 {@code FlowMonitorController} 拆分而来，与 {@link FlowMonitorDashboardController} 共享基路径 {@code
...
public class FlowEfficiencyController {
   ...
   * @return 评分结果：score / level / deductions / totalCount / anomalyCount / overdueRate / proxyRate /
   *     avgDurationMs
   */
