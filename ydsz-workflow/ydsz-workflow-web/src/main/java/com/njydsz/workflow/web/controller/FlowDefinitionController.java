 ...
 *
 * <p>提供流程定义的部署 / 发布 / 废弃 / 查询 / 预览等 REST 接口， 是设计器、流程中心、运维控制台的数据入口。所有接口对标 Activiti / Flowable API
 * 风格。
 *
 * <p><b>核心能力：</b>
 *
 ...
 * 胖 Service」规范。
 *
 * <p><b>拆分说明：</b>本类为原 {@code FlowDefinitionController} 拆分后的部署与查询部分。 版本生命周期管理（切换 / 启停 / 版本历史 / 差异对比
 * / 回滚）见 {@link FlowDefinitionVersionController}； 设计 / 导入导出 / 模拟 / 变更影响分析见 {@link
 * FlowDefinitionDesignController}。
 *
 * @author ydsz-team
 * @since 1.0.0
