...
/**
 * 多语言回退链（P1-6）�? *
 * <p>模板加载时按 locale 回退链查找：用户偏好 locale �?租户默认 locale �?系统默认 zh-CN�? * 例如用户偏好 en-US 时回退链为: en-US �?zh-CN�? *
...
public class LocaleFallbackChain {
    ...
    /**
     * 构建 locale 回退链�?     *
     * @param preferredLocale 用户偏好语言（可�?null�?     * @return 回退链列表（优先级从高到低，至少包含 zh-CN�?     */
