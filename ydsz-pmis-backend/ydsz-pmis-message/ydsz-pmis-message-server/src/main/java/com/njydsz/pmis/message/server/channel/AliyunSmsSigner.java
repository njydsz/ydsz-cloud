...
/**
 * 阿里�?SMS Common RPC V1.0 签名工具�? *
 * <p>实现阿里�?{@code HMAC-SHA1} 签名算法，纯静态方法，可独立单元测试�? * 签名步骤�? * <ol>
...
public final class AliyunSmsSigner {
    ...
    /**
     * 计算阿里�?RPC 签名�?     *
     * @param params           请求参数（不�?Signature�?     * @param accessKeySecret  AccessKey Secret
     * @return Base64 编码的签名�?     */
    public static String sign(Map<String, String> params, String accessKeySecret) {
        ...
        try {
            ...
            throw new IllegalStateException("阿里云签名计算失�? " + e.getMessage(), e);
        }
    }

    /**
     * 构造规范化查询串（�?key 字典序排�?+ percentEncode）�?     *
     * @param params 请求参数
     * @return 规范化查询串
     */
    ...
    /**
     * 阿里�?percentEncode：URL encode 后替�?+ �?%20�? �?%2A�?7E �?~�?     *
