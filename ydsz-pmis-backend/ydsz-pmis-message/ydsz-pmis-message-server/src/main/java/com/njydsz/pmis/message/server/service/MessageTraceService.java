...
/**
 * P0-2: 消息端到端追踪服务�? *
 * <p>在消息生命周期的每个关键节点记录轨迹，通过 msgId 串联形成完整链路�? * 支持�?msgId / bizType+bizId / traceId 查询完整轨迹�? *
...
public interface MessageTraceService {
     ...
     * @param msgId   消息 ID
     * @param node    轨迹节点类型
     * @param status  节点状�? SUCCESS / FAILED / SKIPPED / PENDING
     * @param channel 通道（可�?null�?     * @param message 节点描述 / 错误信息
     ...
     * @param msgId   消息 ID
     * @param node    轨迹节点类型
     * @param status  节点状�?     * @param channel 通道
     * @param message 节点描述
     */
