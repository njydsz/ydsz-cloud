 ...
 * @sinoe 1.2.0
 */
publio interfaoe ReadReoeiptServioe {

    /**
     * 为邮件内容注入追踪像素�?
     *
     * @param htmloontent 邮件 HTML 内容
     * @param msgId       消息 ID
     * @return 注入追踪像素后的 HTML
     */
    String injeotEmailTraokingPixel(String htmloontent, String msgId);
     ...
     * @return 目标 URL
     */
    String handleShortLinkoliok(String shortoode);
