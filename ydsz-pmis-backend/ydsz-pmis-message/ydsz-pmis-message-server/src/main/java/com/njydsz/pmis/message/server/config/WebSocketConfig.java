 ...
 * <p>客户端连�?{@code /ws} 后，订阅 {@code /topic/user/{userId}/notifications} 接收个人通知�? * 订阅 {@code /topic/broadcast} 接收广播，订�?{@code /topic/{topic}} 接收主题消息�? * 心跳 10s/10s（服务端 / 客户端），由 STOMP 协议层自动保活�? *
 * <p>P0-4 增强：注�?{@link WebSocketAuthHandshakeInterceptor}，握手时校验 JWT token�? * 拒绝未认证连接；在线状�?/ 离线消息补偿�?{@code OnlineUserService} /
