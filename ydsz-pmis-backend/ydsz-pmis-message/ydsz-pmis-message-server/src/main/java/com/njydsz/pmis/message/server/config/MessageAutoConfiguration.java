 ...
 * （MessageProperties / ChannelProperties / ChannelRouter / RealtimePushService�? * 提供 {@code @ConditionalOnMissingBean} 兜底保护：当组件扫描未覆盖时由此处注册�? *
...
public class MessageAutoConfiguration {
    ...
    /**
     * 兜底注册通道路由器�?     *
     * @param applicationContext Spring 上下�?     * @param messageProperties  消息配置
     ...
     * @param clusterPublisher      集群广播发布�?     * @param onlineUserService     在线用户状态服�?     * @param offlineMessageService 离线消息补偿服务
