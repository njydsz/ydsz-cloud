...
@EnableScheduling
@ConditionalOnProperty(prefix = "pmis.message", name = "scheduled-enabled", havingValue = "true", matchIfMissing = true)
public class ScheduledMessageScanner {
    ...
    /** 分布式锁 key */
    private static final String LOCK_KEY = "pmis:msg:scheduled:scan:lock";
