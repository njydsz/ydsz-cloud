 ...
 * <h3>Redis 键设计</h3>
 * <pre>
 *   pmis:ip:blacklist:{ip}  → 1   (TTL: 可配置，默认 24h)
 * </pre>
 *
 * <h3>黑名单写入方式</h3>
 * <ul>
 *   <li>安全系统自动写入（检测到暴力破解 / CC 攻击）</li>
 *   <li>运维通过 Redis CLI 手动写入：{@code SET pmis:ip:blacklist:1.2.3.4 1 EX 86400}</li>
...
public class IpBlacklistFilter implements GlobalFilter, Ordered {
    ...
    /** Redis IP 黑名单键前缀 */
    private static final String IP_BLACKLIST_PREFIX = "pmis:ip:blacklist:";
    ...
    private Mono<Void> forbidden(ServerWebExchange exchange, String clientIp) {
        ...
        Result<Void> body = Result.failed(403, "error.IP_BLACKLISTED");
