 ...
 * <h3>与租户级配额的关系</h3>
 * <ul>
 *   <li>租户级配额（{@link com.njydsz.pmis.cronjob.server.service.TenantQuotaService}）：
 ...
 * <h3>Redis Key 设计</h3>
 * <ul>
 *   <li>计数器：{@code pmis:job:global:concurrent}（String 类型，INCR/DECR 原子操作）</li>
...
public class GlobalConcurrencyController {
    ...
    /** 全局并发计数器 Redis key */
    private static final String GLOBAL_CONCURRENT_KEY = "pmis:job:global:concurrent";

    /** 计数器校准锁 key（防止多节点同时校准） */
    private static final String CALIBRATION_LOCK_KEY = "pmis:job:global:concurrent:calibration-lock";
