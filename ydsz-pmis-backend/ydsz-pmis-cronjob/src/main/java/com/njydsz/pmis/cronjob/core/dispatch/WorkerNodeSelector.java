...
public class WorkerNodeSelector {
    ...
    private final ObjectProvider<com.njydsz.pmis.cronjob.core.executor.JobNodeHeartbeat> heartbeatProvider;
    ...
    public WorkerNodeSelector(CronjobProperties cronjobProperties,
                               ...
                               ObjectProvider<com.njydsz.pmis.cronjob.core.executor.JobNodeHeartbeat> heartbeatProvider) {
    ...
    private String resolveLocalNodeId() {
        ...
        com.njydsz.pmis.cronjob.core.executor.JobNodeHeartbeat heartbeat = heartbeatProvider.getIfAvailable();
