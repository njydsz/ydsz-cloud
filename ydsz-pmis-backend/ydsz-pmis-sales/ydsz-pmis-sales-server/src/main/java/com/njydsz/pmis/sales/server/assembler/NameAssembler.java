...
public class NameAssembler {
    ...
    public String resolveEmployee(String id) {
        ...
        try {
            var r = userServiceClient.getEmployee(id);
    ...
    public String resolveCustomer(String id) {
        if (id == null) return null;
        try {
            var r = userServiceClient.getCustomerName(id);
            if (r != null && r.getData() != null) {
                return r.getData();
            }
        } catch (Exception e) {
    ...
    public Map<String, String> batchEmployeeName(List<String> ids) {
        ...
        try {
            var r = userServiceClient.batchEmployeeName(ids);
            if (r != null && r.getData() != null) {
                return r.getData();
            }
        } catch (Exception e) {
    ...
    public Map<String, String> batchCustomerName(List<String> ids) {
        if (ids == null || ids.isEmpty()) return Map.of();
        try {
            var r = userServiceClient.batchCustomerName(ids);
            if (r != null && r.getData() != null) {
                return r.getData();
            }
        } catch (Exception e) {
