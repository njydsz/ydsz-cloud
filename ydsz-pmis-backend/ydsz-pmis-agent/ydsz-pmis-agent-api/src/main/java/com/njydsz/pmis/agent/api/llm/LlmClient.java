...
/**
 * 统一 LLM 客户端抽象接口（P0-2 架构优化，2026-07-12 迁移到 agent 模块）。
 *
 ...
 * <h3>实现方</h3>
 * <ul>
 *   <li>{@link com.njydsz.pmis.agent.server.engine.llm.impl.OpenAICompatibleLlmClient} — OpenAI 兼容协议（生产用）</li>
 *   <li>{@link com.njydsz.pmis.agent.server.engine.llm.impl.MockLlmClient} — 离线 Mock（开发/测试用）</li>
 *   <li>{@link com.njydsz.pmis.agent.server.engine.llm.LlmProviderAdapter} — agent 模块适配器（桥接到 LlmProvider）</li>
 * </ul>
 *
 * <p>切换方式：配置 {@code pmis.agent.ai.llm-client=OPENAI_COMPATIBLE|MOCK}
 *
