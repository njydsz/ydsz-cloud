 ...
 * <h3>核心组件</h3>
 * <ul>
 *   <li>{@link com.njydsz.pmis.agent.engine.trace.AgentTracer} - 链路追踪器接口</li>
 *   <li>{@link com.njydsz.pmis.agent.engine.trace.DefaultAgentTracer} - 默认实现（同步落库 + 降级）</li>
 *   <li>{@link com.njydsz.pmis.agent.engine.trace.TraceContext} - trace 上下文（持有 traceId / rootSpanId）</li>
 *   <li>{@link com.njydsz.pmis.agent.engine.trace.AgentSpan} - span 数据传输对象</li>
 *   <li>{@link com.njydsz.pmis.agent.engine.trace.AgentSpanName} - span 名称常量</li>
 *   <li>{@link com.njydsz.pmis.agent.engine.trace.TracingReActEventListener} - ReAct 事件 → span 转换器</li>
 * </ul>
 *
