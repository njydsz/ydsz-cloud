 ...
 * {@link com.njydsz.pmis.agent.server.service.AgentService#executeStream} 自动降级为同步执行后
 * 发送单个 FINAL_ANSWER 事件。
 *
 * <p>典型实现：
 * <ul>
 *   <li>{@link com.njydsz.pmis.agent.server.engine.FlowGeneratorAgent} - 流程生成（ReAct 流式）</li>
 *   <li>{@link com.njydsz.pmis.agent.server.engine.CommentDraftAgent} - 评论草稿（ReAct 流式）</li>
 * </ul>
 *
 * <p><b>实现约束</b>：
 * <ol>
