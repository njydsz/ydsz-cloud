...
import com.njydsz.pmis.agent.api.dto.DocumentIngestDTO;
import com.njydsz.pmis.agent.api.dto.RagQueryDTO;
import com.njydsz.pmis.agent.domain.rag.TextChunk;
import com.njydsz.pmis.agent.server.rag.DocumentIngestionService;
...
public class RagController {
    ...
    public BaseResponse<Void> deleteDocument(@RequestParam String documentId) {
