...
import com.njydsz.userinfo.domain.dto.user.EmployeeCreateDTO;
import com.njydsz.userinfo.domain.dto.user.EmployeeUpdateDTO;
import com.njydsz.userinfo.domain.entity.org.DepartmentDO;
import com.njydsz.userinfo.domain.entity.org.PositionDO;
import com.njydsz.userinfo.domain.entity.rate.OutsourceRateDO;
import com.njydsz.userinfo.domain.entity.rate.PartTimeRateDO;
...
import com.njydsz.userinfo.domain.enums.user.EmployeeType;
import com.njydsz.userinfo.domain.vo.EmployeeVO;
import com.njydsz.userinfo.infra.mapper.org.DepartmentMapper;
import com.njydsz.userinfo.infra.mapper.org.PositionMapper;
import com.njydsz.userinfo.infra.mapper.rate.OutsourceRateMapper;
import com.njydsz.userinfo.infra.mapper.rate.PartTimeRateMapper;
import com.njydsz.userinfo.infra.mapper.rate.RankMapper;
import com.njydsz.userinfo.infra.mapper.rate.RankRateMapper;
import com.njydsz.userinfo.infra.mapper.user.EmployeeMapper;
import com.njydsz.userinfo.server.service.user.EmployeeService;
...
public class EmployeeServiceImpl implements EmployeeService {
    ...
    public Map<String, Object> getCostProfile(String id) {
        ...
        if (EmployeeType.FULL_TIME.getCode().equals(employeeType)) {
            // 全职：月薪 + 社保公积金 + 差旅报销 + 差旅补贴（公司承担），取 ydsz_rank_rate.total_cost
            ...
            // 兼职：月薪 + 商业保险 + 差旅报销 + 差旅补贴（公司承担），取 ydsz_part_time_rate.total_cost
            ...
            // 外包：人天核算月薪 + 差旅报销 + 差旅补贴（公司承担），取 ydsz_outsource_rate.total_cost
