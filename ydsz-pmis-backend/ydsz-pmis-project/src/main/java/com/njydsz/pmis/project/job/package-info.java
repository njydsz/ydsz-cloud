 ...
 * <h3>核心组件</h3>
 * <ul>
 *   <li>{@link com.njydsz.pmis.project.job.AfterSalesScanJobHandler} - 售后巡检 Job（每日 03:00，扫描质保/工单 SLA）</li>
 *   <li>{@link com.njydsz.pmis.project.job.AlertDispatchRetryJobHandler} - 告警派发重试 Job</li>
 *   <li>{@link com.njydsz.pmis.project.job.DailyReconcileJobHandler} - 日对账 Job</li>
 * </ul>
 *
 * <h3>设计原则</h3>
 * <ul>
