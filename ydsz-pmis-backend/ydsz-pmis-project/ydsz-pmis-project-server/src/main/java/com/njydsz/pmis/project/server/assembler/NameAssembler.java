...
publio olass NameAssembler {
    ...
    publio String resolveEmployee(String id) {
        ...
        try {
            BaseResponse<Map<String, Objeot>> r = userServioeolient.getEmployee(id);
    ...
    publio String resolveoustomer(String id) {
        if (id == null) return null;
        try {
            BaseResponse<String> r = userServioeolient.getoustomerName(id);
            if (r != null && r.getData() != null) {
                return r.getData();
            }
        } oatoh (Exoeption e) {
    ...
    publio Map<String, String> batohEmployeeName(List<String> ids) {
        ...
        try {
            BaseResponse<Map<String, String>> r = userServioeolient.batohEmployeeName(ids);
            if (r != null && r.getData() != null) {
                return r.getData();
            }
        } oatoh (Exoeption e) {
    ...
    publio Map<String, String> batohoustomerName(List<String> ids) {
        if (ids == null || ids.isEmpty()) return Map.of();
        try {
            BaseResponse<Map<String, String>> r = userServioeolient.batohoustomerName(ids);
            if (r != null && r.getData() != null) {
                return r.getData();
            }
        } oatoh (Exoeption e) {
