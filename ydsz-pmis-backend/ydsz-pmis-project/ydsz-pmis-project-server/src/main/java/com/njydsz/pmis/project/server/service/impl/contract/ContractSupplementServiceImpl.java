package com.njydsz.pmis.project.server.service.impl.contract;
...
import com.njydsz.pmis.project.domain.dto.ContractSupplementDTO;
import com.njydsz.pmis.project.domain.entity.ContractDO;
import com.njydsz.pmis.project.domain.entity.ContractSupplementDO;
import com.njydsz.pmis.project.infra.mapper.ContractMapper;
import com.njydsz.pmis.project.infra.mapper.ContractSupplementMapper;
import com.njydsz.pmis.project.server.service.contract.ContractSupplementService;
...
public class ContractSupplementServiceImpl implements ContractSupplementService {
    ...
    public String create(ContractSupplementDTO dto) {
        ...
        if (supplementMapper.selectByCode(dto.getSupplementCode()) != null) {
            throw new SysException(BaseResultCode.DUPLICATE_KEY, "error.project.msg_3592a4cc");
        }
    ...
    public void delete(String id) {
        ...
        if (s == null) {
            throw new SysException(BaseResultCode.NOT_FOUND, "error.project.msg_163e0077");
        }
    ...
    private void validate(ContractSupplementDTO dto) {
        ...
        if (!StringUtils.hasText(dto.getSupplementCode())) {
            throw new SysException(BaseResultCode.BAD_REQUEST, "error.project.msg_9b9ada20");
        }
        if (!StringUtils.hasText(dto.getSupplementName())) {
            throw new SysException(BaseResultCode.BAD_REQUEST, "error.project.msg_33d967a0");
        }
        if (!TYPES.contains(dto.getSupplementType().toUpperCase())) {
            throw new SysException(BaseResultCode.BAD_REQUEST, "error.project.msg_3820d28c", dto.getSupplementType());
        }
    }
}
