 ...
 * 供 {@link com.njydsz.pmis.literule.server.adaptive.AdaptiveThresholdService} 分析规则阈值。
...
public interface TraceDataProvider {
     ...
     * 是否启用轨迹数据提供
     *
     * <p>返回 false 时，{@link com.njydsz.pmis.literule.server.adaptive.AdaptiveThresholdService}
