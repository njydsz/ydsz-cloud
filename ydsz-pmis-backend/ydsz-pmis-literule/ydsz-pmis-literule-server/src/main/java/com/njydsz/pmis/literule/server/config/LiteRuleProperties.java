...
public class LiteRuleProperties {
     ...
     * {@link com.njydsz.pmis.literule.server.spi.FileRuleSource} Bean。
     ...
     * 多级缓存配置（P1-1）
     *
     * <p>启用后自动装饰 {@link com.njydsz.pmis.literule.server.spi.RuleConfigProvider} 为
     * {@link com.njydsz.pmis.literule.server.cache.CachingRuleConfigProvider}，
     ...
     * 规则+模型融合配置（P3-1）
     *
     * <p>启用后，规则引擎在评估前会调用所有已注册的 {@link com.njydsz.pmis.literule.domain.model.ModelInputProvider}
     ...
     * 文件规则源配置（P2-3）
     *
     * <p>控制 {@link com.njydsz.pmis.literule.server.spi.FileRuleSource} 的加载行为。
     *
     * @since 1.7.0
     */
    @Data
     ...
     * 规则+模型融合配置（P3-1）
     *
     * <p>控制 {@link com.njydsz.pmis.literule.domain.model.ModelInputRegistry} 与
     * {@link com.njydsz.pmis.literule.domain.model.MockModelInputProvider} 的行为。
    ...
    public static class ModelConfig {
         ...
         * 单个模型调用超时（毫秒）
         *
         * <p>每个 {@link com.njydsz.pmis.literule.domain.model.ModelInputProvider} 调用最多等待该时长，
         ...
         * false：模型调用失败时抛出 {@link com.njydsz.pmis.literule.domain.model.ModelInvocationException}，
         ...
         * 是否启用 Mock 模型提供者
         *
         * <p>true：自动注册 {@link com.njydsz.pmis.literule.domain.model.MockModelInputProvider}，
         * 返回配置的模拟模型输出，便于开发/测试；
         * false（默认）：不注册 Mock，需业务方提供真实 {@link com.njydsz.pmis.literule.domain.model.ModelInputProvider} 实现。
         */
     ...
     * {@link com.njydsz.pmis.literule.server.core.RuleLifecycleService} 将生成退役建议：
     * <ul>
    ...
    public static class LifecycleConfig {
         ...
         * 是否启用退役检测
         *
         * <p>true（默认）：自动装配 {@link com.njydsz.pmis.literule.server.core.RuleLifecycleService}；
         * false：不装配，退役检测功能不可用。
         */
        private boolean enabled = true;
