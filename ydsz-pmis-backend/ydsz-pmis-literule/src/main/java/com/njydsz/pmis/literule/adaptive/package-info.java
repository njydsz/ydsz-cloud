 ...
 * <h3>核心组件</h3>
 * <ul>
 *   <li>{@link com.njydsz.pmis.literule.adaptive.AdaptiveThresholdService} - 自适应阈值分析服务</li>
 *   <li>{@link com.njydsz.pmis.literule.adaptive.ThresholdExtractor} - 条件表达式阈值提取器</li>
 *   <li>{@link com.njydsz.pmis.literule.adaptive.ThresholdAnalysis} - 阈值分析结果</li>
 *   <li>{@link com.njydsz.pmis.literule.adaptive.DistributionStats} - 数据分布统计</li>
 *   <li>{@link com.njydsz.pmis.literule.adaptive.ThresholdStrategy} - 调整策略枚举</li>
 * </ul>
 *
 * <h3>数据流</h3>
 * <pre>
