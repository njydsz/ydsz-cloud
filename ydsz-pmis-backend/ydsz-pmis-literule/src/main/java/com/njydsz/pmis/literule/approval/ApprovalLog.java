 ...
 * 审批日志（P1-3 多级审批流）
 *
 * <p>记录单次审批操作的全部信息，包括审批人、动作、意见、委托目标等。
 * 一个 {@link ApprovalRecord} 包含多条 ApprovalLog，按时间顺序追加。
 *
 * <p>动作类型（{@link #action}）取值：
 * <ul>
 *   <li>{@link #ACTION_APPROVE} - 审批通过</li>
 *   <li>{@link #ACTION_REJECT} - 审批驳回</li>
 *   <li>{@link #ACTION_DELEGATE} - 委托他人审批</li>
 *   <li>{@link #ACTION_COMMENT} - 仅评论（不改变状态）</li>
 *   <li>{@link #ACTION_SUBMIT} - 提交审核</li>
