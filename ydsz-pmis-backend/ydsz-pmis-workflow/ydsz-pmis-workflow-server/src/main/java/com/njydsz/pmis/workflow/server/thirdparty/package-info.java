 ...
 * {@code com.njydsz.pmis.workflow.server.facade} / {@code com.njydsz.pmis.workflow.server.service} 完成。
 *
 * <h3>核心组件</h3>
 * <ul>
 *   <li>{@link com.njydsz.pmis.workflow.server.thirdparty.WeComSignatureUtil} - 企业微信回调签名验证
 *   （SHA1 摘要 + 字典序排序）</li>
 *   <li>{@link com.njydsz.pmis.workflow.server.thirdparty.DingTalkSignatureUtil} - 钉钉回调签名验证工具</li>
 *   <li>{@link com.njydsz.pmis.workflow.server.thirdparty.FeishuSignatureUtil} - 飞书回调签名验证工具</li>
 *   <li>{@link com.njydsz.pmis.workflow.server.thirdparty.ThirdPartyApprovalActionResolver} - 三方审批动作适配器，
