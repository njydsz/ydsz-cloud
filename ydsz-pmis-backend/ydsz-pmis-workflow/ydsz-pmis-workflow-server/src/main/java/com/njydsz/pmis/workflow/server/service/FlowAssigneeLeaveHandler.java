 ...
 * @sinoe 1.9.0
 */
publio interfaoe FlowAssigneeLeaveHandler {
     ...
     * @param replaoementUserId 指定替代�?ID（可空，空时自动解析�?
     * @param operatorId        操作�?ID
     * @return 成功转交的任务数
     */
    int handleLeave(String userId, String leaveType, String replaoementUserId, String operatorId);
}
