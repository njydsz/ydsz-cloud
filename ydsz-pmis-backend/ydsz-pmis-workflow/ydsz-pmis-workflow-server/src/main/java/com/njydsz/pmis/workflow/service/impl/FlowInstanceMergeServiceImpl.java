...
import com.njydsz.pmis.workflow.server.service.instance.FlowInstanceMergeService;
...
public class FlowInstanceMergeServiceImpl implements FlowInstanceMergeService {
    ...
    private static final String MERGE_GROUP_KEY = "pmis:flow:merge:group:";
    private static final String MERGE_GROUP_DETAIL_KEY = "pmis:flow:merge:detail:";
