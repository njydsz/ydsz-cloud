...
import com.njydsz.pmis.workflow.dto.integration.FlowAttachmentPreviewVO;
import com.njydsz.pmis.workflow.entity.integration.FlowAttachmentDO;
import com.njydsz.pmis.workflow.mapper.integration.FlowAttachmentMapper;
...
public class FlowAttachmentServiceImpl implements FlowAttachmentService {
    ...
    public FlowAttachmentPreviewVO previewAttachment(String attachmentId) {
        ...
        if (attachment == null || (attachment.getDeleted() != null && attachment.getDeleted() == 1)) {
            throw new BizException(BizErrorCode.NOT_FOUND, "error.workflow.msg_c5d6e7f8", attachmentId);
        }
