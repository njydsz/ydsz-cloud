...
public interface FlowEventSubscriptionMapper extends BaseMapper<FlowEventSubscriptionDO> {
     ...
     * @return 匹配的订阅列表
     */
    List<FlowEventSubscriptionDO> selectWaitingByEvent(@Param("tenantId") Long tenantId,
     ...
     * 按关联键匹配 WAITING 消息订阅
     */
    List<FlowEventSubscriptionDO> selectWaitingByCorrelation(@Param("tenantId") Long tenantId,
     ...
     */
    int cancelByTask(@Param("boundaryTaskId") Long boundaryTaskId,
     ...
     */
    long countWaitingByInstance(@Param("instanceId") Long instanceId);
}
