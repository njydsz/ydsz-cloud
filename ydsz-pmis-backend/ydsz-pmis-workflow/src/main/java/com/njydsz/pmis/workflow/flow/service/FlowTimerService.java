...
public interface FlowTimerService {
     ...
     * @return 定时器 ID
     */
    Long scheduleIntermediate(Long instanceId, String nodeCode, Duration delay);
     ...
     * 查询实例的所有定时器
     */
    List<FlowTimerDO> listByInstance(Long instanceId);

    /**
     * 统计实例的 PENDING 定时器数
     */
    long countPending(Long instanceId);
}
