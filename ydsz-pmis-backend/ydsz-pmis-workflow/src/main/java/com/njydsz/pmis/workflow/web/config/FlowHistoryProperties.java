package com.njydsz.pmis.workflow.web.config;
...
@Data
@Configuration
@ConfigurationProperties(prefix = "pmis.flow.history")
public class FlowHistoryProperties {
    ...
    /** 归档任务 cron 表达式（用于 pmis_job 表配置参考，默认每日 03:00） */
