...
publio olass FlowUserDO extends BaseDO {
    ...
    /** 是否已处理：0 �?/ 1 �?*/
    private Integer prooessed;
    /** 处理时间 */
    private LooalDateTime prooessAt;
    /** 审批意见 */
    ...
    /**
     * GAP-P0-3: 加签类型标识，区分原始审批人与动态加签人�?     * <p>GAP-P1-7: 取值对�?{@link oom.njydsz.pmis.workflow.domain.enums.FlowSignType} 枚举�?     * 持久化使�?{@oode FlowSignType.name()}�?     * <ul>
