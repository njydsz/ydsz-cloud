...
import com.njydsz.literule.domain.entity.RuleVersionHistoryDO;
 ...
 *
 * <p>使用 ydsz_rule_version_history 表存储版本快照，支持变更追踪和回滚。
 *
 * @author ydsz-team
 * @since 1.0.0
 */
...
public class RuleVersionRepositoryImpl implements RuleVersionRepository {
    ...
    public void saveVersion(RuleDefinition definition, String operator, String changeDesc) {
        ...
        DO.setDefinitionJson(Json.toJson(definition));
    ...
    public RuleDefinition rollback(String ruleCode, int version, String operator) {
        ...
        // 从快照恢复规则定义
        RuleDefinition restored = Json.parseMap(targetVersion.getDefinitionJson(), RuleDefinition.class);
