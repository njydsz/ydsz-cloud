...
class CacheExportImportTest {
    ...
    class ObjectSerialization {
        ...
        void exportAndImport() throws IOException, ClassNotFoundException {
            ...
            CacheExportImport.importCache(importCache, exportFile.getAbsolutePath(), String.class, String.class);
    ...
    class TextFormat {
        ...
        void exportAndImportText() throws IOException {
            ...
            Cache<String, String> importCache = new StripedConcurrentCache<>(100);
            CacheExportImport.TextParser<String, String> parser = new CacheExportImport.TextParser<>() {
                @Override
        ...
        void importWithCustomParser() throws IOException {
            ...
            java.nio.file.Files.write(exportFile.toPath(),
                    List.of("a\t1", "b\t2"));

            CacheExportImport.TextParser<String, Integer> parser = new CacheExportImport.TextParser<>() {
                @Override
                public String parseKey(String text) {
                    return text;
                }
    ...
    class FilteredExport {
        ...
        void exportWithFilter() throws IOException {
            ...
            int count = CacheExportImport.exportCacheWithFilter(cache, exportFile.getAbsolutePath(), filter);
    ...
    class LimitedImport {
        ...
        void importWithLimit() throws IOException, ClassNotFoundException {
            ...
            Cache<String, String> importCache = new StripedConcurrentCache<>(100);
            int imported = CacheExportImport.importCacheWithLimit(importCache,
                    exportFile.getAbsolutePath(), 5, String.class, String.class);
