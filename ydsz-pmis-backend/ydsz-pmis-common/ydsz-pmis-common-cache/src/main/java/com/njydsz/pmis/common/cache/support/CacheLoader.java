 ...
 * <p>核心功能：
 * <ul>
 *   <li>单键加载：缓存未命中时自动调用 load() 加载数据</li>
 *   <li>批量加载：支持 getAll() 批量加载，减少数据库查询次数</li>
 *   <li>异步加载：支持 loadAsync() 异步加载，不阻塞调用线程</li>
 *   <li>批量异步加载：支持 loadAllAsync() 批量异步加载</li>
 * </ul>
 *
 * <p>与 Function 的区别：
 * <ul>
 *   <li>CacheLoader 支持批量和异步操作，更适合缓存场景</li>
 *   <li>支持加载时间统计，自动记录加载耗时</li>
 *   <li>提供默认实现，简化使用</li>
 * </ul>
 *
 * <p>使用示例：
