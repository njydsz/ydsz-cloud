 ...
 *
 * <p>解决了 {@link com.njydsz.pmis.common.cache.metrics.CacheMeterBinder} 中 GET/PUT Timer
...
public class TimedCacheDecorator<K, V> implements Cache<K, V> {
  ...
  public TimedCacheDecorator(
      Cache<K, V> delegate, com.njydsz.pmis.common.cache.metrics.CacheMeterBinder binder) {
    this.delegate = delegate;
