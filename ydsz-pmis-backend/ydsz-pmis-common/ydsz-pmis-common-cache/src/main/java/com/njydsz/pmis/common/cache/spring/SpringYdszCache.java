 ...
 * 使 YdszCache 支持 @Cacheable、@CachePut、@CacheEvict 等 Spring Cache 注解。
 *
 * @author Marvin Lee
...
public class SpringYdszCache extends AbstractValueAdaptingCache {
     ...
     */
    public SpringYdszCache(@NonNull String name, @NonNull Cache<Object, Object> delegate, boolean allowNullValues) {
