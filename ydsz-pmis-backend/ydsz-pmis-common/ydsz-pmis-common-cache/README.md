...
| 依赖 | Scope | 说明 |
|------|-------|------|
| `ydsz-pmis-common-core` | compile | 核心基础 |
| `ydsz-pmis-common-util` | compile | Jackson、SLF4J 等 |
| `ydsz-pmis-common-redis` | optional | L2 Redis 缓存后端 |
