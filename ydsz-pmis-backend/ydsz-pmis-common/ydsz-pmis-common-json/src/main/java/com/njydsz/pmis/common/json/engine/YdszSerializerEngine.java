...
public final class YdszSerializerEngine {
    ...
    private static final boolean MONITORING_ENABLED =
        Boolean.getBoolean("pmis.json.monitoring");
    ...
    public static String serialize(Object obj) {
        if (MONITORING_ENABLED) {
            ...
            try {
                return YdszSerializationProvider.serialize(obj);
            } finally {
    ...
    public static String serialize(Object obj, long features) {
        if (MONITORING_ENABLED) {
            long start = System.nanoTime();
            try {
                return YdszSerializationProvider.serialize(obj, features);
            } finally {
                long elapsed = System.nanoTime() - start;
                serializeCount++;
                serializeTotalNanos += elapsed;
    ...
    public static String format(Object obj) {
        if (MONITORING_ENABLED) {
            long start = System.nanoTime();
            try {
                return YdszSerializationProvider.format(obj);
            } finally {
                long elapsed = System.nanoTime() - start;
                serializeCount++;
                serializeTotalNanos += elapsed;
    ...
    public static String serialize(Object obj, Class<?> viewClass) {
        if (MONITORING_ENABLED) {
            long start = System.nanoTime();
            try {
                return YdszSerializationProvider.serializeWithView(obj, viewClass);
            } finally {
                long elapsed = System.nanoTime() - start;
                serializeCount++;
                serializeTotalNanos += elapsed;
    ...
    public static String serialize(Object obj, Class<?> viewClass, boolean pretty) {
        if (MONITORING_ENABLED) {
            long start = System.nanoTime();
            try {
                return YdszSerializationProvider.serializeWithView(obj, viewClass, pretty);
            } finally {
                long elapsed = System.nanoTime() - start;
                serializeCount++;
                serializeTotalNanos += elapsed;
    ...
    public static void clearAllCaches() {
        ...
        YdszSerializationProvider.clearThreadLocals();
    }
