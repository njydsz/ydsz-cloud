...
class SerializationContextTest {
    ...
    void testCaptureAndApply() {
        // 设置 Provider 值
        com.njydsz.pmis.common.json.provider.SerializationProvider.setWriteNulls(true);
        com.njydsz.pmis.common.json.provider.SerializationProvider.setPrettyPrint(true);
        ...
        // 修改 Provider 值
        com.njydsz.pmis.common.json.provider.SerializationProvider.setWriteNulls(false);
        com.njydsz.pmis.common.json.provider.SerializationProvider.setPrettyPrint(false);

        // 从 context 恢复
        ctx.applyToProvider();
        assertTrue(com.njydsz.pmis.common.json.provider.SerializationProvider.isWriteNulls());
        assertTrue(com.njydsz.pmis.common.json.provider.SerializationProvider.isPrettyPrint());
