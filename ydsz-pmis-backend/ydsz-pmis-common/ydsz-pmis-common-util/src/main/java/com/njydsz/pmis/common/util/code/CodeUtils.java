 ...
 * <pre>
 * // 生成 4 位数字验证码
 * CaptchaResult result = CodeUtils.generateNumeric(4);
 * BufferedImage image = result.getImage();
 * String code = result.getCode();
 *
 * // 生成 6 位混合验证码
 * CaptchaResult result = CodeUtils.generateAlphanumeric(6);
 *
 * // 生成算术验证码
 * CaptchaResult result = CodeUtils.generateArithmetic();
 *
 * // 自定义配置
...
public class CodeUtils {
    ...
    private CodeUtils() {
        throw new UnsupportedOperationException("CodeUtils is a utility class and cannot be instantiated");
    }
