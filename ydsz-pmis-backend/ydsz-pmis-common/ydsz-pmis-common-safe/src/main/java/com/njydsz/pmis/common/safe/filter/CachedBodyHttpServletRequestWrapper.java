 ...
 * 缓存请求体的 HTTP 请求包装器
 *
 * <p>将请求体读取到内存中，支持多次读取。解决 ServletInputStream 只能读一次的问题，
 * 供 XSS Filter、SQL 注入 Filter、API 签名 Filter 等多个过滤器共享请求体。
 *
 * <p><b>使用场景：</b>
 * <ul>
 *   <li>XSS Filter 需要读取并清洗 JSON 请求体</li>
 *   <li>SQL 注入 Filter 需要读取并检查请求参数</li>
 *   <li>API 签名 Filter 需要读取请求体计算签名</li>
 * </ul>
 *
