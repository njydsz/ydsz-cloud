...
public class RedisCheckpointStore implements CheckpointStore {
    ...
    public void save(String bucketName, String objectName, String checkpoint, long ttlSeconds) {
        ...
        try {
            ...
            log.warn("[Storage] RedisCheckpointStore save failed, bucket={}, object={}, message={}",
    ...
    public String get(String bucketName, String objectName) {
        ...
        try {
            ...
            log.warn("[Storage] RedisCheckpointStore get failed, bucket={}, object={}, message={}",
                    bucketName, objectName, e.getMessage());
            return null;
        }
    }
    ...
    public void remove(String bucketName, String objectName) {
        ...
        try {
            ...
            log.warn("[Storage] RedisCheckpointStore remove failed, bucket={}, object={}, message={}",
                    bucketName, objectName, e.getMessage());
        }
    }
    ...
    public String buildKey(String bucketName, String objectName) {
        String safeBucket = URLEncoder.encode(bucketName, StandardCharsets.UTF_8)
                .replace("+", "%20");
        String safeObjectName = URLEncoder.encode(objectName, StandardCharsets.UTF_8)
                .replace("+", "%20");
