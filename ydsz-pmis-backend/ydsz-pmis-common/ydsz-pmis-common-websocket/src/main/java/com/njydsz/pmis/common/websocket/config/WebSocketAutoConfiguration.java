package com.njydsz.pmis.common.websocket.config;
...
import com.njydsz.pmis.common.websocket.push.DefaultRealtimePushTemplate;
import com.njydsz.pmis.common.websocket.push.RealtimePushTemplate;
import com.njydsz.pmis.common.websocket.ratelimit.WebSocketRateLimiter;
import com.njydsz.pmis.common.websocket.session.OnlineUserService;
import com.njydsz.pmis.common.websocket.session.WebSocketSessionEventListener;
...
public class WebSocketAutoConfiguration {
    ...
    public RealtimePushTemplate realtimePushTemplate(
            SimpMessagingTemplate messagingTemplate,
            @Autowired(required = false) com.njydsz.pmis.common.websocket.cluster.WebSocketClusterPublisher clusterPublisher,
            OnlineUserService onlineUserService,
            OfflineMessageStore offlineMessageStore,
    ...
    private static class NoOpClusterPublisher extends com.njydsz.pmis.common.websocket.cluster.WebSocketClusterPublisher {
        ...
        @Override
        public boolean publish(com.njydsz.pmis.common.websocket.cluster.WebSocketClusterMessage message) {
            return false;
        }
    }
}
