 ...
 * 通知模板引擎自动配置
 *
 * <p>当 pmis.notify.template.enabled=true（默认）时生效，自动创建模板引擎和模板管理器 Bean。
 *
 * <p>支持的配置项：
 * <ul>
...
@ConditionalOnProperty(prefix = "pmis.notify.template", name = "enabled", havingValue = "true", matchIfMissing = true)
