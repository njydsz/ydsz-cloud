 ...
 * 写入元数据 - 封装Excel写入配置信息
 *
 * <p>包含写入Excel所需的所有配置参数,如文件路径、映射类型、Sheet信息等。
 * 在写入过程中被持续使用,控制输出的格式和行为。</p>
 *
 * <h3>配置项分类</h3>
 * <ul>
 *   <li>输出目标 - filePath、file、outputStream(三选一)</li>
 *   <li>Sheet配置 - sheetName、sheetNo、headRowNumber</li>
 *   <li>映射配置 - clazz、headList</li>
 *   <li>格式配置 - dateFormat、numberFormat</li>
 *   <li>保护配置 - password、passwordProtected</li>
 * </ul>
 *
 * @see ExcelWriter
 * @see ReadMetadata
...
public class WriteMetadata {
     ...
     * <p>初始化默认值:
     * <ul>
     *   <li>sheetName = "sheet1"</li>
     *   <li>sheetNo = 0</li>
     *   <li>headRowNumber = 1</li>
     *   <li>automaticTrim = true</li>
     *   <li>excelType = "xlsx"</li>
     * </ul>
     */
    ...
    public static class WriteHeaderProperty {
        ...
        /** 样式注解 */
        private com.njydsz.pmis.common.excel.annotation.ExcelStyle style;
        ...
        public com.njydsz.pmis.common.excel.annotation.ExcelStyle getStyle() {
            return style;
        }

        public void setStyle(com.njydsz.pmis.common.excel.annotation.ExcelStyle style) {
            this.style = style;
        }
