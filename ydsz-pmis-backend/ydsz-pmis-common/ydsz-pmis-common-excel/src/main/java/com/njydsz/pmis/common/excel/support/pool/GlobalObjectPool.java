 ...
 *   <li>borrow/return 均为无锁操作，基于 CAS 实现</li>
 * </ul>
 *
 * <h3>核心功能</h3>
 * <ul>
 *   <li>通用对象池 - 支持任意类型对象的借还管理</li>
 *   <li>字符串池 - 字符串 intern 优化</li>
 *   <li>日期池 - Date 对象缓存复用</li>
 * </ul>
 *
 * <h3>设计模式</h3>
 * <ul>
 *   <li>对象池模式 - 复用对象减少分配开销</li>
 *   <li>单例模式 - 全局统一管理</li>
 * </ul>
 *
 * <h3>使用示例</h3>
 ...
 *
 * // 字符串 intern
 * String pooledStr = GlobalObjectPool.StringPool.intern("常用字符串");
 * }</pre>
 *
 * @see ObjectPool
 * @see StylePool
...
public class GlobalObjectPool {
     ...
     * 通用对象池实现
     *
     * <p>使用 ConcurrentLinkedQueue 管理可用对象列表，支持无锁借用与归还</p>
     *
     * @param <T> 对象类型
     */
