...
import com.njydsz.pmis.common.socket.health.WebSocketHealthIndicator;
...
import com.njydsz.pmis.common.socket.retry.DeadLetterQueue;
import com.njydsz.pmis.common.socket.retry.MessageRetryQueue;
import com.njydsz.pmis.common.socket.retry.RedisDeadLetterQueue;
...
import com.njydsz.pmis.common.socket.serialize.JsonMessageSerializer;
...
public class WebSocketAutoConfiguration {
    ...
    @ConditionalOnProperty(prefix = "pmis.websocket.ack", name = "enabled", havingValue = "true")
    ...
    @ConditionalOnProperty(prefix = "pmis.websocket.retry", name = "dead-letter-enabled", havingValue = "true")
    ...
    @ConditionalOnProperty(prefix = "pmis.websocket.retry", name = "enabled", havingValue = "true", matchIfMissing = true)
