...
import com.njydsz.pmis.common.base.exporter.DefaultDocExporter;
import com.njydsz.pmis.common.base.exporter.MarkdownDocExporter;

/**
 * 文档模块自动配置类
 *
 * <p>作为 ydsz-pmis-common-base 模块的文档入口配置，负责一站式开启文档模块的所有能力：
 * <ul>
