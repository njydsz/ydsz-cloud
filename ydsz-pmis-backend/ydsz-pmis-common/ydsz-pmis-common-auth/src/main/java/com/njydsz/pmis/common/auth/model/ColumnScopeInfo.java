 ...
 * <p><b>数据结构：</b>
 * <ul>
 *   <li>visibleColumnsByTable：表名到可见字段集合的映射（读权限）</li>
 *   <li>editableColumnsByTable：表名到可编辑字段集合的映射（写权限）</li>
 * </ul>
 *
 * <p><b>与 SQL 拦截器联动：</b>
...
public class ColumnScopeInfo {
    ...
    public ColumnScopeInfo(Map<String, Set<String>> visibleColumnsByTable,
                           Map<String, Set<String>> editableColumnsByTable) {
        this.visibleColumnsByTable = visibleColumnsByTable != null
                ? Collections.unmodifiableMap(visibleColumnsByTable)
                : Collections.emptyMap();
        this.editableColumnsByTable = editableColumnsByTable != null
