 ...
 * 
 * <p>继承 ydsz-pmis-common-domain 的 {@link BaseAuditEntity}，在审计字段上添加 MyBatis-Plus 字段映射与自动填充注解。
 * 
 * <p><b>业务模块应直接依赖 ydsz-pmis-common-jdbc 并使用此类</b>，而非 ydsz-pmis-common-domain 的 BaseAuditEntity。
 * 
 * @param <T> 主键ID类型
 *
 * @author Marvin Lee
