 ...
 * 
 * <p>在 ydsz-pmis-common-domain 的 {@link BaseEntity} 基础上，添加 MyBatis-Plus 注解，包括：
 * <ul>
 ...
 * </ul>
 * 
 * <p><b>业务模块应直接依赖 ydsz-pmis-common-jdbc 并使用此类</b>，而非 ydsz-pmis-common-domain 的 BaseEntity。
 * 
 * <p><b>使用示例：</b>
 * <pre>{@code
 * &#64;Data
