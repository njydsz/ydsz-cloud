...
/**
 * LLM 客户端自动配置（P0-2 架构优化）。
 *
 * <p>根据配置 {@code pmis.common.ai.client-type} 自动创建对应的 {@link LlmClient} Bean：
 * <ul>
...
@ConditionalOnProperty(name = "pmis.common.ai.enabled", havingValue = "true", matchIfMissing = false)
public class LlmClientAutoConfiguration {
    ...
    @ConditionalOnProperty(name = "pmis.common.ai.client-type", havingValue = "OPENAI_COMPATIBLE")
