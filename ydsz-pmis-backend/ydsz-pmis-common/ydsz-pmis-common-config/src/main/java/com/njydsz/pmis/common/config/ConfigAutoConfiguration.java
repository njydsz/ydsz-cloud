...
import com.njydsz.pmis.common.config.health.ConfigEncryptHealthIndicator;
import com.njydsz.pmis.common.config.hotreload.ConfigChangeBridge;
import com.njydsz.pmis.common.config.hotreload.ConfigChangeListener;
...
public class ConfigAutoConfiguration {
    ...
    @ConditionalOnProperty(prefix = "pmis.config.change-monitor", name = "enabled",
    ...
    @ConditionalOnProperty(prefix = "pmis.config.health", name = "enabled",
            havingValue = "true", matchIfMissing = true)
