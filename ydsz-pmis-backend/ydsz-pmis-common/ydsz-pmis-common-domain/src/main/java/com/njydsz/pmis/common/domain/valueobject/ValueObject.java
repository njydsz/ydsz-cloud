ackage com.njydsz.pmis.common.domain.valueobject;
 ...
 *   <li><b>不可变性：</b>值对象一旦创建，其状态不可改变，修改操作应返回新的实例</li>
 *   <li><b>相等性：</b>两个值对象的所有属性值都相等时，它们就是相等的</li>
 *   <li><b>可替换性：</b>相等的值对象可以互相替换，不影响业务逻辑</li>
 * </ul>
 *
 * <p><b>equals/hashCode 建议：</b>
 * <p>值对象的 {@code equals} 和 {@code hashCode} 应基于所有属性值实现，
 * 而非基于对象引用。本接口提供默认方法建议，实现类应确保：
 * <ul>
 *   <li>{@code equals} 比较所有业务属性值</li>
 *   <li>{@code hashCode} 基于所有业务属性值计算</li>
...
public interface ValueObject extends Serializable {
    ...
    /**
     * 获取值对象的所有属性值，用于默认的 equals/hashCode 计算
     *
