ackage com.njydsz.pmis.common.domain.vo;
 ...
 * <ul>
 *   <li>createdAt：创建时间，对应数据库 created_at</li>
 *   <li>updatedAt：更新时间，对应数据库 updated_at</li>
 * </ul>
 *
 * <p><b>通用字段说明：</b>
 * <table>
