 ...
 * 视图对象基类
 *
 * <p>字段命名�?{@link com.njydsz.pmis.common.domain.entity.BaseAuditEntity} 保持一致：
 * <ul>
...
public class BaseVO implements Serializable {
     ...
     * 创建时间
     *
     * <p>�?{@link com.njydsz.pmis.common.domain.entity.BaseAuditEntity#getCreatedAt()} 命名对齐�?
     ...
     * 更新时间
     *
     * <p>�?{@link com.njydsz.pmis.common.domain.entity.BaseAuditEntity#getUpdatedAt()} 命名对齐�?
     * JSON 序列化时格式化为 "yyyy-MM-dd HH:mm:ss"�?
     */
    @YdszJsonFormat("yyyy-MM-dd HH:mm:ss")
