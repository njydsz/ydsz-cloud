...
public class ExternalException extends AbstractRemiException {
     ...
     */
    public static class ExternalExceptionBuilder extends RemiExceptionBuilder<ExternalException, ExternalExceptionBuilder> {
