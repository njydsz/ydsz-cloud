 ...
 * TraceId 过滤器自动配置
 *
 * <p>通过 {@code remi.exception.trace-enabled=true}（默认启用）控制是否注册。
...
@ConditionalOnProperty(prefix = "remi.exception", name = "trace-enabled", havingValue = "true", matchIfMissing = true)
