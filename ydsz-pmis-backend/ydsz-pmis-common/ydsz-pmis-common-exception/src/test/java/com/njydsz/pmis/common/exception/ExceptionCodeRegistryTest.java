...
class ExceptionCodeRegistryTest {
    ...
    void testUnifiedExceptionCodeAutoRegistered() {
        for (com.njydsz.pmis.common.exception.code.UnifiedExceptionCode code :
                com.njydsz.pmis.common.exception.code.UnifiedExceptionCode.values()) {
    ...
    void testUnifiedExceptionCodeResolve() {
        assertEquals(
                com.njydsz.pmis.common.exception.code.UnifiedExceptionCode.NOT_FOUND,
                com.njydsz.pmis.common.exception.code.UnifiedExceptionCode.resolve("A04051")
        );
        assertNull(com.njydsz.pmis.common.exception.code.UnifiedExceptionCode.resolve("INVALID"));
        assertNull(com.njydsz.pmis.common.exception.code.UnifiedExceptionCode.resolve(null));
    }
