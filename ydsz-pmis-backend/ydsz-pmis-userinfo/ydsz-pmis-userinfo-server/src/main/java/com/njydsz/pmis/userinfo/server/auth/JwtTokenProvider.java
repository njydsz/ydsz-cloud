package com.njydsz.pmis.userinfo.server.auth;
 ...
 *
 * <p>原参考实现位于 ydsz-pmis-common-auth.token.JwtTokenProvider 包，因 common 重构后该类已迁移到各业务模块本地化。
 ...
 * {@code pmis.userinfo.jwt.secret} 注入，未配置时使用默认演示密钥（仅供本地开发）。
 *
 * @since 1.0.0
 */
@Slf4j
