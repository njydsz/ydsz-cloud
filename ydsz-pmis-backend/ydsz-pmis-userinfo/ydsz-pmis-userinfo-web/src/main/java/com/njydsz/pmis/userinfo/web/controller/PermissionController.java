...
public class PermissionController {
    ...
    @DistributedLock(key = "permission:create:#{#dto.permCode}", waitTime = 3, leaseTime = 10, message = "正在创建权限，请稍后")
    ...
    @DistributedLock(key = "permission:update:#{#dto.id}", waitTime = 3, leaseTime = 10, message = "正在更新权限，请稍后")
    ...
    @DistributedLock(key = "permission:delete:#{#id}", waitTime = 3, leaseTime = 10, message = "正在删除权限，请稍后")
