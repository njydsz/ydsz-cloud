package com.njydsz.pmis.userinfo.controller.resource;
...
import com.njydsz.pmis.userinfo.entity.resource.ResourceAssignmentDO;
import com.njydsz.pmis.userinfo.service.resource.ResourceAssignmentService;
...
public class ResourceAssignmentController {
    ...
    @GetMapping("/{id}")
    public Result<ResourceAssignmentDO> get(@PathVariable String id) {
    ...
    public Result<Map<String, Object>> utilization(@PathVariable String employeeId) {
