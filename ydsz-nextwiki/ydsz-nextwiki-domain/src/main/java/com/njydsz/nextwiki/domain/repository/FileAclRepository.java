...
public interface FileAclRepository {
   ...
   */
  List<FileAclDO> findByFileNodeId(String fileNodeId);
   ...
   */
  List<FileAclDO> findByFileNodeIdAndGrantee(String fileNodeId, String granteeType, String granteeId);
  ...
  /** 查询用户对某文件的权限（含继承） */
  List<FileAclDO> findEffectivePermissions(String fileNodeId, String userId, List<String> roleIds);

  /** 批量插入继承的 ACL */
  void batchSave(List<FileAclDO> acls);
}
