...
public interface ShareRecipientRepository {
   ...
   */
  void saveBatch(List<ShareRecipientDO> recipients);
   ...
   * @return 目标用户列表
   */
  List<ShareRecipientDO> findByShareId(String shareId);
   ...
   * @return 分享接收记录列表
   */
  List<ShareRecipientDO> findByRecipientId(String recipientId);
