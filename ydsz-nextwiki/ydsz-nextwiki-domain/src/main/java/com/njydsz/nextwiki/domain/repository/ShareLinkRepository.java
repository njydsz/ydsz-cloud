...
public interface ShareLinkRepository {
   ...
   */
  ShareLinkDO save(ShareLinkDO shareLink);
   ...
   */
  ShareLinkDO findById(String id);
   ...
   * @return 分享链接实体，不存在时返回 null
   */
  ShareLinkDO findByShareCode(String shareCode);
   ...
   */
  List<ShareLinkDO> findByFileNodeId(String fileNodeId);
   ...
   */
  List<ShareLinkDO> findActiveSharesByUserId(String userId);
   ...
   */
  void update(ShareLinkDO shareLink);
   ...
   */
  List<ShareLinkDO> findExpiringShares(int withinHours);
}
