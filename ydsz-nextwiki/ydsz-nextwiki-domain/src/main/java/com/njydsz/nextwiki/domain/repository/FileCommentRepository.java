...
public interface FileCommentRepository {
   ...
   * @return 持久化后的评论（回填主键）
   */
  FileCommentDO save(FileCommentDO comment);
   ...
   */
  FileCommentDO findById(String id);
   ...
   */
  List<FileCommentDO> findByFileNodeId(String fileNodeId);
   ...
   */
  List<FileCommentDO> findReplies(String parentCommentId);
   ...
   */
  void update(FileCommentDO comment);
