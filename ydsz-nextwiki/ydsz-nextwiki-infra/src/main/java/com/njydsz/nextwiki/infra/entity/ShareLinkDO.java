 ...
 * 文件分享链接实体
 *
 * <p>生成带密码和过期时间的分享链接，支持文件/文件夹级别的分享。 区别于系统级 RBAC 权限，这是文件级的临时授权机制。
 *
 * <p><b>安全设计：</b>
 *
 * <ul>
 *   <li>分享码（shareCode）使用 UUID 生成，不可猜测
 *   <li>访问密码使用 BCrypt 加密存储
 *   <li>支持访问次数限制和过期时间
 *   <li>支持提取码（4 位数字）二次验证
 * </ul>
 *
...
public class ShareLinkDO extends MpBaseEntity<String> implements Serializable {
