 ...
 *
 * <ul>
 *   <li>{@code POST /ai/summary} - 生成文件内容摘要</li>
 *   <li>{@code GET /ai/status} - 查询 AI 服务可用状态</li>
 *   <li>{@code GET /ai/supported-types} - 查询支持的文件类型</li>
 * </ul>
 *
 * @author ydsz-team
 * @since 1.0.0
...
public class AiController {
    ...
    public BaseResponse<NextwikiDTOs.SummaryResult> generateSummary(
        ...
        NextwikiDTOs.SummaryResult result = aiSummaryService.generateSummary(
