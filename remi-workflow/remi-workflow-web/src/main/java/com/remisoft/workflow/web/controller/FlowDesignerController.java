...
import com.remisoft.workflow.domain.dto.FlowDesignerDataDTO;
...
public class FlowDesignerController {
     ...
     * @return 统一响应结果
     */
    @Idempotent(key = "remi:workflow:FlowDesignerController:saveDesignerData:lock", ttlSeconds = 5)
    ...
    public BaseResponse<Void> saveDesignerData(@PathVariable String id,
        ...
        Map<String, Object> designerData = RemiJson.parseMap(dto.getDesignerData());
     ...
     */
    @Idempotent(key = "remi:workflow:FlowDesignerController:lockDefinition:lock", ttlSeconds = 5)
     ...
     */
    @Idempotent(key = "remi:workflow:FlowDesignerController:unlockDefinition:lock", ttlSeconds = 5)
     ...
     * @return 统一响应结果
     */
    @Idempotent(key = "remi:workflow:FlowDesignerController:saveFormConfig:lock", ttlSeconds = 5)
     ...
     * @return 统一响应结果
     */
    @Idempotent(key = "remi:workflow:FlowDesignerController:saveSlaConfig:lock", ttlSeconds = 5)
    ...
    public BaseResponse<Void> saveSlaConfig(@PathVariable String id,
        ...
        String json = slaConfig == null ? null : RemiJson.toJson(slaConfig);
     ...
     * @return 新创建的流程定义 ID
     */
    @Idempotent(key = "remi:workflow:FlowDesignerController:importTemplate:lock", ttlSeconds = 5)
