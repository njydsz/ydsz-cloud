...
public class FlowDefinitionController {
     ...
     */
    @Idempotent(key = "remi:workflow:FlowDefinitionController:deploy:lock", ttlSeconds = 5)
     ...
     */
    @Idempotent(key = "remi:workflow:FlowDefinitionController:batchDeployFromZip:lock", ttlSeconds = 5)
     ...
     * @return 统一响应结果
     */
    @Idempotent(key = "remi:workflow:FlowDefinitionController:publish:lock", ttlSeconds = 5)
     ...
     * @return 统一响应结果
     */
    @Idempotent(key = "remi:workflow:FlowDefinitionController:deprecate:lock", ttlSeconds = 5)
