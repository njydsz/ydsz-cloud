package com.remisoft.workflow.web.controller.ai;
 ...
 * @author remi-team
 * @since 1.0.0
 * @see com.remisoft.workflow.server.service.FlowCanaryService 灰度发布 Service
 * @see com.remisoft.workflow.domain.enums.CanaryStrategy 切流策略枚举
 */
@Slf4j
@RestController
...
public class FlowCanaryController {
     ...
     * @return 空响应
     */
    @Idempotent(key = "remi:workflow:FlowCanaryController:publishCanary:lock", ttlSeconds = 5)
     ...
     * @return 空响应
     */
    @Idempotent(key = "remi:workflow:FlowCanaryController:adjustCanary:lock", ttlSeconds = 5)
     ...
     * @return 空响应
     */
    @Idempotent(key = "remi:workflow:FlowCanaryController:promoteCanary:lock", ttlSeconds = 5)
     ...
     * @return 空响应
     */
    @Idempotent(key = "remi:workflow:FlowCanaryController:rollbackCanary:lock", ttlSeconds = 5)
