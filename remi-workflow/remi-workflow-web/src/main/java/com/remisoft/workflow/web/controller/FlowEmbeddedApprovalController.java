 ...
 * @since 1.0.0
 *
 * @see com.remisoft.workflow.server.service.FlowEmbeddedApprovalService 嵌入式审批服务
 * @see com.remisoft.workflow.domain.dto.EmbeddedApprovalActionDTO 嵌入式快捷操作 DTO
 * @see com.remisoft.workflow.domain.dto.EmbeddedApprovalViewDTO 嵌入式面板视图 DTO
 */
@Slf4j
@Tag(name = "嵌入式审批")
@RestController
...
public class FlowEmbeddedApprovalController {
    ...
    @Idempotent(key = "remi:workflow:FlowEmbeddedApprovalController:quickAction:lock", ttlSeconds = 5)
    ...
    @Idempotent(key = "remi:workflow:FlowEmbeddedApprovalController:quickActionByPath:lock", ttlSeconds = 5)
