...
public class FlowDelegateController {
     ...
     * </pre>
     */
    @Idempotent(key = "remi:workflow:FlowDelegateController:createDelegateAuth:lock", ttlSeconds = 5)
     ...
     * @return 空响应
     */
    @Idempotent(key = "remi:workflow:FlowDelegateController:revokeDelegateAuth:lock", ttlSeconds = 5)
     ...
     * @return 空响应
     */
    @Idempotent(key = "remi:workflow:FlowDelegateController:updateDelegateAuthStatus:lock", ttlSeconds = 5)
