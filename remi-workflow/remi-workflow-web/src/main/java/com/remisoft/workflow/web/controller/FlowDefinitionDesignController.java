...
import com.remisoft.workflow.domain.dto.FlowDefinitionSimulateDTO;
...
public class FlowDefinitionDesignController {
     ...
     * @return 统一响应结果
     */
    @Idempotent(key = "remi:workflow:FlowDefinitionController:updateNodeCoordinate:lock", ttlSeconds = 5)
     ...
     * @return 统一响应结果
     */
    @Idempotent(key = "remi:workflow:FlowDefinitionController:updateDefinition:lock", ttlSeconds = 5)
     ...
     */
    @Idempotent(key = "remi:workflow:FlowDefinitionController:importDefinition:lock", ttlSeconds = 5)
