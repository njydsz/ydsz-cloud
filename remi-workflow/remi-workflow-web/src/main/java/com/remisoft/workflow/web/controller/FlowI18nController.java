 ...
 * 其它语言暂未内置，需业务方在 {@code remi_workflow_i18n} 表中自行扩展。
 *
 * <p><b>性能优化：</b>所有描述走 Redis 缓存（{@code remi:workflow:i18n:{locale}:{enumType}}），
...
public class FlowI18nController {
     ...
     * <p>语言列表来源：{@code remi_workflow_i18n} 表中 {@code locale} 字段去重。
     *
