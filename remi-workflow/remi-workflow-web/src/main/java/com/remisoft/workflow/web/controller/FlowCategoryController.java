...
public class FlowCategoryController {
     ...
     * @return 新建分类 ID
     */
    @Idempotent(key = "remi:workflow:FlowCategoryController:create:lock", ttlSeconds = 5)
     ...
     * @return 空响应
     */
    @Idempotent(key = "remi:workflow:FlowCategoryController:update:lock", ttlSeconds = 5)
     ...
     * @return 空响应
     */
    @Idempotent(key = "remi:workflow:FlowCategoryController:delete:lock", ttlSeconds = 5)
