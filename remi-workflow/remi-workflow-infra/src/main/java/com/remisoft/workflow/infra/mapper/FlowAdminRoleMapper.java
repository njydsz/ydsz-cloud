 ...
 * 流程管理员角色 Mapper（P1-6）
 *
 * <p>对应数据表 <code>remi_flow_admin_role</code>，存储流程管理员与流程分类的关联。</p>
 ...
 * @since 1.0.0
 *
 * @see com.remisoft.workflow.domain.entity.FlowAdminRole 流程管理员实体
 * @see com.remisoft.workflow.server.service.FlowAdminService 流程管理员 Service
