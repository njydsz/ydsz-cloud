 ...
 * 流程模板 Mapper
 *
 * <p>对应数据表 <code>remi_flow_template</code>，存储可复用的流程模板（带版本化与继承关系）。</p>
 ...
 * @since 1.0.0
 *
 * @see com.remisoft.workflow.domain.entity.FlowTemplate 流程模板实体
 * @see com.remisoft.workflow.server.service.FlowTemplateService 流程模板 Service
