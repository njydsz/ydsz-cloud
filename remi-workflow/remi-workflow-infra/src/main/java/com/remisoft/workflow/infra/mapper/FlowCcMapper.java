 ...
 * 流程抄送 Mapper
 *
 * <p>对应数据表 <code>remi_flow_cc</code>（P0-3），存储流程抄送关系。</p>
 ...
 * @since 1.0.0
 *
 * @see com.remisoft.workflow.domain.entity.FlowCc 抄送实体
 * @see com.remisoft.workflow.server.service.FlowCcService 抄送 Service
...
public interface FlowCcMapper extends BaseMapper<FlowCc> {
     ...
     *
     * <p>无 tenant/ccUser 过滤，统计 remi_flow_cc 表所有未读记录数。
     */
    long countUnread();
