 ...
 * 节点跳转 Mapper
 *
 * <p>对应数据表 <code>remi_flow_skip</code>，记录节点之间的跳转关系（正向流转/退回）。</p>
 ...
 * @since 1.0.0
 *
 * @see com.remisoft.workflow.domain.entity.FlowSkip 节点跳转实体
 * @see com.remisoft.workflow.server.engine.FlowEngine 流程引擎
