 ...
 * P2-2 流程评论 Mapper
 *
 * <p>对应数据表 <code>remi_flow_comment</code>，存储审批评论与多级回复。</p>
 ...
 * @since 1.0.0
 *
 * @see com.remisoft.workflow.domain.entity.FlowComment 评论实体
 * @see com.remisoft.workflow.server.service.FlowCommentService 评论 Service
...
public interface FlowCommentMapper extends BaseMapper<FlowComment> {
     ...
     * @return 一级评论列表（不含回复）
     */
    @Select("SELECT * FROM remi_flow_comment " +
