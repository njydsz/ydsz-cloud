 ...
 *
 * <p>对应数据表 <code>remi_flow_dmn_rule</code>，存储 DMN 决策表的具体行规则。</p>
 * <p>决策规则是决策表的一行（输入条件 + 输出结论），按 hitPolicy 决定命中策略（FIRST/UNIQUE/PRIORITY/ANY）。
 *
 * <p><b>主要索引：</b>
 * <ul>
 *   <li>uk_decision_rule_no — (decisionId+ruleNo) 唯一索引</li>
 *   <li>idx_priority — 优先级排序索引</li>
 * </ul>
 *
 ...
 * @since 1.0.0
 *
 * @see com.remisoft.workflow.domain.entity.FlowDmnRule DMN 规则实体
 * @see com.remisoft.workflow.server.service.FlowDmnService DMN Service
