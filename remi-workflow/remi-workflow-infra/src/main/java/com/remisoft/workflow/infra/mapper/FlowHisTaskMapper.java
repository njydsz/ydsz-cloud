 ...
 * 历史任务 Mapper
 *
 * <p>对应数据表 <code>remi_flow_his_task</code>，归档已完成的流程任务，供已办查询与审计追溯。</p>
 * <p>任务结束（同意/驳回/转办/加签完成）后从 {@code remi_flow_run_task} 迁移到本表，保留完整审批轨迹。
 *
 * <p><b>主要索引：</b>
 * <ul>
 ...
 * @see com.remisoft.workflow.server.service.FlowTaskHistoryService 已办 Service
