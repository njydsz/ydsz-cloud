 ...
 *
 * <p><b>性能优化：</b>「查询全部分类」使用 {@code remi_flow_category} 索引（{@code idx_parent} + {@code idx_sort}），
 * 全表一次性返回（分类数据量小，无分页必要）。
 *
 * @author remi-team
 * @since 1.0.0
 *
 * @see com.remisoft.workflow.server.service.impl.FlowCategoryServiceImpl 实现类
