 ...
 * @since 1.0.0
 *
 * @see com.remisoft.workflow.server.service.impl.FlowDefinitionServiceImpl 实现类
...
public interface FlowDefinitionService {
     ...
     *     <ul>
     *       <li>{@code force=false} 且 {@code remi.flow.publish-block-on-high-risk=true}（默认）→ 抛 SysException 阻断</li>
