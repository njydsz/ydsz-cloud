...
public interface FlowAdvancer {
     ...
     */
    List<FlowNode> advance(FlowInstance currentInstance,
     ...
     * 以避免调用方传 {@code null} 时与 {@link #advance(FlowInstance, String, String, String, Map)}
     ...
     * @since 1.0.0
     */
    default List<FlowNode> advanceMulti(FlowInstance currentInstance,
                                           String currentNodeCode,
                                           String skipType,
     ...
     * 解析出所有满足条件的 PASS 跳转
     */
    List<FlowSkip> resolvePassSkips(FlowInstance instance,
