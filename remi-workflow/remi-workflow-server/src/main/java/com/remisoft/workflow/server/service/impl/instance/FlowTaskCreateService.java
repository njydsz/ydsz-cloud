...
import com.remisoft.workflow.server.engine.FlowServiceNodeExecutor;
import com.remisoft.workflow.server.engine.FlowVariableStrategy;
import com.remisoft.workflow.server.metrics.FlowMetrics;
import com.remisoft.workflow.server.service.FlowDelegateAuthService;
...
import com.remisoft.workflow.server.service.FlowSlaService;
...
public class FlowTaskCreateService {
    ...
    public String createTask(String instanceId, FlowNode node, Map<String, Object> variables,
        ...
        // 正常路径：设置首个办理人 + 写入 remi_flow_user
