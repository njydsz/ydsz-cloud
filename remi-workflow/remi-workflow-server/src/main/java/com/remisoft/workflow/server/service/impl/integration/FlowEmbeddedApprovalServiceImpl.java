 ...
 * @see com.remisoft.workflow.domain.dto.EmbeddedApprovalViewDTO 嵌入式审批面板视图
...
public class FlowEmbeddedApprovalServiceImpl implements FlowEmbeddedApprovalService {
     ...
     * 计算当前用户可执行的操作
     */
    private List<String> computeActions(FlowInstance instance, List<FlowRunTask> pending, String userId) {
