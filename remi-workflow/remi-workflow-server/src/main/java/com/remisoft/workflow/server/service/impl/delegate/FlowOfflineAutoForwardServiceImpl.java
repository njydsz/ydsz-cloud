package com.remisoft.workflow.server.service.impl.delegate;
 ...
 *   <li><b>转交记录</b>：所有自动转交记录到 {@code remi_flow_audit_log}</li>
 * </ul>
 *
 * <p><b>与委派代理的区别：</b>
 * <table>
 ...
 *   <li><b>审计追溯</b>：转交记录同时写入 {@code remi_flow_audit_log}，
 *       标注「自动转交」原因</li>
 ...
 * @see com.remisoft.workflow.domain.entity.FlowDelegateAuth 委派代理实体（优先使用其配置）
 * @see FlowTaskService 流程任务服务（转交后触发新的待办）
 * @see com.remisoft.workflow.server.service.FlowDelegateAuthService 委派代理服务
 */
@Slf4j
@Service
