 ...
 * P1-4: 服务节点执行器
 *
 * <p>负责执行 {@link com.remisoft.workflow.domain.enums.FlowNodeType#SERVICE} 类型节点的自动逻辑，
 ...
 *
 * <p>RestTemplate 由 remi-common-notify 统一提供，通过构造器注入。
 *
 * @since 1.0.0
 * @author remi-team
 */
...
public class FlowServiceNodeExecutor {
    ...
    /**
     * WEBHOOK / HTTP 通道使用的 RestTemplate（由 remi-common-notify 统一提供）。
     */
