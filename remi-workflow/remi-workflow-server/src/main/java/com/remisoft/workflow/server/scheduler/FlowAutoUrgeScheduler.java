package com.remisoft.workflow.server.scheduler;
...
import com.remisoft.workflow.server.service.impl.instance.FlowTaskUrgeService;
...
public class FlowAutoUrgeScheduler {
     ...
     * 每 30 分钟执行一次自动催办扫描。
     */
    @Scheduled(fixedDelayString = "${remi.flow.auto-urge.scan-interval-ms:1800000}")
