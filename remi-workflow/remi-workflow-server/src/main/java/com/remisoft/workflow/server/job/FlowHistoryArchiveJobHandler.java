package com.remisoft.workflow.server.job;
 ...
 * 将其从主表迁移到 {@code remi_flow_his_instance} 冷存储表，同时归档关联的 variable。
 *
 * <p>P2-8 改造点：
 * <ul>
 ...
 * 可在 remi_job 表配置：handler=flowHistoryArchiveJobHandler, cron="0 0 3 * * ?"
 *
 * @since 1.0.0
 * @author remi-team
 */
...
public class FlowHistoryArchiveJobHandler implements JobHandler {
    ...
    private Integer parseInteger(String json, String key) {
        ...
        try {
            Map<String, Object> obj = RemiJson.parseMap(json);
