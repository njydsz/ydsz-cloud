...
import com.remisoft.workflow.domain.dto.FlowAttachmentDTO;
import com.remisoft.workflow.domain.dto.FlowAttachmentPreviewVO;
import com.remisoft.workflow.domain.entity.FlowAttachment;
import com.remisoft.workflow.infra.mapper.FlowAttachmentMapper;
import com.remisoft.workflow.server.config.FlowProperties;
import com.remisoft.workflow.server.service.FlowAttachmentService;
 ...
 * <p><b>核心职责：</b>
 * <ul>
 *   <li><b>附件上传（{@link #upload}）</b>：支持多文件上传，写入 {@code remi_flow_attachment} 表，
 ...
 *       仅允许办公文档 / 图片 / PDF</li>
 *   <li><b>审计追溯</b>：所有上传 / 下载动作记录到 {@code remi_flow_audit_log}，
 *       包括「操作人 / IP / 时间 / 文件名」</li>
 ...
 * @see com.remisoft.workflow.domain.entity.FlowAttachment 附件实体
 * @see com.remisoft.workflow.domain.dto.FlowAttachmentDTO 附件 DTO
 * @see com.remisoft.workflow.domain.dto.FlowAttachmentPreviewVO 附件预览 VO
 */
@Slf4j
@Service
...
public class FlowAttachmentServiceImpl implements FlowAttachmentService {
    ...
    /** 审批附件 Mapper，管理 remi_flow_attachment 表 */
