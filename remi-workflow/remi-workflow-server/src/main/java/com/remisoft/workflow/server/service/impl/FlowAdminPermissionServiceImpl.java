...
import com.remisoft.workflow.infra.mapper.FlowAdminRoleMapper;
import com.remisoft.workflow.server.service.FlowAdminPermissionService;
 ...
 * 基于 {@code remi_flow_admin_role} 表实现细粒度的管理员权限控制，区分
 ...
 *   <li><b>审计追溯</b>：所有角色授予 / 撤销操作记录到 {@code remi_flow_audit_log}，
 ...
 * {@code remi-common-auth} 的 RBAC 权限体系管理。
 *
 * @author remi-team
 * @since 1.0.0
 *
 * @see FlowAdminPermissionService 接口定义
 * @see com.remisoft.workflow.domain.entity.FlowAdminRole 管理员角色实体
...
public class FlowAdminPermissionServiceImpl implements FlowAdminPermissionService {
    ...
    /** 管理员角色 Mapper，查询 remi_flow_admin_role 表的角色授权记录 */
