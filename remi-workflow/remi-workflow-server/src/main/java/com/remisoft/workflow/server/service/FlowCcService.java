 ...
 * <p><b>性能优化：</b>
 * <ul>
 *   <li>「抄送我的」使用 {@code remi_flow_cc} 索引（{@code idx_cc_user}）</li>
 *   <li>未读数查询走 Redis 缓存（{@code remi:flow:cc:unread:{userId}}），{@code @CacheEvict} 在 {@code markAsRead} 时失效</li>
 * </ul>
 *
 * @author remi-team
 * @since 1.0.0
 *
 * @see com.remisoft.workflow.server.service.impl.FlowCcServiceImpl 实现类
 * @see com.remisoft.workflow.server.resolver.FlowCcRuleResolver 抄送规则解析器
 */
public interface FlowCcService {

    /**
     * 处理抄送节点 — 展开接收人并写入 remi_flow_cc
     *
     * <p>解析逻辑：
     * <ol>
