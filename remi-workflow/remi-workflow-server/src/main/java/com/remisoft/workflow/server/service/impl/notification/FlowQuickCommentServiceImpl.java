...
import com.remisoft.workflow.infra.mapper.FlowQuickCommentMapper;
 ...
 *   <li>查询走 {@code remi_flow_quick_comment} 复合索引（{@code idx_user} + {@code idx_tenant}）</li>
...
public class FlowQuickCommentServiceImpl implements FlowQuickCommentService {
    ...
    /** 常用语 Mapper，负责 remi_flow_quick_comment 表的增删改查（含用户自定义 + 系统预设） */
