package com.remisoft.workflow.server.queue;
...
public final class FlowQueueChannels {
     ...
     */
    public static final String FLOW_EVENT = "remi:flow:event";
     ...
     */
    public static final String FLOW_TIMEOUT = "remi:flow:timeout";
}
