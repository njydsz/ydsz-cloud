 ...
 * </ul>
 *
 * <p><b>数据来源：</b>{@code remi_flow_his_task} 表（已归档历史任务），
...
public class FlowAssigneeDedupService {
    ...
    /** 历史任务 Mapper，负责 {@code remi_flow_his_task} 表的查询（已审批人来源） */
     ...
     * <p>用于会签 / 普通节点的「单点去重判断」。
     *
     * <p><b>性能优化：</b>走 {@code remi_flow_his_task} 索引 {@code idx_instance_assignee}，
     * {@code O(1)} 时间复杂度。
     *
