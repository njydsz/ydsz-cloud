 ...
 * @see com.remisoft.common.redis.service.RedisService Redis 服务
...
public class FlowInstanceMergeServiceImpl implements FlowInstanceMergeService {
    ...
    private static final String MERGE_GROUP_KEY = "remi:flow:merge:group:";
    /** Redis Key 前缀：合并组元信息 */
    private static final String MERGE_GROUP_DETAIL_KEY = "remi:flow:merge:detail:";
