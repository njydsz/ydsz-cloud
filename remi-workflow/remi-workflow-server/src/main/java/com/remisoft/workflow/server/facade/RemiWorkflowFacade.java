 ...
 * 自建工作流 Facade（唯一实现）
 *
 * <p>所有操作落 remi_flow_* 表，对外暴露的 WorkflowFacade 统一接口实现。
 *
...
public class RemiWorkflowFacade implements WorkflowFacade {
     ...
     * 来源：remi_flow_node.coordinate JSON 字段（BPMN 部署时由 BPMNDI 段自动注入，
     * 或前端设计器保存）。
     *
