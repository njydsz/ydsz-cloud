...
@Data
@Validated
@ConfigurationProperties(prefix = "remi.flow")
public class FlowProperties {
     ...
     * 以及三方回调失败重试策略（由 {@link com.remisoft.workflow.server.job.FlowThirdPartyRetryJobHandler} 消费）。
     */
    @Data
    public static class ThirdParty {
         ...
         * 三方回调失败重试策略配置。
         *
         * <p>由 {@link com.remisoft.workflow.server.job.FlowThirdPartyRetryJobHandler} 定时消费，
     ...
     * P3-3.4: 自动催办配置。
     *
     * <p>由 {@link com.remisoft.workflow.server.scheduler.FlowAutoUrgeScheduler} 消费。
     */
    @Data
     ...
     * P3-3.4: 子流程嵌套配置。
     *
     * <p>由 {@link com.remisoft.workflow.server.service.impl.instance.FlowSubProcessServiceImpl} 消费。
     */
    @Data
     ...
     * P3-3.4: 附件预览配置。
     *
     * <p>由 {@link com.remisoft.workflow.server.service.impl.integration.FlowAttachmentServiceImpl} 消费。
     */
    @Data
