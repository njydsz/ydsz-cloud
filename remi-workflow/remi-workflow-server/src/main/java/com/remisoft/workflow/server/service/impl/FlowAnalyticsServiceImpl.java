 ...
 * <p><b>数据来源：</b>
 * <ul>
 *   <li>{@code remi_flow_instance} — 流程实例表（活跃实例，实时数据）</li>
 *   <li>{@code remi_flow_his_instance} — 历史实例表（已完成实例，趋势数据）</li>
 *   <li>{@code remi_flow_his_task} — 历史任务表（审批操作，效率数据）</li>
 *   <li>{@code remi_flow_run_task} — 运行时任务表（在途任务，活跃数据）</li>
 * </ul>
 *
 * <p><b>事务边界：</b>
 * <ul>
 ...
 *       普通管理员仅能查看自己部门的数据</li>
 *   <li><b>实时性权衡</b>：活跃数据实时查询（{@code remi_flow_instance}），
 *       历史数据离线分析（{@code remi_flow_his_instance}）</li>
