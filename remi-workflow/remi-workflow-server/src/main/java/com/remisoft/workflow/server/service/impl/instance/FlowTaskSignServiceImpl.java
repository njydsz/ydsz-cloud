...
import com.remisoft.workflow.domain.enums.FlowAssigneeType;
import com.remisoft.workflow.domain.enums.FlowPerformType;
import com.remisoft.workflow.domain.enums.FlowSignType;
 ...
 * <p><b>设计要点：</b>
 * <ul>
 *   <li><b>审计追溯</b>：所有加签减签操作写入 {@code remi_flow_audit_log}，标注 {@code COUNTERSIGN_*} 类型</li>
...
public class FlowTaskSignServiceImpl {
     ...
     *   <li>向 {@code remi_flow_user} 插入新审批人（{@code signType=BEFORE}）</li>
    ...
    public void countersignBefore(FlowTaskOperateDTO dto) {
        ...
        // 前加签：在当前节点前插入临时审批人
        // 实现：为当前任务新增一个审批人记录到 remi_flow_user，approveCount+1
     ...
     * <ol>
     *   <li>向 {@code remi_flow_user} 插入新审批人（{@code signType=AFTER}）</li>
    ...
    public void countersignAfter(FlowTaskOperateDTO dto) {
        ...
        // 3. 新增审批人写入 remi_flow_user（processed=0）
     ...
     * <p>对标钉钉/飞书"并加签"。实现方式：
     * <ol>
     *   <li>向 remi_flow_user 插入新审批人（signType=PARALLEL，processed=0）</li>
     ...
     *   <li>从 {@code remi_flow_user} 中按 {@code (instanceId, nodeCode, userId)} 复合键删除</li>
     ...
     * <ol>
     *   <li>校验任务状态（<b>未完成</b>）</li>
     *   <li>向 {@code remi_flow_user} 插入新审批人（{@code signType=ADD}，{@code weight=1}）</li>
