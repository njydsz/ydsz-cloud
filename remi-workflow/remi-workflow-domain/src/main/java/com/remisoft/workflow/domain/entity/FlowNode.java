 ...
 * 流程节点实体
 *
 * <p>对应数据库表 {@code remi_flow_node}，对标 Warm-Flow {@code flow_node}，
 ...
 * @see com.remisoft.workflow.domain.enums.FlowNodeType 节点类型枚举
 * @see com.remisoft.workflow.server.engine.AssignmentResolver 办理人解析器
 */
@Data
@SuperBuilder
@NoArgsConstructor
@EqualsAndHashCode(callSuper = true)
@TableName("remi_flow_node")
public class FlowNode extends MpBaseEntity<String> {

    @Serial
    private static final long serialVersionUID = 1L;

    /** 所属流程定义 ID（关联 {@code remi_flow_definition.id}） */
     ...
     * SLA 超时配置 JSON。
     *
     * <p>格式：{@code {"timeoutMinutes":120,"action":"REMIND|ESCALATE|AUTO_PASS|AUTO_REJECT","reminderCount":3,"adminUserId":"xxx"}}。
