 ...
 * 三方审批回调日志实体
 *
 * <p>对应数据库表 {@code remi_flow_third_party_log}，P0-2: 三方审批 SDK（钉钉/飞书/企微）回调原始数据落库。
 ...
 * @since 1.0.0
 *
 * @see com.remisoft.workflow.server.thirdparty.ThirdPartyCallbackHandler 三方回调处理器
 * @see com.remisoft.workflow.server.scheduler.ThirdPartyCallbackRetryJob 回调重试任务
 */
@Data
@SuperBuilder
@NoArgsConstructor
@EqualsAndHashCode(callSuper = true)
@TableName("remi_flow_third_party_log")
public class FlowThirdPartyLog extends MpBaseEntity<String> {
