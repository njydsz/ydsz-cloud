 ...
 * 节点跳转关联实体
 *
 * <p>对应数据库表 {@code remi_flow_skip}，对标 Warm-Flow {@code flow_skip}，
 ...
 * @see com.remisoft.workflow.domain.enums.FlowSkipType 跳转类型枚举
 */
@Data
@SuperBuilder
@NoArgsConstructor
@EqualsAndHashCode(callSuper = true)
@TableName("remi_flow_skip")
public class FlowSkip extends MpBaseEntity<String> {
    ...
    /** 跳转类型（{@link com.remisoft.workflow.domain.enums.FlowSkipType}.name） */
    ...
    /** 下一节点类型（{@link com.remisoft.workflow.domain.enums.FlowNodeType}.code） */
