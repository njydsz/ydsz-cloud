 ...
 * 流程委派代理（长期授权）实体
 *
 * <p>对应数据库表 {@code remi_flow_delegate_auth}，P1-4: 长期授权委派，
 ...
 * @since 1.0.0
 *
 * @see com.remisoft.workflow.server.scheduler.FlowDelegateScheduler 委派扫描调度器
 */
@Data
@SuperBuilder
@NoArgsConstructor
@EqualsAndHashCode(callSuper = true)
@TableName("remi_flow_delegate_auth")
