package com.remisoft.workflow.domain.converter;
...
import com.remisoft.workflow.domain.entity.FlowAdminRole;
import com.remisoft.workflow.domain.entity.FlowAttachment;
import com.remisoft.workflow.domain.entity.FlowAuditLog;
import com.remisoft.workflow.domain.entity.FlowAutoTrigger;
import com.remisoft.workflow.domain.entity.FlowCategory;
import com.remisoft.workflow.domain.entity.FlowCc;
import com.remisoft.workflow.domain.entity.FlowCcRule;
...
import com.remisoft.workflow.domain.entity.FlowHisInstance;
...
import com.remisoft.workflow.domain.entity.FlowUser;
import com.remisoft.workflow.domain.dto.post.FlowDelegateAuthPostDTO;
import com.remisoft.workflow.domain.dto.put.FlowDelegateAuthPutDTO;
import com.remisoft.workflow.domain.vo.FlowAdminRoleVO;
import com.remisoft.workflow.domain.vo.FlowAttachmentVO;
import com.remisoft.workflow.domain.vo.FlowAuditLogVO;
import com.remisoft.workflow.domain.vo.FlowAutoTriggerVO;
import com.remisoft.workflow.domain.vo.FlowCategoryVO;
import com.remisoft.workflow.domain.vo.FlowCcVO;
import com.remisoft.workflow.domain.vo.FlowCcRuleVO;
import com.remisoft.workflow.domain.vo.FlowCommentVO;
import com.remisoft.workflow.domain.vo.FlowDefinitionVO;
import com.remisoft.workflow.domain.vo.FlowDelegateAuthVO;
import com.remisoft.workflow.domain.vo.FlowDmnDecisionVO;
import com.remisoft.workflow.domain.vo.FlowDmnRuleVO;
import com.remisoft.workflow.domain.vo.FlowEventSubscriptionVO;
import com.remisoft.workflow.domain.vo.FlowHisInstanceVO;
import com.remisoft.workflow.domain.vo.FlowHisTaskVO;
import com.remisoft.workflow.domain.vo.FlowInstanceVO;
import com.remisoft.workflow.domain.vo.FlowNodeVO;
import com.remisoft.workflow.domain.vo.FlowQuickCommentVO;
import com.remisoft.workflow.domain.vo.FlowRunTaskVO;
import com.remisoft.workflow.domain.vo.FlowSkipVO;
import com.remisoft.workflow.domain.vo.FlowTemplateVO;
import com.remisoft.workflow.domain.vo.FlowThirdPartyAccountVO;
import com.remisoft.workflow.domain.vo.FlowThirdPartyLogVO;
import com.remisoft.workflow.domain.vo.FlowTimerVO;
import com.remisoft.workflow.domain.vo.FlowUserVO;
import com.remisoft.workflow.domain.vo.StringVO;
