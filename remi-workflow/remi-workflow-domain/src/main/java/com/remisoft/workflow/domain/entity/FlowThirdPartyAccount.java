 ...
 * 三方审批账号映射实体
 *
 * <p>对应数据库表 {@code remi_flow_third_party_account}，P0-2: 三方审批账号映射（钉钉/飞书/企微）。
 ...
 * @since 1.0.0
 *
 * @see com.remisoft.workflow.server.thirdparty.ThirdPartyApprovalClient 三方审批客户端
 * @see com.remisoft.workflow.server.scheduler.ThirdPartyTokenRefresher token 刷新调度器
 */
@Data
@SuperBuilder
@NoArgsConstructor
@EqualsAndHashCode(callSuper = true)
@TableName("remi_flow_third_party_account")
