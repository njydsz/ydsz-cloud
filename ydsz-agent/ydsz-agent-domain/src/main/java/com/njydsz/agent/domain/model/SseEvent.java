 ...
 * <h3>事件类型</h3>
 * <ul>
 *   <li>{@link #EVENT_MESSAGE} — 增量文本片段</li>
 *   <li>{@link #EVENT_TOOL_CALL_STARTED} — 工具调用开始</li>
 *   <li>{@link #EVENT_TOOL_CALL_COMPLETED} — 工具调用完成</li>
 *   <li>{@link #EVENT_REASONING} — 思考链/ReAct 推理过程</li>
 *   <li>{@link #EVENT_CITATION} — 引用来源（RAG 检索命中）</li>
 *   <li>{@link #EVENT_DONE} — 生成完成</li>
 *   <li>{@link #EVENT_ERROR} — 生成错误</li>
 * </ul>
 *
...
public final class SseEvent {
    ...
    public static SseEvent toolCallStarted(String toolName, Map<String, Object> arguments) {
        return new SseEvent(EVENT_TOOL_CALL_STARTED, Map.of(
                "tool", toolName,
    ...
    public static SseEvent toolCallCompleted(String toolName, String result, long durationMs) {
        return new SseEvent(EVENT_TOOL_CALL_COMPLETED, Map.of(
                "tool", toolName,
     ...
     * @return SSE 事件
     */
    public static SseEvent citation(String documentId, String documentTitle, String snippet, double score) {
        return new SseEvent(EVENT_CITATION, Map.of(
    ...
    public static SseEvent error(String errorCode, String errorMessage) {
        return new SseEvent(EVENT_ERROR, Map.of(
                "code", errorCode,
