package com.njydsz.agent.domain.event;
 ...
 * Agent 域领域事件。
 *
 * <p>封装 Agent 执行生命周期事件，继承 {@link DomainEvent}， 事件类型常量统一取自 {@link
 * DomainEventTypes}（AGENT_EXECUTION_STARTED / AGENT_EXECUTION_COMPLETED / AGENT_EXECUTION_FAILED）。
 *
 * <p><b>发布方式：</b>
 *
 * <pre>{@code
...
public class AgentDomainEvent extends DomainEvent {
  ...
  public AgentDomainEvent(
      String eventType, String executionId, String aggregateType, Map<String, Object> metadata) {
    super(
   ...
   * @return Agent 域事件实例
   */
  public static AgentDomainEvent of(
      String eventType, String executionId, Map<String, Object> metadata) {
