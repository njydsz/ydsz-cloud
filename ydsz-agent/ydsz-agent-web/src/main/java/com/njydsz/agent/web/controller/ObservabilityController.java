 ...
 * <ul>
 *   <li>{@code GET /api/v1/agent/observability/overview} - 面板概览（今日成本、活跃会话等）</li>
 *   <li>{@code GET /api/v1/agent/observability/model-usage} - 模型使用分布</li>
 * </ul>
 *
 * @author ydsz-team
 * @since 1.0.0
