...
用法：
    ...
    python scan_comments.py <模块关键字>       # 只看匹配模块
...
def is_functional_interface_above(src_lines: list, method_line: int = None) -> bool:
    line = method_line
    if not line:
        return False
    idx = line - 2
