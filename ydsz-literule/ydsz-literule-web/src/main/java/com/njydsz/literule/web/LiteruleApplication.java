 ...
 *
 * <ul>
 *   <li>端口：9007（按构建顺序 8/10）
 *   <li>服务名：{@code ydsz-literule}
 *   <li>配置中心：Nacos（共享 {@code ydsz-common.yaml} + 本服务 data-id）
 * </ul>
 *
 * <h3>跨服务联动</h3>
 *
 * <ul>
 *   <li>规则触发 → 通过 {@code CronjobServiceClient} 联动定时任务
 *   <li>规则触发 → 通过 {@code WorkflowServiceClient} 联动工作流审批
 *   <li>规则触发 → 通过 {@code DefaultAlertActionHandler} 联动消息中心告警
 * </ul>
 *
 * @author ydsz-team
 * @since 26.09.01
