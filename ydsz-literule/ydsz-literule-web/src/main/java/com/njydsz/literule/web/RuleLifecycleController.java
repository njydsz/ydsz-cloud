...
import com.njydsz.literule.domain.dto.RuleRejectDTO;
import com.njydsz.literule.domain.dto.RuleStatusChangeDTO;
import com.njydsz.literule.domain.dto.RuleSubmitReviewDTO;
...
public class RuleLifecycleController {
   ...
   * @param ruleCode 规则编码
   * @param operator 操作人
   * @param dto 状态变更请求参数（包含目标状态和变更备注）
   * @return 操作结果
   */
