 ...
 *   <li><b>版本</b>：规则集本身有独立版本号，支持升级与回滚
 *   <li><b>市场属性</b>：作者、下载量、评分等市场检索维度
 *   <li><b>行业适用性</b>：标注适用行业，便于按行业筛选
 * </ul>
 *
 * <p>典型场景：
 *
 * <ul>
 *   <li>新项目快速初始化（导入"金融行业风险预警规则集"）
 *   <li>跨租户共享最佳实践（运营团队发布官方规则集）
 *   <li>版本化升级（从 1.0.0 升级到 1.0.0，回滚到 1.0.0）
 * </ul>
 *
 * @author ydsz-team
 * @since 1.0.0
