 ...
 * 表达式校验结果
 *
 * <p>由 {@link com.njydsz.literule.domain.service.ExpressionValidationService} 在表达式保存前/编辑时校验返回， 提供给前端表达式编辑器渲染错误位置、错误类型、修复建议等。
 *
 * <p>当 {@link #valid} 为 false 时，{@link #errorType} 与 {@link #errorMessage} 必填。 当 {@link #valid} 为
 * true 时，{@link #errorType} 为 {@link ErrorType#OK}。
 *
 * @since 26.09.01
 * @author ydsz-team
 */
