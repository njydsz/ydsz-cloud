...
public class RuleResult implements Serializable {
  ...
  /** 结果 ID */
  @Builder.Default private String resultId = IdGenerator.nextIdStr();
   ...
   * 是否为灰度候选版本评估结果
   *
   * <p>当规则定义了 canaryRatio 且当前流量命中灰度桶时， 引擎会同时评估主版本与候选版本，候选版本结果此字段为 true。
   *
   * @since 1.0.0
   */
  @Builder.Default private boolean canary = false;
