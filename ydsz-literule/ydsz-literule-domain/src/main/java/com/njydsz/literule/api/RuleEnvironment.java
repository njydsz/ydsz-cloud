 ...
 * 规则环境维度常量（P1-5 多环境隔离）
 *
 * <p>与 {@link com.njydsz.literule.api.RuleDefinition#getTenantId()} 维度正交，实现 dev/staging/prod 环境的规则隔离。
 *
 * <ul>
 ...
 *   <li>规则的 environment 非 {@code "default"} 时，必须与 {@link RuleContext#getEnvironment()} 完全匹配
 * </ul>
 *
 * @author ydsz-team
 * @since 1.0.0
