 ...
 * 规则执行轨迹记录
 *
 * <p>对应持久化表 {@code ydsz_rule_execution_trace}（见 V043）。 由 {@code TraceRecorder} 在每条规则评估后异步写入。
 *
 * @author ydsz-team
 * @since 1.0.0
 */
public class RuleExecutionTrace implements Serializable {
  ...
  public Map<String, Object> getFactsSnapshot() {
    return factsSnapshot;
  }

  public void setFactsSnapshot(Map<String, Object> factsSnapshot) {
    this.factsSnapshot = factsSnapshot;
  }
