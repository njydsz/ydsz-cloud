 ...
 * @author ydsz-team
 * @since 26.09.01
 * @see RulePackVO 规则包实体
 * @see com.njydsz.literule.server.service.RulePackService 规则包 Service
 * @see com.baomidou.mybatisplus.core.mapper.BaseMapper MyBatis-Plus 通用 Mapper
 */
@Mapper
public interface RulePackMapper extends BaseMapper<RulePackVO> {
   ...
   * @return 版本列表（最新版本在前）
   */
  List<RulePackVO> selectByPackCode(@Param("packCode") String packCode);
   ...
   */
  RulePackVO selectByPackCodeVersion(
   ...
   * @return 匹配行业的规则集列表
   */
  List<RulePackVO> selectByIndustry(@Param("industry") String industry);
