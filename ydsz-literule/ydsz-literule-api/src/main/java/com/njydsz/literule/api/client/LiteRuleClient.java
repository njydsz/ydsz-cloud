 ...
 *     YdszResponse<List<RuleResultVO>> resp = liteRuleClient.dryRun(null, facts);
...
public interface LiteRuleClient {
   ...
   *
   * <p>对应 literule 模块: POST /api/literule/rules/dry-run
   *
  ...
  YdszResponse<List<RuleResultVO>> dryRun(
   ...
   *
   * <p>对应 literule 模块: POST /api/literule/rules/evaluate
   *
   * <p>与 {@link #dryRun} 的区别：
   *
   * <ul>
