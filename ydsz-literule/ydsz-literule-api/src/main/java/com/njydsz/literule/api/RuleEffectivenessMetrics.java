 ...
 * <ul>
 *   <li><b>Precision（精确率）</b>：TP / (TP + FP)，规则触发时有多少是真正应该触发的</li>
 *   <li><b>Recall（召回率）</b>：TP / (TP + FN)，应该触发的场景中规则实际触发了多少</li>
 *   <li><b>F1-Score</b>：2 * P * R / (P + R)，精确率和召回率的调和平均</li>
 *   <li><b>Specificity（特异度）</b>：TN / (TN + FP)，不应触发的场景中规则正确未触发多少</li>
 *   <li><b>Accuracy（准确率）</b>：(TP + TN) / (TP + FP + FN + TN)，总体判断正确率</li>
 ...
 * <h3>使用场景</h3>
 * <ul>
 *   <li>风控规则上线后，人工抽检规则触发结果，标注 TP/FP，评估精确率</li>
 *   <li>对历史已知风险事件回放，评估规则召回率</li>
 *   <li>灰度发布期间，对比新旧版本的 F1-Score 判断是否应全量切换</li>
...
public class RuleEffectivenessMetrics implements Serializable {
     ...
     *
     * <p>应该触发的场景中规则实际触发的比例。1.0 表示没有漏报。
     * 分母为 0 时返回 0.0。
     *
     * @return 0.0 ~ 1.0
     */
     ...
     * <p>基于 F1-Score 评级：
     * <ul>
     *   <li>EXCELLENT：F1 ≥ 0.90</li>
     *   <li>GOOD：F1 ≥ 0.75</li>
     *   <li>FAIR：F1 ≥ 0.60</li>
     *   <li>POOR：F1 < 0.60</li>
     *   <li>INSUFFICIENT_DATA：总样本数不足（< 30）</li>
     * </ul>
     *
     * @return 效果等级
     */
