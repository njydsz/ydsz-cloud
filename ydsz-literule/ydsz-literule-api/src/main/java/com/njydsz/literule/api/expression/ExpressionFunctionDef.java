...
public class ExpressionFunctionDef implements Serializable {
    ...
    public static List<ExpressionFunctionDef> defaults() {
        return List.of(
            ...
            of("contains", "contains(str, sub)", "是否包含子串", "contains(\"hello\", \"ell\")", "string", "all"),
            of("startsWith", "startsWith(str, prefix)", "是否以 prefix 开头", "startsWith(url, \"https\")", "string", "all"),
            of("endsWith", "endsWith(str, suffix)", "是否以 suffix 结尾", "endsWith(file, \".pdf\")", "string", "all"),
            ...
            of("dateFormat", "dateFormat(d, fmt)", "日期格式化", "dateFormat(now(), \"yyyy-MM-dd\")", "datetime", "all"),
    ...
    private static ExpressionFunctionDef of(String name, String signature, String description, String sample, String category, String engines) {
