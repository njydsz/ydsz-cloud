...
public interface RulePackProvider {
   ...
   * @return 规则集列表
   */
  List<RulePackVO> search(String keyword);
   ...
   */
  RulePackVO getLatest(String packCode);
   ...
   */
  List<RulePackVO> listVersions(String packCode);
   ...
   * @return 规则集；不存在返回 null
   */
  RulePackVO getVersion(String packCode, String version);
   ...
   * @return 保存后的规则集
   */
  RulePackVO publish(RulePackVO pack, String operator);
