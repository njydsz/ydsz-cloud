...
public class LiteRuleProperties {
     ...
     * {@link com.njydsz.literule.server.spi.FileRuleSource} Bean。
     ...
     * 多级缓存配置（P1-1）
     *
     * <p>启用后自动装饰 {@link com.njydsz.literule.server.spi.RuleConfigProvider} 为
     * {@link com.njydsz.literule.server.cache.CachingRuleConfigProvider}，
     ...
     * {@link com.njydsz.literule.server.spi.FactProvider}
     * 从外部数据源（DB、Redis、HTTP API 等）动态采集事实数据，
     * 合并到 {@link com.njydsz.literule.api.RuleContext} 的 facts 中。
     *
     ...
     * 规则+模型融合配置（P3-1）
     *
     * <p>控制 {@link com.njydsz.literule.domain.model.ModelInputRegistry} 与
    ...
    public static class ModelConfig {
         ...
         * 单个模型调用超时（毫秒）
         *
         * <p>每个 {@link com.njydsz.literule.domain.model.ModelInputProvider} 调用最多等待该时长，
         ...
         * 返回配置的模拟模型输出，便于开发/测试；
         * false（默认）：不注册 Mock，需业务方提供真实 {@link com.njydsz.literule.domain.model.ModelInputProvider} 实现。
         */
    ...
    public static class FactConfig {
         ...
         * 单个 provider 调用超时（毫秒）
         *
         * <p>每个 {@link com.njydsz.literule.server.spi.FactProvider} 调用最多等待该时长，
         * 超时则取消并返回空 Map（或抛异常，取决于 {@link #fallbackOnError}）。
         ...
         * {@link com.njydsz.literule.server.spi.FactCollectionException}，
     ...
     * {@link com.njydsz.literule.server.core.RuleLifecycleService} 将生成退役建议：
     * <ul>
