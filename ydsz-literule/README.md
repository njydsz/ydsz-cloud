...
| **当前版本** | `26.09.01`（项目版本号统一为 26.09.01） |
...
# 启动服务
java -jar ydsz-literule-web/target/ydsz-literule-web-26.09.01.jar
```
...
- **当前版本**：`26.09.01`（项目版本号统一为 26.09.01，详见 `.trae/rules/version-policy.md`）
- **变更需走 PR + Code Review**
