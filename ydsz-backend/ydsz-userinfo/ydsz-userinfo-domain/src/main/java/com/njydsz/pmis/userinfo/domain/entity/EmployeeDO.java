 ...
 * 员工实体
 *
 * <p>员工的完整档案信息（区别于 ydsz_user_account 登录账号）。
 * 一对一关联 ydsz_user_account(user_id)；多对一关联 ydsz_department / ydsz_position / ydsz_rank。
...
public class EmployeeDO extends BaseDO {
    ...
    /** 关联登录账号 ID（ydsz_user_account.id） */
    ...
    /** 部门 ID（ydsz_department.id） */
    private String departmentId;

    /** 岗位 ID（ydsz_position.id，可空） */
    ...
    /** 兼职费率 ID（仅 PART_TIME 类型填写，关联 ydsz_part_time_rate.id） */
    private String partTimeRateId;

    /** 外包费率 ID（仅 OUTSOURCE 类型填写，关联 ydsz_outsource_rate.id） */
