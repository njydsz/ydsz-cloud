package com.njydsz.userinfo.server.service.impl.auth;
...
import com.njydsz.userinfo.domain.dto.auth.CaptchaVO;
import com.njydsz.userinfo.domain.dto.auth.LoginContextDTO;
import com.njydsz.userinfo.domain.dto.auth.LoginDTO;
import com.njydsz.userinfo.domain.dto.auth.LoginResultVO;
...
import com.njydsz.userinfo.server.auth.JwtTokenProvider;
import com.njydsz.userinfo.server.security.AccountLockedEvent;
import com.njydsz.userinfo.server.service.auth.AuthService;
...
public class AuthServiceImpl implements AuthService {
    ...
    /** 验证码 Redis Key 前缀 */
    private static final String CAPTCHA_KEY_PREFIX = "ydsz:captcha:";
    /** 登录失败计数 Redis Key 前缀 */
    private static final String LOGIN_FAIL_PREFIX = "ydsz:login:fail:";
     ...
     * 是否强制启用图形验证码 (测试场景可关闭)
     */
    @Value("${ydsz.auth.captcha-required:true}")
