...
import com.njydsz.userinfo.api.fallback.UserServiceClientFallback;
...
public interface UserServiceClient {
    ...
    BaseResponse<Map<String, Object>> getEmployee(@PathVariable("id") String id);
    ...
    BaseResponse<String> getCustomerName(@RequestParam("customerId") String customerId);
    ...
    BaseResponse<Map<String, String>> batchEmployeeName(@RequestParam("ids") List<String> ids);
    ...
    BaseResponse<Map<String, String>> batchCustomerName(@RequestParam("ids") List<String> customerIds);
    ...
    BaseResponse<BigDecimal> getLevelRate(@RequestParam("levelCode") String levelCode);
}