 ...
 * <ul>
 *   <li>每分钟维度：{@code ydsz:stats:realtime:{yyyyMMddHHmm}} → Hash(channel, count)</li>
 *   <li>延迟分位数：{@code ydsz:stats:latency:{channel}} → Sorted Set(score=costMs, member=msgId)</li>
 *   <li>渠道错误计数：{@code ydsz:stats:errors:{channel}:{yyyyMMdd}} → INCR</li>
 * </ul>
 *
