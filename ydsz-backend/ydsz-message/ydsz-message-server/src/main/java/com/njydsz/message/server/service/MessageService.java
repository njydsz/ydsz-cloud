 ...
 * 是消息中心（ydsz-message）的<b>统一入口</b>，所有消息发送都通过本 Service 进入。
 *
 * <p><b>核心职责：</b>
 * <ul>
 ...
 *   <li>超过 {@code ydsz.message.receipt-timeout-minutes} 未回执标记为 TIMEOUT</li>
 * </ul>
 *
 * @author ydsz-team
 * @since 1.0.0
...
public interface MessageService {
     ...
     * 直接发送消息（走本模块 DTO）
     *
     * <p>供 ydsz-message 内部 Controller 使用，比 {@link #send} 多了本模块扩展字段
