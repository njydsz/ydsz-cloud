package com.njydsz.common.ratelimit.aop;
...
import com.njydsz.common.ratelimit.enums.RateLimitDimension;
...
public class RateLimitAspect {
    ...
    @Around("@annotation(com.njydsz.common.ratelimit.annotation.RateLimit)")
    public Object around(ProceedingJoinPoint pjp) throws Throwable {
        ...
        if (decision.isBlocked()) {
            ...
            String code = annotation.errorCode().isEmpty()
