package com.njydsz.common.ratelimit.metrics;
 ...
 * <ul>
 *   <li>{@code ydsz_ratelimit_decisions_total{resource, result}} - 限流决策总数</li>
 *   <li>{@code ydsz_ratelimit_block_total{resource, algorithm}} - 限流阻塞数</li>
 *   <li>{@code ydsz_ratelimit_pass_total{resource, algorithm}} - 限流通过数</li>
 * </ul>
 *
 * @author ydsz-team
 * @since 1.0.0
