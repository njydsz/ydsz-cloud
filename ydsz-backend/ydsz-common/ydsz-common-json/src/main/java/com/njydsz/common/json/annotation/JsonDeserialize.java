 ...
 * 替代默认的反射字段赋值逻辑。</p>
 *
 * <p>反序列化器需实现 {@link com.njydsz.common.json.deserializer.JsonDeserializer}，
 * 使用 {@link com.njydsz.common.json.reader.JSONReader} 进行流式解析，避免完整 JSON 字符串复制。</p>
 *
 * <p>使用示例：</p>
 * <pre><code>
...
public @interface JsonDeserialize {
     ...
     * 自定义反序列化器实现类。
     *
     * <p>必须实现 {@link com.njydsz.common.json.deserializer.JsonDeserializer}，
