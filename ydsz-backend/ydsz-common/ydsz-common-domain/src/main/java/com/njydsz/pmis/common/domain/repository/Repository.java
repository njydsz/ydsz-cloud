package com.njydsz.common.domain.repository;
 ...
 * <p><b>核心语义：</b>
 * <ul>
 *   <li>仓储是聚合根的持久化抽象，每个聚合根对应一个仓储</li>
 *   <li>仓储接口定义在领域层，实现在基础设施层</li>
 *   <li>通过 Specification 模式实现灵活的条件查询</li>
 * </ul>
 *
 * <p><b>使用示例：</b>
 * <pre>{@code
 * public interface OrderRepository extends Repository<Order, Long> {
 *     // 可继承本接口提供的基础方法，也可定义业务特定方法
 * }
 *
 * // 使用
