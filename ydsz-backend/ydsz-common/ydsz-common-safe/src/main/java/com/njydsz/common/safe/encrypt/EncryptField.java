 ...
 * 字段级加密注解
 *
 * <p>标注在实体类字段上，MyBatis 持久化时自动加密，查询时自动解密。
 * 支持 AES-256-GCM 加密算法，密钥由配置统一管理。
 *
 * <p><b>使用示例：</b>
 * <pre>{@code
 * public class User {
 ...
 * <p><b>安全特性：</b>
 * <ul>
 *   <li>AES-256-GCM 认证加密，防篡改</li>
 *   <li>每次加密使用随机 IV，相同明文产生不同密文</li>
 *   <li>密钥通过配置中心管理，支持密钥轮换</li>
 * </ul>
 *
 * @author ydsz-team
 * @since 1.0.0
