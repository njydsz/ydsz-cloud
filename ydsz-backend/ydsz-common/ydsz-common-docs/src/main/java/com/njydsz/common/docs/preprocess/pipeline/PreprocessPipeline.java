 ...
 * <p><b>默认处理链：</b>
 * <ol>
 *   <li>{@link com.njydsz.common.docs.preprocess.impl.TextNormalizer} (order=10) - 文本归一化</li>
 *   <li>{@link com.njydsz.common.docs.preprocess.impl.TextCleaner} (order=20) - 噪声清洗</li>
 *   <li>{@link com.njydsz.common.docs.preprocess.impl.TextChunker} (order=30) - 文本分块</li>
 * </ol>
 *
 * @author ydsz-team
 * @since 1.0.0
