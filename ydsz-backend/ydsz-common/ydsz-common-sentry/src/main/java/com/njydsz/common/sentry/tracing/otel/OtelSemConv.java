 ...
 *
 * <p>定义 YDSZ 框架约定的标准 Span Attribute / Resource Attribute 名称，
...
public final class OtelSemConv {
    ...
    /** 租户 ID */
    public static final AttributeKey<String> YDSZ_TENANT_ID = AttributeKey.stringKey("ydsz.tenant.id");
    /** 业务单号 */
    public static final AttributeKey<String> YDSZ_BUSINESS_NO = AttributeKey.stringKey("ydsz.business_no");
    /** 用户 ID */
    public static final AttributeKey<String> YDSZ_USER_ID = AttributeKey.stringKey("ydsz.user.id");
    /** 客户端类型（web/app/inner） */
    public static final AttributeKey<String> YDSZ_CLIENT_TYPE = AttributeKey.stringKey("ydsz.client.type");
    /** 错误码 */
    public static final AttributeKey<String> YDSZ_ERROR_CODE = AttributeKey.stringKey("ydsz.error.code");
    /** 业务模块 */
    public static final AttributeKey<String> YDSZ_MODULE = AttributeKey.stringKey("ydsz.module");
    /** 业务动作 */
    public static final AttributeKey<String> YDSZ_ACTION = AttributeKey.stringKey("ydsz.action");
    /** 灰度标签（用于按流量染色查询） */
    public static final AttributeKey<String> YDSZ_GRAY_TAG = AttributeKey.stringKey("ydsz.gray.tag");
    /** 压测标记 */
    public static final AttributeKey<String> YDSZ_PRESSURE_TAG = AttributeKey.stringKey("ydsz.pressure.tag");
