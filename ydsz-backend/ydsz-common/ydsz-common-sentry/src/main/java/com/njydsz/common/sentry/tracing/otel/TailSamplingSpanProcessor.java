    ...
    public static class Rules {
        ...
        public static SamplingRule errorCode(String... prefixes) {
            return SamplingRule.builder()
                    .name("error-code")
                    .predicate(span -> {
                        String code = span.getAttribute(OtelSemConv.YDSZ_ERROR_CODE);
                        if (code == null) {
                            return false;
                        }
        ...
        public static SamplingRule grayTag(String tagValue) {
            return SamplingRule.builder()
                    ...
                    .predicate(span -> tagValue.equals(span.getAttribute(OtelSemConv.YDSZ_GRAY_TAG)))
                    .build();
        }
        ...
        public static SamplingRule pressureTraffic() {
            return SamplingRule.builder()
                    ...
                    .predicate(span -> {
                        String tag = span.getAttribute(OtelSemConv.YDSZ_PRESSURE_TAG);
