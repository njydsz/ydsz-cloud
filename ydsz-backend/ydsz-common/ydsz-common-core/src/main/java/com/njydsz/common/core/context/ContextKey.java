 ...
 * 上下文键，提供类型安全的上下文存取。
 *
 * <p>替代 {@code Map<String, Object> + String key} 的字符串键模式，
 * 在编译期提供类型保证，避免运行时的 {@code ClassCastException}。</p>
 *
 * <h3>设计参考</h3>
 * <ul>
 *   <li><b>Netty</b>：{@code AttributeKey<T>}</li>
 *   <li><b>Spring Cloud Sleuth</b>：{@code BaggageField}</li>
 * </ul>
 *
 * <h3>使用对比</h3>
 * <pre>{@code
...
public final class ContextKey<T> {
    ...
    T cast(Object value) {
        ...
        throw new ClassCastException(
                "ContextKey '" + key + "' expects " + type.getName()
