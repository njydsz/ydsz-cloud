...
public enum BaseResultCode implements ResultCode {
     ...
     * @since 1.5.0
     */
    public static BaseResultCode[] successCodes() {
        return new BaseResultCode[]{SUCCESS};
    }
     ...
     * @since 1.5.0
     */
    public static java.util.Set<BaseResultCode> authCodes() {
        return java.util.Set.of(
                UNAUTHORIZED, TOKEN_EXPIRED, TOKEN_INVALID,
                FORBIDDEN, DATA_SCOPE_FORBIDDEN,
                PASSWORD_WEAK, PASSWORD_EXPIRED, PASSWORD_REUSED,
                MFA_REQUIRED, MFA_INVALID,
                ACCOUNT_LOCKED, SESSION_KICKED);
    }
     ...
     * @since 1.5.0
     */
    public static java.util.Set<BaseResultCode> dbCodes() {
        return java.util.Set.of(
                DB_DUPLICATE_KEY, DB_CONSTRAINT_VIOLATION, DB_DATA_INTEGRITY,
                DB_QUERY_TIMEOUT, DB_CONNECTION_FAILED, DB_LOCK_CONTENTION);
    }
     ...
     * @since 1.5.0
     */
    public static java.util.Set<BaseResultCode> integrationCodes() {
        return java.util.Set.of(
                THIRD_PARTY_SERVICE_ERROR, THIRD_PARTY_TIMEOUT, THIRD_PARTY_RATE_LIMITED,
                CACHE_OPERATION_FAILED, MQ_PUBLISH_FAILED, MQ_CONSUME_FAILED);
    }

    /**
     * 判断是否为客户端错误（4xx）。
     *
     * @return true 如果是 4xx 错误
     * @since 1.5.0
     */
