 ...
 * <ul>
 *   <li>{@code ydsz.netty.channels.active}（Gauge）— 活跃 Channel 数</li>
 *   <li>{@code ydsz.netty.bytes.read.total}（Counter）— 累计读取字节数</li>
 *   <li>{@code ydsz.netty.bytes.written.total}（Counter）— 累计写入字节数</li>
 *   <li>{@code ydsz.netty.connections.total}（Counter）— 累计连接数</li>
 *   <li>{@code ydsz.netty.disconnections.total}（Counter）— 累计断开数</li>
 *   <li>{@code ydsz.netty.messages.received}（Counter）— 消息接收数</li>
 *   <li>{@code ydsz.netty.messages.sent}（Counter）— 消息发送数</li>
 *   <li>{@code ydsz.netty.reconnect.attempts}（Counter）— 重连尝试次数</li>
 *   <li>{@code ydsz.netty.reconnect.successes}（Counter）— 重连成功次数</li>
 * </ul>
 *
