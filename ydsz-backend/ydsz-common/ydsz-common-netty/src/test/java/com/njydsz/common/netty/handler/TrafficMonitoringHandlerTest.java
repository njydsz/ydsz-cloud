...
class TrafficMonitoringHandlerTest {
    ...
    void testChannelReadAccumulatesBytesRead() {
        ...
        assertEquals(2.0, registry.counter("ydsz.netty.messages.received").count());
    ...
    void testWriteAccumulatesBytesWritten() {
        ...
        assertEquals(2.0, registry.counter("ydsz.netty.messages.sent").count());
    ...
    void testNonByteBufMessageIgnored() {
        ...
        assertEquals(0.0, registry.counter("ydsz.netty.messages.received").count());
