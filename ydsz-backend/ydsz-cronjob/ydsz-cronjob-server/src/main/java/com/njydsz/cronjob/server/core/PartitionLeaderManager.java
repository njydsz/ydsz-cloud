 ...
 *   <li>每个分区有独立的 Leader 选举（Redis 锁 key: {@code ydsz:job:leader:{role}-{partition}}）</li>
...
@ConditionalOnProperty(prefix = "ydsz.cronjob.leader.partition", name = "enabled", havingValue = "true")
