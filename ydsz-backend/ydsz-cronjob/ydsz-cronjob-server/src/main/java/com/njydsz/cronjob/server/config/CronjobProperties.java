...
public class CronjobProperties {
     ...
     * <h3>工作流程</h3>
     * <ol>
     *   <li>Leader 计算分片分配方案（{@link com.njydsz.cronjob.server.core.sharding.ShardingStrategy}）</li>
     ...
     * 告警扫描配置（P3-2 周期性告警扫描）。
     *
     * <p>控制 {@link com.njydsz.cronjob.server.core.alert.AlertScanner} 的扫描间隔。
     * 仅 Leader 节点启用周期性扫描，统计 FAIL_RATE / DURATION_P95 等需要聚合计算的告警类型。
     *
     * <p>对应配置前缀 {@code ydsz.cronjob.alert.scan-interval-ms}（与 {@link AlertProperties} 共享前缀，
     ...
     *   <li>{@code db}：基于 ydsz_job_node 心跳表（向后兼容，需配合 JobNodeHeartbeat + JobNodeReaper）</li>
     * </ul>
     */
    @Data
     ...
     * </ul>
     *
     * <p>清理范围：ydsz_job_log / ydsz_job_log_content /
     * ydsz_job_alert_log / ydsz_job_task，每天凌晨 3 点由 Leader 节点执行。
     */
    @Data
