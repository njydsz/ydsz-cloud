...
public class GlueJobHandler implements JobHandler {
    ...
    private CompilerConfiguration createSecureCompilerConfiguration() {
        ...
        List<String> importsWhitelist = List.of(
                ...
                "com.njydsz.common.core.job.JobHandler",
                "com.njydsz.common.core.job.JobContextHolder",
                "com.njydsz.common.core.job.JobLoggerHolder",
                "com.njydsz.common.core.job.ProcessResult"
        );
