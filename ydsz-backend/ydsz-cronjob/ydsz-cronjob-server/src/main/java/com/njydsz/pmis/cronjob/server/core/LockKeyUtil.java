 ...
 * <h3>锁 key 格式</h3>
 * <ul>
 *   <li>非分片任务：{@code ydsz:job:lock:{jobKey}}</li>
 *   <li>分片任务：{@code ydsz:job:lock:{jobKey}:shard:{shardIndex}}</li>
 * </ul>
 *
...
public final class LockKeyUtil {
     ...
     * @return 分片任务返回 {@code ydsz:job:lock:{jobKey}:shard:{shardIndex}}，
     *         非分片任务返回 {@code ydsz:job:lock:{jobKey}}
     */
