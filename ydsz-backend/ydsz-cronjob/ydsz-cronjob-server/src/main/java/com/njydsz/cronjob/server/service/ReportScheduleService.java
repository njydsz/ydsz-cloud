 ...
 * {@code ydsz_export_record} 表,接收人通过邮件/IM 收到下载链接。
 *
 * <p><b>核心职责：</b>
 * <ul>
 ...
 * 订阅关系存储在 {@code ydsz_report_subscription} 表。
 *
 * @author ydsz-team
 * @since 1.0.0
 *
 * @see com.njydsz.cronjob.domain.entity.job.ReportSubscription 报表订阅实体
 * @see com.njydsz.system.domain.entity.config.ExportRecord 导出记录实体(落库)
 */
public interface ReportScheduleService {
    ...
    /**
     * 分发报表：落库 ydsz_export_record（source='SUBSCRIPTION'）并发送邮件通知。
     *
     * @param subId      订阅 ID
     * @param reportType 报表类型
