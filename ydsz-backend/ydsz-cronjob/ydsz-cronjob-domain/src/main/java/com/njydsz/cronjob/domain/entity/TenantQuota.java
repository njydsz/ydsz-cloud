 ...
 * 租户级配额实体（P7-2）。
 *
 * <p>对应 {@code ydsz_tenant_quota} 表，存储每个租户的任务数 / 并发数 / 日执行量上限。
 * 表物理位置在 ydsz-cronjob 模块（{@code TenantQuotaMapper} 在 ydsz-cronjob-infra），
 * 因此本实体归属 ydsz-cronjob-domain，不归 ydsz-system。
 *
 * @author ydsz-team
 * @since 1.0.0
 */
