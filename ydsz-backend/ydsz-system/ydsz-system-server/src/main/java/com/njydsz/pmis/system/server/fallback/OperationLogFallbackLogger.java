package com.njydsz.system.server.fallback;
 ...
 * 操作日志补偿记录器
 *
 * <p>当 {@link com.njydsz.system.server.listener.OperationLogListener} 落库失败且重试仍失败时，
...
public class OperationLogFallbackLogger {
    ...
    public void log(OperationLogEvent event, Throwable error) {
        try {
            ...
            FALLBACK_LOGGER.info(Json.toJson(record));
