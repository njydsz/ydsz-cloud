...
public class BillableUtilizationSnapshotController {
     ...
     */
    @GetMapping("/page")
    public PageResponse<List<BillableUtilizationSnapshotVO>> page(@RequestParam(defaultValue="1") int p, @RequestParam(defaultValue="10") int s) {
     ...
     * @return 是否创建成功
     */
    @Idempotent(key = "ydsz:project:BillableUtilizationSnapshotController:save:lock", ttlSeconds = 5)
    @PostMapping
     ...
     * @return 是否更新成功
     */
    @Idempotent(key = "ydsz:project:BillableUtilizationSnapshotController:update:lock", ttlSeconds = 5)
    @PutMapping
     ...
     * @return 是否删除成功
     */
    @Idempotent(key = "ydsz:project:BillableUtilizationSnapshotController:remove:lock", ttlSeconds = 5)
    @DeleteMapping("/{id}")
