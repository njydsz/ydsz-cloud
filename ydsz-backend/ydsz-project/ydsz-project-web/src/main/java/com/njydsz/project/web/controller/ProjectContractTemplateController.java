...
public class ProjectContractTemplateController {
    ...
    @GetMapping("/{id}")
    public BaseResponse<ProjectContractTemplate> getById(@PathVariable String id) { return BaseResponse.success(service.getById(id)); }

    @GetMapping("/page")
    public PageResponse<ProjectContractTemplate> page(@RequestParam(defaultValue="1") int p, @RequestParam(defaultValue="10") int s) {
