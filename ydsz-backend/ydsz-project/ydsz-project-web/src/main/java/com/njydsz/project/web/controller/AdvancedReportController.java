package com.njydsz.project.web.controller.report;
...
import com.njydsz.project.server.service.AdvancedReportService;
...
public class AdvancedReportController {
    ...
    public BaseResponse<List<Map<String, Object>>> evm(@RequestParam String initiationId) {
        return BaseResponse.success(service.evmReport(initiationId));
    }
    ...
    public BaseResponse<List<Map<String, Object>>> utilizationRank(
        ...
        return BaseResponse.success(service.utilizationRank(top));
    }
    ...
    public BaseResponse<List<Map<String, Object>>> utilizationRankRange(
        ...
        return BaseResponse.success(service.utilizationRank(top, from, to, department));
    }
    ...
    public BaseResponse<Map<String, Object>> utilizationOf(
            ...
            @RequestParam(required = false) @DateTimeFormat(iso = DateTimeFormat.ISO.DATE) LocalDate from,
            @RequestParam(required = false) @DateTimeFormat(iso = DateTimeFormat.ISO.DATE) LocalDate to) {
        return BaseResponse.success(service.utilizationOf(employeeId, from, to));
    }
    ...
    public BaseResponse<List<Map<String, Object>>> utilizationByDepartment(
            @RequestParam(required = false) @DateTimeFormat(iso = DateTimeFormat.ISO.DATE) LocalDate from,
            @RequestParam(required = false) @DateTimeFormat(iso = DateTimeFormat.ISO.DATE) LocalDate to) {
        return BaseResponse.success(service.utilizationByDepartment(from, to));
    }
    ...
    public BaseResponse<List<Map<String, Object>>> benchCost() {
        return BaseResponse.success(service.benchCostReport());
    }
    ...
    public BaseResponse<List<Map<String, Object>>> benchCostRange(
            @RequestParam(required = false) @DateTimeFormat(iso = DateTimeFormat.ISO.DATE) LocalDate from,
            @RequestParam(required = false) @DateTimeFormat(iso = DateTimeFormat.ISO.DATE) LocalDate to) {
        return BaseResponse.success(service.benchCostReport(from, to));
    }
    ...
    public BaseResponse<List<Map<String, Object>>> dualRate(@RequestParam(required = false) String period) {
        return BaseResponse.success(service.dualRateProfitCompare(period));
    }
    ...
    public BaseResponse<List<Map<String, Object>>> gantt(@RequestParam String initiationId) {
        return BaseResponse.success(service.resourceGantt(initiationId));
    }
    ...
    public BaseResponse<List<Map<String, Object>>> riskDashboard() {
        return BaseResponse.success(service.riskDashboard());
    }
    ...
    public BaseResponse<Map<String, Object>> riskMatrix(
        ...
        return BaseResponse.success(service.riskMatrix(initiationId, riskType, status));
    }
    ...
    public BaseResponse<Map<String, Object>> utilizationTrend(
            ...
            @RequestParam(required = false) @DateTimeFormat(iso = DateTimeFormat.ISO.DATE) LocalDate to,
            @RequestParam(required = false) String department) {
        return BaseResponse.success(service.resourceUtilizationTrend(from, to, department));
    }
    ...
    public BaseResponse<Map<String, Object>> projectHealthDashboard(
        ...
        return BaseResponse.success(service.projectHealthDashboard(initiationIds, health));
    }
}
