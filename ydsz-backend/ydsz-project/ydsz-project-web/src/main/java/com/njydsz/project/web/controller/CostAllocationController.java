...
public class CostAllocationController {
    ...
    @GetMapping("/{id}")
    public BaseResponse<CostAllocation> getById(@PathVariable String id) { return BaseResponse.success(service.getById(id)); }

    @GetMapping("/page")
    public PageResponse<CostAllocation> page(@RequestParam(defaultValue="1") int p, @RequestParam(defaultValue="10") int s) {
