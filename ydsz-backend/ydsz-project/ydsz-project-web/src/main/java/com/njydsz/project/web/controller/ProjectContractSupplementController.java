...
public class ProjectContractSupplementController {
    ...
    @GetMapping("/{id}")
    public BaseResponse<ProjectContractSupplement> getById(@PathVariable String id) { return BaseResponse.success(service.getById(id)); }

    @GetMapping("/page")
    public PageResponse<ProjectContractSupplement> page(@RequestParam(defaultValue="1") int p, @RequestParam(defaultValue="10") int s) {
