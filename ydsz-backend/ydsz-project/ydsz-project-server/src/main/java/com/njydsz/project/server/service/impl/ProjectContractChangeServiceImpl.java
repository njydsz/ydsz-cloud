...
public class ProjectContractChangeServiceImpl implements ProjectContractChangeService {
    ...
    public ProjectContractChangeDO getById(String id) { return repository.getById(id); }
    public IPage<ProjectContractChangeDO> page(int p, int s) { return repository.page(new Page<>(p, s)); }
    @Transactional(rollbackFor = Exception.class)
    public boolean save(ProjectContractChangeDO e) { return repository.save(e); }
    @Transactional(rollbackFor = Exception.class)
    public boolean updateById(ProjectContractChangeDO e) { return repository.updateById(e); }
    @Transactional(rollbackFor = Exception.class)
