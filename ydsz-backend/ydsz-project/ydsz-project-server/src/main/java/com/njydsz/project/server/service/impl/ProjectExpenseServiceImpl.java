...
public class ProjectExpenseServiceImpl implements ProjectExpenseService {
    ...
    public ProjectExpenseDO getById(String id) { return repository.getById(id); }
    public IPage<ProjectExpenseDO> page(int p, int s) { return repository.page(new Page<>(p, s)); }
    @Transactional(rollbackFor = Exception.class)
    public boolean save(ProjectExpenseDO e) { return repository.save(e); }
    @Transactional(rollbackFor = Exception.class)
    public boolean updateById(ProjectExpenseDO e) { return repository.updateById(e); }
    @Transactional(rollbackFor = Exception.class)
