...
public class ExecutionTimeEntryServiceImpl implements ExecutionTimeEntryService {
    ...
    public ExecutionTimeEntryDO getById(String id) { return repository.getById(id); }
    public IPage<ExecutionTimeEntryDO> page(int p, int s) { return repository.page(new Page<>(p, s)); }
    @Transactional(rollbackFor = Exception.class)
    public boolean save(ExecutionTimeEntryDO e) { return repository.save(e); }
    @Transactional(rollbackFor = Exception.class)
    public boolean updateById(ExecutionTimeEntryDO e) { return repository.updateById(e); }
    @Transactional(rollbackFor = Exception.class)
