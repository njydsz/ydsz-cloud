...
public class ProjectProfitSimulationServiceImpl implements ProjectProfitSimulationService {
    ...
    public ProjectProfitSimulationDO getById(String id) { return repository.getById(id); }
    public IPage<ProjectProfitSimulationDO> page(int p, int s) { return repository.page(new Page<>(p, s)); }
    @Transactional(rollbackFor = Exception.class)
    public boolean save(ProjectProfitSimulationDO e) { return repository.save(e); }
    @Transactional(rollbackFor = Exception.class)
    public boolean updateById(ProjectProfitSimulationDO e) { return repository.updateById(e); }
    @Transactional(rollbackFor = Exception.class)
