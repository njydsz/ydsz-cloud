...
public class RateInternalServiceImpl implements RateInternalService {
    ...
    public RateInternal getById(String id) { return repository.getById(id); }
    public IPage<RateInternal> page(int p, int s) { return repository.page(new Page<>(p, s)); }
    @Transactional(rollbackFor = Exception.class)
    public boolean save(RateInternal e) { return repository.save(e); }
    @Transactional(rollbackFor = Exception.class)
    public boolean updateById(RateInternal e) { return repository.updateById(e); }
    @Transactional(rollbackFor = Exception.class)
