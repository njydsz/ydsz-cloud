...
import com.njydsz.literule.domain.entity.RuleVariableDefDO;
import com.njydsz.literule.infra.mapper.RuleVariableDefMapper;
 ...
 * 数据库变量注册表
 *
 * <p>从 {@code ydsz_rule_variable_def} 表加载变量定义，实现 {@link VariableRegistry}。
 * 作为 {@link com.njydsz.literule.server.expr.ExpressionValidationService} 的变量空间数据源，
