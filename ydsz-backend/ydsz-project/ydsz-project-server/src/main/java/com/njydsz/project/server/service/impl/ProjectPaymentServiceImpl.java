...
public class ProjectPaymentServiceImpl implements ProjectPaymentService {
    ...
    public ProjectPaymentDO getById(String id) { return repository.getById(id); }
    public IPage<ProjectPaymentDO> page(int p, int s) { return repository.page(new Page<>(p, s)); }
    @Transactional(rollbackFor = Exception.class)
    public boolean save(ProjectPaymentDO e) { return repository.save(e); }
    @Transactional(rollbackFor = Exception.class)
    public boolean updateById(ProjectPaymentDO e) { return repository.updateById(e); }
    @Transactional(rollbackFor = Exception.class)
