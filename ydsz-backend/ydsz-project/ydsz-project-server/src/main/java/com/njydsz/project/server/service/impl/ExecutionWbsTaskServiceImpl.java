...
public class ExecutionWbsTaskServiceImpl implements ExecutionWbsTaskService {
    ...
    public ExecutionWbsTask getById(String id) { return repository.getById(id); }
    public IPage<ExecutionWbsTask> page(int p, int s) { return repository.page(new Page<>(p, s)); }
    @Transactional(rollbackFor = Exception.class)
    public boolean save(ExecutionWbsTask e) { return repository.save(e); }
    @Transactional(rollbackFor = Exception.class)
    public boolean updateById(ExecutionWbsTask e) { return repository.updateById(e); }
    @Transactional(rollbackFor = Exception.class)
