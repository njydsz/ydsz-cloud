...
public class ProjectGateReviewServiceImpl implements ProjectGateReviewService {
    ...
    public ProjectGateReview getById(String id) { return repository.getById(id); }
    public IPage<ProjectGateReview> page(int p, int s) { return repository.page(new Page<>(p, s)); }
    @Transactional(rollbackFor = Exception.class)
    public boolean save(ProjectGateReview e) { return repository.save(e); }
    @Transactional(rollbackFor = Exception.class)
    public boolean updateById(ProjectGateReview e) { return repository.updateById(e); }
    @Transactional(rollbackFor = Exception.class)
