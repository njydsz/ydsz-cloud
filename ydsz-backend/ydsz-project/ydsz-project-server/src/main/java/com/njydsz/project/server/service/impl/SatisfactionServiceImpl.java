...
public class SatisfactionServiceImpl implements SatisfactionService {
    ...
    public SatisfactionDO getById(String id) { return repository.getById(id); }
    public IPage<SatisfactionDO> page(int p, int s) { return repository.page(new Page<>(p, s)); }
    @Transactional(rollbackFor = Exception.class)
    public boolean save(SatisfactionDO e) { return repository.save(e); }
    @Transactional(rollbackFor = Exception.class)
    public boolean updateById(SatisfactionDO e) { return repository.updateById(e); }
    @Transactional(rollbackFor = Exception.class)
