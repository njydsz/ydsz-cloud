...
import com.njydsz.project.domain.dto.RiskCreateDTO;
import com.njydsz.project.domain.dto.RiskStatusDTO;
import com.njydsz.project.domain.entity.RiskDO;
import com.njydsz.project.domain.enums.RiskLevel;
import com.njydsz.project.domain.enums.RiskStatus;
import com.njydsz.project.domain.vo.RiskVO;
import com.njydsz.project.infra.mapper.RiskMapper;
import com.njydsz.project.server.engine.RiskScoreEvaluator;
import com.njydsz.project.server.service.RiskService;
...
public class RiskServiceImpl implements RiskService {
    ...
    public String create(RiskCreateDTO dto) {
        ...
        if (!StringUtils.hasText(dto.getRiskCode())) {
            throw new SysException(BaseResultCode.BAD_REQUEST, "error.execution.msg_cad9859b");
        }
        if (!StringUtils.hasText(dto.getRiskTitle())) {
            throw new SysException(BaseResultCode.BAD_REQUEST, "error.execution.msg_def770be");
        }
        ...
        if (riskMapper.selectByCode(dto.getRiskCode()) != null) {
            throw new SysException(BaseResultCode.DUPLICATE_KEY, "error.execution.msg_25ba60bd", dto.getRiskCode());
        }
        RiskDO r = new RiskDO();
    ...
    public void delete(String id) {
        ...
        if (RiskStatus.fromCode(r.getStatus()) == RiskStatus.OCCURRED) {
            throw new SysException(BaseResultCode.BAD_REQUEST, "error.execution.msg_0fa95df6");
        }
    ...
    private RiskDO loadByIdDO(String id) {
        ...
        if (r == null) throw new SysException(BaseResultCode.NOT_FOUND, "error.execution.msg_eed2ed24");
        return r;
    }
