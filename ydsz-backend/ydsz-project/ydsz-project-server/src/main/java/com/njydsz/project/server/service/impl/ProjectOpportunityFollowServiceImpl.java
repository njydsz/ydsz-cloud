...
public class ProjectOpportunityFollowServiceImpl implements ProjectOpportunityFollowService {
    ...
    public ProjectOpportunityFollow getById(String id) { return repository.getById(id); }
    public IPage<ProjectOpportunityFollow> page(int p, int s) { return repository.page(new Page<>(p, s)); }
    @Transactional(rollbackFor = Exception.class)
    public boolean save(ProjectOpportunityFollow e) { return repository.save(e); }
    @Transactional(rollbackFor = Exception.class)
    public boolean updateById(ProjectOpportunityFollow e) { return repository.updateById(e); }
    @Transactional(rollbackFor = Exception.class)
