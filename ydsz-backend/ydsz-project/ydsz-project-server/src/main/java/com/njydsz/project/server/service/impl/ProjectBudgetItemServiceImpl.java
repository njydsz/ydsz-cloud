...
public class ProjectBudgetItemServiceImpl implements ProjectBudgetItemService {
    ...
    public ProjectBudgetItem getById(String id) { return repository.getById(id); }
    public IPage<ProjectBudgetItem> page(int p, int s) { return repository.page(new Page<>(p, s)); }
    @Transactional(rollbackFor = Exception.class)
    public boolean save(ProjectBudgetItem e) { return repository.save(e); }
    @Transactional(rollbackFor = Exception.class)
    public boolean updateById(ProjectBudgetItem e) { return repository.updateById(e); }
    @Transactional(rollbackFor = Exception.class)
