...
public class ProjectChangeServiceImpl implements ProjectChangeService {
    ...
    public ProjectChange getById(String id) { return repository.getById(id); }
    public IPage<ProjectChange> page(int p, int s) { return repository.page(new Page<>(p, s)); }
    @Transactional(rollbackFor = Exception.class)
    public boolean save(ProjectChange e) { return repository.save(e); }
    @Transactional(rollbackFor = Exception.class)
    public boolean updateById(ProjectChange e) { return repository.updateById(e); }
    @Transactional(rollbackFor = Exception.class)
