 ...
 * <p><b>缓存策略：</b>
 * <ul>
 *   <li>role:xxx → 用户列表：TTL 5 分钟</li>
 *   <li>position:xxx → 用户列表：TTL 5 分钟</li>
 *   <li>leader:xxx → 上级 ID：TTL 5 分钟</li>
 *   <li>dept:xxx → 部门负责人：TTL 10 分钟（变更频率低）</li>
 * </ul>
 *
 * <p><b>缓存失效触发：</b>
 * <ul>
 *   <li>用户角色分配变更 → 失效 role 相关缓存</li>
 *   <li>用户岗位/上级变更 → 失效 position/leader 相关缓存</li>
 *   <li>部门负责人变更 → 失效 dept 相关缓存</li>
 * </ul>
 *
 * @author ydsz-team
 * @since 1.0.0
