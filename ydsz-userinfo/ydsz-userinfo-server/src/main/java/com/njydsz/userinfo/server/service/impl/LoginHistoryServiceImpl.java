...
public class LoginHistoryServiceImpl implements LoginHistoryService {
    ...
    @Override
    public void recordLoginAttempt(String userId, String username, String loginIp,
        ...
        try {
            ...
            // 登录历史记录失败不应影响登录主流程
            log.warn("Failed to record login history: username={}, ip={}, error={}",
    ...
    public boolean isIpBlocked(String ip) {
        ...
        try {
            ...
            wrapper.eq(UserLoginHistory::getLoginIp, ip)
