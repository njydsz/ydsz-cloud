 ...
 * </ul>
 *
 * <p>P2-1: 通过 {@link ObjectProvider}&lt;{@link RedisService}&gt; 可选注入 Redis 二级缓存服务。
 * 仅当启用 {@code ydsz.feign.name-assembler.redis-cache-enabled=true} 且 classpath 中存在
 * {@link RedisService} 时，Redis L2 缓存才会启用。
 *
...
public class UserInfoNameAssemblerAutoConfiguration {
     ...
     *
     * <p>P2-1: 通过 {@link ObjectProvider}&lt;{@link RedisService}&gt; 可选注入 Redis 服务，
