 ...
 *
 * <p>定义 userinfo 模块的 UserAccount 聚合根的持久化操作契约。
 * 领域层通过此接口与基础设施解耦，不依赖 MyBatis-Plus 等具体 ORM 实现。
 *
 * <p><b>实现约束</b>：
 * <ul>
 *   <li>实现类应位于 infra 模块（如 {@code UserRepositoryImpl}），基于 MyBatis-Plus Mapper 实现</li>
 *   <li>所有方法均为聚合根级别操作，不接受/返回 PO/DTO，仅使用领域实体</li>
 *   <li>批量操作应保持事务一致性</li>
 * </ul>
 *
 * @author ydsz-team
