...
public interface CompanyDeptRepository {
   ...
   */
  CompanyDeptDO findById(String id);
   ...
   * @return 公司-部门关联列表
   */
  List<CompanyDeptDO> findByCompanyId(String companyId);
   ...
   */
  CompanyDeptDO findByDeptId(String deptId);
  ...
  List<CompanyDeptDO> list(
      com.baomidou.mybatisplus.core.conditions.query.LambdaQueryWrapper<CompanyDeptDO> wrapper);
   ...
   * @return 插入影响的行数
   */
  int insert(CompanyDeptDO entity);
   ...
   * @return 更新影响的行数
   */
  int updateById(CompanyDeptDO entity);
