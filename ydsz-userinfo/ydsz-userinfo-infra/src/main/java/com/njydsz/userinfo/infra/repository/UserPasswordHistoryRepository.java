...
public interface UserPasswordHistoryRepository {
   ...
   * @return 插入影响的行数
   */
  int insert(UserPasswordHistory entity);
   ...
   * @return 密码历史列表
   */
  List<UserPasswordHistory> findRecentByUserId(String userId, int limit);
   ...
   */
  int delete(
      com.baomidou.mybatisplus.core.conditions.query.LambdaQueryWrapper<UserPasswordHistory> wrapper);
