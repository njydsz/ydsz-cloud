...
public interface UserAccountRepository {
   ...
   * @return 分页结果
   */
  Page<UserAccount> page(Page<UserAccount> page,
      com.baomidou.mybatisplus.core.conditions.query.LambdaQueryWrapper<UserAccount> wrapper);
   ...
   * @return 用户账号列表
   */
  List<UserAccount> listByIds(java.util.Collection<String> ids);
