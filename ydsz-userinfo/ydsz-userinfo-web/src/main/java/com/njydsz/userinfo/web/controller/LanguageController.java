 ...
 *
 * <ul>
 *   <li>前端 i18n 文案（前端通过 {@code /api/Language/list} 加载语言选项）
...
public class LanguageController {
   ...
   * <p>幂等保护 5 秒；限流 50 QPS；写审计日志。
   *
   * <p>删除前置校验：默认语言（{@code isDefault=true}）<b>禁止删除</b>，避免后端文案回退链断裂。 如需删除默认语言，<b>必须先</b>设置其他语言为默认。
   *
   * @param id 语言 ID
   * @return 是否成功
   */
