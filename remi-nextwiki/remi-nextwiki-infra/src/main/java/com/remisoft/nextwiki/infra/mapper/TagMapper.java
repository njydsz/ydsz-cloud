 ...
 * 标签 Mapper
 *
 * <p>对应数据表 <code>remi_tag</code>。
 * <p>标签是文件分类/检索的辅助手段，与文件是多对多关系（{@code remi_file_tag}）。
 *
 * <p><b>主要索引：</b>
 * <ul>
 ...
 * @since 1.0.0
 *
 * @see com.remisoft.nextwiki.domain.entity.Tag 标签实体
 * @see com.remisoft.nextwiki.server.service.TagService 标签 Service
