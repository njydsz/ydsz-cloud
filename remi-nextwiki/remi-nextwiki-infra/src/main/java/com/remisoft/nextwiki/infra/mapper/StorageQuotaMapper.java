 ...
 * 存储配额 Mapper
 *
 * <p>对应数据表 <code>remi_storage_quota</code>。
 ...
 * @since 1.0.0
 *
 * @see com.remisoft.nextwiki.domain.entity.StorageQuota 存储配额实体
 * @see com.remisoft.nextwiki.server.service.StorageQuotaService 配额 Service
