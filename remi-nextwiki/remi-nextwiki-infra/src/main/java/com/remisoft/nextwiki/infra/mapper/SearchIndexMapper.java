package com.remisoft.nextwiki.infra.mapper;
...
import com.remisoft.nextwiki.domain.entity.SearchIndex;

/**
 * 搜索索引 Mapper
 *
 * <p>对应数据表 <code>remi_search_index</code>。
 * <p>索引按文件版本同步（ES/PG 全文索引），支持全文检索/高亮/排序/聚合。
 *
 * <p><b>主要索引：</b>
 * <ul>
 *   <li>uk_index_id — 索引 ID 唯一索引</li>
 *   <li>idx_file_version — (文件+版本) 索引</li>
 * </ul>
 *
 ...
 * @since 1.0.0
 *
 * @see com.remisoft.nextwiki.domain.entity.SearchIndex 搜索索引实体
 * @see com.remisoft.nextwiki.server.service.SearchIndexService 搜索 Service
