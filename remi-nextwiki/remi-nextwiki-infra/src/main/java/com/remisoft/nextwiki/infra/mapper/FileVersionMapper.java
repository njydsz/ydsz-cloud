 ...
 * 文件版本 Mapper
 *
 * <p>对应数据表 <code>remi_file_version</code>。
 * <p>文件每次编辑保存新版本（content + 元数据），支持回滚、对比、审计。
 *
 * <p><b>主要索引：</b>
 * <ul>
 *   <li>uk_version_id — 版本 ID 唯一索引</li>
 *   <li>idx_file_id — 文件维度查询索引</li>
 *   <li>idx_version_no — 版本号排序索引</li>
 * </ul>
 *
 ...
 * @since 1.0.0
 *
 * @see com.remisoft.nextwiki.domain.entity.FileVersion 文件版本实体
 * @see com.remisoft.nextwiki.server.service.FileVersionService 文件版本 Service
