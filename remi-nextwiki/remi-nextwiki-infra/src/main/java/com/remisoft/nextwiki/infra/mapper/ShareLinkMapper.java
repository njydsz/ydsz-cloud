 ...
 * 分享链接 Mapper
 *
 * <p>对应数据表 <code>remi_share_link</code>。
 ...
 * @since 1.0.0
 *
 * @see com.remisoft.nextwiki.domain.entity.ShareLink 分享链接实体
 * @see com.remisoft.nextwiki.server.service.ShareLinkService 分享 Service
