...
import com.remisoft.nextwiki.infra.mapper.StorageQuotaMapper;
...
public class StorageQuotaRepositoryImpl implements StorageQuotaRepository {
    ...
    /**
     * 新增或更新存储配额：无主键时插入；有主键时按乐观锁更新（revision 缺失退化为普通更新，
     * 并发冲突抛 {@link OptimisticLockingFailureException}），成功后 revision 自增 1。
     *
