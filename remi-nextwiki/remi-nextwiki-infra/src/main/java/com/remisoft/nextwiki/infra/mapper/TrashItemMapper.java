 ...
 * 回收站 Mapper
 *
 * <p>对应数据表 <code>remi_trash_item</code>。
 ...
 * @since 1.0.0
 *
 * @see com.remisoft.nextwiki.domain.entity.TrashItem 回收项实体
 * @see com.remisoft.nextwiki.server.service.TrashItemService 回收站 Service
