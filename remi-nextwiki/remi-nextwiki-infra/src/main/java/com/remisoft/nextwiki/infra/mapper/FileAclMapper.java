 ...
 * 文件权限 ACL Mapper
 *
 * <p>对应数据表 <code>remi_file_acl</code>。
 ...
 * @since 1.0.0
 *
 * @see com.remisoft.nextwiki.domain.entity.FileAcl 文件权限实体
 * @see com.remisoft.nextwiki.server.service.FileAclService 文件权限 Service
