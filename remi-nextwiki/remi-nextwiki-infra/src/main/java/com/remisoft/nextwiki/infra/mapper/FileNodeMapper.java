 ...
 * 文件节点 Mapper
 *
 * <p>对应数据表 <code>remi_file_node</code>。
 ...
 * @since 1.0.0
 *
 * @see com.remisoft.nextwiki.domain.entity.FileNode 文件节点实体
 * @see com.remisoft.nextwiki.server.service.FileNodeService 文件节点 Service
