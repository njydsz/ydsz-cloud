...
import com.remisoft.nextwiki.domain.entity.ShareLink;
import com.remisoft.nextwiki.server.service.ShareApplicationService;
 ...
 *                                          ↓
 *                                  remi-nextwiki-server.ShareApplicationService
 *                                          ↓
 *                                  remi-nextwiki-infra.ShareLinkMapper
 *                                          ↓
 *                                  remi_share_link
 * </pre>
 *
...
public class ShareController {
    ...
    @Idempotent(key = "remi:nextwiki:ShareController:createShare:lock", ttlSeconds = 5)
    @PostMapping
    ...
    @Idempotent(key = "remi:nextwiki:ShareController:verifyAccess:lock", ttlSeconds = 5)
    ...
    @Idempotent(key = "remi:nextwiki:ShareController:revoke:lock", ttlSeconds = 5)
