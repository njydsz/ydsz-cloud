...
import com.remisoft.nextwiki.domain.repository.FileCommentRepository;
 ...
 *                                            ↓
 *                                   remi-nextwiki-domain.FileCommentRepository
 *                                            ↓
...
public class FileCommentController {
    ...
    @Idempotent(key = "remi:nextwiki:FileCommentController:addComment:lock", ttlSeconds = 5)
    @PostMapping
    ...
    @Idempotent(key = "remi:nextwiki:FileCommentController:deleteComment:lock", ttlSeconds = 5)
    ...
    @Idempotent(key = "remi:nextwiki:FileCommentController:resolveComment:lock", ttlSeconds = 5)
