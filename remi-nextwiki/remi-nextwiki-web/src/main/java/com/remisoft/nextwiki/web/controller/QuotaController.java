...
import com.remisoft.nextwiki.server.service.QuotaApplicationService;
 ...
 *                                            ↓
 *                                   remi-nextwiki-server.QuotaApplicationService
 *                                            ↓
 *                                   remi-nextwiki-infra.StorageQuotaMapper
 *                                            ↓
 *                                   remi_storage_quota
 * </pre>
 *
...
public class QuotaController {
     ...
     */
    @Idempotent(key = "remi:nextwiki:QuotaController:setQuota:lock", ttlSeconds = 5)
    @PostMapping("/set")
