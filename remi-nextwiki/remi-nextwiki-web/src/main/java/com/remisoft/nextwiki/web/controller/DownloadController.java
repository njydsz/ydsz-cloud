...
import com.remisoft.nextwiki.server.service.DownloadApplicationService;
import com.remisoft.nextwiki.server.service.DownloadApplicationService.DownloadContext;
import com.remisoft.nextwiki.server.service.DownloadApplicationService.SignedDownloadContext;
 ...
 *                                            ↓
 *                                   remi-nextwiki-server.DownloadApplicationService
 *                                            ↓
 *                                   remi-common-safe (ClientIpResolver / 限流)
 *                                   remi-common-file (IFileStorage 抽象)
 *                                            ↓
...
public class DownloadController {
     ...
     */
    @Idempotent(key = "remi:nextwiki:DownloadController:downloadFolder:lock", ttlSeconds = 5)
     ...
     */
    @Idempotent(key = "remi:nextwiki:DownloadController:download:lock", ttlSeconds = 5)
    @PostMapping("/{nodeId}")
     ...
     */
    @Idempotent(key = "remi:nextwiki:DownloadController:generateSignedUrl:lock", ttlSeconds = 5)
