...
import com.remisoft.cronjob.server.core.executor.SandboxScriptExecutor;
 ...
 * 调度执行时由本处理器从 {@code remi_job_glue} 表读取最新版本源代码，
...
public class GlueJobHandler implements JobHandler {
    ...
    private CompilerConfiguration createSecureCompilerConfiguration() {
        ...
        List<String> importsWhitelist = List.of(
                ...
                "com.remisoft.cronjob.domain.job.JobHandler",
                "com.remisoft.cronjob.domain.job.JobExecutionContext",
                "com.remisoft.cronjob.domain.job.JobExecutionContext",
                "com.remisoft.cronjob.domain.job.ProcessResult"
        );
