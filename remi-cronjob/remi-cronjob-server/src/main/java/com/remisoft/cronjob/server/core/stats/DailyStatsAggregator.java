package com.remisoft.cronjob.server.core.stats;
 ...
 * 每天凌晨 1 点定时聚合昨天 {@code remi_job_log} 的执行数据，写入
 * {@code remi_job_daily_stats}，供前端趋势图展示。
 *
 * <h3>设计要点</h3>
 * <ul>
...
public class DailyStatsAggregator {
     ...
     *
     * <p>仅在 {@code remi.cronjob.leader.enabled=true} 时进入聚合启用分支；
