package com.remisoft.cronjob.server.core.logger;
 ...
 * 绑定到 {@link com.remisoft.cronjob.domain.job.JobExecutionContext} 的 ThreadLocal。
 *
 * <h3>实现要点</h3>
 * <ul>
...
public class JobLoggerImpl implements JobLogger {
     ...
     * 构造任务日志器。
     *
     * @param logId               执行日志 ID（关联 remi_job_log.id）
     * @param jobKey              任务 KEY
