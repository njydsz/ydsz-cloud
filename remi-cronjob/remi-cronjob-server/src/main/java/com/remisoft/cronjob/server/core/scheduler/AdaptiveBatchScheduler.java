 ...
 *
 * <p>仅在 {@code remi.cronjob.adaptive-batch.enabled=true} 时启用。
 *
 * @author remi-team
 * @since 1.0.0
 */
...
@ConditionalOnProperty(name = "remi.cronjob.adaptive-batch.enabled", havingValue = "true")
public class AdaptiveBatchScheduler {
     ...
     *
     * <p>仅当 {@code remi.cronjob.adaptive-batch.enabled=true} 且有
     ...
     */
    @Scheduled(fixedDelayString = "#{${remi.cronjob.adaptive-batch.eval-interval-seconds:10} * 1000}")
