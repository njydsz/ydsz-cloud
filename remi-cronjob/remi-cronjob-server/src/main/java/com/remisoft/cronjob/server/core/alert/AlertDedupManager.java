 ...
 * </ol>
 *
 * <p>仅在 {@code remi.cronjob.alert-dedup.enabled=true} 时启用。
 *
 * @author remi-team
 * @since 1.0.0
 */
...
@ConditionalOnProperty(name = "remi.cronjob.alert-dedup.enabled", havingValue = "true")
public class AlertDedupManager {
    ...
    /** Redis key 前缀：告警聚合计数 */
    private static final String AGGREGATE_COUNT_PREFIX = "remi:alert:dedup:count:";
    /** Redis key 前缀：升级状态 */
    private static final String ESCALATION_PREFIX = "remi:alert:dedup:escalate:";
