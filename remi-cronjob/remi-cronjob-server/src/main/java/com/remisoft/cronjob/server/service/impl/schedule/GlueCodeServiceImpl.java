package com.remisoft.cronjob.server.service.impl.schedule;
...
import com.remisoft.cronjob.infra.mapper.schedule.GlueCodeMapper;
 ...
 * GLUE 脚本服务实现。
 *
 * <p>维护任务运行时的 GLUE 脚本（Java/Shell/Python/JS）源码，对应 {@code remi_glue_code} 表。
 *
...
public class GlueCodeServiceImpl implements GlueCodeService {
    ...
    public List<GlueCode> listVersions(String jobId) {
        ...
        wrapper.eq(GlueCode::getJobId, jobId)
                .orderByDesc(GlueCode::getVersion);
