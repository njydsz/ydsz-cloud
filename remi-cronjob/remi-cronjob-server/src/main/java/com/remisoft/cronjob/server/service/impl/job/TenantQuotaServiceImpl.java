...
import com.remisoft.cronjob.infra.mapper.job.TenantQuotaMapper;
 ...
 * 租户配额服务实现。
 *
 * <p>管理租户的任务配额 ({@code remi_tenant_quota})：并发任务数上限、日调度次数上限、
 *
...
public class TenantQuotaServiceImpl implements TenantQuotaService {
    ...
    /** Redis key 前缀：并发计数器 */
    private static final String CONCURRENT_KEY_PREFIX = "remi:quota:concurrent:";
    /** Redis key 前缀：日执行计数器 */
    private static final String DAILY_KEY_PREFIX = "remi:quota:daily:";
