...
@ConditionalOnProperty(prefix = "remi.cronjob.leader", name = "enabled", havingValue = "true")
public class RedissonLeaderElector implements LeaderElector {

    /** Leader 锁 key 前缀 */
    private static final String LOCK_KEY_PREFIX = "remi:job:leader:";
    /** P0-3: Leader 持有者标识 key 前缀（value=nodeId，供 getCurrentLeader 读取） */
    private static final String HOLDER_KEY_PREFIX = "remi:job:leader:holder:";
