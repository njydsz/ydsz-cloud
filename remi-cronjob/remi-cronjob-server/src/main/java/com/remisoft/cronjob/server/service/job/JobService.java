 ...
 * 任务调度 Service 接口
 *
 * <p>提供任务（{@code remi_job}）的完整管理能力：CRUD、暂停/恢复、立即触发、
 * 调度器注册/取消、应用启动加载等。是定时任务（remi-cronjob）模块的核心入口。
 *
 * <p><b>核心职责：</b>
 * <ul>
 ...
 * @since 1.0.0
 *
 * @see com.remisoft.cronjob.domain.entity.job.Job 任务实体
 * @see com.remisoft.cronjob.server.service.JobHistoryService 任务历史 Service
 */
