package com.remisoft.cronjob.server.core.discovery;
 ...
 *
 * <p>查询 {@code remi_job_node} 表中 {@code last_heartbeat} 在阈值内的节点，
 * 与 {@link com.remisoft.cronjob.server.core.executor.JobNodeHeartbeat} + 
 * {@link com.remisoft.cronjob.server.core.executor.JobNodeReaper} 配合使用。
 *
 * <p>通过 {@code remi.cronjob.node-discovery.type=db} 启用，
...
public class DbNodeDiscoveryStrategy implements NodeDiscoveryStrategy {
     ...
     *
     * @return 本节点唯一标识，与 {@link com.remisoft.cronjob.server.core.executor.JobNodeHeartbeat} 保持一致
     */
    @Override
