 ...
 * 通过 {@link DiscoveryClient} 获取在线执行器节点，替代手动维护的 remi_job_node 心跳表。
 *
 * <h3>工作原理</h3>
 * <ol>
 ...
 * </ol>
 *
 * <p>默认启用（{@code matchIfMissing = true}），通过 {@code remi.cronjob.node-discovery.type=nacos} 显式指定。
 *
 * @author remi-team
 * @since 1.0.0
 */
@Slf4j
@Component
@ConditionalOnProperty(name = "remi.cronjob.node-discovery.type", havingValue = "nacos", matchIfMissing = true)
