 ...
 * <pre>
 * docker run --rm \
 *   --name remi-sandbox-{jobKey}-{timestamp} \
 ...
 * <h3>启用方式</h3>
 * <pre>
 * remi.cronjob.sandbox.docker-enabled=true
 * remi.cronjob.sandbox.docker-image=python:3.11-slim
 * remi.cronjob.sandbox.docker-memory=512m
 * remi.cronjob.sandbox.docker-cpus=2
 * </pre>
 *
...
public class DockerSandboxExecutor {
    ...
    public SandboxResult execute(String scriptContent, String language, int timeoutSeconds,
        ...
        String containerName = "remi-sandbox-" + System.currentTimeMillis();
