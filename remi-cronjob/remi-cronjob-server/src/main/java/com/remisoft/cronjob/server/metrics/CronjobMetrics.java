 ...
 * </ul>
 *
 * <p>所有指标前缀 {@code remi_cronjob_}，便于在 Grafana 看板中筛选。
 *
 ...
 *   <tr><td>remi_cronjob_job_dispatched_total</td><td>Counter</td><td>trigger_type, status</td><td>任务派发总数</td></tr>
 *   <tr><td>remi_cronjob_job_failed_total</td><td>Counter</td><td>job_key</td><td>任务失败总数</td></tr>
 *   <tr><td>remi_cronjob_job_timeout_total</td><td>Counter</td><td>job_key</td><td>任务超时总数</td></tr>
 *   <tr><td>remi_cronjob_misfire_total</td><td>Counter</td><td>policy</td><td>Misfire 触发总数</td></tr>
 *   <tr><td>remi_cronjob_alert_dispatched_total</td><td>Counter</td><td>alert_type, status</td><td>告警派发总数</td></tr>
 *   <tr><td>remi_cronjob_job_duration_ms</td><td>Timer</td><td>job_key, status</td><td>任务执行耗时</td></tr>
 *   <tr><td>remi_cronjob_job_running</td><td>Gauge</td><td>-</td><td>当前运行中任务数</td></tr>
 *   <tr><td>remi_cronjob_scanner_due_jobs</td><td>Gauge</td><td>-</td><td>上次扫描到的待触发任务数</td></tr>
 *   <tr><td>remi_cronjob_scanner_scanning</td><td>Gauge</td><td>-</td><td>扫描器是否正在扫描（0/1）</td></tr>
 * </table>
 *
 * @author remi-team
 * @since 1.0.0
...
public class CronjobMetrics extends AbstractModuleMetrics {
    ...
    private void registerGauges() {
        // 运行中任务数（查询 DB）
        registry.gauge("remi_cronjob_job_running", Tags.empty(), this, m -> {
        ...
        // 上次扫描到的待触发任务数
        registry.gauge("remi_cronjob_scanner_due_jobs", Tags.empty(), lastScanDueJobs);

        // 扫描器扫描中标志
        registry.gauge("remi_cronjob_scanner_scanning", Tags.empty(), scanningFlag);

        // P1-1: 自适应批量大小
        registry.gauge("remi_cronjob_adaptive_batch_size", Tags.empty(), adaptiveBatchSize);

        // P1-1: 系统负载评分（0-1000，除以1000得到 0-1）
        registry.gauge("remi_cronjob_system_load_score", Tags.empty(), systemLoadScore);
    }
