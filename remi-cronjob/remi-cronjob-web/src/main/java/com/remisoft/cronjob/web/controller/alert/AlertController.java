package com.remisoft.cronjob.web.controller.alert;
...
import com.remisoft.cronjob.domain.dto.alert.AlertRuleSaveDTO;
import com.remisoft.cronjob.domain.entity.job.JobAlertLog;
import com.remisoft.cronjob.domain.entity.job.JobAlertRule;
import com.remisoft.cronjob.server.service.alert.AlertService;
...
public class AlertController {
    ...
    @Idempotent(key = "remi:cronjob:AlertController:createRule:lock", ttlSeconds = 5)
    ...
    @Idempotent(key = "remi:cronjob:AlertController:updateRule:lock", ttlSeconds = 5)
    ...
    @Idempotent(key = "remi:cronjob:AlertController:deleteRule:lock", ttlSeconds = 5)
    ...
    @AuthApiPermission(apiCodes = PermissionCodes.CRONJOB_ALERT_UPDATE)
    @Idempotent(key = "remi:cronjob:AlertController:toggleRule:lock", ttlSeconds = 5)
