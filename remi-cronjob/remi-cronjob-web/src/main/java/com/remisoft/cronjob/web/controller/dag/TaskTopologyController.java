...
import com.remisoft.cronjob.infra.mapper.dag.JobDagNodeInstanceMapper;
...
public class TaskTopologyController {
     ...
     * <p>组装 3 部分数据：
     * <ol>
     *   <li>{@code dagDefinition} - 从 {@code remi_job_dag.dag_definition} JSON 字段反序列化为 {@link DagDefinition}</li>
     *   <li>{@code dagInstance} - DAG 实例主表（{@code remi_job_dag_instance}）</li>
     *   <li>{@code nodeInstances} - DAG 节点实例列表（{@code remi_job_dag_node_instance}）</li>
     * </ol>
     *
     ...
     *
     * @param jobKey 任务 KEY（{@code remi_job.job_key}）
