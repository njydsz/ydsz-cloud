...
import com.remisoft.cronjob.infra.mapper.job.JobWebhookMapper;
...
public class JobWebhookController {
    ...
    @Idempotent(key = "remi:cronjob:JobWebhookController:create:lock", ttlSeconds = 5)
    ...
    @AuthApiPermission(apiCodes = PermissionCodes.CRONJOB_JOB_UPDATE)
    @Idempotent(key = "remi:cronjob:JobWebhookController:update:lock", ttlSeconds = 5)
    ...
    @AuthApiPermission(apiCodes = PermissionCodes.CRONJOB_JOB_UPDATE)
    @Idempotent(key = "remi:cronjob:JobWebhookController:delete:lock", ttlSeconds = 5)
    ...
    @AuthApiPermission(apiCodes = PermissionCodes.CRONJOB_JOB_UPDATE)
    @Idempotent(key = "remi:cronjob:JobWebhookController:testWebhook:lock", ttlSeconds = 5)
