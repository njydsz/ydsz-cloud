package com.remisoft.cronjob.web.controller.connector;
...
import com.remisoft.cronjob.server.core.connector.ConnectorConfig;
import com.remisoft.cronjob.server.core.connector.ConnectorExportResult;
import com.remisoft.cronjob.server.core.connector.ConnectorManager;
import com.remisoft.cronjob.server.core.connector.ConnectorTaskInfo;
import com.remisoft.cronjob.server.core.connector.JobConnector;
...
import com.remisoft.cronjob.domain.dto.post.ConnectorConfigPostDTO;
...
import com.remisoft.cronjob.domain.enums.CronjobResultCode;
...
public class ConnectorController {
    ...
    @Idempotent(key = "remi:cronjob:ConnectorController:testConnection:lock", ttlSeconds = 5)
    @PostMapping("/test")
    ...
    @Idempotent(key = "remi:cronjob:ConnectorController:listRemoteTasks:lock", ttlSeconds = 5)
    ...
    @Idempotent(key = "remi:cronjob:ConnectorController:importTasks:lock", ttlSeconds = 5)
    @PostMapping("/import")
    ...
    @Idempotent(key = "remi:cronjob:ConnectorController:exportTasks:lock", ttlSeconds = 5)
    @PostMapping("/export")
