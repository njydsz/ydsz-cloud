package com.remisoft.cronjob.web.controller.schedule;
...
import com.remisoft.cronjob.server.service.schedule.GlueCodeService;
...
public class GlueCodeController {
    ...
    @Idempotent(key = "remi:cronjob:GlueCodeController:save:lock", ttlSeconds = 5)
    ...
    @AuthApiPermission(apiCodes = PermissionCodes.CRONJOB_GLUE_MANAGE)
    @Idempotent(key = "remi:cronjob:GlueCodeController:rollback:lock", ttlSeconds = 5)
