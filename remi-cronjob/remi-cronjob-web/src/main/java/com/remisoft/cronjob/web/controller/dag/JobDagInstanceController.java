...
import com.remisoft.cronjob.server.service.dag.JobDagInstanceService;
import com.remisoft.cronjob.server.vo.DagInstanceVisualizationVO;
...
public class JobDagInstanceController {
    ...
    @Idempotent(key = "remi:cronjob:JobDagInstanceController:pauseInstance:lock", ttlSeconds = 5)
    ...
    @AuthApiPermission(apiCodes = PermissionCodes.CRONJOB_DAG_UPDATE)
    @Idempotent(key = "remi:cronjob:JobDagInstanceController:resumeInstance:lock", ttlSeconds = 5)
    ...
    @AuthApiPermission(apiCodes = PermissionCodes.CRONJOB_DAG_UPDATE)
    @Idempotent(key = "remi:cronjob:JobDagInstanceController:cancelInstance:lock", ttlSeconds = 5)
    ...
    @AuthApiPermission(apiCodes = PermissionCodes.CRONJOB_DAG_UPDATE)
    @Idempotent(key = "remi:cronjob:JobDagInstanceController:updateContext:lock", ttlSeconds = 5)
