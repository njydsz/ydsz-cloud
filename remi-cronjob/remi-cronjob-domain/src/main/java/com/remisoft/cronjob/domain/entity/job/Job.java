 ...
 * 定时任务定义
 *
 * <p>对应 remi_job 表，描述一个调度任务的处理器、Cron 表达式、参数及执行统计。
 *
 * @author remi-team
 * @since 1.0.0
 */
...
public class Job extends MpBaseEntity<String> {
     ...
     * 标记 {@code remi_job_log.is_slow=1}，用于性能趋势分析。
     */
     ...
     * null 视为 {@link com.remisoft.cronjob.server.core.dispatch.MisfirePolicy#FIRE_NOW}。
     */
