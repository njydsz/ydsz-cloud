 ...
 *
 * <p>P3-1-merge: 原对应 {@code remi_job_alert_log} 表，现已合并到 {@code remi_alert_dispatch}
 * （source_type='CRONJOB'）。本实体映射到 remi_alert_dispatch 表，新增字段（alert_code,
...
public class JobAlertLog extends MpBaseEntity<String> {
    ...
    /** 规则 ID（映射到 remi_alert_dispatch.rule_id） */
    private String ruleId;

    /** 规则名称（映射到 remi_alert_dispatch.title） */
    ...
    /** 触发该告警的任务日志 ID（关联 remi_job_log.id） */
