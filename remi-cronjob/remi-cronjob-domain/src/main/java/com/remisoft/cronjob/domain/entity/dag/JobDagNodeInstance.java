package com.remisoft.cronjob.domain.entity.dag;
...
/**
 * DAG 节点实例实体（remi_job_dag_node_instance 表，P2 DAG 增强）。
 *
 * <p>记录 DAG 实例中每个任务节点的执行状态。一个 DAG 实例包含若干节点实例，
 * 每个节点实例关联一个任务执行日志（remi_job_log）。
 *
 * <p>节点状态流转：
 * <ul>
...
@TableName("remi_job_dag_node_instance")
