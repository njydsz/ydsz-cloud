package com.remisoft.cronjob.domain.dto.alert;
...
public class AlertRuleSaveDTO implements Serializable {
    ...
    @Schema(description = "告警类型: FAIL/TIMEOUT/SLOW/FAIL_RATE/DURATION_P95",
    ...
    @Schema(description = "通知通道（JSON 数组: [\"EMAIL\",\"DINGTALK\"]）",
            requiredMode = Schema.RequiredMode.REQUIRED)
