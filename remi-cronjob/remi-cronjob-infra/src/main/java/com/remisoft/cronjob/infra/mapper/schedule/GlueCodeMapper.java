package com.remisoft.cronjob.infra.mapper.schedule;
 ...
 * GLUE 脚本代码 Mapper
 *
 * <p>对应数据表 <code>remi_glue_code</code>。
 ...
 * @since 1.0.0
 *
 * @see com.remisoft.cronjob.domain.entity.schedule.GlueCode GLUE 实体
 * @see com.remisoft.cronjob.server.service.GlueCodeService GLUE Service
