 ...
 * 任务变更历史 Mapper
 *
 * <p>对应数据表 <code>remi_job_history</code>。
 ...
 * @since 1.0.0
 *
 * @see com.remisoft.cronjob.domain.entity.job.JobHistory 变更历史实体
 * @see com.remisoft.cronjob.server.service.JobHistoryService 变更历史 Service
...
public interface JobHistoryMapper extends BaseMapper<JobHistory> {
     ...
     * @return 实际删除条数
     */
    @Delete("DELETE FROM remi_job_history "
            + "WHERE id IN ("
            + "  SELECT id FROM remi_job_history "
