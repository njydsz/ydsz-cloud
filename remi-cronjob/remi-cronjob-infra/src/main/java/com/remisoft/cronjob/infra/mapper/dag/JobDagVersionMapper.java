 ...
 * 任务 DAG 版本历史 Mapper
 *
 * <p>对应数据表 <code>remi_job_dag_version</code>。
 ...
 * @since 1.0.0
 *
 * @see com.remisoft.cronjob.domain.entity.dag.JobDagVersion DAG 版本实体
...
public interface JobDagVersionMapper extends BaseMapper<JobDagVersion> {
     ...
     */
    @Select("SELECT MAX(version) FROM remi_job_dag_version WHERE dag_id = #{dagId} AND deleted = 0")
