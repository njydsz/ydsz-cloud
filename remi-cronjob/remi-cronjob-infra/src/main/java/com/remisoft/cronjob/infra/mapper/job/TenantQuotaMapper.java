 ...
 * 租户任务配额 Mapper
 *
 * <p>对应数据表 <code>remi_tenant_quota</code>。
 ...
 * @since 1.0.0
 *
 * @see com.remisoft.cronjob.domain.entity.job.TenantQuota 配额实体
 * @see com.remisoft.cronjob.server.service.TenantQuotaService 配额 Service
