 ...
 * 任务日统计 Mapper
 *
 * <p>对应数据表 <code>remi_job_daily_stats</code>。
 ...
 * @since 1.0.0
 *
 * @see com.remisoft.cronjob.domain.entity.log.JobDailyStats 日统计实体
 * @see com.remisoft.cronjob.server.service.JobStatsService 任务统计 Service
...
public interface JobDailyStatsMapper extends BaseMapper<JobDailyStats> {
    ...
    /**
     * 聚合 {@code remi_job_log} 在指定时间窗口内的执行统计（按 job_id 分组）。
     *
     ...
     */
    @Insert("INSERT INTO remi_job_daily_stats (id, job_id, job_key, stats_date, "
