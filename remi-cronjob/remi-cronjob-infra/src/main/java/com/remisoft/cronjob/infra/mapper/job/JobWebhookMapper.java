 ...
 * 任务 Webhook Mapper
 *
 * <p>对应数据表 <code>remi_job_webhook</code>。
 ...
 * @since 1.0.0
 *
 * @see com.remisoft.cronjob.domain.entity.job.JobWebhook Webhook 实体
 * @see com.remisoft.cronjob.server.service.JobWebhookService Webhook Service
