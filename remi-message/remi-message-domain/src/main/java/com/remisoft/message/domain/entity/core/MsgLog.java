package com.remisoft.message.domain.entity.core;
 ...
 *
 * <p>对应数据库表 {@code remi_msg_log}，是消息中心的核心事实表。每条消息从创建到最终送达
 ...
 *   <li><b>状态</b>：{@code status}（{@link com.remisoft.message.domain.enums.core.MessageStatusEnum}）、
 *       {@code receiptStatus}（{@link com.remisoft.message.domain.enums.receipt.ReceiptStatusEnum}）、
 *       {@code recallStatus}（{@link com.remisoft.message.domain.enums.receipt.RecallStatusEnum}）</li>
 *   <li><b>重试</b>：{@code retryCount}（已重试次数）、{@code maxRetryCount}（最大重试次数）、
 *       {@code nextRetryAt}（下次重试时间，指数退避 + 随机抖动）</li>
 *   <li><b>优先级</b>：{@code priority}（{@link com.remisoft.message.domain.enums.core.MessagePriorityEnum}）</li>
 ...
 * @since 1.0.0
 *
 * @see com.remisoft.message.domain.enums.core.MessageStatusEnum 消息状态枚举
 * @see com.remisoft.message.domain.enums.core.MessageChannelEnum 消息通道枚举
 * @see com.remisoft.message.domain.enums.core.MessagePriorityEnum 消息优先级枚举
 */
@Data
@SuperBuilder
@NoArgsConstructor
@EqualsAndHashCode(callSuper = true)
@TableName("remi_msg_log")
public class MsgLog extends MpBaseEntity<String> {
    ...
    /** 聚合批次 ID(关联 remi_msg_aggregate.id) */
    private String batchId;

    /** 命中的路由规则 ID(关联 remi_msg_route_rule.id) */
