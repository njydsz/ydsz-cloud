package com.remisoft.message.domain.constant;
...
public final class MessageConstants {
    ...
    /** 消费幂等 key 前缀 */
    public static final String IDEMPOTENT_KEY_PREFIX = "remi:msg:idempotent:";

    /** 消费幂等 TTL（秒），覆盖 RocketMQ 重投窗口 */
    public static final long IDEMPOTENT_TTL_SECONDS = 600L;

    /** 限流 key 前缀 */
    public static final String RATE_LIMIT_KEY_PREFIX = "remi:msg:ratelimit:";

    /** P2-5: 多维度限流 key 前缀 */
    public static final String RATE_LIMIT_RECEIVER_PREFIX = "remi:msg:ratelimit:receiver:";
    public static final String RATE_LIMIT_TEMPLATE_PREFIX = "remi:msg:ratelimit:template:";
    public static final String RATE_LIMIT_TENANT_PREFIX = "remi:msg:ratelimit:tenant:";

    /** P2-1: 智能去重 key 前缀（SET NX EX 原子去重） */
    public static final String DEDUP_KEY_PREFIX = "remi:msg:dedup:";

    /** 聚合批次锁前缀 */
    public static final String AGGREGATE_LOCK_PREFIX = "remi:msg:aggregate:lock:";

    /** 路由规则缓存 key */
    public static final String ROUTE_RULE_CACHE_KEY = "remi:msg:route:rules";

    /** 灰度桶缓存 key 前缀 */
    public static final String CANARY_CACHE_PREFIX = "remi:msg:canary:";

    /** 频率统计 key 前缀（每日 / 每小时） */
    public static final String FREQUENCY_DAILY_PREFIX = "remi:msg:freq:daily:";
    public static final String FREQUENCY_HOURLY_PREFIX = "remi:msg:freq:hourly:";
    ...
    /** 重试扫描分布式锁 key */
    public static final String RETRY_SCAN_LOCK_KEY = "remi:msg:retry:scan:lock";

    /** 聚合批次扫描分布式锁 key (P2-4: 多实例部署保证唯一执行) */
    public static final String AGGREGATE_SCAN_LOCK_KEY = "remi:msg:aggregate:scan:lock";
    ...
    public static final String RECEIPT_PULL_LOCK_KEY = "remi:msg:receipt:pull:lock";
    ...
    // WebSocket 相关常量已迁移到 com.remisoft.common.socket.constant.WebSocketConstants
}
