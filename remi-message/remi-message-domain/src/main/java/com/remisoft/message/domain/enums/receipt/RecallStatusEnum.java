package com.remisoft.message.domain.enums.receipt;


/**
 * 消息撤回状态枚举
 *
 * <p>对应 SQL {@code remi_msg_log.recall_status} 的 CHECK 约束取值。
 ...
 * （默认 24 小时内，由 {@code remi.message.recall-timeout-hours} 配置）。
 *
 * @author remi-team
 * @since 1.0.0
 */
