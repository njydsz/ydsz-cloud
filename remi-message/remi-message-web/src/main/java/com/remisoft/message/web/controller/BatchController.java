...
import com.remisoft.message.server.service.batch.BatchService;
 ...
 *
 * <p>提供<b>异步批量发送</b>的 HTTP API，是 remi-message 处理大量通知的核心入口。
 ...
 * 系统按 (userId, contact) 解析每个接收人的发送地址，逐条生成 {@code remi_msg_log} 后批量提交到 MQ。
 *
 ...
 * @author remi-team
 * @since 1.0.0
 * @see com.remisoft.message.server.service.batch.BatchService 批量发送服务
 * @see com.remisoft.message.domain.entity.batch.MsgBatch 批次实体
 */
@Slf4j
...
public class BatchController {
    ...
    @Idempotent(key = "remi:message:BatchController:submitBatch:lock", ttlSeconds = 5)
