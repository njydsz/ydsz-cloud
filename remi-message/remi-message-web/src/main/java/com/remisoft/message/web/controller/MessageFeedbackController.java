...
import com.remisoft.message.domain.dto.core.MessageFeedbackDTO;
import com.remisoft.message.domain.entity.config.MsgFeedback;
import com.remisoft.message.domain.vo.MsgFeedbackVO;
import com.remisoft.message.server.service.core.MessageFeedbackService;
 ...
 * @author remi-team
 * @since 1.0.0
 * @see com.remisoft.message.server.service.core.MessageFeedbackService 消息反馈服务
 * @see com.remisoft.message.domain.entity.config.MsgFeedback 反馈实体
 */
...
public class MessageFeedbackController {
    ...
    @Idempotent(key = "remi:message:MessageFeedbackController:submitFeedback:lock", ttlSeconds = 5)
