package com.remisoft.message.web.controller.archive;
...
import com.remisoft.message.server.service.archive.MessageArchiveService;
 ...
 * </ul>
 *
 * <p><b>多租户隔离：</b>所有查询按 {@link com.remisoft.common.security.TenantContext#getTenantId()} 当前租户过滤，
 * 跨租户日志不可见。
 *
 * <p><b>性能特性：</b>
 * <ul>
 ...
 * @author remi-team
 * @since 1.0.0
 * @see com.remisoft.message.server.service.archive.MessageArchiveService 消息归档服务
