 ...
 * </ul>
 *
 * <p><b>token 格式：</b>由 {@link com.remisoft.message.server.token.UnsubscribeTokenService} 生成，
 ...
 * @author remi-team
 * @since 1.0.0
 * @see com.remisoft.message.server.service.config.UnsubscribeService 退订服务
 * @see com.remisoft.message.server.token.UnsubscribeTokenPayload 退订 token 载荷
 */
@Slf4j
...
public class UnsubscribeController {
    ...
    @Idempotent(key = "remi:message:UnsubscribeController:oneClick:lock", ttlSeconds = 5)
    ...
    @AuthApiPermission(apiCodes = PermissionCodes.MESSAGE_UNSUBSCRIBE_ACT)
    @Idempotent(key = "remi:message:UnsubscribeController:resubscribe:lock", ttlSeconds = 5)
