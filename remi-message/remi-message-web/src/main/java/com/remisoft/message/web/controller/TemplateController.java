...
import com.remisoft.message.domain.vo.MsgTemplateVO;
...
public class TemplateController {
    ...
    @Idempotent(key = "remi:message:TemplateController:create:lock", ttlSeconds = 5)
    ...
    @Idempotent(key = "remi:message:TemplateController:update:lock", ttlSeconds = 5)
    ...
    @Idempotent(key = "remi:message:TemplateController:delete:lock", ttlSeconds = 5)
    ...
    @Idempotent(key = "remi:message:TemplateController:audit:lock", ttlSeconds = 5)
