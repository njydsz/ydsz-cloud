package com.remisoft.message.web.controller.canary;
 ...
 * @author remi-team
 * @since 1.0.0
 * @see com.remisoft.message.server.service.canary.CanaryService 灰度桶服务
 * @see com.remisoft.message.domain.entity.canary.MsgCanary 灰度桶实体
 */
...
public class CanaryController {
    ...
    @Idempotent(key = "remi:message:CanaryController:upsert:lock", ttlSeconds = 5)
