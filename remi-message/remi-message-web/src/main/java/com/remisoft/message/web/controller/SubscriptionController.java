 ...
 *   <li>用户订阅「我审批的」主题，remi-workflow 待办变更自动推送给该用户</li>
 * </ul>
 *
 ...
 * @author remi-team
 * @since 1.0.0
 * @see com.remisoft.message.server.service.config.SubscriptionService 订阅服务
...
public class SubscriptionController {
    ...
    @Idempotent(key = "remi:message:SubscriptionController:upsert:lock", ttlSeconds = 5)
    ...
    @Idempotent(key = "remi:message:SubscriptionController:unsubscribe:lock", ttlSeconds = 5)
