 ...
 * </ul>
 *
 * <p>配置项 {@code remi.message.tcp-push.enabled=true} 启用，
 * 端口通过 {@code remi.message.tcp-push.port} 配置（默认 9123）。
 *
 * @author remi-team
 * @since 1.0.0
 */
...
@ConditionalOnProperty(prefix = "remi.message.tcp-push", name = "enabled", havingValue = "true")
