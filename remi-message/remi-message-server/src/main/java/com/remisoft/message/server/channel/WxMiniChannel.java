...
@Slf4j
@Component
@ConditionalOnProperty(prefix = "remi.message.wx-mini", name = "provider", havingValue = "wechat", matchIfMissing = false)
public class WxMiniChannel implements MessageChannel {
    ...
    private static final String ACCESS_TOKEN_CACHE_KEY = "remi:wx:mini:access_token";
