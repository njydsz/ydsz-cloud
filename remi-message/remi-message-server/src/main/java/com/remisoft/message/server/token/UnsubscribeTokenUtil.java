package com.remisoft.message.server.token;
...
public class UnsubscribeTokenUtil {
    ...
    /** 开发环境默认密钥（生产必须通过 remi.message.unsubscribe.secret 覆盖） */
    private static final String DEFAULT_SECRET = "remi-default-unsubscribe-secret-DO-NOT-USE-IN-PROD-CHANGE-IT";
     ...
     * 拼接完整退订链接。
     *
     * <p>当 {@code remi.message.unsubscribe.base-url} 未配置时返回 token 本身。
     *
     * @param token token 字符串
