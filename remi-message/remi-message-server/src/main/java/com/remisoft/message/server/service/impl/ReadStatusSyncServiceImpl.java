...
public class ReadStatusSyncServiceImpl implements ReadStatusSyncService {
     ...
     * @throws com.remisoft.common.exception.custom.SysException msgId 或 userId 为空时
     */
    @Override
     ...
     * @throws com.remisoft.common.exception.custom.SysException notificationId 或 userId 为空时
     */
    @Override
    @Transactional(rollbackFor = Exception.class)
