 ...
 * <ul>
 *   <li>活跃度 Bitmap: {@code remi:activity:{userId}} → Bitmap(24*7=168 bits, hour-of-week)</li>
 *   <li>活跃计数: {@code remi:activity:count:{userId}} → 最近 7 天活跃次数</li>
 *   <li>小时维度计数: {@code remi:activity:hourly:{userId}} → Hash(hour→count, 0-23)</li>
 * </ul>
 *
 * <p>推荐策略：
 * <ol>
...
public class DeliveryTimeOptimizerImpl implements DeliveryTimeOptimizer {
    ...
    /** Redis key 前缀 */
    private static final String ACTIVITY_HOURLY_PREFIX = "remi:activity:hourly:";
    private static final String ACTIVITY_COUNT_PREFIX = "remi:activity:count:";
