...
import com.remisoft.message.server.event.DeadLetterAlertEvent;
 ...
 * 消息日志服务实现。
 *
 * <p>管理消息发送全链路日志 ({@code remi_msg_log})：发送、送达、读取、点击、退订、失败、批量 ID。
 *
...
public class MessageLogServiceImpl implements MessageLogService {
    ...
    private MessageStatusEnum parseStatus(String value) {
        try {
            ...
            throw new SysException(BaseResultCode.BAD_REQUEST, "非法消息状态: " + value);
        }
    }
}
