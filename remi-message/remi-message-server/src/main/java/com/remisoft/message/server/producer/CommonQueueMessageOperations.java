package com.remisoft.message.server.producer;
 ...
 *
 * <p>当 {@code remi.message.mq-type=common-queue} 且 classpath 存在
...
@ConditionalOnProperty(prefix = "remi.message", name = "mq-type", havingValue = "common-queue")
