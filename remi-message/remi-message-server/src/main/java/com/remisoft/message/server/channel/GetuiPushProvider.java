 ...
 *
 * <p>仅当 {@code remi.message.push.provider=getui} 时装配；凭证缺失时返回 fail
 * （由 {@link com.remisoft.message.server.channel.impl.PushChannel} 自动降级到 Mock）。
 *
...
@Slf4j
@Component
@ConditionalOnProperty(prefix = "remi.message.push", name = "provider", havingValue = "getui")
