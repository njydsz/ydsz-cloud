...
import com.remisoft.message.server.service.core.MsgLogArchiveService;
...
@EnableScheduling
@ConditionalOnProperty(prefix = "remi.message", name = "archive-enabled", havingValue = "true", matchIfMissing = true)
public class MsgLogArchiveServiceImpl implements MsgLogArchiveService {

    /** 父表名 */
    private static final String PARENT_TABLE = "remi_msg_log";
    /** 分区名前缀 */
    private static final String PARTITION_PREFIX = "remi_msg_log_y";
    /** 归档表名前缀 */
    private static final String ARCHIVE_PREFIX = "remi_msg_log_archive_";
     ...
     */
    @Scheduled(cron = "${remi.message.archive-cron:0 30 2 1 * *}")
    ...
    /**
     * 生成分区名: {@code remi_msg_log_y2026m05}。
     *
     * @param year  年
     * @param month 月(1-12)
     * @return 分区名
    ...
    /**
     * 生成归档表名: {@code remi_msg_log_archive_202605}。
     *
     * @param year  年
     * @param month 月(1-12)
     * @return 归档表名
