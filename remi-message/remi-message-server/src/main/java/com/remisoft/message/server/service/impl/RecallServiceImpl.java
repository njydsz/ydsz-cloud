package com.remisoft.message.server.service.impl.receipt;
...
import com.remisoft.message.infra.mapper.core.MsgNotificationMapper;
import com.remisoft.message.server.realtime.RealtimePushService;
import com.remisoft.message.server.service.core.MessageLogService;
import com.remisoft.message.server.service.core.MessageTraceService;
import com.remisoft.message.server.service.impl.MessageRecallPushService;
 ...
 *
 * <p>邮件/站内信标记为 RECALLED。撤回记录写入 {@code remi_msg_log} 状态变更轨迹。
 *
 * @author remi-team
 * @since 1.0.0
 */
...
public class RecallServiceImpl implements RecallService {
     ...
     * @return true 表示撤回成功
     * @throws com.remisoft.common.exception.custom.SysException 参数为空 / 通知不存在 / 越权时
     */
    @Override
     ...
     * @param logId 消息日志 ID
     * @return true 表示撤回成功
     * @throws com.remisoft.common.exception.custom.SysException logId 为空时
     */
    @Override
     ...
     * @param bizId   单据 ID
     * @return 实际撤回的通知数 + 消息数
     * @throws com.remisoft.common.exception.custom.SysException bizType 或 bizId 为空时
     */
    @Override
    @Transactional(rollbackFor = Exception.class)
