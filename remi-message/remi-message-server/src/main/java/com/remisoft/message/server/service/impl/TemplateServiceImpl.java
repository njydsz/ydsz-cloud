package com.remisoft.message.server.service.impl.template;
...
import com.remisoft.message.domain.dto.template.TemplateAuditDTO;
import com.remisoft.message.domain.dto.template.TemplateCreateDTO;
import com.remisoft.message.domain.dto.template.TemplateQueryDTO;
import com.remisoft.message.domain.entity.template.MsgTemplate;
import com.remisoft.message.domain.enums.template.TemplateAuditStatusEnum;
import com.remisoft.message.infra.mapper.template.MsgTemplateMapper;
 ...
 * 消息模板服务实现。
 *
 * <p>维护消息模板 ({@code remi_msg_template} / {@code remi_msg_template_version})：
 *
...
public class TemplateServiceImpl implements TemplateService {
     ...
     * @return 已创建的模板实体
     * @throws com.remisoft.common.exception.custom.SysException 参数为空 / 编码或通道为空 / 模板已存在时
     */
    @Override
     ...
     * @return 更新后的模板实体
     * @throws com.remisoft.common.exception.custom.SysException id 为空 / dto 为空 / 模板不存在时
     */
    @Override
     ...
     * @throws com.remisoft.common.exception.custom.SysException id 为空时
     */
    @Override
     ...
     * @param id 模板 ID
     * @return 模板实体
     * @throws com.remisoft.common.exception.custom.SysException id 为空 / 模板不存在时
     */
    @Override
     ...
     * @throws com.remisoft.common.exception.custom.SysException templateCode 或 channel 为空时
     */
    @Override
     ...
     * @throws com.remisoft.common.exception.custom.SysException 参数为空 / 非法流转时
     */
    @Override
     ...
     * @return 渲染后的模板内容
     * @throws com.remisoft.common.exception.custom.SysException templateCode/channel 为空 / 模板不存在时
     */
    @Override
