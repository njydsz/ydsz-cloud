...
import com.remisoft.message.domain.enums.core.MessagePriorityEnum;
 ...
 * {@link RedisRateLimiter}（remi-common-redis 公共能力），统一全项目限流技术栈。
 *
...
public class RateLimitServiceImpl implements RateLimitService {
     ...
     * </ul>
     */
    @Value("${remi.message.rate-limit.fail-open:true}")
