...
import com.remisoft.message.domain.dto.core.UserReachProfileDTO;
import com.remisoft.message.server.service.core.ReachStrategyService;
...
public class ReachStrategyServiceImpl implements ReachStrategyService {
    ...
    /** Redis 画像缓存 key 前缀 */
    private static final String PROFILE_KEY_PREFIX = "remi:reach:profile:";
