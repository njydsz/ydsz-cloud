...
import com.remisoft.message.domain.dto.core.MessageSendDTO;
import com.remisoft.message.domain.dto.core.RichMediaContent;
...
import com.remisoft.message.domain.enums.receipt.RecallStatusEnum;
...
import com.remisoft.message.server.config.RetryStrategyResolver;
import com.remisoft.message.server.filter.SensitiveWordFilter;
import com.remisoft.message.server.metric.MessageMetrics;
import com.remisoft.message.server.producer.MessageQueueOperations;
import com.remisoft.message.server.service.batch.AggregateService;
import com.remisoft.message.server.service.canary.CanaryService;
...
import com.remisoft.message.server.service.config.UserChannelBindingService;
import com.remisoft.message.server.service.config.VariableSourceResolver;
import com.remisoft.message.server.service.core.DedupService;
import com.remisoft.message.server.service.core.DeliveryTimeOptimizer;
...
import com.remisoft.message.server.service.core.RateLimitService;
import com.remisoft.message.server.service.impl.AggregatePersistenceService;
import com.remisoft.message.server.service.impl.ChannelSuppressionEngine;
import com.remisoft.message.server.service.impl.DndService;
import com.remisoft.message.server.service.impl.EmailBounceHandler;
import com.remisoft.message.server.service.impl.ParallelBatchSender;
import com.remisoft.message.server.service.impl.SenderQuotaService;
import com.remisoft.message.server.service.template.TemplateService;
import com.remisoft.message.server.template.RichMediaRenderer;
import com.remisoft.message.server.template.TemplateEngine;
import com.remisoft.message.server.template.TemplateVariableValidator;
 ...
 * 消息服务实现（核心）。
 *
 * <p>统一的消息发送入口：根据 {@code remi_message_service} 配置选择渠道策略 → 渲染模板 → 解析变量 → 
 *
...
public class MessageServiceImpl implements MessageService {
     ...
     * 半消息发送后由 {@link com.remisoft.message.server.producer.MessageTransactionListener}
