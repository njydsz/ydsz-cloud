 ...
 * 启用加签安全模式时，需配置 {@code remi.channel.dingtalk.secret}，通道会自动计算
 ...
 *   <li>{@code remi.channel.dingtalk.default-token}（兜底）</li>
 * </ol>
 *
 * @author remi-team
 * @since 1.0.0
...
public class DingTalkChannel implements MessageChannel {
    ...
    /**
     * 注入配置后按 {@code remi.channel.dingtalk.connect-timeout / read-timeout} 构建 RestClient。
     */
    @PostConstruct
    public void init() {
