 ...
 * 消息轨迹 Mapper
 *
 * <p>对应数据表 <code>remi_msg_trace</code>。
 * <p>轨迹按时间线记录消息的关键事件（创建/调度/发送/送达/已读/点击/失败/重试），用于消息全链路追踪与排查。
 *
 * <p><b>主要索引：</b>
 * <ul>
 *   <li>idx_msg_id — 消息维度查询索引（按时间排序）</li>
 *   <li>idx_trace_at — 轨迹时间排序索引</li>
 * </ul>
 *
 ...
 * @see com.remisoft.message.server.service.MsgTraceService 轨迹 Service
