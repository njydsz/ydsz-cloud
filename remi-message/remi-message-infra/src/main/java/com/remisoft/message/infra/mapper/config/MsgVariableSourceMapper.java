 ...
 * 消息变量数据源 Mapper
 *
 * <p>对应数据表 <code>remi_msg_variable_source</code>。
 ...
 * @since 1.0.0
 *
 * @see com.remisoft.message.domain.entity.config.MsgVariableSource 变量源实体
 * @see com.remisoft.message.server.service.MsgVariableSourceService 变量源 Service
