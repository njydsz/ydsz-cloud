 ...
 * 邮件通道实现。
 *
 * <p>通过 {@link JavaMailSender} 发送邮件，自动识别 HTML（内容含 {@code <}）或纯文本格式。 发件人取 {@code
...
public class EmailChannel implements MessageChannel {
   ...
   *
   * <ul>
   *   <li>HTML 邮件注入追踪像素（已读回执）
   *   <li>支持附件：通过 channelMeta.attachments 传入（Base64 编码）
   *   <li>支持内嵌图片：通过 channelMeta.inlineImages 传入
   *   <li>注入 List-Unsubscribe 头（退订支持）
   * </ul>
   *
   * @param request 消息请求
