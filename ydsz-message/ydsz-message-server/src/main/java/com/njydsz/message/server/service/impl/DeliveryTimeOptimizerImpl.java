 ...
 * <ul>
 *   <li>活跃度 Bitmap: {@code ydsz:activity:{userId}} → Bitmap(24*7=168 bits, hour-of-week)</li>
 *   <li>活跃计数: {@code ydsz:activity:count:{userId}} → 最近 7 天活跃次数</li>
 *   <li>小时维度计数: {@code ydsz:activity:hourly:{userId}} → Hash(hour→count, 0-23)</li>
 * </ul>
 *
 * <p>推荐策略：
 * <ol>
