 ...
 * 死信告警事件（P1-4）。
 *
 * <p>当指定时间窗口内某通道死信数量达到 {@link MessageProperties.DeadLetterAlertConfig#getThreshold()} 时由 {@code
 * MessageLogServiceImpl.markDead} 发布，由 {@link DeadLetterAlertListener} 消费执行告警动作（日志告警 / 钉钉机器人 /
 * 邮件等，可扩展）。
 *
 * @author ydsz-team
 * @since 1.0.0
