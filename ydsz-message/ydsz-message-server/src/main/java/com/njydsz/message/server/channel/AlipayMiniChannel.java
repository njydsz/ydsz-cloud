...
@Slf4j
@Component
@ConditionalOnProperty(prefix = "ydsz.message.alipay-mini", name = "provider", havingValue = "alipay", matchIfMissing = false)
public class AlipayMiniChannel implements MessageChannel {
    ...
    public MessageResult send(MessageRequest request) {
        ...
        try {
            ...
            // 解析响应（支付宝返回 JSON）
            Map<String, Object> result = YdszJson.fromJson(respBody, new JsonType<Map<String, Object>>() {});
            if (result != null) {
