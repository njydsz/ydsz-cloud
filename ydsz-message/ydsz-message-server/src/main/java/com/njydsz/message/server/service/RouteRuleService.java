 ...
 * 消息路由规则 Service
 *
 * <p>基于 SpEL 表达式的「消息 → 通道/模板」路由能力。在多通道、多模板并存时, 路由规则按 {@code priority} 升序匹配,首个 SpEL
 * 求值命中的规则决定最终通道和模板, 实现"什么样的消息走哪个通道发什么内容"的灵活配置。
 *
 * <p><b>核心职责：</b>
 *
 * <ul>
 ...
 *       #page}
 *   <li><b>启用规则查询</b>：{@link #listEnabled} — 内存中按 priority 升序缓存
 *   <li><b>匹配</b>：{@link #match} — SpEL 求值命中即返回,未命中返回 null
 * </ul>
 *
