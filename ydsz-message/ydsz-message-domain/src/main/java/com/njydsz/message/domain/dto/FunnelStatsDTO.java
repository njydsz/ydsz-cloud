 ...
 *
 * <ol>
 *   <li>sent（已发送）：status = SUCCESS 的消息总量
 *   <li>delivered（已送达）：receiptStatus IN (DELIVERED, READ, CLICKED)
 *   <li>read（已读）：receiptStatus IN (READ, CLICKED)
 *   <li>clicked（已点击）：receiptStatus = CLICKED
 * </ol>
 *
