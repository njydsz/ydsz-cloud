 ...
 *
 * <p>提供所有消息模块 Entity → VO 的转换方法。 MpBaseEntity
 * 的自动填充字段（deleted/revision/tenantId/createdBy/createdAt/updatedBy/updatedAt） 在 entityToVO 方向无需
 * ignore（VO 中不存在的字段自动忽略），仅 DTO→Entity 方向需要 ignore。
 *
 * @author ydsz-team
 * @since 1.0.0
 */
