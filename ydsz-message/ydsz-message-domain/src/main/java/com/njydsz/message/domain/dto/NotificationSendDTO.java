...
public class NotificationSendDTO {
  ...
  /** 接收人 ID(单发) */
  @Xss private String receiverId;

  /** 接收人 ID 列表(群发) */
  private List<String> receiverIds;

  /** 通知标题 */
  @Xss private String title;

  /** 通知内容 */
  private String content;

  /** 通知级别: INFO/WARN/ERROR/URGENT */
  @Xss private String level;
  ...
  /** 点击跳转 URL */
  @Xss private String actionUrl;

  /** 跳转按钮文案 */
  @Xss private String actionText;

  /** 通知图标标识 */
  @Xss private String icon;

  /** 扩展字段 JSON */
  @Xss private String extra;

  /** 来源模块 */
  @Xss private String sourceModule;
