...
/**
 * 消息发送结果 VO（替代旧 {@code com.njydsz.common.feign.MessageResult}）。
 *
 * <p>错误消息分层：
 *
 * <ul>
 ...
 * @since 26.09.21
 */
public class MessageSendResultVO implements Serializable {
   ...
   * @return 成功结果
   */
  public static MessageSendResultVO ok(String channel, String traceId) {
   ...
   * @return 失败结果
   */
  public static MessageSendResultVO fail(
