 ...
 *
 * <p>替代已弃用的 {@code com.njydsz.common.feign.MessageRequest}，用于批量发送场景中的子请求项。
 * 字段与原始 {@code MessageRequest} 完全一致，仅做了包归属迁移以符合 DDD 分层（消息 DTO 不应散落于 common-feign）。
 *
 * @author ydsz-team
 * @since 26.09.25
 */
@Data
public class MessageItemRequestDTO implements Serializable {
  ...
  /** 级联子消息列表 */
  private List<MessageItemRequestDTO> cascadeTo;
