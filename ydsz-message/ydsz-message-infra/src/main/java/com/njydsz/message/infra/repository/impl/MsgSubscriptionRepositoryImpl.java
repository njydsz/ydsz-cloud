...
public class MsgSubscriptionRepositoryImpl implements MsgSubscriptionRepository {
  ...
  @Override
  public IPage<MsgSubscriptionVO> findPage(MsgSubscriptionQuery query) {
    ...
    Page<MsgSubscriptionVO> voPage = new Page<>(entityPage.getCurrent(), entityPage.getSize(), entityPage.getTotal());
