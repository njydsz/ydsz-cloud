 ...
 * 是用户中心服务（remi-userinfo）最核心的 Service，被各业务模块通过
 ...
 * <p><b>Feign 远程调用契约：</b>
 * <ul>
 *   <li>本接口中所有 {@code listXxxByXxxId} 方法可被工作流服务（remi-workflow）调用，
 ...
 * @see com.remisoft.userinfo.api.UserAccountClient Feign Client 接口
 */
public interface UserAccountService {
     ...
     * @throws com.remisoft.common.exception.BizException 用户名已存在时抛出
     */
     ...
     * @return true=成功
     * @throws com.remisoft.common.exception.BizException 旧密码错误时抛出
     */
     ...
     *
     * <p>实现：单条 SQL {@code SELECT id, real_name FROM remi_user_account WHERE id IN (...)}，
