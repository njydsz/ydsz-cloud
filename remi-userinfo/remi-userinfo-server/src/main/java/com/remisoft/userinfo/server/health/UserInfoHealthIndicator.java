package com.remisoft.userinfo.server.health;
...
@ConditionalOnProperty(prefix = "remi.userinfo", name = "health-enabled", havingValue = "true", matchIfMissing = true)
...
public class UserInfoHealthIndicator extends AbstractModuleHealthIndicator {
    ...
    protected void doHealthCheck(Health.Builder builder) {
        // Redis 连通性
        checkRedis(builder, () -> {
            redisService.hasKey("remi:userinfo:health:probe");
            return "PONG";
        });
