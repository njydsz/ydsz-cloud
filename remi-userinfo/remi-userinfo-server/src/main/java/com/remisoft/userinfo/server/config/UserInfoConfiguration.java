...
import com.remisoft.userinfo.server.health.UserInfoHealthIndicator;

/**
 * 用户信息中心模块配置
 *
 * <p>统一管理 remi-userinfo 微服务的横切关注点：密码编码器、异步任务、缓存、配置属性注册。
 * 该 Configuration 由 remi-userinfo-server 的 Spring Boot 启动类通过 @Import 或
 * 组件扫描自动加载。
 *
 * <p><b>核心职责：</b>
 * <ul>
 ...
 * @see com.remisoft.userinfo.UserInfoApplication remi-userinfo 启动类
 */
@Configuration
@EnableAsync
@EnableCaching
