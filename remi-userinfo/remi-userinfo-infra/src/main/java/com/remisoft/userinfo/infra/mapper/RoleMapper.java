 ...
 * 角色 Mapper 接口
 *
 * <p>对应数据表 {@code remi_role}，存储 RBAC 模型中的角色。
 * 角色是「权限集合」概念，一个角色包含多个权限（{@code remi_menu}），多个用户可属于同一角色。
 *
 ...
 * @since 1.0.0
 *
 * @see com.remisoft.userinfo.domain.entity.Role 角色实体（含 dataScope 数据权限范围字段）
 * @see com.remisoft.userinfo.infra.mapper.RolePermissionMapper 角色-权限关联 Mapper
 * @see com.remisoft.userinfo.infra.mapper.UserRoleMapper 用户-角色关联 Mapper
 */
@Mapper
