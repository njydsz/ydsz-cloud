 ...
 * 用户自定义字段 Mapper
 *
 * <p>对应数据表 <code>remi_user_field</code>，存储用户表的扩展字段定义。</p>
 ...
 * @since 1.0.0
 *
 * @see com.remisoft.userinfo.domain.entity.UserField 用户扩展字段实体
 * @see com.remisoft.userinfo.server.service.UserFieldService 用户扩展字段 Service
