<!--
  @fileoverview BPMN 2.0 专业流程设计器（基于 bpmn-js）
  @description
    P0-01 引入 bpmn-js 替换自绘 SVG，对标炎黄盈动 / 奥哲 BPMN 建模工具。
    P1-02 新增自定义属性面板（Vue 组件式）：节点名称 / 审批人 / 会签 / 条件表达式 / SLA 等。
    能力：拖拽式 BPMN 2.0 建模、属性编辑、XML 导入导出、模板加载、
    dagre 自动布局（见 ./bpmn/autoLayout.ts）。
    配套自研工作流 v2 引擎，PC 端专用。
  @module views/workflow/components/BpmnDesigner
  @author ydsz-team
  @since 1.0.0
-->
