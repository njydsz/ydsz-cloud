 ...
 * @description 与后端 com.njydsz.common.permission.PermissionCodes 一一对应：
...
export const PC = {
  ...
  MESSAGE_TEMPLATE_VIEW: 'message:template:view',
  MESSAGE_TEMPLATE_CREATE: 'message:template:create',
  MESSAGE_TEMPLATE_UPDATE: 'message:template:update',
  MESSAGE_TEMPLATE_DELETE: 'message:template:delete',
  MESSAGE_TEMPLATE_APPROVE: 'message:template:approve',
  MESSAGE_ROUTE_RULE_LIST: 'message:route-rule:list',
  MESSAGE_ROUTE_RULE_VIEW: 'message:route-rule:view',
  MESSAGE_ROUTE_RULE_CREATE: 'message:route-rule:create',
  MESSAGE_ROUTE_RULE_UPDATE: 'message:route-rule:update',
  MESSAGE_ROUTE_RULE_DELETE: 'message:route-rule:delete',
  MESSAGE_DEAD_LETTER_VIEW: 'message:dead-letter:view',
  MESSAGE_DEAD_LETTER_RESEND: 'message:dead-letter:resend',
  MESSAGE_CANARY_VIEW: 'message:canary:view',
  MESSAGE_CANARY_UPDATE: 'message:canary:update',
  MESSAGE_CANARY_REPORT: 'message:canary:report',
  MESSAGE_AGGREGATE_LIST: 'message:aggregate:list',
