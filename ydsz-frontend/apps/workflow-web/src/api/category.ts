...
export function getCategoryPageApi(params: CategoryApi.CategoryPageQuery) {
  ...
  }>(`/api/workflow/categories/page`, { params });
}

/** 查询全部列表 */
export function getCategoryListApi() {
  return requestClient.get<CategoryApi.CategoryVO[]>(`/api/workflow/categories/list`);
}

/** 根据 ID 查询 */
export function getCategoryByIdApi(id: string) {
  return requestClient.get<CategoryApi.CategoryVO>(`/api/workflow/categories/${id}`);
}
...
export function updateCategoryApi(data: CategoryApi.CategoryDTO) {
  return requestClient.put<boolean>(`/api/workflow/categories`, data);
}

/** 删除 */
export function deleteCategoryApi(id: string) {
  return requestClient.delete<boolean>(`/api/workflow/categories/${id}`);
}
