...
public class AppInfoController {
    ...
    @Idempotent(key = "remi:system:AppInfoController:save:lock", ttlSeconds = 5)
    @PostMapping
    ...
    @Idempotent(key = "remi:system:AppInfoController:update:lock", ttlSeconds = 5)
    @PutMapping
    ...
    @Idempotent(key = "remi:system:AppInfoController:remove:lock", ttlSeconds = 5)
    @DeleteMapping("/{id}")
