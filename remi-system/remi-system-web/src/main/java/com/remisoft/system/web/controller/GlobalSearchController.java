 ...
 * <p><b>核心职责：</b>
 * <ul>
 *   <li><b>跨模块聚合</b>：单次请求并发查询多个 {@link com.remisoft.common.search.spi.SearchProvider}，
 *       合并结果按相关度排序</li>
 ...
 * @see com.remisoft.common.search.spi.SearchProvider 搜索 Provider SPI
...
public class GlobalSearchController {
     ...
     * 所有匹配的 {@link com.remisoft.common.search.spi.SearchProvider} → 聚合结果 → 权限过滤后返回。
