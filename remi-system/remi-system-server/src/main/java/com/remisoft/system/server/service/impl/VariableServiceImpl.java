...
import com.remisoft.system.infra.mapper.VariableMapper;
 ...
 *   <li>TTL 取自配置 {@code remi.system.variable.cache-ttl-minutes}，默认 5 分钟</li>
 ...
 *   <li><b>软删除</b>：{@code remi_variable} 表采用 <b>逻辑删除</b>（{@code deleted} 字段）</li>
...
public class VariableServiceImpl implements VariableService {
    ...
    /** 变量 Mapper（继承 {@code remi_variable} 表 CRUD） */
