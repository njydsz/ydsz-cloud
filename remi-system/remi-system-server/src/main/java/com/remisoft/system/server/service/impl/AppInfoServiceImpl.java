...
import com.remisoft.system.infra.mapper.AppInfoMapper;
 ...
 * 维护 {@code remi_app_info} 应用注册表，对标大厂「开放平台 / 应用市场」的 AppId/AppSecret 管理体系，
 ...
 * <p><b>设计要点：</b>
 * <ul>
 *   <li><b>密钥不返回</b>：{@link AppInfoVO} 中 {@code appSecret} 字段为 null（{@code @com.remisoft.common.json.annotation.JsonIgnore}），
 *       避免泄漏到前端 / 日志</li>
 *   <li><b>登录态隔离</b>：管理后台「应用列表」自动按当前用户部门 + 创建人过滤
 *       （{@code @DataScope}），避免越权查看</li>
 *   <li><b>软删除</b>：{@code remi_app_info} 表采用 <b>逻辑删除</b>（{@code deleted} 字段）</li>
 ...
 * @see com.remisoft.system.domain.entity.AppInfo 应用实体
 */
@Slf4j
@Service
...
public class AppInfoServiceImpl implements AppInfoService {
    ...
    /** 应用注册 Mapper（继承 {@code remi_app_info} 表 CRUD） */
     ...
     * 高频场景应配合 Redis 缓存（如 {@code remi:app:client:{appKey}}，TTL 5min）。
     *
