...
import com.remisoft.system.infra.repository.DictRepository;
 ...
 * 维护 {@code remi_dict_type} 字典类型表，是「字典项」（{@link DictItemServiceImpl}）的父级元数据，
 ...
 *       （{@code remi:dict:type:{typeCode}} / {@code remi:dict:full:{typeCode}}），
...
public class DictServiceImpl implements DictService {
     ...
     *   <li>插入 {@code remi_dict_type} 表</li>
     * </ol>
     *
     ...
     *   <li>更新 {@code remi_dict_type} 表</li>
     * </ol>
     *
     * <p><b>注意：</b>更新 {@code typeCode} 会导致所有依赖该编码的下游缓存失效，
     * 调用方需主动清理 {@code remi:dict:*} 相关 Redis key。
     *
