...
import com.remisoft.system.infra.mapper.DictVersionMapper;
import com.remisoft.system.server.service.DictVersionService;
 ...
 *       记录变更前的<b>全量字典项 JSON 快照</b>，写入 {@code remi_dict_version} 表</li>
 ...
 *   <li><b>软删除</b>：{@code remi_dict_version} 表采用 <b>逻辑删除</b>（{@code deleted} 字段），
 *       与物理删除不同</li>
 * </ul>
 *
 * <p><b>典型使用：</b>
 ...
 * @see com.remisoft.system.domain.vo.DictVersionVO 字典版本 VO
 */
@Slf4j
@Service
...
public class DictVersionServiceImpl implements DictVersionService {
    ...
    /** 字典版本 Mapper（继承 {@code remi_dict_version} 表 CRUD） */
     ...
     * </ul>
     *
     * @param typeCode 字典类型编码（{@code remi_dict_type.type_code}）
