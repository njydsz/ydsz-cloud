 ...
 * 系统变量 Service 接口
 *
 * <p>提供系统变量（{@code remi_variable}）的 CRUD、按 key 查询值、分页查询等能力。
 * 集成 Redis 缓存和缓存穿透防护。
 *
 * <p><b>核心职责：</b>
 * <ul>
 ...
 *       {@code @Value("${remi.variable.xxx}")} 占位符解析</li>
 ...
 * <p><b>缓存策略：</b>
 * <ul>
 *   <li>Redis 缓存（{@code remi:variable:{key}}），TTL 30min</li>
...
public interface VariableService {
     ...
     * 按变量键查询变量值（走缓存）
     *
     * <p>典型用法：业务代码中通过 {@code variableService.getVariableValue("remi.feature.xxx")}
