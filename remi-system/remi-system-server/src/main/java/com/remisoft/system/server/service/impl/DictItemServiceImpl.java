 ...
 *   <li><b>软删除</b>：{@code remi_dict_item} 表采用 <b>逻辑删除</b>（{@code deleted} 字段），
...
public class DictItemServiceImpl implements DictItemService {
    ...
    /** 字典项 Mapper（继承 {@code remi_dict_item} 表 CRUD） */
     ...
     *
     * @param parentId 父字典项 ID（{@code remi_dict_item.parent_id}）
     ...
     *   <li>插入 {@code remi_dict_item} 表</li>
     ...
     * <ol>
     *   <li>DTO 转 DO</li>
     *   <li>更新 {@code remi_dict_item} 表</li>
     ...
     * 序列化为 JSON 后写入 {@code remi_dict_version} 表，作为变更前的「基线」快照，
     * 支持后续版本回滚。
     *
     * @param typeCode  字典类型编码
