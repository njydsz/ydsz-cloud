 ...
 * 字典版本管理 Mapper
 *
 * <p>对应数据表 <code>remi_dict_version</code>。
 ...
 * @see com.remisoft.system.server.service.DictVersionService 字典版本 Service
...
public interface DictVersionMapper extends BaseMapper<DictVersion> {
     ...
     */
    @Select("SELECT * FROM remi_dict_version WHERE type_code = #{typeCode} AND deleted = 0 "
