 ...
 * 字典项 Mapper 接口
 *
 * <p>提供对 {@code remi_dict_item} 表的 CRUD 操作 + 高频查询自定义 SQL。
 ...
 * @see com.remisoft.system.server.service.DictItemService 字典项 Service
 */
@Mapper
public interface DictItemMapper extends BaseMapper<DictItem> {
     ...
     */
    @Select("SELECT * FROM remi_dict_item WHERE type_code = #{typeCode} AND item_code = #{itemCode} "
     ...
     */
    @Select("SELECT * FROM remi_dict_item WHERE type_code = #{typeCode} AND deleted = 0 AND status = 'ENABLED' "
