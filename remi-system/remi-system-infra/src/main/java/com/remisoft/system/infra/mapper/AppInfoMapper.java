 ...
 * 应用信息 Mapper
 *
 * <p>对应数据表 <code>remi_app_info</code>。
 * <p>应用是系统接入的子系统（业务模块/三方系统），AppId/Secret 用于 API 网关鉴权。
 *
 * <p><b>主要索引：</b>
 * <ul>
 *   <li>uk_app_id — AppId 唯一索引</li>
 * </ul>
 *
 ...
 * @see com.remisoft.system.server.service.AppInfoService 应用 Service
...
public interface AppInfoMapper extends BaseMapper<AppInfo> {
     ...
     */
    @Select("SELECT * FROM remi_app_info WHERE app_key = #{appKey} AND deleted = 0 AND status = 'ENABLED' LIMIT 1")
