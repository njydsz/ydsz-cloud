 ...
 * 字典类型 VO
 *
 * <p>对应 {@code remi_dict_type} 表的展示视图，是「字典中心」列表 / 详情接口的返回值类型。
 * 由 {@link com.remisoft.system.domain.converter.SystemConverter} 从
 * {@link com.remisoft.system.domain.entity.DictType} 实体转换而来。
 *
 * <p><b>字段语义：</b>
 * <ul>
 ...
 * @see com.remisoft.system.domain.dto.DictTypeDTO 字典类型 DTO
