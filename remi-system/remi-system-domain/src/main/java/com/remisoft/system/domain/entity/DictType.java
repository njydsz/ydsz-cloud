 ...
 * 字典类型实体
 *
 * <p>对应数据库表 {@code remi_dict_type}，存储数据字典分类信息。
 * 字典类型用于对系统中的枚举/常量进行统一管理（如性别、状态、级别、地区代码等），
 * 配合 {@link DictItem} 形成两级字典体系：
 * <pre>
 ...
 * </pre>
 *
 * <p><b>业务引用：</b>业务代码中通过 {@code typeCode} 引用字典类型（如注解 {@code @DictType("order_status")}），
 * 通过 {@link DictItem#getItemValue()} 获取具体枚举值。
 *
 ...
 * @see com.remisoft.system.server.service.DictVersionService 字典版本管理
 */
@Data
@SuperBuilder
@NoArgsConstructor
@EqualsAndHashCode(callSuper = true)
@TableName("remi_dict_type")
