 ...
 * 字典项 VO
 *
 * <p>对应 {@code remi_dict_item} 表的展示视图，是「字典中心」列表 / 详情接口的返回值类型，
 * 也是前端下拉框、单选框、级联选择器、Tag 组件的<b>核心数据载体</b>。
 *
 * <p>由 {@link com.remisoft.system.domain.converter.SystemConverter} 从
 * {@link com.remisoft.system.domain.entity.DictItem} 实体转换而来。
 *
 * <p><b>字段语义：</b>
 * <ul>
 ...
 * </ul>
 *
 * <p><b>缓存策略：</b>读取时按 {@code remi:dict:item:{typeCode}} 整体缓存至 Redis；
 ...
 * @see com.remisoft.system.domain.dto.DictItemDTO 字典项 DTO
