package com.remisoft.system.domain.query;
 ...
 * 字典类型分页查询参数
 *
 * <p>对应 {@code remi_dict_type} 表的分页查询条件，由 Controller 接收并透传给
 ...
 * </ul>
 *
 * <p><b>多租户：</b>租户过滤由 MyBatis 拦截器（{@code remi-common-jdbc}）自动注入，
 ...
 * @since 1.0.0
 *
 * @see com.remisoft.common.domain.query.PageQuery 父类（分页参数）
 * @see com.remisoft.system.server.service.DictTypeService 字典类型服务
 */
@Data
@SuperBuilder
@NoArgsConstructor
