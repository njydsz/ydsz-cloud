package com.remisoft.system.domain.enums;

/**
 * 配置值类型枚举
 *
 * <p>用于系统配置（{@code remi_config}）和系统变量（{@code remi_variable}）的值类型校验。
 ...
 *   <li>{@link #JSON} — JSON 对象 / 数组类型，写入时 {@code RemiJson.toJson}，读取时 {@code RemiJson.fromJson}</li>
 * </ul>
 *
 * <p><b>使用场景：</b>
 * <ul>
