 ...
 * 字典类型创建/更新 DTO
 *
 * <p>对应 {@code remi_dict_type} 表的写入参数。字典类型是「业务维度」的分类容器，
 ...
 *
 * <p><b>缓存策略：</b>字典类型通过 {@code remi:dict:type:{typeCode}} 缓存至 Redis；
 * 字典类型 + 字典项的「完整字典」通过 {@code remi:dict:full:{typeCode}} 整体缓存，
