package com.remisoft.literule.api.client;
...
import com.remisoft.literule.api.fallback.LiteRuleClientFallback;

/**
 * 规则引擎服务 Feign 客户端
 *
 * <p>供 {@code remi-project} / {@code remi-userinfo} / {@code remi-finance}
