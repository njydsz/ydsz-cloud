 ...
 * 表达式求值器接口
 *
 * <p>抽象表达式引擎，默认提供 {@link com.remisoft.literule.server.expr.liteexpr.LiteExprEvaluator}。
 *
 * @since 1.0.0
 * @author remi-team
 */
public interface ExpressionEvaluator {
     ...
     * 具体实现类（如 {@link com.remisoft.literule.server.expr.liteexpr.LiteExprEvaluator}）应 override 本方法提供详细错误信息。
     *
     * @param expression 表达式字符串
     * @return 校验结果
     * @since 1.0.0
