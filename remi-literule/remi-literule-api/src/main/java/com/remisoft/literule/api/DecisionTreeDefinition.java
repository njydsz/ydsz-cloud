 ...
 * </ul>
 *
 * <p>持久化于 {@code remi_rule_decision_tree}（见 V048，root_node 字段存储 JSON），
 * 由 {@code DecisionTreeConfigProvider} SPI 加载，
 * 通过 {@link com.remisoft.literule.server.impl.DecisionTreeRule#from(DecisionTreeDefinition, com.remisoft.literule.server.expr.ExpressionEvaluator)}
 * 转换为可执行规则。
 *
 * <p>JSON 示例：
 * <pre>
