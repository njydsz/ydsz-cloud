...
import com.remisoft.literule.infra.mapper.DecisionTableMapper;
import com.remisoft.literule.server.config.DecisionTableAdminService;
 ...
 * 决策表管理 Controller
 *
 * <p>业务背景：决策表（DMN 风格）是规则引擎的一种高级规则表达形式，
 * 适合表达多条件组合的判定逻辑。运营人员可通过 Excel 在线/离线编辑决策表，
 * 由引擎在运行时根据事实数据匹配命中行并返回动作值。
 *
 * <p>核心能力：
 * <ul>
 *   <li>决策表 CRUD</li>
 *   <li>决策表评估（按 tableCode 加载并执行 DMN 评估）</li>
 *   <li>Excel 导入/导出/模板下载</li>
 * </ul>
 *
