...
import com.remisoft.literule.server.spi.RuleConflictDetectorProvider;
 ...
 * 规则冲突检测 Controller
 *
 * <p>业务背景：随着规则数量增长，多条规则之间可能出现条件重叠、严重度矛盾、
 * 优先级倒挂等冲突，影响规则引擎的判定准确性。冲突检测器通过 SPI 由
 * project 模块提供实现，对当前生效规则集做静态分析并返回冲突对列表。
 *
