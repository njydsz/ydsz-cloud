 ...
 * <p>暴露的 Prometheus 指标：
 * <ul>
 *   <li>{@code remi_literule_rule_evaluations_total{rule_code,scenario}} — 评估总次数</li>
 *   <li>{@code remi_literule_rule_triggered_total{rule_code,severity}} — 触发总次数</li>
 *   <li>{@code remi_literule_rule_errors_total{rule_code}} — 异常总次数</li>
 *   <li>{@code remi_literule_rule_eval_duration{rule_code}} — 评估耗时分布（P50/P95/P99）</li>
 *   <li>{@code remi_literule_breaker_state{rule_code}} — 熔断状态（0/1/2）</li>
 *   <li>{@code remi_literule_trace_queue_size} — Trace 队列积压（Gauge）</li>
 *   <li>{@code remi_literule_registered_rules} — 当前注册规则数（Gauge）</li>
 *   <li>{@code remi_literule_evaluated_rules} — 单次评估遍历规则数（Gauge）</li>
 *   <li>{@code remi_literule_slow_rule_total{rule_code}} — 慢规则计数</li>
 * </ul>
 *
 * @since 1.1.0
 * @author remi-team
