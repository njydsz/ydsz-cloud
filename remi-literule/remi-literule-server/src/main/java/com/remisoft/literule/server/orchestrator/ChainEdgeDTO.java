package com.remisoft.literule.server.orchestrator;
 ...
 * <ul>
 *   <li><b>THEN</b> - 顺序流：source 执行完毕后执行 target</li>
 *   <li><b>IF_BRANCH</b> - 条件分支：source 是 IF/ELIF 节点，target 是分支动作节点，
 *       condition 字段携带分支条件表达式</li>
 *   <li><b>SWITCH_BRANCH</b> - 分支选择：source 是 SWITCH 节点，target 是分支节点，
 *       branchValue 字段携带分支 key</li>
 *   <li><b>FOR_ITER</b> - 循环迭代：source 是 FOR 节点，target 是循环体节点</li>
 *   <li><b>WHILE_ITER</b> - 条件循环：source 是 WHILE 节点，target 是循环体节点</li>
 *   <li><b>DEFAULT_BRANCH</b> - 默认分支：SWITCH/ELIF 未命中时执行的兜底分支</li>
 *   <li><b>GROUP_MEMBER</b> - 组成员：source 是 GROUP 节点，target 是组成员节点</li>
 * </ul>
 *
