 ...
 * 规则变量定义 DO
 *
 * <p>映射 remi_rule_variable_def 表，存储规则表达式中可引用的变量元数据。
 * 由 {@link com.remisoft.project.literule.DatabaseVariableRegistry} 加载，
 * 供 {@link com.remisoft.literule.server.expr.ExpressionValidationService} 做 UNDEFINED_VARIABLE 校验。
 *
 * @author remi-team
 * @since 1.0.0
 */
...
@TableName("remi_rule_variable_def")
