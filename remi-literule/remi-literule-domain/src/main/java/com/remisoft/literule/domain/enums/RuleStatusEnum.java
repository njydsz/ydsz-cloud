package com.remisoft.literule.domain.enums;
 ...
 * 规则生命周期状态枚举。
 *
 * <p>对应 {@code remi_rule_def.status} 字段（DRAFT / PUBLISHED / DISABLED），
 * 实现 {@link BaseStatusEnum} 契约，提供规则发布/下线状态流转校验。
 *
 * <p><b>状态流转：</b>
 * <pre>
...
public enum RuleStatusEnum implements BaseStatusEnum<RuleStatusEnum> {
     ...
     * <p>流转规则：
     * <ul>
     *   <li>DRAFT → PUBLISHED / DISABLED</li>
     *   <li>PUBLISHED → DISABLED / DRAFT（下线或重新编辑）</li>
     *   <li>DISABLED → DRAFT / PUBLISHED（重新编辑或直接恢复发布）</li>
     * </ul>
     *
     * @param target 目标状态
     * @return true 表示允许流转
