 ...
 * 规则变量定义 Mapper
 *
 * <p>对应数据表 <code>remi_rule_variable_def</code>。
 * <p>变量定义决定规则入参/出参的数据类型、来源、必填、约束，是规则配置的核心元数据。
 *
 * <p><b>主要索引：</b>
 * <ul>
 *   <li>uk_rule_var — (规则+变量名) 唯一索引</li>
 * </ul>
 *
 ...
 * @since 1.0.0
 *
 * @see com.remisoft.literule.domain.entity.RuleVariableDef 规则变量实体
 * @see com.remisoft.literule.server.service.RuleLifecycleService 规则生命周期 Service
...
public interface RuleVariableDefMapper extends BaseMapper<RuleVariableDef> {
     ...
     */
    @Select("SELECT * FROM remi_rule_variable_def WHERE var_name = #{varName} LIMIT 1")
