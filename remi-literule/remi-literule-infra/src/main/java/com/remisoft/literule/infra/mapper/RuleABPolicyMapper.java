 ...
 * 规则 A/B 策略 Mapper
 *
 * <p>对应数据表 <code>remi_rule_ab_policy</code>。
 ...
 * @since 1.0.0
 *
 * @see com.remisoft.literule.domain.entity.RuleABPolicy A/B 策略实体
 * @see com.remisoft.literule.server.service.RuleABPolicyService A/B Service
