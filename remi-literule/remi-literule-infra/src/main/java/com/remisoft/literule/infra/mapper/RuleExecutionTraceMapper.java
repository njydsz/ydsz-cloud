 ...
 * 规则执行轨迹 Mapper
 *
 * <p>对应数据表 <code>remi_rule_execution_trace</code>。
 ...
 * @since 1.0.0
 *
 * @see com.remisoft.literule.domain.entity.RuleExecutionTraceDO 执行轨迹实体
 * @see com.remisoft.literule.server.service.RuleExecutionTraceService 轨迹 Service
...
public interface RuleExecutionTraceMapper extends BaseMapper<RuleExecutionTraceDO> {
    ...
    @Select("""
            ...
            FROM remi_rule_execution_trace
