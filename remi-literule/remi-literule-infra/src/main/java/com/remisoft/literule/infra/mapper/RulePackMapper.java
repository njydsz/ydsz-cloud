 ...
 * 规则包 Mapper
 *
 * <p>对应数据表 <code>remi_rule_pack</code>。
 ...
 * @since 1.0.0
 *
 * @see com.remisoft.literule.domain.entity.RulePackDO 规则包实体
 * @see com.remisoft.literule.server.service.RulePackService 规则包 Service
