 ...
 * 规则版本历史 Mapper
 *
 * <p>对应数据表 <code>remi_rule_version_history</code>。
 * <p>规则版本管理：每次发布生成快照（DSL+配置），支持回滚、对比、A/B 实验。
 *
 * <p><b>主要索引：</b>
 * <ul>
 *   <li>uk_rule_version — (规则+版本号) 唯一索引</li>
 *   <li>idx_publish_at — 发布时间排序索引</li>
 * </ul>
 *
 ...
 * @since 1.0.0
 *
 * @see com.remisoft.literule.domain.entity.RuleVersionHistory 规则版本实体
