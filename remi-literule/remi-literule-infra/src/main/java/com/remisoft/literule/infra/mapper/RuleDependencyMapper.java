 ...
 * 规则依赖关系 Mapper
 *
 * <p>对应数据表 <code>remi_rule_dependency</code>。
 * <p>规则依赖决定规则的执行顺序（DAG），避免循环依赖，是规则编排的核心元数据。
 *
 * <p><b>主要索引：</b>
 * <ul>
 *   <li>uk_rule_dep — (规则+依赖规则) 唯一索引</li>
 * </ul>
 *
 ...
 * @since 1.0.0
 *
 * @see com.remisoft.literule.domain.entity.RuleDependency 规则依赖实体
 * @see com.remisoft.literule.server.service.RuleDependencyService 规则依赖 Service
