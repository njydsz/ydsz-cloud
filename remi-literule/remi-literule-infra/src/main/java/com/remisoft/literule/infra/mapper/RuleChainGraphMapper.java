 ...
 * 规则链 Mapper
 *
 * <p>对应数据表 <code>remi_rule_chain_graph</code>。
 ...
 * @since 1.0.0
 *
 * @see com.remisoft.literule.domain.entity.RuleChainGraphDO 规则链实体
 * @see com.remisoft.literule.server.service.RuleChainGraphService 规则链 Service
