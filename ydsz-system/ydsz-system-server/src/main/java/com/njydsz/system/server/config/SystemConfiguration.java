 ...
 * <ul>
 *   <li>注册 {@link SystemProperties}（{@code @ConfigurationProperties(prefix = "ydsz.system")}），
 *       通过 {@code @EnableConfigurationProperties} 激活</li>
 *   <li>注册 {@link BCryptPasswordEncoder} Bean，强度由
 *       {@code ydsz.system.app.bcrypt-strength} 配置（合法范围 4-31，默认 10）</li>
 * </ul>
 *
 * <p><b>BCrypt 强度建议：</b>
 * <ul>
...
public class SystemConfiguration {
     ...
     * BCrypt 密码编码器 Bean
     *
     * <p>用于 {@link com.njydsz.system.server.service.AppInfoService} 加密 {@code appSecret} 字段。
     * BCrypt 是<b>单向</b>哈希函数，不可逆；同一明文每次加密结果不同（盐值随机）。
     *
     * @param properties 系统配置
     * @return {@link BCryptPasswordEncoder} 实例，强度取自
     *         {@code ydsz.system.app.bcrypt-strength}（合法 4-31，越界回退 10）
     */
    @Bean
