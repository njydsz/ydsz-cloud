 ...
 * <p><b>暴露指标清单：</b>
 * <ul>
 *   <li>{@code ydsz_system_config_read_total} / {@code config_read_duration_ms} —
 *       配置读取次数 / 耗时（Counter / Timer）</li>
 *   <li>{@code ydsz_system_config_cache_hit_total} / {@code config_cache_miss_total} —
 *       配置缓存命中 / 未命中（Counter）</li>
 *   <li>{@code ydsz_system_dict_query_total} / {@code dict_query_duration_ms} —
 *       字典查询次数 / 耗时</li>
 *   <li>{@code ydsz_system_dict_cache_hit_total} / {@code dict_cache_miss_total} —
 *       字典缓存命中 / 未命中</li>
 *   <li>{@code ydsz_system_variable_read_total} / {@code variable_read_duration_ms} —
 *       系统变量读取次数 / 耗时</li>
 *   <li>{@code ydsz_system_variable_cache_hit_total} / {@code variable_cache_miss_total} —
 *       系统变量缓存命中 / 未命中</li>
 *   <li>{@code ydsz_system_app_validate_success_total} / {@code app_validate_fail_total} —
 *       应用密钥校验成功 / 失败</li>
 * </ul>
 *
