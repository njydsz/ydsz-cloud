 ...
 * 租户管理 Controller
 *
 * <p>提供 SaaS 多租户的 CRUD、分页查询等管理能力。
 * 租户是系统多租户隔离的最高层，支持套餐绑定、配额管理、到期控制。
 *
...
public class TenantController {
     ...
     * @return 新创建的租户 ID
     */
    @Audit(module = "租户管理", type = AuditType.OPERATION, action = AuditAction.CREATE,
    ...
    @PostMapping
    public BaseResponse<String> save(@Valid @RequestBody TenantDTO dto,
     ...
     * @return 是否成功
     */
    @Audit(module = "租户管理", type = AuditType.OPERATION, action = AuditAction.UPDATE,
    ...
    @PutMapping
    public BaseResponse<Boolean> update(@Valid @RequestBody TenantDTO dto,
            @RequestHeader(value = AuthHeaderConstants.X_USER_ID, required = false) String userId) {
     ...
     * @return 是否成功
     */
    @Audit(module = "租户管理", type = AuditType.OPERATION, action = AuditAction.DELETE,
            content = "'删除租户: ' + #id")
