 ...
 * 系统变量 VO
 *
 * <p>对应 {@code ydsz_variable} 表的展示视图，是「系统变量中心」列表 / 详情接口的返回值类型。
 * 由 {@link com.njydsz.system.domain.converter.SystemConverter} 从
 * {@link com.njydsz.system.domain.entity.Variable} 实体转换而来。
 *
 * <p><b>字段语义：</b>
 * <ul>
 ...
 *   <li>Spring 占位符解析：{@code @Value("${ydsz.variable.xxx}")}</li>
 * </ul>
 *
 * <p><b>缓存策略：</b>读取通过 {@code ydsz:variable:{key}} 缓存至 Redis；
