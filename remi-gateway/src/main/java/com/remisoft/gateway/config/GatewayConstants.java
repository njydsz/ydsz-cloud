 ...
 * <h3>使用约束</h3>
 * <ul>
 *   <li>所有 X-User-* / X-Internal-* 头在 {@link com.remisoft.gateway.filter.AuthGlobalFilter}
 *       中统一注入，{@link com.remisoft.gateway.config.PathGuard#internalHeaders()}
 *       中定义需剥离的客户端伪造头集合</li>
 *   <li>新增内部头时必须同步更新 PathGuard 列表 + 下游 BaseAuthFilter 解析逻辑</li>
 *   <li>下游服务信任网关的前提是 {@link com.remisoft.gateway.config.InternalHeaderSigner}
 *       签名校验通过</li>
 * </ul>
 *
