 ...
 *
 * <p>当 {@code remi.gateway.dynamic-routes.enabled=true} 时，
...
@Slf4j
@Configuration
@ConditionalOnProperty(prefix = "remi.gateway.dynamic-routes", name = "enabled", havingValue = "true")
public class NacosRouteConfig {
    ...
    public RouteDefinitionRepository nacosRouteDefinitionRepository(
            ...
            @Value("${remi.gateway.dynamic-routes.data-id:gateway-routes.json}") String dataId,
