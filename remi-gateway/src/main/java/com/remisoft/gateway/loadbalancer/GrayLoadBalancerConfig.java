package com.remisoft.gateway.loadbalancer;
 ...
 * 通过 {@code remi.gray-loadbalancer.enabled=true} 控制是否启用
 * （默认 true,保持向后兼容）。
 *
...
@Slf4j
@Configuration
@ConditionalOnProperty(value = "remi.gray-loadbalancer.enabled", havingValue = "true", matchIfMissing = true)
