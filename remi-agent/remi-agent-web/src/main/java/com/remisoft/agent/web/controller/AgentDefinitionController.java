...
import com.remisoft.agent.server.agent.AgentDefinitionService;
...
import com.remisoft.agent.domain.converter.AgentConverter;
import com.remisoft.agent.domain.dto.post.AgentDefinitionPostDTO;
import com.remisoft.agent.domain.dto.put.AgentDefinitionPutDTO;
import com.remisoft.agent.domain.vo.AgentDefinitionVO;
...
public class AgentDefinitionController {
    ...
    @Idempotent(key = "remi:agent:AgentDefinitionController:create:lock", ttlSeconds = 5)
    ...
    @Idempotent(key = "remi:agent:AgentDefinitionController:update:lock", ttlSeconds = 5)
    @PutMapping
    ...
    @Idempotent(key = "remi:agent:AgentDefinitionController:delete:lock", ttlSeconds = 5)
