...
import com.remisoft.agent.api.dto.DagExecutionDTO;
import com.remisoft.agent.domain.agent.AgentDag;
import com.remisoft.agent.server.agent.DagDslParser;
...
public class DagController {
    ...
    @Idempotent(key = "remi:agent:DagController:execute:lock", ttlSeconds = 5)
    ...
    @Idempotent(key = "remi:agent:DagController:write:lock", ttlSeconds = 5)
