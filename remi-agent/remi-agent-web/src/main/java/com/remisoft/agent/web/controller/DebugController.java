...
import com.remisoft.agent.api.dto.AgentTraceDetailDTO;
import com.remisoft.agent.api.dto.AgentTraceListDTO;
import com.remisoft.agent.domain.model.ChatResponse;
import com.remisoft.agent.domain.trace.TraceRecorder.TraceStep;
import com.remisoft.agent.infra.trace.InMemoryTraceRecorder.TraceMeta;
import com.remisoft.agent.server.debug.AgentDebuggerService;
...
public class DebugController {
    ...
    @Idempotent(key = "remi:agent:DebugController:replayTrace:lock", ttlSeconds = 5)
