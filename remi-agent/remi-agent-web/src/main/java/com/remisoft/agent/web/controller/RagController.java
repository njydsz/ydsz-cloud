...
import com.remisoft.agent.api.dto.DocumentIngestDTO;
import com.remisoft.agent.api.dto.RagQueryDTO;
import com.remisoft.agent.domain.rag.TextChunk;
import com.remisoft.agent.server.rag.DocumentIngestionService;
...
public class RagController {
    ...
    @Idempotent(key = "remi:agent:RagController:ingest:lock", ttlSeconds = 5)
    @PostMapping("/ingest")
    ...
    @Idempotent(key = "remi:agent:RagController:deleteDocument:lock", ttlSeconds = 5)
