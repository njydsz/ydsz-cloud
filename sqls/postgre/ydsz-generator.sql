...
CREATE INDEX IF NOT EXISTS idx_ydsz_gen_datasource_tenant ON ydsz_gen_datasource (tenant_id);
CREATE INDEX IF NOT EXISTS idx_ydsz_gen_datasource_tenant_deleted ON ydsz_gen_datasource ((tenant_id));
