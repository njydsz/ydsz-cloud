...
BEGIN
    FOR i IN 0..11 LOOP
        ...
        EXECUTE format(
            ...
            'idx_' || lower(partition_name) || '_instance_id', partition_name
        );
        EXECUTE format(
            'CREATE INDEX IF NOT EXISTS %I ON %I (operator_id, operated_at)',
            'idx_' || lower(partition_name) || '_operator', partition_name
        );
        EXECUTE format(
            'CREATE INDEX IF NOT EXISTS %I ON %I (tenant_id, is_deleted, operated_at)',
            'idx_' || lower(partition_name) || '_tenant_del_at', partition_name
        );
        EXECUTE format(
            'CREATE INDEX IF NOT EXISTS %I ON %I (business_type, business_id)',
            'idx_' || lower(partition_name) || '_business', partition_name
        );
    END LOOP;
END $$;

-- ============================================================================
-- ydsz_flow_idempotent 全链路幂等表
-- ============================================================================
...
-- ============================================================================
-- ydsz_flow_archive_cursor 归档断点续传游标表
-- ============================================================================
