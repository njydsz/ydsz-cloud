...
import com.remisoft.common.jdbc.interceptor.CircuitBreakerInterceptor;
import com.remisoft.common.jdbc.monitor.DatabaseCircuitBreaker;
 ...
 * 数据库熔断器自动配置
 *
 * <p>当 {@code remi.jdbc.circuit-breaker.enabled=true} 时，创建 {@link DatabaseCircuitBreaker}
...
@ConditionalOnProperty(prefix = "remi.jdbc.circuit-breaker", name = "enabled", havingValue = "true")
