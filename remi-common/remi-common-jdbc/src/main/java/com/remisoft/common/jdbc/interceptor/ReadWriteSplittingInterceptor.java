package com.remisoft.common.jdbc.interceptor;
...
import com.remisoft.common.jdbc.config.DataSourceLoadBalanceStrategy;
import com.remisoft.common.jdbc.config.RandomLoadBalanceStrategy;
import com.remisoft.common.jdbc.config.ReadWriteSplittingProperties;
import com.remisoft.common.jdbc.config.RoundRobinLoadBalanceStrategy;
import com.remisoft.common.jdbc.config.WeightedLoadBalanceStrategy;
 ...
 *   <li>random — 随机</li>
 *   <li>weighted — 权重（需配置 remi.jdbc.read-write-splitting.weights）</li>
 * </ul>
 *
 * @author remi-team
 * @since 1.0.0
