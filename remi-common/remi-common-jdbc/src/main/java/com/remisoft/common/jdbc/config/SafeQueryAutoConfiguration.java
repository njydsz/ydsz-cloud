...
import com.remisoft.common.jdbc.interceptor.SafeQueryInnerInterceptor;
 ...
 * <p>触发条件：
 * <ul>
 *   <li>{@code remi.jdbc.safe-query.enabled=true}（默认启用）</li>
 * </ul>
 *
 * @author remi-team
 * @since 1.7.0
...
@ConditionalOnProperty(prefix = "remi.jdbc.safe-query", name = "enabled", havingValue = "true", matchIfMissing = true)
