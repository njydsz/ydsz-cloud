...
import com.remisoft.common.jdbc.config.FieldFillConfiguration;
import com.remisoft.common.jdbc.enums.FieldFillStrategyEnum;
 ...
 * 创建时间字段填充处理器
 *
 * <p>在 INSERT 操作时自动为记录设置创建时间（created_at 字段）。
 * 使用当前系统时间作为填充值，格式为 "yyyy-MM-dd HH:mm:ss"。</p>
 *
 * <h2>使用场景</h2>
 * <ul>
 *   <li>新建用户记录时自动记录创建时间</li>
 *   <li>业务数据录入时自动记录入库时间</li>
 *   <li>审计日志创建时记录操作时间</li>
 * </ul>
 *
 * <h2>SQL 转换示例</h2>
