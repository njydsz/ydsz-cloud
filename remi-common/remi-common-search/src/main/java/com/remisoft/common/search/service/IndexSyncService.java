...
import com.remisoft.common.search.core.IndexOperation;
...
import com.remisoft.common.search.provider.ProviderTypeBridge;
...
public class IndexSyncService {
     ...
     *
     * <p><b>失败重试</b>：内部按 {@code remi.search.index.max-retries} 重试，
