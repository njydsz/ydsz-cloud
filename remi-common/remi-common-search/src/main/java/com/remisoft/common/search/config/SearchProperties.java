 ...
 *       host: localhost
 *       port: 9200
 *       index-name: remi_search
 *     redis:                         # RediSearch 引擎特定配置
 *       index-name: remi_search_idx
 *     solr:                          # Solr 引擎特定配置
...
@Data
@Validated
@ConfigurationProperties(prefix = "remi.search")
public class SearchProperties {
    ...
    public static class PgConfig {
        ...
        /** 索引表名 */
        private String indexTable = "remi_search_index";
        /** 字段权重 */
    ...
    public static class EsConfig {
        ...
        private String indexName = "remi_search";
        private FieldWeights fieldWeights = new FieldWeights();
    }
    ...
    public static class RedisConfig {
        /** RediSearch 索引名称 */
        private String indexName = "remi_search_idx";
    ...
    public static class SolrConfig {
        ...
        private String core = "remi_search";
        private FieldWeights fieldWeights = new FieldWeights();
    }
