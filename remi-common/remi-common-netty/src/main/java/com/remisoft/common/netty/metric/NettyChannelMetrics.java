package com.remisoft.common.netty.metric;
 ...
 * <ul>
 *   <li>{@code remi.netty.channels.active}（Gauge）— 活跃 Channel 数</li>
 *   <li>{@code remi.netty.bytes.read.total}（Counter）— 累计读取字节数</li>
 *   <li>{@code remi.netty.bytes.written.total}（Counter）— 累计写入字节数</li>
 *   <li>{@code remi.netty.connections.total}（Counter）— 累计连接数</li>
 *   <li>{@code remi.netty.disconnections.total}（Counter）— 累计断开数</li>
 *   <li>{@code remi.netty.messages.received}（Counter）— 消息接收数</li>
 *   <li>{@code remi.netty.messages.sent}（Counter）— 消息发送数</li>
 *   <li>{@code remi.netty.reconnect.attempts}（Counter）— 重连尝试次数</li>
 *   <li>{@code remi.netty.reconnect.successes}（Counter）— 重连成功次数</li>
 * </ul>
 *
...
public class NettyChannelMetrics {
    ...
    private static final String METRIC_CHANNELS_ACTIVE = "remi.netty.channels.active";
    private static final String METRIC_BYTES_READ = "remi.netty.bytes.read.total";
    private static final String METRIC_BYTES_WRITTEN = "remi.netty.bytes.written.total";
    private static final String METRIC_CONNECTIONS = "remi.netty.connections.total";
    private static final String METRIC_DISCONNECTIONS = "remi.netty.disconnections.total";
    private static final String METRIC_MESSAGES_RECEIVED = "remi.netty.messages.received";
    private static final String METRIC_MESSAGES_SENT = "remi.netty.messages.sent";
    private static final String METRIC_RECONNECT_ATTEMPTS = "remi.netty.reconnect.attempts";
    private static final String METRIC_RECONNECT_SUCCESSES = "remi.netty.reconnect.successes";
