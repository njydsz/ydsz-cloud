package com.remisoft.common.netty.codec;
 ...
 *
 * <p>组合 {@link LengthFieldFrameDecoder}（解码）和 {@link LengthFieldPrepender}（编码），
 * 业务方只需在 Pipeline 中添加此组合即可完成长度域编解码。
 *
 * <p>协议格式：
 * <pre>
 * +--------+------------------+
...
public final class LengthFieldCodec {
     ...
     */
    public static void addToPipeline(ChannelPipeline pipeline, int maxFrameLength, int lengthFieldLength) {
