...
class NettyChannelMetricsTest {
    ...
    void testIncrementActiveChannels() {
        ...
        assertEquals(3.0, meterRegistry.find("remi.netty.channels.active").gauge().value());
    }
    ...
    void testAddBytesRead() {
        ...
        assertEquals(3072.0, meterRegistry.find("remi.netty.bytes.read.total").gauge().value());
    }
    ...
    void testAddBytesWritten() {
        ...
        assertEquals(1024.0, meterRegistry.find("remi.netty.bytes.written.total").gauge().value());
    }
    ...
    void testIncrementMessagesReceived() {
        ...
        assertEquals(2.0, meterRegistry.counter("remi.netty.messages.received").count());
    }
    ...
    void testIncrementMessagesSent() {
        ...
        assertEquals(3.0, meterRegistry.counter("remi.netty.messages.sent").count());
    }
    ...
    void testIncrementConnections() {
        ...
        assertEquals(1.0, meterRegistry.counter("remi.netty.connections.total").count());
    }
    ...
    void testIncrementDisconnections() {
        ...
        assertEquals(2.0, meterRegistry.counter("remi.netty.disconnections.total").count());
    }
    ...
    void testIncrementReconnectAttempts() {
        ...
        assertEquals(3.0, meterRegistry.counter("remi.netty.reconnect.attempts").count());
    }
    ...
    void testIncrementReconnectSuccesses() {
        ...
        assertEquals(1.0, meterRegistry.counter("remi.netty.reconnect.successes").count());
    }
