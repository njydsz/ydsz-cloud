 ...
 *
 * <p>定义 REMI 框架约定的标准 Span Attribute / Resource Attribute 名称，
 * 避免业务方硬编码字符串，便于跨服务、跨语言统一查询。
 *
 * <p>参考：
 * <ul>
 *   <li><a href="https://opentelemetry.io/docs/specs/semconv/">OTel Semantic Conventions</a></li>
 *   <li><a href="https://github.com/open-telemetry/semantic-conventions">open-telemetry/semantic-conventions</a></li>
 * </ul>
 *
 * @author remi-team
 * @since 1.0.0
...
public final class OtelSemConv {
    ...
    /** 影响行数 */
    public static final AttributeKey<Long> DB_RESPONSE_ROWS = AttributeKey.longKey("db.response.rows");
    ...
    /** 租户 ID */
    public static final AttributeKey<String> REMI_TENANT_ID = AttributeKey.stringKey("remi.tenant.id");
    /** 业务单号 */
    public static final AttributeKey<String> REMI_BUSINESS_NO = AttributeKey.stringKey("remi.business_no");
    /** 用户 ID */
    public static final AttributeKey<String> REMI_USER_ID = AttributeKey.stringKey("remi.user.id");
    /** 客户端类型（web/app/inner） */
    public static final AttributeKey<String> REMI_CLIENT_TYPE = AttributeKey.stringKey("remi.client.type");
    /** 错误码 */
    public static final AttributeKey<String> REMI_ERROR_CODE = AttributeKey.stringKey("remi.error.code");
    /** 业务模块 */
    public static final AttributeKey<String> REMI_MODULE = AttributeKey.stringKey("remi.module");
    /** 业务动作 */
    public static final AttributeKey<String> REMI_ACTION = AttributeKey.stringKey("remi.action");
    /** 灰度标签（用于按流量染色查询） */
    public static final AttributeKey<String> REMI_GRAY_TAG = AttributeKey.stringKey("remi.gray.tag");
    /** 压测标记 */
    public static final AttributeKey<String> REMI_PRESSURE_TAG = AttributeKey.stringKey("remi.pressure.tag");
