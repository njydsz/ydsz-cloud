package com.remisoft.common.sentry.logging;
...
public class LokiLogPublisher implements LogPublisher, AutoCloseable {
    ...
    private String buildLokiPayload(LogEvent event) {
        ...
        streamLabels.put("app", event.getAppName() != null ? event.getAppName() : "remi");
    ...
    private String buildLokiBatchPayload(List<LogEvent> events) {
        String appName = events.get(0).getAppName() != null ? events.get(0).getAppName() : "remi";
