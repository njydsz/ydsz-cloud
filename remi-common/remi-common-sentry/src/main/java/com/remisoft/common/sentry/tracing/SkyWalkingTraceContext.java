...
public class SkyWalkingTraceContext implements TraceContext {
    ...
    public String getTraceId() {
        try {
            return org.apache.skywalking.apm.toolkit.trace.TraceContext.traceId(); // FQN-OK: name conflict with com.remisoft.common.sentry.spi.TraceContext
        } catch (Exception e) {
            return null;
        }
    }
    ...
    public String getSpanId() {
        try {
            return String.valueOf(org.apache.skywalking.apm.toolkit.trace.TraceContext.spanId()); // FQN-OK: name conflict with com.remisoft.common.sentry.spi.TraceContext
        } catch (Exception e) {
            return null;
        }
    }
    ...
    public String getSegmentId() {
        try {
            return org.apache.skywalking.apm.toolkit.trace.TraceContext.segmentId(); // FQN-OK: name conflict with com.remisoft.common.sentry.spi.TraceContext
        } catch (Exception e) {
            return null;
        }
    }
    ...
    public boolean isTracing() {
        try {
            return org.apache.skywalking.apm.toolkit.trace.TraceContext.traceId() != null; // FQN-OK: name conflict with com.remisoft.common.sentry.spi.TraceContext
        } catch (Exception e) {
            return false;
        }
    }
