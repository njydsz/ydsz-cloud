...
import com.remisoft.common.event.gateway.RocketMqEventPublishGateway;
 ...
 *
 * <p>通过 {@code remi.event.rocketmq.*} 配置 NameServer 地址、Topic、生产组、消费组等。
 *
 * @author remi-team
 * @since 1.0.0
 */
...
public class RocketMqGatewayConfiguration {
    ...
    public EventPublishGateway rocketMqEventPublishGateway(
        ...
        log.info("RocketMqEventPublishGateway registered: topic=remi-outbox-events");
