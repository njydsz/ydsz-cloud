 ...
 * <p>投递策略：
 * <ul>
 *   <li>Topic：固定为 {@code remi-outbox-events}（可通过配置覆盖）</li>
...
public class RocketMqEventPublishGateway implements EventPublishGateway {
    ...
    /** 默认 Topic 名称 */
    private static final String DEFAULT_TOPIC = "remi-outbox-events";
     ...
     * @param topic            目标 Topic（null 或空时使用默认值 remi-outbox-events）
     */
