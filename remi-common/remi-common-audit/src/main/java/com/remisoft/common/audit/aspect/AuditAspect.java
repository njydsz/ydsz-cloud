package com.remisoft.common.audit.aspect;
...
import com.remisoft.common.audit.context.AuditContext.AuditContextData;
import com.remisoft.common.audit.domain.AuditLog;
import com.remisoft.common.audit.enums.AuditStatus;
 ...
 *       {@link com.remisoft.common.audit.config.AuditProperties#getSensitiveParams()}</li>
 *   <li>对超大参数（&gt;10KB）和深嵌套对象进行截断/占位，避免 OOM</li>
 *   <li>异步事件通过 Spring {@code ApplicationEventPublisher} 发布，
 *       由 {@link com.remisoft.common.audit.config.AuditEventListener} 委托
 *       {@link com.remisoft.common.audit.core.AuditRecorder} 落盘</li>
...
public class AuditAspect {
     ...
     */
    @Pointcut("@annotation(com.remisoft.common.audit.annotation.Audit)")
