package com.remisoft.common.audit.config;
...
import com.remisoft.common.audit.aspect.AuditAspect;
import com.remisoft.common.audit.core.AsyncAuditRecorder;
import com.remisoft.common.audit.core.AuditFallbackWriter;
import com.remisoft.common.audit.core.AuditMetricsBinder;
import com.remisoft.common.audit.core.AuditQueryService;
import com.remisoft.common.audit.core.AuditRecorder;
import com.remisoft.common.audit.core.AuditStorage;
import com.remisoft.common.audit.core.DefaultAuditQueryService;
import com.remisoft.common.audit.core.DefaultAuditRecorder;
import com.remisoft.common.audit.core.DisruptorAuditRecorder;
import com.remisoft.common.audit.health.AuditHealthIndicator;
import com.remisoft.common.audit.sharding.DailyShardingStrategy;
import com.remisoft.common.audit.sharding.MonthlyShardingStrategy;
import com.remisoft.common.audit.sharding.TableShardingStrategy;
import com.remisoft.common.audit.sharding.YearlyShardingStrategy;
 ...
 *   <li>{@link com.remisoft.common.audit.core.AuditStorage}：审计日志存储（JDBC / 控制台）</li>
 *   <li>{@link com.remisoft.common.audit.core.AuditRecorder}：异步/同步审计记录器</li>
 *   <li>{@link com.remisoft.common.audit.sharding.TableShardingStrategy}：分表策略</li>
 *   <li>{@link com.remisoft.common.audit.core.AuditQueryService}：审计日志查询服务</li>
 *   <li>{@link com.remisoft.common.audit.health.AuditHealthIndicator}：健康检查指示器</li>
 * </ul>
 * </p>
 *
