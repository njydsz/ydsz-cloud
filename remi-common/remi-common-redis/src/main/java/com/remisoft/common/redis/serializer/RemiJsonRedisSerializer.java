package com.remisoft.common.redis.serializer;
 ...
 * @since 1.0.0
 */
public class RemiJsonRedisSerializer implements RedisSerializer<Object> {
     ...
     * 将反序列化为 Object 类型。
     */
    public RemiJsonRedisSerializer() {
     ...
     */
    public RemiJsonRedisSerializer(Class<?> clazz) {
     ...
     * @since 1.0.0
     */
    public RemiJsonRedisSerializer(JsonType<?> typeRef) {
        this.clazz = Object.class;
     ...
     * @return 序列化器实例
     */
    public static RemiJsonRedisSerializer of(Class<?> type) {
        return new RemiJsonRedisSerializer(type);
    }
     ...
     * @since 1.0.0
     */
    public static RemiJsonRedisSerializer of(JsonType<?> typeRef) {
        return new RemiJsonRedisSerializer(typeRef);
    }
}
