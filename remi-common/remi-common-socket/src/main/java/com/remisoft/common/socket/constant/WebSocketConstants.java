package com.remisoft.common.socket.constant;
...
public final class WebSocketConstants {
    ...
    /** 在线用户 Redis key 前缀（Hash: remi:ws:online:{userId} -> sessionId） */
    public static final String WS_ONLINE_KEY_PREFIX = "remi:ws:online:";

    /** 离线消息 Redis List key 前缀（remi:ws:offline:{userId}） */
    public static final String WS_OFFLINE_KEY_PREFIX = "remi:ws:offline:";

    /** 集群广播 Redis Channel */
    public static final String WS_CLUSTER_CHANNEL = "remi:ws:cluster:push";
