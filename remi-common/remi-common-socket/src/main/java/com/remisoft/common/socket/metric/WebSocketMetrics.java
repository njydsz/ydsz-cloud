package com.remisoft.common.socket.metric;
 ...
 * <p>注册以下指标：
 * <ul>
 *   <li>{@code remi.websocket.push.total}（Counter）— 推送次数，tag: type, success</li>
 *   <li>{@code remi.websocket.push.duration}（Timer）— 推送耗时</li>
 *   <li>{@code remi.websocket.connections.active}（Gauge）— 活跃连接数（由业务侧注册）</li>
 * </ul>
 *
...
public class WebSocketMetrics {
    ...
    private static final String METRIC_PUSH_TOTAL = "remi.websocket.push.total";
    private static final String METRIC_PUSH_DURATION = "remi.websocket.push.duration";
