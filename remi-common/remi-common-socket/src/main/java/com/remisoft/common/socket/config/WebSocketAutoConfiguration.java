...
import com.remisoft.common.socket.ack.MessageAckService;
import com.remisoft.common.socket.audit.WebSocketAuditService;
import com.remisoft.common.socket.auth.WebSocketAuthInterceptor;
import com.remisoft.common.socket.cluster.WebSocketClusterMessage;
...
import com.remisoft.common.socket.heartbeat.WebSocketHeartbeatHandler;
import com.remisoft.common.socket.health.WebSocketHealthIndicator;
import com.remisoft.common.socket.interceptor.StompMessageInterceptor;
import com.remisoft.common.socket.lifecycle.WebSocketConnectionListener;
import com.remisoft.common.socket.metric.WebSocketMetrics;
import com.remisoft.common.socket.monitor.SlowConnectionDetector;
import com.remisoft.common.socket.offline.OfflineMessageStore;
import com.remisoft.common.socket.offline.RedisOfflineMessageStore;
import com.remisoft.common.socket.push.DefaultRealtimePushTemplate;
import com.remisoft.common.socket.push.RealtimePushTemplate;
import com.remisoft.common.socket.ratelimit.ConnectionLimiter;
import com.remisoft.common.socket.ratelimit.WebSocketRateLimiter;
import com.remisoft.common.socket.retry.DeadLetterQueue;
import com.remisoft.common.socket.retry.MessageRetryQueue;
import com.remisoft.common.socket.retry.RedisDeadLetterQueue;
import com.remisoft.common.socket.retry.RedisMessageRetryQueue;
import com.remisoft.common.socket.retry.RetryableMessage;
import com.remisoft.common.socket.resilience.WebSocketCircuitBreaker;
import com.remisoft.common.socket.serialize.JsonMessageSerializer;
import com.remisoft.common.socket.serialize.MessageSerializer;
import com.remisoft.common.socket.session.OnlineUserService;
import com.remisoft.common.socket.session.WebSocketSessionEventListener;
 ...
 * WebSocket 自动装配配置。
 *
 * <p>当 classpath 存在 {@link SimpMessagingTemplate} 且 {@code remi.websocket.enabled=true} 时自动生效。
 *
 * <p>自动注册以下 Bean（按依赖顺序）：
 * <ul>
...
@ConditionalOnProperty(prefix = "remi.websocket", name = "enabled", havingValue = "true", matchIfMissing = true)
public class WebSocketAutoConfiguration {
    ...
    @ConditionalOnProperty(prefix = "remi.websocket.offline", name = "enabled", havingValue = "true", matchIfMissing = true)
    ...
    @ConditionalOnProperty(prefix = "remi.websocket.ack", name = "enabled", havingValue = "true")
    ...
    @ConditionalOnProperty(prefix = "remi.websocket.retry", name = "dead-letter-enabled", havingValue = "true")
    ...
    @ConditionalOnProperty(prefix = "remi.websocket.retry", name = "enabled", havingValue = "true", matchIfMissing = true)
