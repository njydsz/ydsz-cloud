 ...
 * <p>限流 key 格式：
 * <ul>
 *   <li>{@code remi:ws:ratelimit:user:{userId}}</li>
 *   <li>{@code remi:ws:ratelimit:ip:{ip}}</li>
 * </ul>
 *
 * @author remi-team
 * @since 1.0.0
...
public class WebSocketRateLimiter {
    ...
    private static final String RATE_LIMIT_USER_PREFIX = "remi:ws:ratelimit:user:";
    private static final String RATE_LIMIT_IP_PREFIX = "remi:ws:ratelimit:ip:";
