...
p = pathlib.Path(r'd:\Code\remi\remi-pmis\remi-backend\remi-common\remi-common-socket\src\main\java\com\remisoft\common\socket\config\WebSocketAutoConfiguration.java')
