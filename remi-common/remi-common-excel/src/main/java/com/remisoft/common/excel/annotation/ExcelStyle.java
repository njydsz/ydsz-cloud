...
import com.remisoft.common.excel.core.ExcelWriter;

/**
 * Excel样式注解 - 用于自定义单元格样式
 *
 * <p>可应用于JavaBean的字段上,控制Excel单元格的样式显示。
 * 支持表头样式和数据样式两种配置。</p>
 *
 * <h3>使用示例</h3>
 * <pre>{@code
...
public @interface ExcelStyle {
     ...
     * <p>支持颜色值:
     * <ul>
     *   <li>RED, BLUE, GREEN, YELLOW, WHITE, BLACK等标准颜色</li>
     *   <li>或使用ARGB格式如"#FF0000"</li>
     * </ul>
     *
     * @return 字体颜色名称或十六进制值
     */
