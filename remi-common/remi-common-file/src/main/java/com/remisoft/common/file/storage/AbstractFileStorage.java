...
import com.remisoft.common.file.callback.UploadProgressListener;
...
import com.remisoft.common.file.domain.BatchDeleteResult;
    ...
    public void uploadChunk(String bucketName, String objectName, String uploadId, int partNumber, MultipartFile file) {
        ...
        try {
            ...
            if (isChunkMd5CheckEnabled() && chunkMd5 != null) {
                checkpointService.updateChunkMd5InCheckpoint(resolvedBucket, resolvedObjectName, partNumber, chunkMd5, chunkData != null ? chunkData.length : 0);
            }
