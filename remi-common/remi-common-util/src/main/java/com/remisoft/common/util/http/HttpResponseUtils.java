...
public final class HttpResponseUtils {
     ...
     *
     * <p>内部使用 {@link RemiJson#toJson(Object)} 序列化，再调用 {@link #renderString} 渲染。
    ...
    public static void renderJson(HttpServletResponse response, Object object, HttpStatus httpStatus) {
        ...
        render(response, RemiJson.toJson(object), httpStatus.value(), DEFAULT_CONTENT_TYPE, DEFAULT_CHARSET);
    }
