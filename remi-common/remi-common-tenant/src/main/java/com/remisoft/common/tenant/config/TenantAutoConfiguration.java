...
import com.remisoft.common.tenant.async.TenantContextTaskDecorator;
import com.remisoft.common.tenant.datasource.TenantDataSourceFilter;
import com.remisoft.common.tenant.datasource.TenantDataSourceRouter;
import com.remisoft.common.tenant.feign.TenantContextFeignInterceptor;
import com.remisoft.common.tenant.health.TenantHealthIndicator;
import com.remisoft.common.tenant.interceptor.TenantInterceptorProvider;
import com.remisoft.common.tenant.metrics.TenantMetrics;
import com.remisoft.common.tenant.web.TenantContextWebFilter;
 ...
 * 多租户自动装配。
 *
 * <p>条件：{@code remi.tenant.enabled=true}（默认 false，不启用）。
 *
 * <p>装配内容：
 * <ul>
...
@Slf4j
@AutoConfiguration
@ConditionalOnProperty(prefix = "remi.tenant", name = "enabled", matchIfMissing = false)
...
public class TenantAutoConfiguration {
     ...
     */
    @Bean
    @ConditionalOnClass(name = "com.remisoft.common.redis.service.RedisRateLimiter")
    @ConditionalOnMissingBean
     ...
     */
    @Bean
    @ConditionalOnProperty(prefix = "remi.tenant", name = "mode",
                          havingValue = "ISOLATE_DB")
    @ConditionalOnClass(name = "com.remisoft.common.jdbc.datasource.DynamicRoutingDataSource")
    @ConditionalOnMissingBean
