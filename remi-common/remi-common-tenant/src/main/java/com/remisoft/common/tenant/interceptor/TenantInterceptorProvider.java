package com.remisoft.common.tenant.interceptor;
 ...
 * 租户隔离拦截器 SPI 提供者。
 *
 * <p>当 {@code common-tenant} 在 classpath 且 {@code remi.tenant.enabled=true} 时，
 * 通过 {@link InnerInterceptorProvider} SPI 接口自动注册到
