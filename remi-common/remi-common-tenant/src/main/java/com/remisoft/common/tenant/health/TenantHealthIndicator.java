package com.remisoft.common.tenant.health;
 ...
 * <ul>
 *   <li>多租户是否启用</li>
 *   <li>当前隔离模式（SINGLE / MULTI / ISOLATE_DB）</li>
 *   <li>租户列名</li>
 *   <li>系统租户 ID / 超级管理员租户 ID</li>
 *   <li>SQL 拦截指标（通过 / 拒绝 / 跳过）</li>
 *   <li>fail-closed 拒绝次数</li>
 *   <li>ISOLATE_DB 模式数据源路由器状态（可选）</li>
 * </ul>
 *
 * @author remi-team
 * @since 1.0.0
...
public class TenantHealthIndicator implements HealthIndicator {
    ...
    public TenantHealthIndicator(TenantProperties properties,
    ...
    public Health health() {
        ...
        if (router != null) {
            ...
            builder.withDetail("datasourceSwitchCount",
                    metrics != null ? metrics.getDatasourceSwitchCount() : 0);
        }
