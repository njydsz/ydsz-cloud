...
/**
 * RemiCache 的 Spring Cache 适配器（Spring 6.x）。
 *
 * <p>将 RemiCache 的 Cache 接口适配为 Spring Cache 的标准接口，
 ...
 * 
 */
public class SpringRemiCache extends AbstractValueAdaptingCache {

  private final String name;
  private final Cache<Object, Object> delegate;

  /**
   * 创建 Spring RemiCache 适配器。
   *
   * @param name 缓存名称
   * @param delegate RemiCache 实例
   * @param allowNullValues 是否允许 null 值
   */
  public SpringRemiCache(String name, Cache<Object, Object> delegate, boolean allowNullValues) {
