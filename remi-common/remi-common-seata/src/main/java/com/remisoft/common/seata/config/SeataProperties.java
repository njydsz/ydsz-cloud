...
@Getter
@Setter
@ConfigurationProperties(prefix = "remi.seata")
public class SeataProperties {
    ...
    /** Seata 应用 ID */
    private String seataApplicationId = "remi-app";

    /** Seata 事务组 */
    private String seataTxServiceGroup = "remi-tx-group";
    ...
    private String tccLogRedisKeyPrefix = "remi:tcc:log:";
