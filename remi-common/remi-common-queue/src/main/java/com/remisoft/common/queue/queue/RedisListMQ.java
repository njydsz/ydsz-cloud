...
import com.remisoft.common.queue.service.impl.RedisListPublisher;
import com.remisoft.common.queue.service.impl.RedisListSubscriber;
...
public class RedisListMQ implements IMessageQueue {
    ...
    public RedisListMQ(RedisService redisService, QueueProperties config, ExecutorService consumerExecutor) {
        ...
        log.info("[RedisListMQ] 初始化成功（复用 remi-common-redis 连接）");
