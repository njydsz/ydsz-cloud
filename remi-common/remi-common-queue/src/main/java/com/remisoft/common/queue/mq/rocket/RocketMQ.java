...
import com.remisoft.common.queue.queue.AbstractMessageQueue;
 ...
 * <p><b>资源管理：</b>
 * <ul>
 *   <li>构造时创建临时 Producer 验证 NameServer 连通性</li>
 *   <li>每个 Publisher 持有独立的 DefaultMQProducer</li>
 *   <li>{@link #doClose()} 关闭所有已创建的 Producer，防止资源泄漏</li>
 * </ul>
 *
 * @author remi-team
 * @since 1.0.0
