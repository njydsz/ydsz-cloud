 ...
 * 由于 {@link com.remisoft.common.queue.mq.rabbit.RabbitMQPublisher} 在构造时
...
class RabbitMQPropertiesTest {
    ...
    void testDefaultValues() {
        ...
        assertEquals("remi-rabbitmq-queue", properties.getQueueName());
        assertEquals("remi-exchange", properties.getExchangeName());
        assertEquals("remi.routing.key", properties.getRoutingKey());
    ...
    void testResolvedQueueNameDefaults() {
        ...
        assertEquals("remi-rabbitmq-queue", properties.resolvedQueueName());
