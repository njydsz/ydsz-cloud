package com.remisoft.common.config;
...
import com.remisoft.common.config.health.ConfigEncryptHealthIndicator;
...
public class ConfigAutoConfiguration {
    ...
    @ConditionalOnProperty(prefix = "remi.config.change-monitor", name = "enabled",
    ...
    @ConditionalOnProperty(prefix = "remi.config.health", name = "enabled",
            havingValue = "true", matchIfMissing = true)
