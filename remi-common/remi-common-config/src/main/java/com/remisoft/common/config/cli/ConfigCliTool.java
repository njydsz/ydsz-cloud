package com.remisoft.common.config.cli;
 ...
 * <pre>{@code
 * # 加密
 * java -cp remi-common-config.jar com.remisoft.common.config.cli.ConfigCliTool encrypt "my-db-password" "master-password"
 *
 * # 输出: ENC(G8NkR6qVw2J3FpY0bXxC7A==)
 *
 * # 解密
 * java -cp remi-common-config.jar com.remisoft.common.config.cli.ConfigCliTool decrypt "G8NkR6qVw2J3FpY0bXxC7A==" "master-password"
 *
 * # 输出: my-db-password
 *
 * # 使用环境变量提供主密码（推荐）
 * export JASYPT_ENCRYPTOR_PASSWORD="master-password"
 * java -cp remi-common-config.jar com.remisoft.common.config.cli.ConfigCliTool encrypt "my-db-password"
 * }</pre>
 *
 * <h3>算法默认值</h3>
...
public class ConfigCliTool {
    ...
    private static void printUsage() {
        System.out.println("REMI Config Encrypt CLI Tool");
        System.out.println();
