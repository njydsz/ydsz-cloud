 ...
 * 配置增强属性
 *
 * <p>本模块作为 Jasypt 的增强层，不再自行实现加密逻辑。
 * 加密 / 解密由 {@code jasypt-spring-boot-starter} 全局处理，
...
@Getter
@Setter
@ConfigurationProperties(prefix = "remi.config")
public class ConfigProperties {
     ...
     * CLI 加密工具属性
     *
     * <p>用于 {@link com.remisoft.common.config.cli.ConfigCliTool} 命令行工具，
     * 默认值与 Jasypt 全局配置对齐。
     */
    @Getter
    @Setter
