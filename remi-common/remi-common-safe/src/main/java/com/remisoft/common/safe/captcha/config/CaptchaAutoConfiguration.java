package com.remisoft.common.safe.captcha.config;
...
import com.remisoft.common.safe.captcha.core.CaptchaGenerator;
import com.remisoft.common.safe.captcha.core.CaptchaRateLimiter;
import com.remisoft.common.safe.captcha.core.CaptchaStore;
import com.remisoft.common.safe.captcha.generator.ArithmeticCaptchaGenerator;
import com.remisoft.common.safe.captcha.generator.ImageCaptchaGenerator;
import com.remisoft.common.safe.captcha.properties.CaptchaProperties;
import com.remisoft.common.safe.captcha.store.LocalCaptchaStore;
import com.remisoft.common.safe.captcha.validator.CaptchaValidator;
 ...
 *
 * <p>通过 {@code remi.safe.captcha.*} 配置类型、长度、有效期、Redis 存储 Key 前缀。
 *
 * @author remi-team
 * @since 1.0.0
 */
