...
import com.remisoft.common.base.exporter.DefaultDocExporter;
import com.remisoft.common.base.exporter.MarkdownDocExporter;

/**
 * 文档模块自动配置类
 *
 * <p>作为 remi-common-base 模块的文档入口配置，负责一站式开启文档模块的所有能力：
 * <ul>
 ...
 *
 * <p><b>环境控制：</b>
 * 文档功能默认关闭（{@code remi.doc.enabled=false}），需显式配置开启。
 * 生产环境通过 {@link DocSecurityConfiguration} 的 {@code remi.doc.production-enabled}
 * 和 {@code remi.doc.basic-auth} 控制访问安全。
 *
