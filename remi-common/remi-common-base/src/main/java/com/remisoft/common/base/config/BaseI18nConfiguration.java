...
public abstract class BaseI18nConfiguration {
     ...
     *
     * <p>返回值为 {@link ResourceBundleMessageSource} 接受的 basename 列表，
     * 例如 {@code new String[]{"messages", "i18n/messages"}}。
     *
     ...
     * 注册 LocaleResolver
     *
     * <p>基于 {@link AcceptHeaderLocaleResolver} 从 HTTP 请求头 {@code Accept-Language} 解析语言。
     * 默认语言为简体中文，支持 zh_CN 和 en_US。
     *
     ...
     * 注册 MessageSource
     *
     * <p>使用 {@link ResourceBundleMessageSource} 加载多语言资源文件，
     * 设置默认编码 UTF-8，开启 {@code useCodeAsDefaultMessage} 以便在缺失 key 时
     * 返回 code 而非抛出 NoSuchMessageException。
     *
