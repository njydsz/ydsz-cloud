...
import com.remisoft.common.base.config.BaseSecurityHeadersProperties;
...
public class BaseHealthIndicator implements HealthIndicator {
    ...
    /** 期望的时区 ID，从配置 {@code remi.base.timezone} 读取，默认 {@code Asia/Shanghai} */
     ...
     * @param expectedTimezone 期望的时区 ID（从 {@code remi.base.timezone} 配置读取）
     */
    public BaseHealthIndicator(BaseSecurityHeadersProperties securityHeadersProperties,
                               DocProperties docProperties,
                               @Value("${remi.base.timezone:Asia/Shanghai}") String expectedTimezone) {
