package com.remisoft.common.base.actuator;
 ...
 * 配置注册端点 — 暴露运行时配置信息。
 *
 * <p>P1-3: 配置注册端点全量推广 — 通过 Actuator 端点暴露所有 remi.* 前缀的配置项，
 * 便于运维人员在线排查配置问题。
 *
 * <h3>端点信息</h3>
 * <ul>
 *   <li>{@code GET /actuator/config-registry} — 查看所有 remi.* 配置</li>
...
public class ConfigRegistryEndpoint {
    ...
    private static final String REMI_PREFIX = "remi.";
     ...
     * 读取指定前缀下的配置项。
     *
     * @param prefix 配置前缀（如 "remi.audit"）
     * @return 匹配的配置项 Map
     */
    @ReadOperation
