package com.remisoft.common.base.architecture;
 ...
 * <p><b>使用方式：</b>
 * <pre>{@code
 * mvn test -pl remi-common/remi-common-base -Dtest=ArchitectureRulesTest
 * }</pre>
 *
 * @author remi-team
 * @since 1.0.0
 */
@AnalyzeClasses(packages = {"com.remisoft"})
public class ArchitectureRulesTest {
     ...
     *
     * <p>例如：remi-project-server 不可 import com.remisoft.workflow.infra.mapper.*，
    ...
    static final ArchRule businessHealthIndicatorShouldExtendAbstract = classes()
            ...
            .and().resideInAnyPackage(
                    ...
                    "..nextwiki..", "..literule..", "..agent..",
                    "..userinfo..", "..system..", "..project..")
            .should().beAssignableTo("com.remisoft.common.web.health.AbstractModuleHealthIndicator")
    ...
    static final ArchRule businessMetricsShouldExtendAbstract = classes()
            ...
            .and().resideInAnyPackage(
                    ...
                    "..userinfo..", "..system..", "..project..")
            .and().resideInAPackage("..server..")
            .should().beAssignableTo("com.remisoft.common.base.metrics.AbstractModuleMetrics")
    ...
    static final ArchRule scheduledTasksShouldUseDistributedLock = noMethods()
            ...
            .and().areNotAnnotatedWith("com.remisoft.common.lock.annotation.DistributedScheduled")
     ...
     * <p><b>例外：</b>
     * <ul>
     *   <li>{@code remi-common-json} 模块自身允许使用 {@code jackson-annotations}
     ...
     * </ul>
     *
     * <p>相关参考：{@code docs/remi-common-json-integration-analysis.md} P0/P1 治理项
     *
     * @since 2026-08-03
     */
    @ArchTest
    static final ArchRule noExternalJsonLibraryUsage = noClasses()
            .that().resideOutsideOfPackage("com.remisoft.common.json..")
            .and().resideOutsideOfPackage("com.remisoft.agent.domain..")
            .should().dependOnClassesThat()
            .resideInAnyPackage(
    ...
    static final ArchRule controllerErrorMustIncludeCode = noClasses()
            .that().resideInAPackage("..web.controller..")
            .should().callMethod(
                    com.remisoft.common.core.response.BaseResponse.class,
                    "error",
                    String.class)
