package com.remisoft.common.app.config;
...
import com.remisoft.common.app.advice.AppGlobalResponseAdvice;
import com.remisoft.common.app.auth.AppAuthHandler;
import com.remisoft.common.app.exception.AppExceptionHandler;
import com.remisoft.common.app.filter.AppAuthFilter;
import com.remisoft.common.app.filter.AppContentCachingFilter;
import com.remisoft.common.app.filter.AppRequestIdResponseFilter;
import com.remisoft.common.app.health.AppHealthIndicator;
import com.remisoft.common.app.interceptor.AppRequestLogInterceptor;
import com.remisoft.common.app.metrics.AppMetrics;
...
import com.remisoft.common.base.config.BaseAutoConfiguration;
import com.remisoft.common.base.config.BaseMvcConfiguration;
import com.remisoft.common.base.constant.BaseFilterOrders;
import com.remisoft.common.base.interceptor.BaseHttpInterceptor;
import com.remisoft.common.safe.config.ApiSignatureProperties;
import com.remisoft.common.safe.config.SafeConfiguration;
 ...
 * </pre>
 *
 * <p><b>注意：</b>API 签名验证和安全响应头由 {@code remi-common-safe} 模块统一提供，
 * 通过 {@code remi.safe.api-signature.enabled} 和 {@code remi.safe.security-headers.enabled}
 * 控制启用，本模块不再重复注册。
 *
 * @author remi-team
 * @since 1.0.0
...
public class AppMvcConfiguration extends BaseMvcConfiguration {
    ...
    @ConditionalOnProperty(prefix = "remi.app", name = "enabled", havingValue = "true", matchIfMissing = true)
