package com.remisoft.common.app.filter;

import jakarta.servlet.http.HttpServletRequest;

import com.remisoft.common.app.config.AppTraceProperties;
import com.remisoft.common.app.util.RequestIdGenerator;
import com.remisoft.common.base.filter.BaseRequestIdResponseFilter;
 ...
 *
 * <p>优先复用鉴权阶段在 {@link RequestContext} 中缓存的 RequestId，
...
public class AppRequestIdResponseFilter extends BaseRequestIdResponseFilter {
     ...
     * 解析当前请求的 RequestId
     *
     * <p>优先从 {@link RequestContext} 中获取上游过滤器写入的值，
    ...
    public String resolveRequestId(HttpServletRequest request) {
        String requestId = RequestContext.getExtraHeader(HEADER_REQUEST_ID);
