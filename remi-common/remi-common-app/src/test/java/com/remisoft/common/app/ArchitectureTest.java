package com.remisoft.common.app;
...
/**
 * remi-common-app 模块架构分层校验测试。
 *
 * <p>使用 ArchUnit 静态校验包依赖关系，确保模块内分层清晰、无循环依赖。
 * 校验范围：remi-common-app 模块自身的字节码（不含传递依赖）。
 *
 * <p><b>校验规则：</b>
 * <ul>
 *   <li>所有类必须在 {@code com.remisoft.common.app..} 包下</li>
 ...
 * @since 1.0.0
 */
@DisplayName("remi-common-app 架构分层校验")
class ArchitectureTest {

    /**
     * 仅导入 remi-common-app 模块自身的类，避免校验传递依赖（如 Spring Framework）。
     */
    private final JavaClasses classes = new ClassFileImporter()
            .withImportOption(ImportOption.Predefined.DO_NOT_INCLUDE_JARS)
            .withImportOption(ImportOption.Predefined.DO_NOT_INCLUDE_TESTS)
            .importPackages("com.remisoft.common.app..");

    @Test
    @DisplayName("所有类必须在 com.remisoft.common.app 包下")
    void allClassesShouldBeInAppPackage() {
        ArchRule rule = classes()
                .should().resideInAPackage("com.remisoft.common.app..")
                .because("remi-common-app 模块所有类必须在 com.remisoft.common.app 包或子包下");
    ...
    void slicesShouldBeFreeOfCycles() {
        slices().matching("com.remisoft.common.app.(*)..")
