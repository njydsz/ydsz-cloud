package com.remisoft.common.notify.provider;

import com.remisoft.common.notify.channel.EmailMessage;
 ...
 *
 * <p>每个提供商实现此接口，通过 {@code remi.notify.email.provider} 配置项选择当前使用的提供商。
