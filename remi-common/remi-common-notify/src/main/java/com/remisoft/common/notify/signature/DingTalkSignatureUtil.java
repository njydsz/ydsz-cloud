package com.remisoft.common.notify.signature;
 ...
 * 钉钉回调签名验证工具。
 *
 * <p>P0-2: 从 workflow 模块迁移到 common-notify，作为通用 IM 签名能力。
 * 供 workflow 三方审批回调验证、common-notify DingTalkNotifySender 等场景共用。
 *
