package com.remisoft.common.notify.config;
...
import com.remisoft.common.notify.aggregate.NotificationAggregator;
import com.remisoft.common.notify.aggregate.TimeWindowAggregator;
import com.remisoft.common.notify.audit.NotifyAuditService;
import com.remisoft.common.notify.channel.NotifyChannelStrategy;
import com.remisoft.common.notify.core.AsyncNotifyService;
import com.remisoft.common.notify.core.DeadLetterHandler;
import com.remisoft.common.notify.core.InMemoryDeadLetterHandler;
import com.remisoft.common.notify.core.NotifyCircuitBreakerRegistry;
import com.remisoft.common.notify.core.NotifyRetryQueue;
import com.remisoft.common.notify.core.NotifyService;
import com.remisoft.common.notify.core.NotifyServiceImpl;
import com.remisoft.common.notify.core.PersistentNotifyRetryQueue;
import com.remisoft.common.notify.core.TransactionalNotifyPublisher;
import com.remisoft.common.notify.helper.NotifyHelper;
import com.remisoft.common.notify.dedup.NotifyDedupService;
import com.remisoft.common.notify.fallback.NotifyFallbackManager;
import com.remisoft.common.notify.health.NotifyHealthIndicator;
import com.remisoft.common.notify.i18n.NotifyI18nResolver;
import com.remisoft.common.notify.i18n.NotifyI18nService;
import com.remisoft.common.notify.metrics.NotifyMetrics;
import com.remisoft.common.notify.preference.NotifyPreferenceManager;
import com.remisoft.common.notify.provider.AliyunSmsProvider;
import com.remisoft.common.notify.provider.SmsProvider;
import com.remisoft.common.notify.ratelimit.NotifyRateLimiterManager;
import com.remisoft.common.notify.security.DkimSigner;
import com.remisoft.common.notify.security.EmailSmtpHealthChecker;
import com.remisoft.common.notify.security.NotifyPasswordResolver;
import com.remisoft.common.notify.template.HtmlTemplateRegistry;
import com.remisoft.common.notify.template.TemplateEngine;
import com.remisoft.common.notify.template.TemplateVariableValidator;
import com.remisoft.common.notify.tracking.EmailTrackingService;
import com.remisoft.common.util.concurrent.ExecutorUtils;
 ...
 * 邮件渠道的 {@link JavaMailSender} Bean 由本配置类根据 {@code remi.notify.email} 配置自动创建。
 *
...
public class NotifyConfiguration {
	...
	@ConditionalOnProperty(prefix = "remi.notify.email", name = "enabled", havingValue = "true")
	 ...
	 *
	 * <p>依据 {@code remi.notify.email} 配置装配 SMTP 主机/端口/协议（SSL/STARTTLS）与超时参数；
	 ...
	 *
	 * <p>在 {@code remi.notify.sms.provider=aliyun} 时生效，封装阿里云短信网关的鉴权与发送。
	...
	@ConditionalOnProperty(prefix = "remi.notify.sms", name = "provider", havingValue = "aliyun")
	 ...
	 * 依据 {@code remi.notify.ratelimit} 配置初始化；无自定义 Bean 时注册默认实现。
	 */
	@Bean
