 ...
 *
 * <p>基于 OWASP Java HTML Sanitizer 对 HTML 邮件内容进行标签白名单过滤，
 * 阻止 &lt;script&gt;、onload、onerror 等危险标签和属性注入。
 *
 * <p><b>过滤策略：</b>
 * <ul>
 *   <li>允许基本格式化标签（b、i、u、strong、em、br、p 等）</li>
 *   <li>允许超链接（a），自动添加 rel="nofollow" 和 target="_blank"</li>
 *   <li>允许图片（img），但过滤 javascript: 协议</li>
 *   <li>允许表格、样式标签</li>
 *   <li>完全过滤 script、iframe、object、embed 等危险标签</li>
 * </ul>
 *
