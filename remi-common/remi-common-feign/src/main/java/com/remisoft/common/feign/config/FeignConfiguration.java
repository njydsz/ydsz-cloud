...
import com.remisoft.common.feign.codec.JsonEncoder;
import com.remisoft.common.feign.codec.ResponseUnwrapDecoder;
import com.remisoft.common.feign.compress.GzipRequestCompressInterceptor;
import com.remisoft.common.feign.health.FeignHealthIndicator;
import com.remisoft.common.feign.interceptor.BulkheadRequestInterceptor;
import com.remisoft.common.feign.interceptor.FeignResponseInterceptor;
import com.remisoft.common.feign.monitor.FeignResponseMetricsAdapter;
import com.remisoft.common.feign.trace.TraceRequestInterceptor;
...
public class FeignConfiguration {
     ...
     * <ul>
     *   <li>400 Bad Request - {@link com.remisoft.common.feign.exception.BadRequestException}</li>
     *   <li>404 Not Found - {@link com.remisoft.common.feign.exception.NotFoundException}</li>
     *   <li>401/403/429/500/503 - {@link com.remisoft.common.feign.exception.OpenFeignException}</li>
     * </ul>
     *
     * @param feignProperties Feign 配置属性
     ...
     * 仅当 {@code remi.feign.bulkhead.enabled=true} 时生效。
     * <p>
    ...
    @ConditionalOnProperty(prefix = "remi.feign.bulkhead", name = "enabled", havingValue = "true")
     ...
     * {@code remi.feign.circuit-breaker.state-ttl-seconds} 配置。
     *
     * @param feignProperties      Feign 配置属性
