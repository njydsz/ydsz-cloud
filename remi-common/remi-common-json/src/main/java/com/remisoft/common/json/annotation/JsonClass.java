...
public @interface JsonClass {
    ...
    enum NamingStrategy {
         ...
         */
        public com.remisoft.common.json.naming.PropertyNamingStrategy toPropertyNamingStrategy() {
            switch (this) {
                case SNAKE_CASE: return com.remisoft.common.json.naming.PropertyNamingStrategy.SNAKE_CASE;
                case KEBAB_CASE: return com.remisoft.common.json.naming.PropertyNamingStrategy.KEBAB_CASE;
                case CAMEL_CASE: return com.remisoft.common.json.naming.PropertyNamingStrategy.LOWER_CAMEL_CASE;
                default: return null;
            }
        }
    }
