 ...
 * <p><b>指标列表：</b>
 * <ul>
 *   <li>{@code remi.json.serialize.duration} — 序列化耗时（P50/P90/P99）</li>
 *   <li>{@code remi.json.deserialize.duration} — 反序列化耗时（P50/P90/P99）</li>
 *   <li>{@code remi.json.serialize.success} — 序列化成功次数</li>
 *   <li>{@code remi.json.serialize.failure} — 序列化失败次数</li>
 *   <li>{@code remi.json.deserialize.success} — 反序列化成功次数</li>
 *   <li>{@code remi.json.deserialize.failure} — 反序列化失败次数</li>
 * </ul>
 *
 * @author remi-team
 * @since 1.0.0
