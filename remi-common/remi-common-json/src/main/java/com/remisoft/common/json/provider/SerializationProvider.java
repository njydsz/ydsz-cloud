...
import com.remisoft.common.json.exception.JsonSerializationException;
import com.remisoft.common.json.naming.PropertyNamingStrategy;
import com.remisoft.common.json.writer.BeanSerializer;
...
public final class SerializationProvider {
     ...
     *                     需与 {@link com.remisoft.common.json.internal.JsonConfig.CircularReferenceStrategy}
     *                     枚举名一致
     */
     ...
     *
     * <p>自定义序列化器统一实现 {@link com.remisoft.common.json.serializer.JsonSerializer}，
    ...
    public static final class ThreadLocalSnapshot {
        ...
        private final com.remisoft.common.json.naming.PropertyNamingStrategy savedNamingStrategy;
