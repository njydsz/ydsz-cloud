 ...
 * @since 1.0.0
 */
@ConfigurationProperties(prefix = "remi.json")
@Validated
public class JsonProperties {
     ...
     * 支持通配符模式，例如 {@code com.remisoft.*.entity} 匹配所有子包下的 entity 包。
     * 默认扫描 {@code com.remisoft} 包，覆盖所有项目业务代码。</p>
     */
    private List<String> whitelistPackages = Arrays.asList("com.remisoft");
