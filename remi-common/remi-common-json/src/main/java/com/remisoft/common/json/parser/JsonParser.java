package com.remisoft.common.json.parser;
...
public class JsonParser implements Closeable {
     ...
     */
    public com.remisoft.common.json.tree.JsonNode readValueAsTree() {
        try {
            // 回退一个字符，因为当前 token 已经被读取但未消费 value
            reader.back();
            String rawValue = reader.readRawValue();
            return com.remisoft.common.json.RemiJson.readTree(rawValue);
        } catch (Exception e) {
