 ...
 *
 * <p>序列化器需实现 {@link com.remisoft.common.json.serializer.JsonSerializer}，
 * 直接写入 {@link com.remisoft.common.json.writer.JSONWriter}，零拷贝、避免中间 String 分配。</p>
 *
 * <p>使用示例：</p>
 * <pre><code>
 ...
 * }
 *
 * public class MoneySerializer implements com.remisoft.common.json.serializer.JsonSerializer{@literal <}Money{@literal >} {
 *     {@literal @}Override
 ...
 * @author remi-team
 * @since 1.0.0
 * @see com.remisoft.common.json.serializer.JsonSerializer 自定义序列化器 SPI
 * @see JsonDeserialize
 */
@Documented
...
public @interface JsonSerialize {
     ...
     * 自定义序列化器实现类。
     *
     * <p>必须实现 {@link com.remisoft.common.json.serializer.JsonSerializer}，
