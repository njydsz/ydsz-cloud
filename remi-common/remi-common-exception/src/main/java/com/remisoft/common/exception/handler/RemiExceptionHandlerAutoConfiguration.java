...
import com.remisoft.common.exception.config.RemiExceptionCoreAutoConfiguration;
 ...
 * <p>合并了原有的 4 个处理器配置类：
 * <ul>
 *   <li>Spring MVC 全局异常处理器</li>
 *   <li>Validation 参数校验异常处理器</li>
 *   <li>WebFlux 响应式异常处理器</li>
 *   <li>JDBC 数据访问异常处理器</li>
 * </ul>
 *
 * <p>每个处理器按 Servlet / Reactive 类型自动适配，
 * 在纯 WebMVC 项目或纯 WebFlux 项目中仅装配对应的一个。
 *
 * @author remi-team
 * @since 1.0.0
 */
...
public class RemiExceptionHandlerAutoConfiguration {
