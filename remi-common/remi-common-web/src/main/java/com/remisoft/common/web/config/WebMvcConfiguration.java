...
import com.remisoft.common.web.advice.GlobalResponseAdvice;
import com.remisoft.common.web.auth.AuthHandlerFactory;
import com.remisoft.common.web.filter.ContentCachingFilter;
import com.remisoft.common.web.filter.SecurityHeaderFilter;
import com.remisoft.common.web.filter.TraceIdResponseFilter;
import com.remisoft.common.web.filter.WebAuthFilter;
import com.remisoft.common.web.health.WebHealthIndicator;
import com.remisoft.common.web.interceptor.RequestLogInterceptor;
import com.remisoft.common.web.metrics.WebMetrics;
...
public class WebMvcConfiguration extends BaseMvcConfiguration {
     ...
     * 注册 TraceId 响应过滤器。
     *
     * <p>将链路追踪 ID 注入响应头/MDC，便于日志串联；仅当 {@code remi.web.trace.enabled=true}（默认）时装配。
     ...
     * 仅当 Spring Boot Health 抽象与开关 {@code remi.web.health-indicator.enabled=true}（默认）存在时装配。
     *
