 ...
 *   <li>支持通过 {@code remi.web.shutdown.log-enabled=false} 关闭停机日志。</li>
 * </ul>
 *
...
@ConditionalOnProperty(prefix = "remi.web.shutdown", name = "log-enabled", havingValue = "true", matchIfMissing = true)
