...
import com.remisoft.common.web.filter.ResponseCompressionFilter;
...
@ConditionalOnProperty(prefix = "remi.web.compression", name = "enabled", havingValue = "true", matchIfMissing = true)
