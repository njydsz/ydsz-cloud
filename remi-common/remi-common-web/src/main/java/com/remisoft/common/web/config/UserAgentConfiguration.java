...
@ConditionalOnProperty(prefix = "remi.web.user-agent", name = "enabled", havingValue = "true", matchIfMissing = true)
public class UserAgentConfiguration {
     ...
     * 仅在 classpath 存在 {@code UserAgentAnalyzer} 且 {@code remi.web.user-agent.enabled=true}（默认）时装配。
