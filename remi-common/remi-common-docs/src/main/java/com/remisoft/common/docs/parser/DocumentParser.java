package com.remisoft.common.docs.parser;
 ...
 * 通过 {@link com.remisoft.common.docs.parser.registry.DocumentParserRegistry} 注册和路由。
 *
 * <p><b>实现要求：</b>
 * <ul>
 ...
 *   <li>解析失败时应抛出 {@link com.remisoft.common.docs.exception.DocumentException}</li>
 * </ul>
 *
 * @author remi-team
 * @since 1.0.0
