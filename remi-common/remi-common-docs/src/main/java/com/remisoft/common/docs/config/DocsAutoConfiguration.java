...
import com.remisoft.common.docs.health.DocsHealthIndicator;
 ...
 * 文档处理模块自动配置类
 * <p>
 * 作为 remi-common-docs 模块的自动配置入口，
 * 通过 Spring Boot AutoConfiguration 机制激活文档解析、预处理、安全扫描和 PII 检测等能力。
 *
 * <p><b>配置开关：</b>
 * {@code remi.docs.enabled=true}（默认启用）
 *
 * @author remi-team
 * @since 1.0.0
 */
...
@ConditionalOnProperty(prefix = "remi.docs", name = "enabled", havingValue = "true", matchIfMissing = true)
