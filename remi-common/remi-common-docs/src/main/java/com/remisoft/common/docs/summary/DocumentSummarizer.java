package com.remisoft.common.docs.summary;
 ...
 *   <li>如需高质量摘要/关键词，推荐接入 LLM 服务（如 remi-agent 模块）</li>
 * </ul>
 *
 * @author remi-team
 * @since 1.0.0
...
public class DocumentSummarizer {
     ...
     * 文档自动分类（基于关键词匹配）
     * <p>
     * 支持通过 {@code remi.docs.classifier-rules} 配置自定义分类规则。
