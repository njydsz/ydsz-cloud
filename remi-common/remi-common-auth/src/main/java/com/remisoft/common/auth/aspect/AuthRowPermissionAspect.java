...
import com.remisoft.common.auth.annotation.AuthRowPermission;
import com.remisoft.common.auth.model.DataScopeAware;
...
public class AuthRowPermissionAspect {
     ...
     */
    @Pointcut("@annotation(com.remisoft.common.auth.annotation.AuthRowPermission) || @within(com.remisoft.common.auth.annotation.AuthRowPermission)")
