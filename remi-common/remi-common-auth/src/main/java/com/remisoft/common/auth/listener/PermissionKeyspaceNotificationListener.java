package com.remisoft.common.auth.listener;
...
public class PermissionKeyspaceNotificationListener {
     ...
     * 支持自定义 key 前缀模式，默认匹配 remi-auth:role-* 格式。
     */
