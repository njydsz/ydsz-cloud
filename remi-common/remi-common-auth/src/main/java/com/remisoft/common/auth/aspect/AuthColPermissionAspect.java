...
import com.remisoft.common.auth.model.ColumnScopeAware;
...
public class AuthColPermissionAspect {
     ...
     */
    @Pointcut("@annotation(com.remisoft.common.auth.annotation.AuthColPermission) || @within(com.remisoft.common.auth.annotation.AuthColPermission)")
