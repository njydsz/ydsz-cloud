 ...
 * 配合 JDBC SQL 拦截器（{@code com.remisoft.common.jdbc.interceptor.DataScopeInterceptor}）
 ...
 * }</pre>
 *
 * <p><b>兼容性：</b>与历史 {@code com.remisoft.common.annotation.DataScope} 字段语义完全一致，
 * 新代码统一使用本注解。
 *
 * @author remi-team
 * @since 1.0.0
 *
 * @see com.remisoft.common.auth.aspect.AuthRowPermissionAspect 行级权限 AOP
 */
