package com.remisoft.common.auth.aspect;
...
public class AuthPermissionAspect {
     ...
     */
    @Pointcut("@annotation(com.remisoft.common.auth.annotation.AuthMenuPermission) || @within(com.remisoft.common.auth.annotation.AuthMenuPermission)")
     ...
     */
    @Pointcut("@annotation(com.remisoft.common.auth.annotation.AuthApiPermission) || @within(com.remisoft.common.auth.annotation.AuthApiPermission)")
     ...
     * 校验失败时抛出 {@link com.remisoft.common.auth.exception.PermissionDeniedException}。
     *
