package com.remisoft.common.auth.handler;
 ...
 *
 * <p>从 {@code com.remisoft.common.util.auth.AbstractAuthHandler} 迁移而来，
...
public abstract class AbstractAuthHandler implements AuthHandler {
     ...
     * 按逗号分割字符串并过滤空值
     *
     * <p>委托给 {@link com.remisoft.common.auth.util.PermissionUtils#splitCsv} 统一处理 CSV 解析，
     * 消除重复逻辑。
     *
     * @param value 待分割的字符串
