...
import com.remisoft.common.auth.aspect.AuthColPermissionAspect;
import com.remisoft.common.auth.aspect.AuthPermissionAspect;
import com.remisoft.common.auth.aspect.AuthRowPermissionAspect;
import com.remisoft.common.auth.cache.LocalPermissionCache;
import com.remisoft.common.auth.desensitize.ColumnDesensitizationService;
import com.remisoft.common.auth.event.PermissionCacheInvalidationListener;
import com.remisoft.common.auth.event.PermissionChangeCacheInvalidator;
import com.remisoft.common.auth.event.PermissionChangeNotifier;
import com.remisoft.common.auth.event.PermissionChangePublisher;
import com.remisoft.common.auth.health.AuthHealthIndicator;
import com.remisoft.common.auth.listener.PermissionKeyspaceNotificationListener;
...
import com.remisoft.common.auth.token.JwtTokenService;
import com.remisoft.common.auth.token.TokenProperties;
...
public class AuthConfiguration {
    ...
    @Bean
    @ConditionalOnMissingBean
    @ConditionalOnProperty(prefix = "remi.auth", name = "rate-limit-enabled", havingValue = "true", matchIfMissing = false)
    ...
    @Bean
    @ConditionalOnMissingBean
    @ConditionalOnProperty(prefix = "remi.auth", name = "csrf-enabled", havingValue = "true", matchIfMissing = false)
