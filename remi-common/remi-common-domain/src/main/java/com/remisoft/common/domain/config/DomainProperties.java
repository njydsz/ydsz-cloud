 ...
 * Domain 模块统一配置属性
 *
 * <p>集中管理 domain 模块的所有配置项。对齐 Spring Boot 配置命名风格（remi.domain.分组.属性）。
 *
...
public class DomainProperties {
    ...
    public static class Idempotent {
         ...
         * {@link com.remisoft.common.domain.contract.IdempotentOperation#getExpireSeconds()} 覆盖单个操作的过期时间。
         */
