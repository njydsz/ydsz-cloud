    ...
    void init_idempotentSet() {
        ...
        org.junit.jupiter.api.Assertions.assertThrows(IllegalStateException.class, () -> {
            org.springframework.test.util.ReflectionTestUtils.setField(
                    ...
                    new java.util.concurrent.atomic.AtomicReference<com.remisoft.common.core.config.CoreProperties>());
            PageConstants.init(new com.remisoft.common.core.config.CoreProperties());
        });
    }
