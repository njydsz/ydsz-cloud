 ...
 *   <tr><td>{@code PageConstants.getMaxPageSize()}</td><td>运行时值</td><td>返回 remi.core.max-page-size 配置值</td></tr>
 * </table>
 *
...
public final class PageConstants {
     ...
     * 运行时实际上限由 {@code remi.core.max-page-size} 配置控制，请使用 {@link #getMaxPageSize()}。
     */
