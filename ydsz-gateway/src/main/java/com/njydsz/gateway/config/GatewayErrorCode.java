 ...
 * <ul>
 *   <li>401xx → 跳转登录页</li>
 *   <li>403xx → 提示无权限 + 联系管理员</li>
 *   <li>429xx → 展示倒计时 + 禁用提交按钮</li>
 *   <li>502xx / 503xx / 504xx → 提示"服务繁忙，请稍后"</li>
 *   <li>500xx → 提示"系统异常" + 自动上报 Sentry</li>
 * </ul>
 *
 * <h3>i18n 消息键</h3>
 * <p>所有错误响应的 {@code message} 字段使用 i18n 键（如 {@code error.TOKEN_INVALID}），
 * 前端根据 {@code Accept-Language} 头或用户设置的语言环境翻译。
 * 后端不负责翻译，仅提供统一键名。
 *
 * @since 1.0.0
 * @author ydsz-team
