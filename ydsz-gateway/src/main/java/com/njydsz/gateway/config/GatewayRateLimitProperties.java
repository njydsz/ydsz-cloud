 ...
 * 原名 {@code RateLimitProperties} 与 common-safe ratelimit 同名（E1 命中）。本类为
 * <b>WebFlux 响应式网关路由前置全局限流</b>，与 common-safe 的 Servlet AOP 方法级限流
 * 技术栈互斥、语义不同，按 ADR-011 双轨保留并重命名消歧。配置前缀
 * {@code ydsz.gateway.ratelimit} 不变。
 *
 * <p>配置示例：
 *
 * <pre>
