...
public enum DagInstanceStatus implements BaseStatusEnum<DagInstanceStatus> {
   ...
   *
   * <ul>
   *   <li>PENDING → RUNNING / CANCELLED
   *   <li>RUNNING → PAUSED / SUCCESS / FAILED / PARTIAL_SUCCESS / CANCELLED / TIMEOUT
   *   <li>PAUSED → RUNNING / CANCELLED / TIMEOUT
   *   <li>SUCCESS / FAILED / PARTIAL_SUCCESS / CANCELLED / TIMEOUT 为终态，不可再流转
   * </ul>
   *
   * @param target 目标状态
   * @return true 表示允许流转
