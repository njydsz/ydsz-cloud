 ...
 * <ul>
 *   <li>上下文串扰：线程复用时读到上一个任务的日志器/分片信息</li>
 *   <li>内存泄漏：InheritableThreadLocal 持有已结束任务的引用</li>
 * </ul>
 *
 * <h3>用法示例</h3>
 * <pre>{@code
 ...
 * }</pre>
 *
 * <p>与直接使用 {@link JobExecutionContext#setLogger(JobLogger)} / {@link JobExecutionContext#setShardingContext(ShardingContext)}
 * 相比，本作用域提供结构化生命周期管理；旧 API 仍可独立使用，
