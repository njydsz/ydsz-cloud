 ...
 * 避免业务代码直接 {@code new} 自建线程池。配置参数通过 {@link CronjobProperties} 注入， 注册到 {@link
 * ThreadPoolRegistry} 统一监控。
 *
...
public class CronjobSchedulerConfig {
   ...
   *
   * <p>Bean 名称 {@code cronjobTaskScheduler}，通过 {@link CronjobProperties}
   * 注入 poolSize / awaitTerminationSeconds 等参数。
   *
