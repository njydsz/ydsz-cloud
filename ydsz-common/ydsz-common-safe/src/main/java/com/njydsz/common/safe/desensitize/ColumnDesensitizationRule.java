 ...
 * 列脱敏规则枚举。
 *
 * <p>定义内置脱敏规则及其正则表达式与替换模板，供 {@link ColumnDesensitizationExecutor} 使用。
 *
 * <p><b>规则示例：</b>
 *
 * <ul>
 *   <li>{@link #PHONE}：{@code 13812345678} → {@code 138****5678}
 *   <li>{@link #EMAIL}：{@code user@example.com} → {@code u***@example.com}
 *   <li>{@link #ID_CARD}：{@code 110101199001011234} → {@code 110***********1234}
 *   <li>{@link #BANK_CARD}：{@code 6222021234567890123} → {@code 622202***********0123}
 *   <li>{@link #CUSTOM}：使用调用方提供的正则与替换模板
 * </ul>
 *
 * @author ydsz-team
 * @since 1.0.0
