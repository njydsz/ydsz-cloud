 ...
 * <p><b>SpEL 支持说明：</b>
 * <ul>
 *   <li>支持 {@code "#paramName"} 形式引用方法参数</li>
 *   <li>支持 {@code "#paramName.field"} 形式引用参数的字段</li>
 *   <li>空字符串 {@code "''"} 使用方法签名作为键</li>
 * </ul>
 *
 * @author ydsz-team
 * @since 1.0.0
...
public class IdempotentInterceptor implements HandlerInterceptor {
     ...
     *
     * <p>使用 Spring {@link MethodBasedEvaluationContext} 实现标准 SpEL 解析，
     * 支持 {@code "#paramName"} 和 {@code "#paramName.field"} 形式。
     *
    ...
    private String parseSpel(String spel, HandlerMethod handlerMethod, HttpServletRequest request) {
        ...
        Expression expression = expressionCache.computeIfAbsent(
                methodKey, k -> EXPRESSION_PARSER.parseExpression(spel));
