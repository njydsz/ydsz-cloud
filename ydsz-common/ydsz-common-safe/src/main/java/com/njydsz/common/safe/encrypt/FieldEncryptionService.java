 ...
 * <p><b>安全特性：</b>
 * <ul>
 *   <li>AES-256-GCM 认证加密，同时保证机密性和完整性</li>
 *   <li>每次加密使用 12 字节随机 IV，确保相同明文产生不同密文</li>
 *   <li>密文格式：[version(1B)][iv(12B)][ciphertext+tag(16B)]</li>
 *   <li>支持密钥版本管理，便于密钥轮换</li>
 * </ul>
 *
 * @author ydsz-team
 * @author ydsz-team
...
public class FieldEncryptionService {
    ...
    public FieldEncryptionService(Map<Integer, String> keys, int defaultKeyVersion) {
        ...
        keys.forEach((version, base64Key) -> {
