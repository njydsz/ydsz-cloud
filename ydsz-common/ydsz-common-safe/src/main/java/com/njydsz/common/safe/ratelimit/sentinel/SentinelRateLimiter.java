 ...
 * <ul>
 *   <li>QPS 限流（集群/本地模式）</li>
 *   <li>并发线程数限流</li>
 *   <li>warmup 预热限流</li>
 *   <li>统一控制台管理规则</li>
 * </ul>
 *
 * <p><b>启用方式：</b>在 application.yml 中配置 {@code ydsz.safe.ratelimit.sentinel-enabled=true}
 * 并添加 {@code sentinel-core} 依赖。
 *
 * <p><b>使用场景：</b>需要统一控制台管理限流规则、集群限流（配合 Sentinel Transport）或
 * 默认令牌桶无法满足的复杂流控需求时使用。
 *
 * @author ydsz-team
 * @since 1.2.0
