 ...
 *   <li>中间人攻击防护（HSTS）
 *   <li>内容安全策略（CSP）
 *   <li>跨源隔离（COOP/COEP/CORP）
 * </ul>
 *
 * <p><b>使用方式：</b>
 *
 * <ul>
 *   <li>默认启用，自动注册到 Filter 链
 *   <li>可通过配置排除特定路径
 *   <li>建议尽可能早地执行，以确保安全头部被正确设置
 * </ul>
 *
 * @author ydsz-team
 * @since 1.0.0
...
public class SecurityHeaderFilter implements Filter {
   ...
   * 添加安全响应头。
   *
   * <p>P1-1：委托 {@link SecurityHeaderConfigurer#computeHeaders(SecurityHeaderProperties)} 计算头策略， 确保
   * Servlet 栈与 WebFlux 栈（Gateway）使用同一套逻辑。
   *
