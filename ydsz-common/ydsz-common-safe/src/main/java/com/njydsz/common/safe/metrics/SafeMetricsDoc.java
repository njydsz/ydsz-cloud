 ...
 *
 * <p>定义安全模块的 SLI（Service Level Indicator）、SLO（Service Level Objective）和错误预算，
 * 用于量化安全防护能力的有效性和可靠性。
 *
 * <h2>指标分类</h2>
 ...
 * <ul>
 *   <li>{@code ydsz.safe.xss.enabled} - XSS 开关（热更新）</li>
 *   <li>{@code ydsz.safe.csrf.enabled} - CSRF 开关（热更新）</li>
 *   <li>{@code ydsz.safe.ratelimit.enabled} - 限流开关（热更新）</li>
 *   <li>{@code ydsz.safe.ip-access.enabled} - IP 访问控制开关（热更新）</li>
 * </ul>
 *
