 ...
 *   <li>指定包含字段
 *   <li>指定命名策略
 *   <li>类级日期格式 / null 输出 / 枚举序列化方式
 *   <li>AutoType 白名单标记（description）
 * </ul>
 *
 * <p><b>使用示例：</b>
 *
...
public @interface JsonClass {
   ...
   *
   * <p>用于多态场景下的类型保留，对标 fastjson2 的 serializerFeature WriteClassName。
   *
   ...
   *
   * <p>空字符串表示不启用类级日期格式，使用字段级配置或默认 toString。
   *
   * @return 日期格式字符串，默认空
   */
