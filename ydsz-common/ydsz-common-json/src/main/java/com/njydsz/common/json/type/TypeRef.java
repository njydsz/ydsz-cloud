 ...
 *
 * <p>提供更直观的泛型类型构造 API，避免用户手写 {@code new JsonType<T>(){}} 的繁琐语法。</p>
 *
 * <p><b>使用示例：</b></p>
 * <pre>
 * // List 类型
 ...
 * </pre>
 *
 * <p>对于不支持的复杂泛型类型，仍可使用 {@link JsonType} 匿名内部类方式：</p>
 * <pre>
...
public final class TypeRef {
     ...
     *
     * <p>例如：{@code TypeRef.mapOfList(String.class, User.class)} 构造
     * {@code Map<String, List<User>>} 类型引用。</p>
     *
     * @param keyType       键类型
