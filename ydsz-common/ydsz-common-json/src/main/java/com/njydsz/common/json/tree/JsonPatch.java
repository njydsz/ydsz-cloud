 ...
 *
 * <p>对标 Jackson 的 JsonPatch.java，提供 REST API PATCH 方法对资源做局部更新的能力。</p>
 *
 * <p><b>JSON Patch (RFC 6902) 示例：</b></p>
 * <pre>
 ...
 * </pre>
 *
 * <p><b>JSON Merge Patch (RFC 7396) 示例：</b></p>
 * <pre>
 ...
 * </pre>
 *
 * <p><b>路径语法 (JSON Pointer RFC 6901)：</b></p>
 * <ul>
 *   <li>{@code /name} - 对象字段</li>
 *   <li>{@code /items/0} - 数组第 1 个元素</li>
 *   <li>{@code /items/-} - 数组末尾（add 操作专用）</li>
 *   <li>{@code /address/city} - 嵌套对象字段</li>
 * </ul>
 *
 * @author ydsz-team
 * @since 1.2.0
...
public final class JsonPatch {
     ...
     * <p>Merge Patch 语义：</p>
     * <ul>
     *   <li>目标对象中存在的字段：如果 patch 值为 null 则删除，否则替换</li>
     *   <li>目标对象中不存在的字段：添加</li>
     *   <li>patch 中未提及的字段：保持不变</li>
     * </ul>
     *
    ...
    private static void applyTest(PathResolution resolution, String lastSegment, Object expected) {
        ...
        if (!java.util.Objects.equals(actual, expected)) {
            throw new JsonException("TEST failed at '" + lastSegment + "': expected " +
