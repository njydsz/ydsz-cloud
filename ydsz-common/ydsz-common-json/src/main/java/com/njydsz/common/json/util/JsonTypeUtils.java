 ...
 *
 * <p>此前 {@code BeanDeserializerEngine.isSimpleType()}、 {@code BeanReader}
 * 等处独立实现了几乎相同的基本类型判断逻辑，此处统一为单一来源。
 *
 * @author ydsz-team
 * @since 26.09.01
 */
public final class JsonTypeUtils {
   ...
   *
   * <p>统一替代 BeanDeserializerEngine、BeanReader 等处的重复实现。
   *
   * @param type 待判断的类型
   * @return 是基本类型返回 true
   */
