 ...
 * @author ydsz-team
 * @since 1.2.1
 * @deprecated 该校验器仅覆盖 Draft-07 高频子集，不支持 {@code $ref}/{@code allOf}/
 *     {@code items} 等组合关键字，不建议在新场景中使用。轻量入参校验场景可暂时沿用；
 *     若需完整 Draft-07/2020-12 规范支持，请迁移至 networknt/json-schema-validator，
 *     并通过适配层将 {@code com.njydsz.common.json.tree.JsonNode} 转换为其输入模型。
 *     计划于 2.0.0 版本移除。
 */
@Deprecated
