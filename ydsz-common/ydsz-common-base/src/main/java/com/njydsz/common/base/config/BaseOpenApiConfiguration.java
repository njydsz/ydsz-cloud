 ...
 *
 * <p>基于 springdoc-openapi 生成 Swagger 3.0 规范的 API 文档。 子类覆盖 {@link #getTitle()}、{@link
 * #getDescription()} 提供不同的文档标题和描述。
 *
 * <p><b>默认行为：</b>
 *
 * <ul>
 *   <li>注册所有公共请求头（X-User-Id、X-Tenant-Id、X-Access-Token 等）
 *   <li>注册 JWT Bearer Token 认证方案
 *   <li>设置统一的联系信息和外部文档链接
 * </ul>
 *
...
public abstract class BaseOpenApiConfiguration {
  ...
  private Components createComponents() {
    return new Components().headers(createHeaderParams()).securitySchemes(createSecuritySchemes());
  }
