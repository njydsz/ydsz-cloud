...
/**
 * Spring MessageSource 适配器，将 Spring 国际化机制桥接到框架统一的 {@link MessageResolverHolder.MessageResolver} SPI。
 *
 * <p>支持从 Spring {@link MessageSource} 按当前 {@link Locale} 解析消息，
 * 解析失败时静默回退到 defaultValue。</p>
 *
 * @author ydsz-team
 * @since 1.8.0
...
public class SpringMessageResolver implements MessageResolverHolder.MessageResolver {
     ...
     * 按当前 locale 解析国际化消息。
     *
     * <p>解析异常时静默返回 defaultValue，并输出 DEBUG 日志便于排查 i18n 配置问题。</p>
     *
     * @param key          消息 key
