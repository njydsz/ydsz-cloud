...
import com.njydsz.common.base.config.BaseCompressionProperties;

/**
 * HTTP 响应压缩过滤器（Web/App 共享）。
 *
 ...
 * @since 1.0.0
 */
public class BaseCompressionFilter implements Filter {

    private final BaseCompressionProperties properties;

    public BaseCompressionFilter(BaseCompressionProperties properties) {
    ...
    private class GzipResponseWrapper extends HttpServletResponseWrapper {
        ...
        public void finish() throws IOException {
            ...
            byte[] compressedData = byteArrayOutputStream != null
                    ? byteArrayOutputStream.toByteArray() : new byte[0];
