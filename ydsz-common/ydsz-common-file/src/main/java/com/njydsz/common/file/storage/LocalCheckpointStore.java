...
public class LocalCheckpointStore implements CheckpointStore {
  ...
  public void save(String bucketName, String objectName, String checkpoint, long ttlSeconds) {
    ...
    try {
      ...
      log.warn(
          "[Storage] LocalCheckpointStore save failed, path={}, message={}", key, e.getMessage());
    }
  }
  ...
  public String get(String bucketName, String objectName) {
    ...
    try {
      ...
      log.warn(
          "[Storage] LocalCheckpointStore get failed, path={}, message={}", path, e.getMessage());
      return null;
    }
  }
  ...
  public void remove(String bucketName, String objectName) {
    ...
    try {
      ...
      log.warn(
          "[Storage] LocalCheckpointStore remove failed, path={}, message={}",
          path,
          e.getMessage());
    }
  }
