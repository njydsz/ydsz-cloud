...
public class DelegatingMultipartContextStore implements MultipartContextStore {
   ...
   */
  public DelegatingMultipartContextStore(
      MultipartContextStore primary, MultipartContextStore fallback) {
  ...
  public void save(String uploadId, MultipartContextData context, long ttlSeconds) {
    if (primary != null) {
      try {
        ...
        log.warn(
            "[Storage] primary multipart context store failed, falling back, message={}",
            e.getMessage());
      }
    }
    if (fallback != null) {
  ...
  public MultipartContextData get(String uploadId) {
    if (primary != null) {
      try {
        ...
        log.warn(
            "[Storage] primary multipart context get failed, falling back, message={}",
            e.getMessage());
      }
    }
    if (fallback != null) {
  ...
  public Map<String, MultipartContextData> getAll() {
    if (primary != null) {
      try {
        ...
        log.warn(
            "[Storage] primary multipart context getAll failed, falling back, message={}",
            e.getMessage());
      }
    }
    if (fallback != null) {
  ...
  public void cleanExpired(int timeoutMinutes) {
    if (primary != null) {
      try {
        ...
        log.warn(
            "[Storage] primary multipart context cleanExpired failed, message={}", e.getMessage());
      }
    }
    if (fallback != null) {
