 ...
 *
 * <p><b>迁移说明：</b>本接口原定义于 {@code ydsz-common-core}（v2.1.0 精简核心时移除），
 * 因属于异常处理能力，迁移至 {@code ydsz-common-exception} 模块维护。
 *
 * <p><b>类型说明：</b>{@link #resultCode()} 返回值的实际类型为
 * {@code com.njydsz.common.core.code.ResultCode} 的子类型（通常是 {@link ExceptionCode} 的枚举实现），
