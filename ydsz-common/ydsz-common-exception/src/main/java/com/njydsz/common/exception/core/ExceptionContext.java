 ...
 * <p><b>使用场景：</b>
 * <ul>
 *   <li>异常处理器通过 {@link #getLevel()} / {@link #getCategory()} 打指标 tag</li>
 *   <li>全局异常处理器通过 {@link #getSnapshot()} 透写 details 供排查</li>
 *   <li>业务代码通过 {@link #addData(String, Object)} 在异常抛出点追加上下文</li>
 * </ul>
 *
 * <p><b>线程安全：</b>本类的瞬态容器（snapshot、extData）采用延迟初始化 + 非线程安全 Map。
 * 异常对象的生命周期通常限定在单个请求线程内，无需并发保护；
