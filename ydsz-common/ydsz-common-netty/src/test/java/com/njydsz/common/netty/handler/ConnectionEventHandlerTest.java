...
class ConnectionEventHandlerTest {
    ...
    void testChannelActiveIncrementsCounters() {
        ...
        assertEquals(1.0, registry.counter("ydsz.netty.connections.total").count());
    ...
    void testChannelInactiveDecrementsActiveAndIncrementsDisconnections() {
        ...
        assertEquals(1.0, registry.counter("ydsz.netty.disconnections.total").count());
    }
    ...
    void testMultipleChannelsActive() {
        ...
        assertEquals(3.0, registry.counter("ydsz.netty.connections.total").count());
        ...
        assertEquals(0L, metrics.getActiveChannels());
        assertEquals(3.0, registry.counter("ydsz.netty.disconnections.total").count());
    }
