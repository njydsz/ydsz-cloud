 ...
 *
 * <p>作为 {@link ChannelDuplexHandler} 同时拦截入站读和出站写事件， 将字节数累加到 {@link NettyChannelMetrics}。
 *
 * <p>该 Handler 是 {@code @Sharable} 的，可被多个 Channel 共享， 因为所有统计都委托给同一个 {@link NettyChannelMetrics} 实例。
 *
