 ...
 *
 * <p>在 {@code channelActive} 时递增活跃连接数和累计连接数， 在 {@code channelInactive} 时递减活跃连接数并递增累计断开数。
 *
 * <p>该 Handler 是 {@code @Sharable} 的，可被多个 Channel 共享。 当 {@link NettyChannelMetrics} 为 {@code null}
 * 时降级为空操作。
 *
 * @author ydsz-team
 * @since 26.09.01
