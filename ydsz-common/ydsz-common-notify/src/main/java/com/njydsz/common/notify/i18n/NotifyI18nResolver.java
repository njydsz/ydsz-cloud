...
public class NotifyI18nResolver {
  ...
  public String getMessage(
      String key, String userId, String acceptLanguage, Map<String, Object> params) {
    String lang = resolveLanguage(userId, acceptLanguage);
  ...
  private String parseAcceptLanguage(String acceptLanguage) {
    try {
      Locale locale =
          Locale.forLanguageTag(acceptLanguage.split(",")[0].trim().split(";")[0].trim());
