 ...
 *
 * <p>在 HTML 邮件末尾注入 1&times;1 透明追踪像素，当收件人打开邮件时， 邮件客户端自动请求追踪 URL，服务端记录打开事件。
 *
 * <p><b>P3-1 增强：</b>支持多种追踪事件类型（SENT/DELIVERED/OPENED/CLICKED/BOUNCED/COMPLAINED）， 通过 Webhook
 * 接收第三方服务商的事件推送。
 *
 * <p><b>追踪像素原理：</b>
 *
 * <pre>{@code
 * <img src="https://ydsz.ydsz.com/api/notify/track/open?mid=abc123"
 ...
 *   <li>首次打开时间
 *   <li>最近打开时间
 *   <li>打开设备/客户端（通过 User-Agent）
 *   <li>邮件投递状态（P3-1：sent/delivered/bounced/complained）
 *   <li>点击事件（P3-1）
 * </ul>
 *
...
public class EmailTrackingService {
  ...
  public void recordEvent(
      String trackingId, TrackingEvent event, String userAgent, Map<String, String> metadata) {
