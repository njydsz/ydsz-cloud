...
public interface DeadLetterHandler {
     ...
     */
    void moveToDeadLetter(NotifyChannel channel, String receiver, String title,
    ...
    class DeadLetterEntry {
         ...
         */
        public DeadLetterEntry(String messageId, NotifyChannel channel, String receiver,
                               String title, String content, int failedAttempts,
                               String lastError, long createdAt) {
