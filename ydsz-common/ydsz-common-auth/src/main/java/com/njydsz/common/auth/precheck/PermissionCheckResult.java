 ...
 * <ul>
 *   <li>checkPassed：是否通过
 *   <li>hasPermission：当前用户是否拥有权限
 *   <li>missingPermissions：缺少的权限列表
 *   <li>grantedPermissions：已有的权限列表
 *   <li>message：预检消息
 *   <li>suggestion：建议操作
 * </ul>
 *
...
public class PermissionCheckResult {
   ...
   * 判断当前用户是否拥有所需权限。
   *
   * <p>与 {@link #isCheckPassed()} 的区分：本标志表示权限预检的最终结论， 仅当 {@link #isCheckPassed()} 与本方法均返回 {@code
   * true} 时请求才可放行。
   *
