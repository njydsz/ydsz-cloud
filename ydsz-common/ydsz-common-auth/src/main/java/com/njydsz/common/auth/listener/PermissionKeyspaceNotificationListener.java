 ...
 *
 * <p>监听 Redis 中权限相关 key 的变更事件（set/del/expired）， 精确触发本地缓存失效，替代 Pub/Sub 广播模式的不保证送达问题。
 *
 * <p><b>工作原理：</b>
 *
 * <ol>
 *   <li>Redis 开启 notify-keyspace-events 配置（至少包含 KEA）
 *   <li>监听 __keyevent@0__:set、__keyevent@0__:del、__keyevent@0__:expired 频道
 *   <li>当 ydsz-auth:role-* 相关的 key 发生变更时，解析 roleCode 并清理缓存
 * </ol>
 *
...
public class PermissionKeyspaceNotificationListener {
  ...
  public PermissionKeyspaceNotificationListener(
      RbacPermissionEvaluator permissionEvaluator, String keyPrefix) {
