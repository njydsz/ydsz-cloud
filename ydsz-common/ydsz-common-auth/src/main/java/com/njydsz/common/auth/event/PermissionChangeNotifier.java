 ...
 * 权限变更事件发布器。
 *
 * <p>负责发布权限变更事件到 SPI 扩展点监听器。通过 ServiceLoader 自动发现并排序 所有注册的 {@link PermissionChangeListener} 实现。
 *
 * <p><b>核心功能：</b>
 *
 * <ul>
 *   <li>通过 Spring ApplicationEventPublisher 发布 Spring 事件
 *   <li>通过 ServiceLoader 加载所有 PermissionChangeListener SPI 实现
 *   <li>按 getOrder() 排序后依次通知监听器
 * </ul>
 *
 * @author ydsz-team
 * @since 1.0.0
