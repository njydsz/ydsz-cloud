...
public class ColumnDesensitizationContext {
    ...
    public void addRule(String table, String column, ColumnDesensitizationRule rule) {
        ...
        rules.computeIfAbsent(table, k -> new LinkedHashMap<>())
     ...
     * 脱敏规则配置。
     *
     * <p>封装内置规则枚举与自定义正则/替换模板，供
     * {@link ColumnDesensitizationExecutor#desensitize(String, DesensitizationRuleConfig)} 使用。
     */
