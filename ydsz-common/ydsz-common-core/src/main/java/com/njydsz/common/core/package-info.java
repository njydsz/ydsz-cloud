 ...
 *
 * <p>本模块提供统一 API 响应封装、业务结果码定义、请求级上下文传播、多协议链路追踪、 分页响应封装、全局常量、国际化消息资源、Spring Boot 自动配置等基础能力。
 *
 * <h3>设计定位</h3>
 *
 * <ul>
 *   <li><b>零业务语义</b>：仅承载跨切面技术能力，不泄漏认证、租户、审计等具体业务域代码
 *   <li><b>类型安全</b>：上下文读写以 {@code ContextKey<T>} 为编译期担保入口
 *   <li><b>可观测优先</b>：响应体默认埋入 traceId/spanId/requestId，链路可查
 * </ul>
 *
 * <h3>模块依赖约束</h3>
 *
 ...
 *   <li><b>Lombok</b>（provided 范围）：编译期代码生成
 *   <li><b>slf4j-api</b>：MDC 操作
 * </ul>
 *
 * <h3>编码规范</h3>
 *
