 ...
 * return Response.okWithObservability(data, requestId, spanId);
 * return Response.page(total, pageNum, pageSize, records);
 * return Response.fail(BaseResultCode.NOT_FOUND);
 * }</pre>
 *
 * @author ydsz-team
 * @since 1.9.1
