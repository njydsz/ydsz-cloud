 ...
 * 文档解析器 SPI 接口
 *
 * <p>定义文档解析的标准规范。每种文档格式对应一个实现类， 通过 {@link
 * com.njydsz.common.docs.parser.registry.DocumentParserRegistry} 注册和路由。
 *
 * <p><b>实现要求：</b>
 *
 * <ul>
 *   <li>实现类应保证线程安全，建议使用无状态设计
 *   <li>{@link #parse(InputStream, String, ParseOptions)} 中传入的 InputStream 由调用方负责关闭
 *   <li>大文件解析时应注意内存控制，遵循 {@link ParseOptions#getMaxFileSize()} 限制
 *   <li>解析失败时应抛出 {@link com.njydsz.common.docs.exception.DocumentException}
 * </ul>
 *
 * @author ydsz-team
 * @since 1.0.0
