 ...
 * API 密钥/Token 检测器
 *
 * <p>检测文档中泄露的 API 密钥、Access Token、Secret 等凭据。
 *
 * <p><b>检测模式：</b>
 *
 * <ul>
 *   <li>key=value 格式的凭据（key/secret/token/apikey/password/passphrase）
 *   <li>Bearer Token 格式
 *   <li>AWS Access Key ID 格式（AKIA 开头）
 *   <li>JWT 格式（header.payload.signature）
 * </ul>
 *
 * @author ydsz-team
 * @since 26.09.01
...
public class ApiKeyDetector implements PiiDetector {
  ...
  /** AWS Access Key ID */
  private static final Pattern AWS_PATTERN = Pattern.compile("\\bAKIA[0-9A-Z]{16}\\b");
