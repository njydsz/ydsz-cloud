 ...
 *
 * <p>对应阈值来自 {@link com.njydsz.common.domain.config.DomainProperties}
 * （{@code ydsz.domain.page.cursor-warning-threshold} / {@code cursor-reject-threshold}），
 * 默认值与本枚举的 {@link #DEFAULT_WARN_THRESHOLD} / {@link #DEFAULT_REJECT_THRESHOLD} 保持一致，
 * 便于在脱离 Spring 上下文的场景（如单元测试、纯计算）下直接使用。
 *
 * @author ydsz-team
 * @since 1.6.0
