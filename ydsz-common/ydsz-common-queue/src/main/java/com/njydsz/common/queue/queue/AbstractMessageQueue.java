 ...
 *
 * <ul>
 *   <li>{@link #createPublisher(String)} - 创建消息发布者
 *   <li>{@link #createSubscriber(String)} - 创建消息订阅者
 *   <li>{@link #doClose()} - 执行实际的关闭操作
 * </ul>
 *
 * @author ydsz-team
 * @since 26.09.01
...
public abstract class AbstractMessageQueue implements IMessageQueue {
   ...
   * 执行实际的关闭操作
   *
   * <p>子类需要实现此方法,执行特定队列类型的关闭逻辑, 如关闭连接、释放资源等。
   */
