...
public class DeadLetterQueueServiceImpl implements DeadLetterQueueService {
    ...
    public boolean retry(String topic, String messageId) {
        ...
        DeadLetterMessage dlqMessage = YdszJson.fromJson(dlqMessageObj.toString(), DeadLetterMessage.class);
        ...
        try (Cursor<String> cursor = redisTemplate.scan(scanOptions)) {
            while (cursor.hasNext()) {
                ...
                for (Map.Entry<Object, Object> entry : entries.entrySet()) {
                    ...
                    try {
                        DeadLetterMessage msg = YdszJson.fromJson(entry.getValue().toString(), DeadLetterMessage.class);
