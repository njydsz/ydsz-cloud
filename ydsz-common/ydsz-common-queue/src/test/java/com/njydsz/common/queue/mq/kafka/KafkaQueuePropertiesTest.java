...
class KafkaQueuePropertiesTest {
    ...
    void testDefaultValues() {
        ...
        assertEquals("ydsz-consumer-group", properties.getGroupId());
        assertEquals("ydsz-kafka-topic", properties.getTopic());
    ...
    void testResolvedGroupIdDefaults() {
        ...
        assertEquals("ydsz-consumer-group", properties.resolvedGroupId());
    ...
    void testResolvedTopicDefaults() {
        ...
        assertEquals("ydsz-kafka-topic", properties.resolvedTopic());
