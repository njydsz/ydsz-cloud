 ...
 * Excel 全局配置 — 不可变配置对象。
 *
 * <p>通过 {@link Builder} 或 {@link ExcelProperties#toExcelConfig()} 构建，
 * 一旦创建不可修改。建议通过 {@link WriteMetadata} / {@link ReadMetadata} 传递到读写组件。</p>
 *
 * <h3>线程安全性</h3>
 * <p>所有字段均为 {@code final}，天然线程安全，无需同步。</p>
 *
 * @author ydsz-team
 * @since 1.0.0
 */
public class ExcelConfig {
     ...
     * 委派给 {@link FormulaInjectionGuard}，不受 {@code formulaInjectionProtection} 开关影响。</p>
     *
