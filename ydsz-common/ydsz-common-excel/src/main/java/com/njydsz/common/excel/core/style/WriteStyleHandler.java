...
public class WriteStyleHandler {
   ...
   * 初始化预定义颜色缓存
   *
   * <p>支持的颜色名称: RED, BLUE, GREEN, YELLOW, WHITE, BLACK, GRAY_25_PERCENT, GRAY_50_PERCENT, AUTO
   */
  ...
  private CellStyle createDataStyle(ExcelStyle annotation) {
    ...
    if (bgColor != null
        && !bgColor.equalsIgnoreCase("NO_FILL")
        && !bgColor.equalsIgnoreCase("NONE")) {
   ...
   * 将颜色名称转换为 POI 颜色索引
   *
   * <p>支持的颜色名称包括: RED, BLUE, GREEN, YELLOW, WHITE, BLACK 等
   *
