 ...
 * 分布式锁事件监听器
 *
 * <p>提供锁生命周期事件的 SPI 扩展点，业务方可实现此接口感知锁状态变化，
 * 无需修改框架代码。
 *
 * <p>支持的事件类型：
 * <ul>
 *   <li>{@link #onLockAcquired} - 锁获取成功</li>
 *   <li>{@link #onLockReleased} - 锁释放成功</li>
 *   <li>{@link #onLockAcquireTimeout} - 锁获取超时</li>
 *   <li>{@link #onLockRenewalFailed} - 锁续期失败</li>
 * </ul>
 *
 * <p><b>注意：</b>监听器方法必须轻量快速，避免阻塞锁操作主流程。
 * 如需执行耗时操作，请异步处理。
 *
 * @author ydsz-team
 * @since 1.3.0
...
public interface LockEventListener {
     ...
     */
    default void onLockAcquired(String lockKey, String lockValue, LockType lockType, long waitTimeMs) {
        // 默认空实现
    }
     ...
     */
    default void onLockReleased(String lockKey, String lockValue, LockType lockType, long holdTimeMs) {
        // 默认空实现
    }
