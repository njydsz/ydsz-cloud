 ...
 * </ul>
 *
 * <p>支持结构化上下文（{@link #errorCode}、{@link #lockKey}、{@link #lockType}）， 便于日志告警系统基于错误码进行自动分类与根因分析。
...
public class DistributedLockException extends BusinessException {
  ...
  public DistributedLockException(
      String message, LockExceptionCode errorCode, String lockKey, Throwable cause) {
    super();
