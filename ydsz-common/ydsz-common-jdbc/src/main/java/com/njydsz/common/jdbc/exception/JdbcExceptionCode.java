 ...
 * <ul>
 *   <li>D01xxx — 数据源异常（连接池、路由、健康检查）</li>
 *   <li>D02xxx — SQL 执行异常（解析失败、权限拦截、防火墙拦截）</li>
 *   <li>D03xxx — 读写分离异常（从库不可用、延迟超标）</li>
 *   <li>D04xxx — 熔断与限流异常</li>
 * </ul>
 *
 * <p>每个异常码包含：
 * <ul>
 *   <li>code — 唯一错误码（字符串形式，便于日志检索）</li>
 *   <li>key — 国际化消息键（对应 messages_*.properties）</li>
 *   <li>httpStatus — HTTP 状态码（语义化返回给前端）</li>
 * </ul>
 *
 * @author ydsz-team
 * @since 1.8.0
