 ...
 *
 * <p>MyBatis-Plus 的 {@link com.baomidou.mybatisplus.extension.plugins.MybatisPlusInterceptor} 默认按
 * {@code addInnerInterceptor} 顺序执行，不支持基于 {@link Ordered} 的动态排序。 本包装器让任意 {@link InnerInterceptor} 具备
 * {@link Ordered} 能力，便于在自定义拦截器链 排序、或在 {@link
 * com.baomidou.mybatisplus.extension.plugins.MybatisPlusInterceptor} 外部按优先级重新组织执行顺序。
 *
 * <p>典型用法：
 *
 * <pre>{@code
