 ...
 * </pre>
 *
 * <p>包含主键、审计字段、乐观锁、逻辑删除、状态、租户标识等全部通用列。 业务模块可基于此基类直接继承。
 *
 * <p><b>选型建议：</b>
 *
 * <ul>
 *   <li>需要乐观锁（高并发更新场景）→ 继承 {@link MpBaseEntity} 或 {@link MpVersionedEntity}
 *   <li>不需要乐观锁（纯查询/低频更新场景）→ 继承 {@link MpSimpleEntity}
 *   <li>仅需审计字段 → 继承 {@link MpBaseAuditEntity}
 *   <li>仅需主键 → 继承 {@link MpBaseIdEntity}
 * </ul>
 *
 * <p><b>26.09.01</b>：{@code @Version} 从 {@link MpSimpleEntity} 拆出到 {@link MpVersionedEntity}，
