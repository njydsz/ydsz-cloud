 ...
 * 字段填充处理器抽象基类
 *
 * <p>提供字段填充处理的基础实现，继承自 {@link AbstractSqlHandler}。 通过组合 {@link FieldFillStrategyEnum} 策略控制字段在
 * INSERT/UPDATE 操作时的填充行为。
 *
 * <h2>填充策略</h2>
 *
 * <ul>
 *   <li>{@link FieldFillStrategyEnum#INSERT}：仅在 INSERT 时填充
 *   <li>{@link FieldFillStrategyEnum#UPDATE}：仅在 UPDATE 时填充
 *   <li>{@link FieldFillStrategyEnum#INSERT_UPDATE}：在 INSERT 和 UPDATE 时都填充
 * </ul>
 *
 * <h2>使用示例</h2>
 *
 ...
 */
public abstract class AbstractFieldFillHandler extends AbstractSqlHandler
    implements FieldFillHandler {
   ...
   */
  public AbstractFieldFillHandler(
      FieldFillStrategyEnum fieldFillStrategyEnum, InterceptConfig interceptConfig) {
