...
public class RetryableMessage implements Serializable {
   ...
   * @return 可重试消息
   */
  public static RetryableMessage forUser(
      String messageId,
      String userId,
      String type,
      String payloadJson,
   ...
   * @return 可重试消息
   */
  public static RetryableMessage forBroadcast(
      String messageId, String type, String payloadJson, int maxRetries, long retryDelayMs) {
    return new RetryableMessage(
        messageId,
        "BROADCAST",
        null,
   ...
   * @return 可重试消息
   */
  public static RetryableMessage forTopic(
      String messageId,
      String topic,
      String type,
      String payloadJson,
