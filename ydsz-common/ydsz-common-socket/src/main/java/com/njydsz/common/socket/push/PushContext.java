 ...
 *
 * <p>相比仅传递 {@code (userId, pushType, payloadHash)} 的旧接口，PushContext
 * 携带原始 payload 对象、业务类型标签、messageId、优先级等丰富信息，
 * 使过滤器能实现更精细的策略（如：按业务类型限流、按优先级豁免频率限制等）。
 *
...
public record PushContext(
    ...
    public static PushContext forUser(String userId, String type, Object payload, String priority) {
        return new PushContext(userId, "USER", type, payload, null, priority, System.currentTimeMillis(), null);
    }
     ...
     * @return PushContext
     */
    public static PushContext forUser(String userId, String type, Object payload, String messageId, String priority) {
        return new PushContext(userId, "USER", type, payload, messageId, priority, System.currentTimeMillis(), null);
    }
    ...
    public static PushContext forBroadcast(String type, Object payload, String priority) {
        return new PushContext(null, "BROADCAST", type, payload, null, priority, System.currentTimeMillis(), null);
    }
    ...
    public static PushContext forTopic(String topic, String type, Object payload, String priority) {
        return new PushContext(null, "TOPIC", type, payload, null, priority, System.currentTimeMillis(), topic);
    }
}
