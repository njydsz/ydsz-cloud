...
p = pathlib.Path(r'd:\Code\ydsz\ydsz-cloud\ydsz-cloud\ydsz-common\ydsz-common-socket\src\main\java\com\ydszsoft\common\socket\config\WebSocketAutoConfiguration.java')
