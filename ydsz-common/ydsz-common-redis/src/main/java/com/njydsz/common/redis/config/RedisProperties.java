...
public class RedisProperties {
   ...
   *
   * <p>控制防穿透锁、防击穿锁的租约时间、自旋等待时间、续期间隔等参数。 未配置时使用合理的默认值。
   */
   ...
   *
   * <p>所有时间参数均可通过 ydsz.redis.cache-guard.* 配置覆盖。默认值经过 常规业务场景调优，大多数情况下无需修改。
   */
  @Data
  public static class CacheGuard {
     ...
     * 防击穿锁租约时间（秒）
     *
     * <p>默认：10 秒。热点 key 回源时间一般短于 10 秒； 超过该时间仍未完成时 WatchDog 会自动续期。
     */
