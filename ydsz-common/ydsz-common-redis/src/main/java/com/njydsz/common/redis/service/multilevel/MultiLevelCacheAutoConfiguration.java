 ...
 * <ul>
 *   <li>Caffeine 位于 classpath（{@code @ConditionalOnClass Caffeine}）</li>
 *   <li>{@code ydsz.redis.multilevel.enabled=true}（默认 false）</li>
 *   <li>容器中不存在其他 {@link CacheProvider} 实现</li>
 * </ul>
 *
 * <p><b>配置示例：</b>
 * <pre>{@code
...
@AutoConfigureAfter(name = {
        "com.njydsz.common.redis.config.RedisConfiguration"
})
...
public class MultiLevelCacheAutoConfiguration {
     ...
     * 创建多级缓存提供者
     *
     * <p>仅在容器中不存在 {@link CacheProvider} Bean 时创建，避免与默认 Redis 缓存冲突。
     * L1 容量与 TTL 从 {@link RedisProperties.MultiLevel} 配置读取。
     *
    ...
    public MultiLevelCacheProvider multiLevelCacheProvider(RedisStringOps redisStringOps,
