 ...
 * <p><b>命名规范：</b>
 * <ul>
 *   <li>必须使用小写字母、数字、下划线、连字符和冒号</li>
 *   <li>推荐结构：{@code {业务域}:{子域}:{标识符}}，如 {@code user:info:10086}、{@code order:status:20240101}</li>
 *   <li>禁止空格、特殊字符和中文</li>
 *   <li>Key 长度建议控制在 64 字符以内</li>
 *   <li>临时性数据（锁、限流、验证码）应使用独立业务域前缀（{@code lock:}、{@code ratelimit:}、{@code captcha:}）</li>
 * </ul>
 *
 * <p><b>使用场景：</b>
 * <ul>
 *   <li>单元测试中校验 Key 命名合规性</li>
 *   <li>Code Review 时人工对照检查</li>
 *   <li>配合 Redis MONITOR / SCAN 做命名规范巡检</li>
 * </ul>
 *
 * <p><b>使用示例：</b>
 * <pre>{@code
...
public final class RedisKeyNamingConvention {
     ...
     * <p>示例匹配：{@code user:info:10086}、{@code ratelimit:api:login:10086}、{@code captcha:sms:13800138000}
     */
