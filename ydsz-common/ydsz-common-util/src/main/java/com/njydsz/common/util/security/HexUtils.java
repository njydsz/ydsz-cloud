 ...
 * Hex 编解码工具类（统一入口）。
 *
 * <p>提供字节数组 ↔ Hex 字符串的安全转换，替代JDK之前 AesUtils / Sm4Utils 各自实现的
 * {@code bytesToHex} / {@code hexToBytes} 方法。所有安全模块的 Hex 编解码都应使用本类。
 *
...
public final class HexUtils {
     ...
     *
     * <p>与 {@link #encode(byte[])} 行为一致，但输入 null 时返回 null 而非抛异常，
     * 适用于不确定输入是否为 null 的场景。
     *
