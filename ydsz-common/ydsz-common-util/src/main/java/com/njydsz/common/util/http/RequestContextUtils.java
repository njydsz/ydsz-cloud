 ...
 *
 * <p>封装从 Spring {@link RequestContextHolder} 获取当前 HTTP 请求/响应的能力， 统一处理 Servlet 环境检测与异常降级。
 *
...
public final class RequestContextUtils {
   ...
   *
   * <p>通过 Spring RequestContextHolder 获取，仅在 Servlet 请求上下文中可用。 非 Web 环境或未绑定请求上下文时返回 null。
   *
