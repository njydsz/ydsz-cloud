 ...
 * 业务校验工具类
 *
 * <p>提供中国常用业务数据的格式校验能力，所有方法均为 null 安全。
 * 校验规则遵循国家标准（GB 11643-1999 身份证、GB 32100-2015 统一社会信用代码等）。
 *
 * <p><b>规则说明：</b>
 * <ul>
 *   <li>手机号：1开头，第二位3-9，共11位</li>
 *   <li>身份证：18位，末位可为 X，含校验码验证</li>
 *   <li>统一社会信用代码：18位，含校验码验证（GB 32100-2015）</li>
 *   <li>银行卡：13-19位数字，Luhn 算法校验</li>
 * </ul>
 *
...
public final class ValidationUtils {
    ...
    private static final Pattern PLATE_NUMBER_PATTERN = Pattern.compile(
            "^[京津沪渝冀豫云辽黑湘皖鲁新苏浙赣鄂桂甘晋蒙陕吉闽贵粤青藏川宁琼使领][A-Z][A-HJ-NP-Z0-9]{4,5}"
                    + "[A-HJ-NP-Z0-9挂学警港澳]$");
    ...
    /** 统一社会信用代码加权因子 */
    private static final int[] SOCIAL_CREDIT_WEIGHTS = {1, 3, 9, 27, 19, 26, 16, 17, 20, 29, 25, 13, 8, 24, 10, 30, 28};
