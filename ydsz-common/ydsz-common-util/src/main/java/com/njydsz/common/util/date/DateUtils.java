 ...
 *
 * <p>提供 Java 8+ 日期时间 API 的高频操作方法，线程安全。
 * 涵盖：日期边界（日开始/结束/月开始/结束）、日期间差值计算、
 * 工作日计算、格式化与解析、常见判断（闰年/周末/今天）。
 *
 * <p><b>线程安全：</b>所有方法均使用 {@link java.time.format.DateTimeFormatter}，
 * 它是线程安全的（与 {@link java.text.SimpleDateFormat} 不同）。
 *
 * @author ydsz-team
 * @since 4.0.0
 */
