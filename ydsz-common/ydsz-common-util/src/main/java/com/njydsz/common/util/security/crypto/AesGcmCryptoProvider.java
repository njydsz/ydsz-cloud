 ...
 *
 * <p>支持 128 位和 256 位密钥，默认 256 位。
 * 内部使用 ThreadLocal Cipher 池避免 Provider 查找开销。
 *
 * <p><b>密文格式：</b>IV(12 bytes) || ciphertext + GCM tag(16 bytes)
 *
 * <p><b>线程安全：</b>Cipher 实例 ThreadLocal 隔离，generateKey/generateIv 使用共享
 * SecureRandom（内部同步），多线程安全。
 *
 * @author ydsz-team
 * @since 3.0.0
 */
