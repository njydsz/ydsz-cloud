 ...
 *
 * <ol>
 *   <li>显式配置：{@code ydsz.util.snowflake.worker-id}
 *   <li>PodOrdinal：{@link PodOrdinalWorkerIdAllocator} 从 StatefulSet 主机名解析序号
 *   <li>IpHash：{@link IpHashWorkerIdAllocator} 基于本地 IPv4 地址哈希
 * </ol>
 *
 * @author ydsz-team
 * @since 1.0.0
