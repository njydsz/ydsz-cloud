 ...
 *
 * <p>继承 {@link BaseRequestIdResponseFilter}，在响应头中注入 TraceId， 便于前端进行问题排查和日志关联。
 *
 * <p><b>工作流程：</b>
 *
 * <ol>
 *   <li>从 {@link TracerUtils} 获取或生成 TraceId
 *   <li>将 TraceId 写入响应头（{@code X-Trace-Id}）
 *   <li>过滤器结束后清理 ThreadLocal 中的 TraceId
 * </ol>
 *
 * @author ydsz-team
