...
public class OutboxService {
     ...
     *   <li>deduplicationId - 若显式指定则使用</li>
    ...
    public void appendToOutbox(OutboxMessage.OutboxMessageBuilder partialBuilder) {
        ...
        if (deduplicationId != null && outboxRepository.existsByDeduplicationId(deduplicationId)) {
            log.info("Outbox message skipped (duplicate): aggregateType={}, aggregateId={}, eventType={}, "
                            + "deduplicationId={}",
        ...
        log.debug("Outbox message appended: id={}, type={}, aggregate={}/{}, tenant={}",
     ...
     * {@link #appendToOutbox(OutboxMessage.OutboxMessageBuilder)} 可显著减少数据库往返。
     *
     * <p><b>注意：</b>
     * <ul>
