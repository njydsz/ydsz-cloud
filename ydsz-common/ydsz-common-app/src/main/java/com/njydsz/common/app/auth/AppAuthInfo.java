 ...
 * App 端认证上下文信息
 *
 * <p>存储 App 请求处理过程中所需的认证上下文数据（如用户 ID、租户 ID、Token 等）， 通过 {@link
 * com.njydsz.common.core.context.RequestContext} 在请求线程内传递。
 *
 * <p><b>服务类型：</b>固定返回字符串 {@code "appService"}， 与 Web 端、管理端的认证上下文作区分。
 *
