...
public final class OtelSemConv {
    ...
    /** 租户 ID */
    public static final AttributeKey<String> REMI_TENANT_ID = AttributeKey.stringKey("ydsz.tenant.id");
    /** 业务单号 */
    public static final AttributeKey<String> REMI_BUSINESS_NO = AttributeKey.stringKey("ydsz.business_no");
    /** 用户 ID */
    public static final AttributeKey<String> REMI_USER_ID = AttributeKey.stringKey("ydsz.user.id");
    /** 客户端类型（web/app/inner） */
    public static final AttributeKey<String> REMI_CLIENT_TYPE = AttributeKey.stringKey("ydsz.client.type");
    /** 错误码 */
    public static final AttributeKey<String> REMI_ERROR_CODE = AttributeKey.stringKey("ydsz.error.code");
    /** 业务模块 */
    ...
    /** 压测标记 */
    public static final AttributeKey<String> REMI_PRESSURE_TAG = AttributeKey.stringKey("ydsz.pressure.tag");
