 ...
 * 租户级限流门面。
 *
 * <p>将 {@code ydsz-common-redis} 的 {@code RedisRateLimiter} 包装为按租户维度限流， 自动在限流 Key
 * 前添加租户前缀，确保各租户限流配额相互隔离。
 *
 * <p>支持的算法：
 *
 * <ul>
 *   <li><b>固定窗口</b>：按时间窗口计数，窗口切换时存在 2x 突发，适用于粗粒度限流
 *   <li><b>滑动窗口</b>：分桶计数，限流平滑，适用于严格限流场景
...
public class TenantRateLimiter {
  ...
  public boolean tryAcquireTokenBucket(
      String ruleName, int rate, int capacity, Duration period, int permits) {
