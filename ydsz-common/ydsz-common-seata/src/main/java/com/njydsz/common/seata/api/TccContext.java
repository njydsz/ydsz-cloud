 ...
 *
 * <p><b>P2-4 修复</b>：{@link #getAll()} 不再使用 {@code Map.copyOf(data)} 遍历 live view， 改为先复制为 {@link
 * HashMap} 再包装为不可变 Map，确保快照一致性。
 *
 * <p><b>P2-5 修复</b>：{@link #getLong(String)} 解析失败时不再抛出未声明的 {@link NumberFormatException}，改为返回 null
 * 并记录警告。
 *
 * @author ydsz-team
 * @since 1.0.0
