 ...
 *
 * <p><b>P1-1 修复</b>：此前使用普通 {@link ThreadLocal} 存储 XID，在 {@code @Async}、
 * {@code CompletableFuture}、手动线程池场景下 XID 丢失，导致事务链路断裂。
 *
...
public class SeataTaskDecorator implements TaskDecorator {
     ...
     * <p>流程：
     * <ol>
     *   <li>捕获提交线程的当前 XID（如有）</li>
     *   <li>包装任务，在子线程中绑定 XID</li>
     *   <li>任务执行完毕后解绑 XID（无论成功失败）</li>
     * </ol>
     *
     * @param runnable 原始任务
