 ...
 *
 * <ul>
 *   <li>{@link #INIT} - Try 尚未执行
 *   <li>{@link #TRYING} - Try 正在执行
 *   <li>{@link #TRIED} - Try 执行完成，等待 Confirm/Cancel
 *   <li>{@link #CONFIRMING} - Confirm 正在执行
 *   <li>{@link #CONFIRMED} - Confirm 执行完成（终态）
 *   <li>{@link #CANCELLING} - Cancel 正在执行
 *   <li>{@link #CANCELLED} - Cancel 执行完成（终态）
 * </ul>
 *
 * <p>状态流转规则：
 *
