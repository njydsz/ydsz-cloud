 ...
 *
 * <ul>
 *   <li><b>Seata AT</b> - 自动补偿型，通过 undo_log 自动回滚
 *   <li><b>TCC</b> - Try-Confirm-Cancel，业务层手动补偿
 *   <li><b>SAGA</b> - 长事务编排，通过状态机驱动补偿
 *   <li><b>Local</b> - 本地事务降级（单机模式下使用）
 * </ul>
 *
 * <p>使用示例：
 *
 ...
 * }</pre>
 *
 * <p><b>设计原则</b>：本接口仅暴露核心事务能力，suspend/resume 等长事务语义 通过独立的子接口实现，避免接口膨胀。
 *
 * @author ydsz-team
 * @since 1.0.0
 */
