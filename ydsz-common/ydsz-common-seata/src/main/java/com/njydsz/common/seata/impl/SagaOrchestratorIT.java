...
public final class SagaOrchestratorIT {
  ...
  static void testSagaForwardSuccess() throws Exception {
    ...
    List<SagaStep<Void>> steps =
        List.of(
            SagaStep.of(
                "step1",
                () -> {
                  executionLog.add("step1-forward");
                  return null;
                },
            ...
            SagaStep.of(
                "step2",
                () -> {
                  executionLog.add("step2-forward");
                  return null;
                },
    ...
    List<SagaStep<Void>> steps =
        List.of(
            ...
            SagaStep.of(
                "step2-fail",
                () -> {
                  executionLog.add("step2-fail-forward");
            ...
            SagaStep.of(
                "step3-never-reached",
                () -> {
                  executionLog.add("step3-never-reached");
                  return null;
                },
  ...
  static void testSagaExecuteWithCompensation() {
    ...
    try {
      orchestrator.executeWithCompensation(
          "compatTest",
          () -> {
    ...
    List<SagaStep<Void>> steps =
        List.of(
            SagaStep.terminal(
                "terminal-step",
                () -> {
                  executionLog.add("terminal-forward");
                  return null;
                }),
            SagaStep.of(
                "fail-step",
                () -> {
                  executionLog.add("fail-forward");
