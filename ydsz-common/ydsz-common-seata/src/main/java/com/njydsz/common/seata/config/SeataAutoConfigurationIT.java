 ...
 * <p>验证自动配置类在以下场景正确装配：
 * <ul>
 *   <li>ydsz.seata.enabled=true 时注册 DistributedTransactionManager</li>
 *   <li>ydsz.seata.default-type=LOCAL 时使用 LocalTransactionManager</li>
 *   <li>配置属性正确绑定到 SeataProperties</li>
 * </ul>
 *
...
public final class SeataAutoConfigurationIT {
    ...
    static void verifySeataEnabled() {
        ...
        contextRunner
                .withPropertyValues("ydsz.seata.enabled=true",
                        "ydsz.seata.default-type=LOCAL")
                .run(context -> {
