 ...
 * TCC Action 注册表
 *
 * <p>管理 Spring 容器中所有 {@link TccAction} Bean 的注册表， 支持通过 Bean 名称查找 TCC Action 实例，用于跨实例的事务恢复。
 *
 * <p><b>设计目的</b>：替代原 {@code registeredActions} 内存 Map， 解决实例重启后 TCC Action 丢失的问题。通过 Spring Bean
