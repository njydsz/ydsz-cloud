 ...
 * MySQL 数据库方言提供者
 *
 * <p>使用 MySQL 专有的 {@code INSERT ... ON DUPLICATE KEY UPDATE} 语法实现 UPSERT，
 * 性能优于标准 SQL 的 {@code MERGE INTO}。
 *
 * @author ydsz-team
 * @since 1.3.0
 */
public class MysqlTransactionDialectProvider implements TccTransactionDialectProvider {
     ...
     *
     * <p>使用 {@code INSERT ... ON DUPLICATE KEY UPDATE} 语法，
     * 需保证表上有 UNIQUE KEY (xid, branch_id)。
     */
    @Override
