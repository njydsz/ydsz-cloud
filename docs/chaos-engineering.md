...
```bash
# 实验 1: 单次慢调用
curl -X POST http://pmis-system:9001/api/v1/chaos/experiments \
...
curl -X PUT http://pmis-system:9001/api/v1/feature-flags/CANARY_DEPLOY/enabled?enabled=false
```
        ...
        spec:
          ...
          - name: chaos
            ...
            - |
              ...
              sleep 300
              curl -X DELETE http://pmis-system:9001/api/v1/chaos/experiments/ContractService.getContract
