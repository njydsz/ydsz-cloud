<!--
  ===========================================================================
  文件名: encrypted-field-rollout.md
  路径:   docs/security/encrypted-field-rollout.md
  作用:   PMIS 7 类敏感字段（身份证/手机号/银行卡/邮箱/地址/姓名/自定义）从明文到密文的灰度切换 SOP
  阶段:   5 阶段双轨制（双轨 + 灰度 + 可回滚）
  总工期: 4 周
  关联:   dengbao-2.0-3-level-checklist.md  /  deploy/migration/  /  standards/code-quality.md
  ===========================================================================
-->
