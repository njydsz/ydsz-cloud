<!--
  ===========================================================================
  文件名: multi-tenant-evaluation.md
  路径:   docs/multi-tenant-evaluation.md
  作用:   PMIS 多租户架构评估报告：方案对比、可行性、成本、路线图
  现状:   单租户私有化部署（76 实体表，无 tenant_id）
  关联:   standards/database-spec.md  /  standards/api-spec.md
  ===========================================================================
-->
