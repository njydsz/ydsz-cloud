<!--
  ===========================================================================
  文件名: baseline-report.md
  路径:   docs/perf/baseline-report.md
  作用:   PMIS 性能基线报告（v1.1），含 6 套 JMeter 压测场景 + 24h Soak + 500 并发阶梯 + Lighthouse CI
  验收:   页面加载 ≤2s / 操作响应 ≤200ms / 报表查询 ≤5s / 500 并发压力通过
  关联:   deploy/perf/  /  standards/performance-benchmark.md
  ===========================================================================
-->
